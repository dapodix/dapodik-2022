...
/**
 * This class defines the structure of the 'vld_rombel' table.
 *
 *
 *
 ...
 */
class VldRombelTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldRombelTableMap';
