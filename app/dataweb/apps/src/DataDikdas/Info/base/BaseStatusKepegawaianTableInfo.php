...
/*
 * The Base TableInfo for StatusKepegawaian Table
 */
class BaseStatusKepegawaianTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.StatusKepegawaianTableMap';
    ...
    {
        $this->setName('status_kepegawaian');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'status_kepegawaian_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'status_kepegawaian_id_str');
        $this->setHeader(           'Ref.status Kepegawaian');
        $this->setLabel(            'Ref.status kepegawaian');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.statuskepegawaiancombo');
        $this->setXtypeRadio(       'ref.statuskepegawaianradio');
        $this->setXtypeList(        'ref.statuskepegawaianlist');
