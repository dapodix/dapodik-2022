...
/*
 * The Base TableInfo for PenghasilanOrangtuaWali Table
 */
class BasePenghasilanOrangtuaWaliTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PenghasilanOrangtuaWaliTableMap';
    ...
    {
        $this->setName('penghasilan_orangtua_wali');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'penghasilan_orangtua_wali_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'penghasilan_orangtua_wali_id_str');
        $this->setHeader(           'Ref.penghasilan Orangtua Wali');
        $this->setLabel(            'Ref.penghasilan orangtua wali');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.penghasilanorangtuawalicombo');
        $this->setXtypeRadio(       'ref.penghasilanorangtuawaliradio');
        $this->setXtypeList(        'ref.penghasilanorangtuawalilist');
        ...
        $cvar->setColumnName(       'penghasilan_orangtua_wali_id');
        $cvar->setColumnPhpName(    'PenghasilanOrangtuaWaliId');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'batas_bawah');
        $cvar->setColumnPhpName(    'BatasBawah');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Batas Bawah');
        $cvar->setLabel(            'Batas bawah');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'batas_atas');
        $cvar->setColumnPhpName(    'BatasAtas');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Batas Atas');
        $cvar->setLabel(            'Batas atas');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
