 ...
 * @method VldPtkQuery orderByKeterangan($order = Criteria::ASC) Order by the keterangan column
 ...
 * @method VldPtkQuery groupByKeterangan() Group by the keterangan column
 ...
 * @method VldPtk findOneByKeterangan(string $keterangan) Return the first VldPtk filtered by the keterangan column
 ...
 * @method array findByKeterangan(string $keterangan) Return VldPtk objects filtered by the keterangan column
...
abstract class BaseVldPtkQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "logid", "ptk_id", "idtype", "status_validasi", "field_error", "error_message", "app_username", "keterangan", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "vld_ptk" WHERE "logid" = :p0';
        try {
    ...
    public function filterByKeterangan($keterangan = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VldPtkPeer::KETERANGAN, $keterangan, $comparison);
    }
