...
/*
 * The Base TableInfo for JenisTunjangan Table
 */
class BaseJenisTunjanganTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisTunjanganTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_tunjangan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_tunjangan_id_str');
        $this->setHeader(           'Ref.jenis Tunjangan');
        $this->setLabel(            'Ref.jenis tunjangan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenistunjangancombo');
        $this->setXtypeRadio(       'ref.jenistunjanganradio');
        $this->setXtypeList(        'ref.jenistunjanganlist');
        ...
        $cvar->setColumnName(       'jenis_tunjangan_id');
        $cvar->setColumnPhpName(    'JenisTunjanganId');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
