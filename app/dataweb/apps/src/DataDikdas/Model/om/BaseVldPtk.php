...
abstract class BaseVldPtk extends BaseObject implements Persistent
{
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldPtkPeer::KETERANGAN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldPtkPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldPtkPeer::KETERANGAN)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldPtkPeer::KETERANGAN)) $criteria->add(VldPtkPeer::KETERANGAN, $this->keterangan);
