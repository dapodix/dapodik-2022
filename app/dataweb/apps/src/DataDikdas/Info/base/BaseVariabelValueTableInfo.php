...
/*
 * The Base TableInfo for VariabelValue Table
 */
class BaseVariabelValueTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.VariabelValueTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'variabel_value_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'variabel_value_id_str');
        $this->setHeader(           'Variabel Value');
        $this->setLabel(            'Variabel value');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "Variabel"));
        ...
        $cvar->setColumnName(       'variabel_value_id');
        $cvar->setColumnPhpName(    'VariabelValueId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setComboXtype(       'variabelvalueid');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'value_id');
        $cvar->setColumnPhpName(    'ValueId');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'value_name');
        $cvar->setColumnPhpName(    'ValueName');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Value Name');
        $cvar->setLabel(            'Value name');
