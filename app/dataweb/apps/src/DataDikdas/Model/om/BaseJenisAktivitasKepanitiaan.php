...
/**
 * Base class that represents a row from the 'ref.jenis_aktivitas_kepanitiaan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisAktivitasKepanitiaan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisAktivitasKepanitiaanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JenisAktivitasKepanitiaanPeer
     */
    ...
    /**
     * The value for the nm_jns_akt_pan field.
     * @var        string
     */
    protected $nm_jns_akt_pan;
    ...
    /**
     * Initializes internal state of BaseJenisAktivitasKepanitiaan object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nm_jns_akt_pan] column value.
     * 
     * @return string
     */
    public function getNmJnsAktPan()
    {
        return $this->nm_jns_akt_pan;
    }
     ...
     * @return JenisAktivitasKepanitiaan The current object (for fluent API support)
     */
    public function setIdJnsAktPan($v)
    {
        ...
        if ($this->id_jns_akt_pan !== $v) {
            ...
            $this->modifiedColumns[] = JenisAktivitasKepanitiaanPeer::ID_JNS_AKT_PAN;
        }
    ...
    /**
     * Set the value of [nm_jns_akt_pan] column.
     * 
     * @param string $v new value
     * @return JenisAktivitasKepanitiaan The current object (for fluent API support)
     */
    public function setNmJnsAktPan($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->nm_jns_akt_pan !== $v) {
            $this->nm_jns_akt_pan = $v;
            $this->modifiedColumns[] = JenisAktivitasKepanitiaanPeer::NM_JNS_AKT_PAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisAktivitasKepanitiaanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisAktivitasKepanitiaanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisAktivitasKepanitiaanPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisAktivitasKepanitiaanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_jns_akt_pan = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->nm_jns_akt_pan = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = JenisAktivitasKepanitiaanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisAktivitasKepanitiaan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisAktivitasKepanitiaanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisAktivitasKepanitiaanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisAktivitasKepanitiaanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::ID_JNS_AKT_PAN)) {
            $modifiedColumns[':p' . $index++]  = '"id_jns_akt_pan"';
        }
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::NM_JNS_AKT_PAN)) {
            $modifiedColumns[':p' . $index++]  = '"nm_jns_akt_pan"';
        }
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_aktivitas_kepanitiaan" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_jns_akt_pan"':						
                        ...
                        break;
                    case '"nm_jns_akt_pan"':						
                        $stmt->bindValue($identifier, $this->nm_jns_akt_pan, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisAktivitasKepanitiaanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisAktivitasKepanitiaanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JenisAktivitasKepanitiaan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisAktivitasKepanitiaan'][$this->getPrimaryKey()] = true;
        $keys = JenisAktivitasKepanitiaanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdJnsAktPan(),
            $keys[1] => $this->getNmJnsAktPan(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdJnsAktPan($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNmJnsAktPan($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::ID_JNS_AKT_PAN)) $criteria->add(JenisAktivitasKepanitiaanPeer::ID_JNS_AKT_PAN, $this->id_jns_akt_pan);
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::NM_JNS_AKT_PAN)) $criteria->add(JenisAktivitasKepanitiaanPeer::NM_JNS_AKT_PAN, $this->nm_jns_akt_pan);
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::CREATE_DATE)) $criteria->add(JenisAktivitasKepanitiaanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::LAST_UPDATE)) $criteria->add(JenisAktivitasKepanitiaanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::EXPIRED_DATE)) $criteria->add(JenisAktivitasKepanitiaanPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisAktivitasKepanitiaanPeer::LAST_SYNC)) $criteria->add(JenisAktivitasKepanitiaanPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisAktivitasKepanitiaanPeer::DATABASE_NAME);
        $criteria->add(JenisAktivitasKepanitiaanPeer::ID_JNS_AKT_PAN, $this->id_jns_akt_pan);
    ...
    /**
     * Generic method to set the primary key (id_jns_akt_pan column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdJnsAktPan();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisAktivitasKepanitiaan (or compatible) type.
    ...
    {
        $copyObj->setNmJnsAktPan($this->getNmJnsAktPan());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdJnsAktPan(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisAktivitasKepanitiaan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisAktivitasKepanitiaanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisAktivitasKepanitiaanPeer();
        }
     ...
     * If this JenisAktivitasKepanitiaan is new, it will return
        ...
        if (null === $this->collAktivitasKepanitiaans || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAktivitasKepanitiaans) {
                ...
                $collAktivitasKepanitiaans = AktivitasKepanitiaanQuery::create(null, $criteria)
                    ->filterByJenisAktivitasKepanitiaan($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setAktivitasKepanitiaans(PropelCollection $aktivitasKepanitiaans, PropelPDO $con = null)
    {
        ...
        foreach ($aktivitasKepanitiaansToDelete as $aktivitasKepanitiaanRemoved) {
            $aktivitasKepanitiaanRemoved->setJenisAktivitasKepanitiaan(null);
        }
    ...
    protected function doAddAktivitasKepanitiaan($aktivitasKepanitiaan)
    {
        ...
        $aktivitasKepanitiaan->setJenisAktivitasKepanitiaan($this);
    }
    ...
    public function removeAktivitasKepanitiaan($aktivitasKepanitiaan)
    {
        if ($this->getAktivitasKepanitiaans()->contains($aktivitasKepanitiaan)) {
            ...
            $aktivitasKepanitiaan->setJenisAktivitasKepanitiaan(null);
        }
     ...
     * Otherwise if this JenisAktivitasKepanitiaan is new, it will return
     * an empty collection; or if this JenisAktivitasKepanitiaan has previously
     * been saved, it will retrieve related AktivitasKepanitiaans from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisAktivitasKepanitiaan.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(JenisAktivitasKepanitiaanPeer::DEFAULT_STRING_FORMAT);
    }
