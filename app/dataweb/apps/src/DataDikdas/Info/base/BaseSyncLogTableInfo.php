...
/*
 * The Base TableInfo for SyncLog Table
 */
class BaseSyncLogTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.SyncLogTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'sync_log_id_str');
        $this->setHeader(           'Sync Log');
        $this->setLabel(            'Sync log');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "Instalasi"));
        ...
        $cvar->setColumnName(       'sync_log_id');
        $cvar->setColumnPhpName(    'SyncLogId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'id_instalasi');
        $cvar->setColumnPhpName(    'IdInstalasi');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'Instalasi');
        $cvar->setMin(              0);
        ...
        $cvar->setHideColumn(       1);
        $cvar->setXtype(            'hidden');
        $cvar->setComboXtype(       'instalasicombo');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'begin_sync');
        $cvar->setColumnPhpName(    'BeginSync');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'end_sync');
        $cvar->setColumnPhpName(    'EndSync');
        $cvar->setType(             'timestamp');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'End Sync');
        $cvar->setLabel(            'End sync');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sync_media');
        $cvar->setColumnPhpName(    'SyncMedia');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Sync Media');
        $cvar->setLabel(            'Sync media');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'is_success');
        $cvar->setColumnPhpName(    'IsSuccess');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Is Success');
        $cvar->setLabel(            'Is success');
        $cvar->setInputLength(      100);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'selisih_waktu_server');
        $cvar->setColumnPhpName(    'SelisihWaktuServer');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Selisih Waktu Server');
        $cvar->setLabel(            'Selisih waktu server');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
