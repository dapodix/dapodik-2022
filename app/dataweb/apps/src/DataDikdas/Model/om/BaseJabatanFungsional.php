...
/**
 * Base class that represents a row from the 'ref.jabatan_fungsional' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJabatanFungsional extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JabatanFungsionalPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JabatanFungsionalPeer
     */
    ...
    /**
     * Initializes internal state of BaseJabatanFungsional object.
     * @see        applyDefaults()
     */
     ...
     * @return JabatanFungsional The current object (for fluent API support)
     */
    public function setJabatanFungsionalId($v)
    {
        ...
        if ($this->jabatan_fungsional_id !== $v) {
            ...
            $this->modifiedColumns[] = JabatanFungsionalPeer::JABATAN_FUNGSIONAL_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = JabatanFungsionalPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JabatanFungsionalPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JabatanFungsionalPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JabatanFungsionalPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JabatanFungsionalPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jabatan_fungsional_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = JabatanFungsionalPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JabatanFungsional object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JabatanFungsionalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JabatanFungsionalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JabatanFungsionalPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JabatanFungsionalPeer::JABATAN_FUNGSIONAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jabatan_fungsional_id"';
        }
        if ($this->isColumnModified(JabatanFungsionalPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(JabatanFungsionalPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JabatanFungsionalPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JabatanFungsionalPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JabatanFungsionalPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jabatan_fungsional" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JabatanFungsionalPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JabatanFungsionalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JabatanFungsional'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JabatanFungsional'][$this->getPrimaryKey()] = true;
        $keys = JabatanFungsionalPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getJabatanFungsionalId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setJabatanFungsionalId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JabatanFungsionalPeer::JABATAN_FUNGSIONAL_ID)) $criteria->add(JabatanFungsionalPeer::JABATAN_FUNGSIONAL_ID, $this->jabatan_fungsional_id);
        if ($this->isColumnModified(JabatanFungsionalPeer::NAMA)) $criteria->add(JabatanFungsionalPeer::NAMA, $this->nama);
        if ($this->isColumnModified(JabatanFungsionalPeer::CREATE_DATE)) $criteria->add(JabatanFungsionalPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JabatanFungsionalPeer::LAST_UPDATE)) $criteria->add(JabatanFungsionalPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JabatanFungsionalPeer::EXPIRED_DATE)) $criteria->add(JabatanFungsionalPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JabatanFungsionalPeer::LAST_SYNC)) $criteria->add(JabatanFungsionalPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JabatanFungsionalPeer::DATABASE_NAME);
        $criteria->add(JabatanFungsionalPeer::JABATAN_FUNGSIONAL_ID, $this->jabatan_fungsional_id);
    ...
    /**
     * Generic method to set the primary key (jabatan_fungsional_id column).
     *
    ...
    {
        $this->setJabatanFungsionalId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getJabatanFungsionalId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JabatanFungsional (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setJabatanFungsionalId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JabatanFungsional Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JabatanFungsionalPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JabatanFungsionalPeer();
        }
     ...
     * If this JabatanFungsional is new, it will return
        ...
        if (null === $this->collRwyFungsionals || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collRwyFungsionals) {
                ...
                $collRwyFungsionals = RwyFungsionalQuery::create(null, $criteria)
                    ->filterByJabatanFungsional($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setRwyFungsionals(PropelCollection $rwyFungsionals, PropelPDO $con = null)
    {
        ...
        foreach ($rwyFungsionalsToDelete as $rwyFungsionalRemoved) {
            $rwyFungsionalRemoved->setJabatanFungsional(null);
        }
    ...
    protected function doAddRwyFungsional($rwyFungsional)
    {
        ...
        $rwyFungsional->setJabatanFungsional($this);
    }
    ...
    public function removeRwyFungsional($rwyFungsional)
    {
        if ($this->getRwyFungsionals()->contains($rwyFungsional)) {
            ...
            $rwyFungsional->setJabatanFungsional(null);
        }
     ...
     * Otherwise if this JabatanFungsional is new, it will return
     * an empty collection; or if this JabatanFungsional has previously
     * been saved, it will retrieve related RwyFungsionals from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JabatanFungsional.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|RwyFungsional[] List of RwyFungsional objects
     */
    public function getRwyFungsionalsJoinPtk($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RwyFungsionalQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(JabatanFungsionalPeer::DEFAULT_STRING_FORMAT);
    }
