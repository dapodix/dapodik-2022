...
/*
 * The Base TableInfo for IzinOperasional Table
 */
class BaseIzinOperasionalTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.IzinOperasionalTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'id_izin_operasional');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'id_izin_operasional_str');
        $this->setHeader(           'Izin Operasional');
        $this->setLabel(            'Izin operasional');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "SekolahPaud","Sekolah","LembagaNonSekolah"));
        ...
        $cvar->setColumnName(       'id_izin_operasional');
        $cvar->setColumnPhpName(    'IdIzinOperasional');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tmt_izin_operasional');
        $cvar->setColumnPhpName(    'TmtIzinOperasional');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tmt Izin Operasional');
        $cvar->setLabel(            'Tmt izin operasional');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'masa_berlaku');
        $cvar->setColumnPhpName(    'MasaBerlaku');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Masa Berlaku');
        $cvar->setLabel(            'Masa berlaku');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tst_izin_operasional');
        $cvar->setColumnPhpName(    'TstIzinOperasional');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tst Izin Operasional');
        $cvar->setLabel(            'Tst izin operasional');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        $cvar->setHideColumn(       0);
