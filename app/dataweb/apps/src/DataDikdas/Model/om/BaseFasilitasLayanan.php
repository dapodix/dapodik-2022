...
/**
 * Base class that represents a row from the 'ref.fasilitas_layanan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseFasilitasLayanan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\FasilitasLayananPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FasilitasLayananPeer
     */
    ...
    /**
     * Initializes internal state of BaseFasilitasLayanan object.
     * @see        applyDefaults()
     */
     ...
     * @return FasilitasLayanan The current object (for fluent API support)
     */
    public function setFasilitasLayananId($v)
    {
        ...
        if ($this->fasilitas_layanan_id !== $v) {
            ...
            $this->modifiedColumns[] = FasilitasLayananPeer::FASILITAS_LAYANAN_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = FasilitasLayananPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = FasilitasLayananPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = FasilitasLayananPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FasilitasLayananPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = FasilitasLayananPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fasilitas_layanan_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = FasilitasLayananPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FasilitasLayanan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FasilitasLayananPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FasilitasLayananQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FasilitasLayananPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FasilitasLayananPeer::FASILITAS_LAYANAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"fasilitas_layanan_id"';
        }
        if ($this->isColumnModified(FasilitasLayananPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(FasilitasLayananPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(FasilitasLayananPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(FasilitasLayananPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(FasilitasLayananPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."fasilitas_layanan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FasilitasLayananPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FasilitasLayananPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FasilitasLayanan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FasilitasLayanan'][$this->getPrimaryKey()] = true;
        $keys = FasilitasLayananPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFasilitasLayananId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setFasilitasLayananId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FasilitasLayananPeer::FASILITAS_LAYANAN_ID)) $criteria->add(FasilitasLayananPeer::FASILITAS_LAYANAN_ID, $this->fasilitas_layanan_id);
        if ($this->isColumnModified(FasilitasLayananPeer::NAMA)) $criteria->add(FasilitasLayananPeer::NAMA, $this->nama);
        if ($this->isColumnModified(FasilitasLayananPeer::CREATE_DATE)) $criteria->add(FasilitasLayananPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(FasilitasLayananPeer::LAST_UPDATE)) $criteria->add(FasilitasLayananPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(FasilitasLayananPeer::EXPIRED_DATE)) $criteria->add(FasilitasLayananPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(FasilitasLayananPeer::LAST_SYNC)) $criteria->add(FasilitasLayananPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(FasilitasLayananPeer::DATABASE_NAME);
        $criteria->add(FasilitasLayananPeer::FASILITAS_LAYANAN_ID, $this->fasilitas_layanan_id);
    ...
    /**
     * Generic method to set the primary key (fasilitas_layanan_id column).
     *
    ...
    {
        $this->setFasilitasLayananId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getFasilitasLayananId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FasilitasLayanan (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setFasilitasLayananId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FasilitasLayanan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FasilitasLayananPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FasilitasLayananPeer();
        }
     ...
     * If this FasilitasLayanan is new, it will return
    ...
    public function setSekolahPauds(PropelCollection $sekolahPauds, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahPaudsToDelete as $sekolahPaudRemoved) {
            $sekolahPaudRemoved->setFasilitasLayanan(null);
        }
    ...
    protected function doAddSekolahPaud($sekolahPaud)
    {
        ...
        $sekolahPaud->setFasilitasLayanan($this);
    }
    ...
    public function removeSekolahPaud($sekolahPaud)
    {
        if ($this->getSekolahPauds()->contains($sekolahPaud)) {
            ...
            $sekolahPaud->setFasilitasLayanan(null);
        }
     ...
     * Otherwise if this FasilitasLayanan is new, it will return
     * an empty collection; or if this FasilitasLayanan has previously
     * been saved, it will retrieve related SekolahPauds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FasilitasLayanan.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(FasilitasLayananPeer::DEFAULT_STRING_FORMAT);
    }
