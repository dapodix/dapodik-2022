...
/*
 * The Base TableInfo for AlatTransportasi Table
 */
class BaseAlatTransportasiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AlatTransportasiTableMap';
    ...
    {
        $this->setName('alat_transportasi');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'alat_transportasi_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'alat_transportasi_id_str');
        $this->setHeader(           'Ref.alat Transportasi');
        $this->setLabel(            'Ref.alat transportasi');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.alattransportasicombo');
        $this->setXtypeRadio(       'ref.alattransportasiradio');
        $this->setXtypeList(        'ref.alattransportasilist');
