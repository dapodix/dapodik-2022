...
/**
 * This class defines the structure of the 'vld_prestasi' table.
 *
 *
 *
 ...
 */
class VldPrestasiTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldPrestasiTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('prestasi_id', 'PrestasiId', 'VARCHAR', 'prestasi', 'prestasi_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Prestasi', 'DataDikdas\\Model\\Prestasi', RelationMap::MANY_TO_ONE, array('prestasi_id' => 'prestasi_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()
