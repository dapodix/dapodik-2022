...
/*
 * The Base TableInfo for AksesInternet Table
 */
class BaseAksesInternetTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AksesInternetTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'akses_internet_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'akses_internet_id_str');
        $this->setHeader(           'Ref.akses Internet');
        $this->setLabel(            'Ref.akses internet');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.aksesinternetcombo');
        $this->setXtypeRadio(       'ref.aksesinternetradio');
        $this->setXtypeList(        'ref.aksesinternetlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'media');
        $cvar->setColumnPhpName(    'Media');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
