...
abstract class BaseRwySertifikasi extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the tgl_sert field.
     * @var        string
     */
    protected $tgl_sert;

    /**
     * The value for the tgl_exp_sert field.
     * @var        string
     */
    protected $tgl_exp_sert;
    ...
    /**
     * The value for the nomer_registrasi field.
     * @var        string
     */
    protected $nomer_registrasi;
    ...
    /**
     * The value for the kualifikasi field.
     * @var        string
     */
    protected $kualifikasi;
    ...
    /**
     * Get the [optionally formatted] temporal [tgl_sert] column value.
     * 
     *
     ...
     */
    public function getTglSert($format = '%Y-%m-%d')
    {
        if ($this->tgl_sert === null) {
            return null;
        }


        try {
            $dt = new DateTime($this->tgl_sert);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->tgl_sert, true), $x);
        }
    ...
    /**
     * Get the [optionally formatted] temporal [tgl_exp_sert] column value.
     * 
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getTglExpSert($format = '%Y-%m-%d')
    {
        if ($this->tgl_exp_sert === null) {
            return null;
        }


        try {
            $dt = new DateTime($this->tgl_exp_sert);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->tgl_exp_sert, true), $x);
        }
    ...
    /**
     * Get the [nomer_registrasi] column value.
     * 
     * @return string
     */
    public function getNomerRegistrasi()
    {
        return $this->nomer_registrasi;
    }
    ...
    /**
     * Get the [kualifikasi] column value.
     * 
     * @return string
     */
    ...
    public function setKodeLembSert($v)
    {
        ...
        if ($this->kode_lemb_sert !== $v) {
            ...
            $this->modifiedColumns[] = RwySertifikasiPeer::KODE_LEMB_SERT;
        }
    ...
    /**
     * Sets the value of [tgl_sert] column to a normalized version of the date/time value specified.
     * 
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return RwySertifikasi The current object (for fluent API support)
     */
    public function setTglSert($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->tgl_sert !== null || $dt !== null) {
            $currentDateAsString = ($this->tgl_sert !== null && $tmpDt = new DateTime($this->tgl_sert)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->tgl_sert = $newDateAsString;
                $this->modifiedColumns[] = RwySertifikasiPeer::TGL_SERT;
            }
    ...
    /**
     * Sets the value of [tgl_exp_sert] column to a normalized version of the date/time value specified.
     * 
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return RwySertifikasi The current object (for fluent API support)
     */
    public function setTglExpSert($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->tgl_exp_sert !== null || $dt !== null) {
            $currentDateAsString = ($this->tgl_exp_sert !== null && $tmpDt = new DateTime($this->tgl_exp_sert)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->tgl_exp_sert = $newDateAsString;
                $this->modifiedColumns[] = RwySertifikasiPeer::TGL_EXP_SERT;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [nomer_registrasi] column.
     * 
     * @param string $v new value
     * @return RwySertifikasi The current object (for fluent API support)
     */
    public function setNomerRegistrasi($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->nomer_registrasi !== $v) {
            $this->nomer_registrasi = $v;
            $this->modifiedColumns[] = RwySertifikasiPeer::NOMER_REGISTRASI;
        }
    ...
    /**
     * Set the value of [kualifikasi] column.
     * 
     * @param string $v new value
     * @return RwySertifikasi The current object (for fluent API support)
     */
    public function setKualifikasi($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->kualifikasi !== $v) {
            $this->kualifikasi = $v;
            $this->modifiedColumns[] = RwySertifikasiPeer::KUALIFIKASI;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->kode_lemb_sert = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            $this->id_jenis_sertifikasi = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->tgl_sert = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->tgl_exp_sert = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->nomor_sertifikat = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->nomer_registrasi = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->nomor_peserta = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->kualifikasi = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->asal_data = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            ...
            return $startcol + 17; // 17 = RwySertifikasiPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RwySertifikasiPeer::KODE_LEMB_SERT)) {
        ...
        if ($this->isColumnModified(RwySertifikasiPeer::TGL_SERT)) {
            $modifiedColumns[':p' . $index++]  = '"tgl_sert"';
        }
        if ($this->isColumnModified(RwySertifikasiPeer::TGL_EXP_SERT)) {
            $modifiedColumns[':p' . $index++]  = '"tgl_exp_sert"';
        }
        if ($this->isColumnModified(RwySertifikasiPeer::NOMOR_SERTIFIKAT)) {
            $modifiedColumns[':p' . $index++]  = '"nomor_sertifikat"';
        }
        if ($this->isColumnModified(RwySertifikasiPeer::NOMER_REGISTRASI)) {
            $modifiedColumns[':p' . $index++]  = '"nomer_registrasi"';
        }
        if ($this->isColumnModified(RwySertifikasiPeer::NOMOR_PESERTA)) {
            $modifiedColumns[':p' . $index++]  = '"nomor_peserta"';
        }
        if ($this->isColumnModified(RwySertifikasiPeer::KUALIFIKASI)) {
            $modifiedColumns[':p' . $index++]  = '"kualifikasi"';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"id_jenis_sertifikasi"':						
                        ...
                        break;
                    case '"tgl_sert"':						
                        $stmt->bindValue($identifier, $this->tgl_sert, PDO::PARAM_STR);
                        break;
                    case '"tgl_exp_sert"':						
                        $stmt->bindValue($identifier, $this->tgl_exp_sert, PDO::PARAM_STR);
                        break;
                    case '"nomor_sertifikat"':						
                        $stmt->bindValue($identifier, $this->nomor_sertifikat, PDO::PARAM_STR);
                        break;
                    case '"nomer_registrasi"':						
                        $stmt->bindValue($identifier, $this->nomer_registrasi, PDO::PARAM_STR);
                        break;
                    case '"nomor_peserta"':						
                        $stmt->bindValue($identifier, $this->nomor_peserta, PDO::PARAM_STR);
                        break;
                    case '"kualifikasi"':						
                        $stmt->bindValue($identifier, $this->kualifikasi, PDO::PARAM_STR);
                        break;
                    case '"asal_data"':						
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                return $this->getTglSert();
                break;
            case 6:
                return $this->getTglExpSert();
                break;
            case 7:
                return $this->getNomorSertifikat();
                break;
            case 8:
                return $this->getNomerRegistrasi();
                break;
            case 9:
                return $this->getNomorPeserta();
                break;
            case 10:
                return $this->getKualifikasi();
                break;
            case 11:
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getKodeLembSert(),
            $keys[2] => $this->getPtkId(),
            $keys[3] => $this->getBidangStudiId(),
            $keys[4] => $this->getIdJenisSertifikasi(),
            $keys[5] => $this->getTglSert(),
            $keys[6] => $this->getTglExpSert(),
            $keys[7] => $this->getNomorSertifikat(),
            $keys[8] => $this->getNomerRegistrasi(),
            $keys[9] => $this->getNomorPeserta(),
            $keys[10] => $this->getKualifikasi(),
            $keys[11] => $this->getAsalData(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                $this->setTglSert($value);
                break;
            case 6:
                $this->setTglExpSert($value);
                break;
            case 7:
                $this->setNomorSertifikat($value);
                break;
            case 8:
                $this->setNomerRegistrasi($value);
                break;
            case 9:
                $this->setNomorPeserta($value);
                break;
            case 10:
                $this->setKualifikasi($value);
                break;
            case 11:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setKodeLembSert($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setPtkId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setBidangStudiId($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setIdJenisSertifikasi($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setTglSert($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setTglExpSert($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setNomorSertifikat($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setNomerRegistrasi($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setNomorPeserta($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setKualifikasi($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setAsalData($arr[$keys[11]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RwySertifikasiPeer::KODE_LEMB_SERT)) $criteria->add(RwySertifikasiPeer::KODE_LEMB_SERT, $this->kode_lemb_sert);
        ...
        if ($this->isColumnModified(RwySertifikasiPeer::TGL_SERT)) $criteria->add(RwySertifikasiPeer::TGL_SERT, $this->tgl_sert);
        if ($this->isColumnModified(RwySertifikasiPeer::TGL_EXP_SERT)) $criteria->add(RwySertifikasiPeer::TGL_EXP_SERT, $this->tgl_exp_sert);
        ...
        if ($this->isColumnModified(RwySertifikasiPeer::NOMER_REGISTRASI)) $criteria->add(RwySertifikasiPeer::NOMER_REGISTRASI, $this->nomer_registrasi);
        ...
        if ($this->isColumnModified(RwySertifikasiPeer::KUALIFIKASI)) $criteria->add(RwySertifikasiPeer::KUALIFIKASI, $this->kualifikasi);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTglSert($this->getTglSert());
        $copyObj->setTglExpSert($this->getTglExpSert());
        $copyObj->setNomorSertifikat($this->getNomorSertifikat());
        $copyObj->setNomerRegistrasi($this->getNomerRegistrasi());
        $copyObj->setNomorPeserta($this->getNomorPeserta());
        $copyObj->setKualifikasi($this->getKualifikasi());
    ...
    public function getLembSertifikasi(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLembSertifikasi === null && (($this->kode_lemb_sert !== "" && $this->kode_lemb_sert !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLembSertifikasi->addRwySertifikasis($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->tgl_sert = null;
        $this->tgl_exp_sert = null;
        $this->nomor_sertifikat = null;
        $this->nomer_registrasi = null;
        $this->nomor_peserta = null;
        $this->kualifikasi = null;
        $this->asal_data = null;
