...
/*
 * The Base TableInfo for SumberDanaSekolah Table
 */
class BaseSumberDanaSekolahTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.SumberDanaSekolahTableMap';
    ...
    {
        $this->setName('sumber_dana_sekolah');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'sumber_dana_sekolah_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'sumber_dana_sekolah_id_str');
        $this->setHeader(           'Ref.sumber Dana Sekolah');
        $this->setLabel(            'Ref.sumber dana sekolah');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.sumberdanasekolahcombo');
        $this->setXtypeRadio(       'ref.sumberdanasekolahradio');
        $this->setXtypeList(        'ref.sumberdanasekolahlist');
