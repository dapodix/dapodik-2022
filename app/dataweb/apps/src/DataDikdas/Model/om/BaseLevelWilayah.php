...
/**
 * Base class that represents a row from the 'ref.level_wilayah' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseLevelWilayah extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\LevelWilayahPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LevelWilayahPeer
     */
    ...
    /**
     * The value for the level_wilayah field.
     * @var        string
     */
    protected $level_wilayah;
    ...
    /**
     * Initializes internal state of BaseLevelWilayah object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [level_wilayah] column value.
     * 
     * @return string
     */
    public function getLevelWilayah()
    {
        return $this->level_wilayah;
    }
     ...
     * @return LevelWilayah The current object (for fluent API support)
     */
    public function setIdLevelWilayah($v)
    {
        ...
        if ($this->id_level_wilayah !== $v) {
            ...
            $this->modifiedColumns[] = LevelWilayahPeer::ID_LEVEL_WILAYAH;
        }
    ...
    /**
     * Set the value of [level_wilayah] column.
     * 
     * @param string $v new value
     * @return LevelWilayah The current object (for fluent API support)
     */
    public function setLevelWilayah($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->level_wilayah !== $v) {
            $this->level_wilayah = $v;
            $this->modifiedColumns[] = LevelWilayahPeer::LEVEL_WILAYAH;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LevelWilayahPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LevelWilayahPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LevelWilayahPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = LevelWilayahPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_level_wilayah = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->level_wilayah = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = LevelWilayahPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LevelWilayah object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LevelWilayahPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LevelWilayahQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LevelWilayahPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LevelWilayahPeer::ID_LEVEL_WILAYAH)) {
            $modifiedColumns[':p' . $index++]  = '"id_level_wilayah"';
        }
        if ($this->isColumnModified(LevelWilayahPeer::LEVEL_WILAYAH)) {
            $modifiedColumns[':p' . $index++]  = '"level_wilayah"';
        }
        if ($this->isColumnModified(LevelWilayahPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(LevelWilayahPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(LevelWilayahPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(LevelWilayahPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."level_wilayah" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_level_wilayah"':						
                        ...
                        break;
                    case '"level_wilayah"':						
                        $stmt->bindValue($identifier, $this->level_wilayah, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LevelWilayahPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LevelWilayahPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LevelWilayah'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LevelWilayah'][$this->getPrimaryKey()] = true;
        $keys = LevelWilayahPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdLevelWilayah(),
            $keys[1] => $this->getLevelWilayah(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdLevelWilayah($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setLevelWilayah($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LevelWilayahPeer::ID_LEVEL_WILAYAH)) $criteria->add(LevelWilayahPeer::ID_LEVEL_WILAYAH, $this->id_level_wilayah);
        if ($this->isColumnModified(LevelWilayahPeer::LEVEL_WILAYAH)) $criteria->add(LevelWilayahPeer::LEVEL_WILAYAH, $this->level_wilayah);
        if ($this->isColumnModified(LevelWilayahPeer::CREATE_DATE)) $criteria->add(LevelWilayahPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(LevelWilayahPeer::LAST_UPDATE)) $criteria->add(LevelWilayahPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(LevelWilayahPeer::EXPIRED_DATE)) $criteria->add(LevelWilayahPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(LevelWilayahPeer::LAST_SYNC)) $criteria->add(LevelWilayahPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(LevelWilayahPeer::DATABASE_NAME);
        $criteria->add(LevelWilayahPeer::ID_LEVEL_WILAYAH, $this->id_level_wilayah);
    ...
    /**
     * Generic method to set the primary key (id_level_wilayah column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdLevelWilayah();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of LevelWilayah (or compatible) type.
    ...
    {
        $copyObj->setLevelWilayah($this->getLevelWilayah());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdLevelWilayah(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LevelWilayah Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LevelWilayahPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LevelWilayahPeer();
        }
     ...
     * If this LevelWilayah is new, it will return
    ...
    public function setMstWilayahs(PropelCollection $mstWilayahs, PropelPDO $con = null)
    {
        ...
        foreach ($mstWilayahsToDelete as $mstWilayahRemoved) {
            $mstWilayahRemoved->setLevelWilayah(null);
        }
    ...
    protected function doAddMstWilayah($mstWilayah)
    {
        ...
        $mstWilayah->setLevelWilayah($this);
    }
    ...
    public function removeMstWilayah($mstWilayah)
    {
        if ($this->getMstWilayahs()->contains($mstWilayah)) {
            ...
            $mstWilayah->setLevelWilayah(null);
        }
     ...
     * Otherwise if this LevelWilayah is new, it will return
     * an empty collection; or if this LevelWilayah has previously
     * been saved, it will retrieve related MstWilayahs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LevelWilayah.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(LevelWilayahPeer::DEFAULT_STRING_FORMAT);
    }
