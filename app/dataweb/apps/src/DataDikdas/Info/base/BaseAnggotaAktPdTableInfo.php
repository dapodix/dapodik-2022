...
/*
 * The Base TableInfo for AnggotaAktPd Table
 */
class BaseAnggotaAktPdTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AnggotaAktPdTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_ang_akt_pd_str');
        $this->setHeader(           'Anggota Akt Pd');
        $this->setLabel(            'Anggota akt pd');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "AktPd","RegistrasiPesertaDidik"));
        ...
        $cvar->setColumnName(       'id_ang_akt_pd');
        $cvar->setColumnPhpName(    'IdAngAktPd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_pd');
        $cvar->setColumnPhpName(    'NmPd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nipd');
        $cvar->setLabel(            'Nipd');
        $cvar->setInputLength(      24);
        $cvar->setFieldWidth(       72);
        $cvar->setColumnWidth(      132);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'textfield');
        $cvar->setComboXtype(       '');
        $cvar->setDisplayField(     '');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jns_peran_pd');
        $cvar->setColumnPhpName(    'JnsPeranPd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jns Peran Pd');
        $cvar->setLabel(            'Jns peran pd');
