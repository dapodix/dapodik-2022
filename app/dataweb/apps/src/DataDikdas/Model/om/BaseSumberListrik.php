...
abstract class BaseSumberListrik extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\SumberListrikPeer';
    ...
    /**
     * Initializes internal state of BaseSumberListrik object.
     * @see        applyDefaults()
     */
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SumberListrikPeer::SUMBER_LISTRIK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"sumber_listrik_id"';
        }
        if ($this->isColumnModified(SumberListrikPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(SumberListrikPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(SumberListrikPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(SumberListrikPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(SumberListrikPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."sumber_listrik" (%s) VALUES (%s)',
    ...
    public function setSekolahLongitudinals(PropelCollection $sekolahLongitudinals, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahLongitudinalsToDelete as $sekolahLongitudinalRemoved) {
            $sekolahLongitudinalRemoved->setSumberListrik(null);
        }
    ...
    protected function doAddSekolahLongitudinal($sekolahLongitudinal)
    {
        ...
        $sekolahLongitudinal->setSumberListrik($this);
    }
    ...
    public function removeSekolahLongitudinal($sekolahLongitudinal)
    {
        if ($this->getSekolahLongitudinals()->contains($sekolahLongitudinal)) {
            ...
            $sekolahLongitudinal->setSumberListrik(null);
        }
