 ...
 * @method VldBangunanQuery orderByKeterangan($order = Criteria::ASC) Order by the keterangan column
 ...
 * @method VldBangunanQuery groupByKeterangan() Group by the keterangan column
 ...
 * @method VldBangunan findOneByKeterangan(string $keterangan) Return the first VldBangunan filtered by the keterangan column
 ...
 * @method array findByKeterangan(string $keterangan) Return VldBangunan objects filtered by the keterangan column
...
abstract class BaseVldBangunanQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "logid", "id_bangunan", "idtype", "status_validasi", "field_error", "error_message", "app_username", "keterangan", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "vld_bangunan" WHERE "logid" = :p0';
        try {
    ...
    public function filterByKeterangan($keterangan = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VldBangunanPeer::KETERANGAN, $keterangan, $comparison);
    }
