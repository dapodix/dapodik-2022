...
/*
 * The Base TableInfo for JenisPenghargaan Table
 */
class BaseJenisPenghargaanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisPenghargaanTableMap';
    ...
    {
        $this->setName('jenis_penghargaan');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_penghargaan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_penghargaan_id_str');
        $this->setHeader(           'Ref.jenis Penghargaan');
        $this->setLabel(            'Ref.jenis penghargaan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenispenghargaancombo');
        $this->setXtypeRadio(       'ref.jenispenghargaanradio');
        $this->setXtypeList(        'ref.jenispenghargaanlist');
