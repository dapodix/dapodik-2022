...
/*
 * The Base TableInfo for AlasanLayakPip Table
 */
class BaseAlasanLayakPipTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AlasanLayakPipTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_layak_pip_str');
        $this->setHeader(           'Ref.alasan Layak Pip');
        $this->setLabel(            'Ref.alasan layak pip');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.alasanlayakpipcombo');
        $this->setXtypeRadio(       'ref.alasanlayakpipradio');
        $this->setXtypeList(        'ref.alasanlayakpiplist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'alasan_layak_pip');
        $cvar->setColumnPhpName(    'AlasanLayakPip');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Alasan Layak Pip');
        $cvar->setLabel(            'Alasan layak pip');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
