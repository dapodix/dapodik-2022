...
/**
 * Base class that represents a row from the 'vld_nilai_test' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldNilaiTest extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldNilaiTestPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldNilaiTestPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldNilaiTest object.
     * @see        applyDefaults()
     */
     ...
     * @return VldNilaiTest The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldNilaiTestPeer::LOGID;
        }
    ...
    public function setNilaiTestId($v)
    {
        ...
        if ($this->nilai_test_id !== $v) {
            ...
            $this->modifiedColumns[] = VldNilaiTestPeer::NILAI_TEST_ID;
        }

        if ($this->aNilaiTest !== null && $this->aNilaiTest->getNilaiTestId() !== $v) {
            $this->aNilaiTest = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldNilaiTestPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldNilaiTestPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldNilaiTestPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldNilaiTestPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldNilaiTestPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldNilaiTestPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldNilaiTestPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldNilaiTestPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldNilaiTestPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldNilaiTestPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldNilaiTestPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nilai_test_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldNilaiTestPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldNilaiTest object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aNilaiTest !== null && $this->nilai_test_id !== $this->aNilaiTest->getNilaiTestId()) {
            $this->aNilaiTest = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldNilaiTestPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldNilaiTestQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldNilaiTestPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aNilaiTest !== null) {
                if ($this->aNilaiTest->isModified() || $this->aNilaiTest->isNew()) {
                    $affectedRows += $this->aNilaiTest->save($con);
                }
                $this->setNilaiTest($this->aNilaiTest);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldNilaiTestPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::NILAI_TEST_ID)) {
            $modifiedColumns[':p' . $index++]  = '"nilai_test_id"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldNilaiTestPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_nilai_test" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aNilaiTest !== null) {
                if (!$this->aNilaiTest->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aNilaiTest->getValidationFailures());
                }
            }


            if (($retval = VldNilaiTestPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldNilaiTestPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldNilaiTest'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldNilaiTest'][$this->getPrimaryKey()] = true;
        $keys = VldNilaiTestPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getNilaiTestId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aNilaiTest) {
                $result['NilaiTest'] = $this->aNilaiTest->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNilaiTestId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldNilaiTestPeer::LOGID)) $criteria->add(VldNilaiTestPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldNilaiTestPeer::NILAI_TEST_ID)) $criteria->add(VldNilaiTestPeer::NILAI_TEST_ID, $this->nilai_test_id);
        if ($this->isColumnModified(VldNilaiTestPeer::IDTYPE)) $criteria->add(VldNilaiTestPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldNilaiTestPeer::STATUS_VALIDASI)) $criteria->add(VldNilaiTestPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldNilaiTestPeer::FIELD_ERROR)) $criteria->add(VldNilaiTestPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldNilaiTestPeer::ERROR_MESSAGE)) $criteria->add(VldNilaiTestPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldNilaiTestPeer::KETERANGAN)) $criteria->add(VldNilaiTestPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldNilaiTestPeer::APP_USERNAME)) $criteria->add(VldNilaiTestPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldNilaiTestPeer::CREATE_DATE)) $criteria->add(VldNilaiTestPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldNilaiTestPeer::LAST_UPDATE)) $criteria->add(VldNilaiTestPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldNilaiTestPeer::SOFT_DELETE)) $criteria->add(VldNilaiTestPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldNilaiTestPeer::LAST_SYNC)) $criteria->add(VldNilaiTestPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldNilaiTestPeer::UPDATER_ID)) $criteria->add(VldNilaiTestPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldNilaiTestPeer::DATABASE_NAME);
        $criteria->add(VldNilaiTestPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldNilaiTest (or compatible) type.
    ...
    {
        $copyObj->setNilaiTestId($this->getNilaiTestId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldNilaiTest Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldNilaiTestPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldNilaiTestPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldNilaiTests($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a NilaiTest object.
     *
     * @param             NilaiTest $v
     * @return VldNilaiTest The current object (for fluent API support)
     * @throws PropelException
     */
    public function setNilaiTest(NilaiTest $v = null)
    {
        if ($v === null) {
            $this->setNilaiTestId(NULL);
        } else {
            $this->setNilaiTestId($v->getNilaiTestId());
        }

        $this->aNilaiTest = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the NilaiTest object, it will not be re-added.
        if ($v !== null) {
            $v->addVldNilaiTest($this);
        }
    ...
    /**
     * Get the associated NilaiTest object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return NilaiTest The associated NilaiTest object.
     * @throws PropelException
     */
    public function getNilaiTest(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNilaiTest === null && (($this->nilai_test_id !== "" && $this->nilai_test_id !== null)) && $doQuery) {
            $this->aNilaiTest = NilaiTestQuery::create()->findPk($this->nilai_test_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNilaiTest->addVldNilaiTests($this);
             */
        }

        return $this->aNilaiTest;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aNilaiTest instanceof Persistent) {
              $this->aNilaiTest->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldNilaiTestPeer::DEFAULT_STRING_FORMAT);
    }
