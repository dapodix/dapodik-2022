...
/**
 * This class defines the structure of the 'vld_nilai_rapor' table.
 *
 *
 *
 ...
 */
class VldNilaiRaporTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldNilaiRaporTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('nilai_id', 'NilaiId', 'VARCHAR', true, null, null);
