...
/*
 * The Base TableInfo for JabatanFungsional Table
 */
class BaseJabatanFungsionalTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JabatanFungsionalTableMap';
    ...
    {
        $this->setName('jabatan_fungsional');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jabatan_fungsional_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jabatan_fungsional_id_str');
        $this->setHeader(           'Ref.jabatan Fungsional');
        $this->setLabel(            'Ref.jabatan fungsional');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jabatanfungsionalcombo');
        $this->setXtypeRadio(       'ref.jabatanfungsionalradio');
        $this->setXtypeList(        'ref.jabatanfungsionallist');
