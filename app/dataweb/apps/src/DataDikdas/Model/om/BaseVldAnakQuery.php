 ...
 * @method VldAnakQuery orderBySoftDelete($order = Criteria::ASC) Order by the soft_delete column
 * @method VldAnakQuery orderByLastSync($order = Criteria::ASC) Order by the last_sync column
 * @method VldAnakQuery orderByUpdaterId($order = Criteria::ASC) Order by the updater_id column
 *
 ...
 * @method VldAnakQuery groupBySoftDelete() Group by the soft_delete column
 * @method VldAnakQuery groupByLastSync() Group by the last_sync column
 * @method VldAnakQuery groupByUpdaterId() Group by the updater_id column
 *
 ...
 *
 * @method VldAnakQuery leftJoinErrortype($relationAlias = null) Adds a LEFT JOIN clause to the query using the Errortype relation
 * @method VldAnakQuery rightJoinErrortype($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Errortype relation
 * @method VldAnakQuery innerJoinErrortype($relationAlias = null) Adds a INNER JOIN clause to the query using the Errortype relation
 *
 * @method VldAnakQuery leftJoinAnak($relationAlias = null) Adds a LEFT JOIN clause to the query using the Anak relation
 * @method VldAnakQuery rightJoinAnak($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Anak relation
 * @method VldAnakQuery innerJoinAnak($relationAlias = null) Adds a INNER JOIN clause to the query using the Anak relation
 *
 ...
 * @method VldAnak findOneBySoftDelete(string $soft_delete) Return the first VldAnak filtered by the soft_delete column
 * @method VldAnak findOneByLastSync(string $last_sync) Return the first VldAnak filtered by the last_sync column
 * @method VldAnak findOneByUpdaterId(string $updater_id) Return the first VldAnak filtered by the updater_id column
 *
 ...
 * @method array findBySoftDelete(string $soft_delete) Return VldAnak objects filtered by the soft_delete column
 * @method array findByLastSync(string $last_sync) Return VldAnak objects filtered by the last_sync column
 * @method array findByUpdaterId(string $updater_id) Return VldAnak objects filtered by the updater_id column
 *
...
abstract class BaseVldAnakQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'pendataan', $modelName = 'DataDikdas\\Model\\VldAnak', $modelAlias = null)
    {
    ...
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = VldAnakPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT "logid", "anak_id", "idtype", "status_validasi", "field_error", "error_message", "keterangan", "app_username", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "vld_anak" WHERE "logid" = :p0';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new VldAnak();
            $obj->hydrate($row);
            VldAnakPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(VldAnakPeer::LOGID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(VldAnakPeer::LOGID, $keys, Criteria::IN);
    }
    ...
    public function filterBySoftDelete($softDelete = null, $comparison = null)
    {
        if (is_array($softDelete)) {
            ...
            if (isset($softDelete['min'])) {
                $this->addUsingAlias(VldAnakPeer::SOFT_DELETE, $softDelete['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($softDelete['max'])) {
                $this->addUsingAlias(VldAnakPeer::SOFT_DELETE, $softDelete['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(VldAnakPeer::SOFT_DELETE, $softDelete, $comparison);
    }
    ...
    public function filterByUpdaterId($updaterId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(VldAnakPeer::UPDATER_ID, $updaterId, $comparison);
    }
    ...
    {
        if ($vldAnak) {
            $this->addUsingAlias(VldAnakPeer::LOGID, $vldAnak->getLogid(), Criteria::NOT_EQUAL);
        }
