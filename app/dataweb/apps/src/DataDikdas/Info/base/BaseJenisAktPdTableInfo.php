...
/*
 * The Base TableInfo for JenisAktPd Table
 */
class BaseJenisAktPdTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisAktPdTableMap';
    ...
    {
        $this->setName('jenis_akt_pd');
        $this->setPhpName('JenisAktPd');
        $this->setClassname('DataDikdas\\Model\\JenisAktPd');
        $this->setPackage('DataDikdas.Model');
    }

    public function setVariables() {

        $this->setPkName(            'id_jns_akt_pd');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'id_jns_akt_pd_str');
        $this->setHeader(           'Ref.jenis Akt Pd');
        $this->setLabel(            'Ref.jenis akt pd');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisaktpdcombo');
        $this->setXtypeRadio(       'ref.jenisaktpdradio');
        $this->setXtypeList(        'ref.jenisaktpdlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_jns_akt_pd');
        $cvar->setColumnPhpName(    'NmJnsAktPd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Jns Akt Pd');
        $cvar->setLabel(            'Nm jns akt pd');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_jns_akt_pd');
        $cvar->setColumnPhpName(    'KetJnsAktPd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Jns Akt Pd');
        $cvar->setLabel(            'Ket jns akt pd');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
