...
/**
 * Base class that represents a row from the 'ref.jenis_kepanitiaan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisKepanitiaan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisKepanitiaanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JenisKepanitiaanPeer
     */
    ...
    /**
     * The value for the nm_jns_panitia field.
     * @var        string
     */
    protected $nm_jns_panitia;
    ...
    /**
     * Initializes internal state of BaseJenisKepanitiaan object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nm_jns_panitia] column value.
     * 
     * @return string
     */
    public function getNmJnsPanitia()
    {
        return $this->nm_jns_panitia;
    }
     ...
     * @return JenisKepanitiaan The current object (for fluent API support)
     */
    public function setIdJnsPanitia($v)
    {
        ...
        if ($this->id_jns_panitia !== $v) {
            ...
            $this->modifiedColumns[] = JenisKepanitiaanPeer::ID_JNS_PANITIA;
        }
    ...
    /**
     * Set the value of [nm_jns_panitia] column.
     * 
     * @param string $v new value
     * @return JenisKepanitiaan The current object (for fluent API support)
     */
    public function setNmJnsPanitia($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->nm_jns_panitia !== $v) {
            $this->nm_jns_panitia = $v;
            $this->modifiedColumns[] = JenisKepanitiaanPeer::NM_JNS_PANITIA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisKepanitiaanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisKepanitiaanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisKepanitiaanPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisKepanitiaanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_jns_panitia = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->nm_jns_panitia = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = JenisKepanitiaanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisKepanitiaan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisKepanitiaanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisKepanitiaanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisKepanitiaanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->kepanitiaansScheduledForDeletion !== null) {
                if (!$this->kepanitiaansScheduledForDeletion->isEmpty()) {
                    KepanitiaanQuery::create()
                        ->filterByPrimaryKeys($this->kepanitiaansScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisKepanitiaanPeer::ID_JNS_PANITIA)) {
            $modifiedColumns[':p' . $index++]  = '"id_jns_panitia"';
        }
        if ($this->isColumnModified(JenisKepanitiaanPeer::NM_JNS_PANITIA)) {
            $modifiedColumns[':p' . $index++]  = '"nm_jns_panitia"';
        }
        if ($this->isColumnModified(JenisKepanitiaanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisKepanitiaanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisKepanitiaanPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisKepanitiaanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_kepanitiaan" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_jns_panitia"':						
                        ...
                        break;
                    case '"nm_jns_panitia"':						
                        $stmt->bindValue($identifier, $this->nm_jns_panitia, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisKepanitiaanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisKepanitiaanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JenisKepanitiaan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisKepanitiaan'][$this->getPrimaryKey()] = true;
        $keys = JenisKepanitiaanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdJnsPanitia(),
            $keys[1] => $this->getNmJnsPanitia(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdJnsPanitia($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNmJnsPanitia($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisKepanitiaanPeer::ID_JNS_PANITIA)) $criteria->add(JenisKepanitiaanPeer::ID_JNS_PANITIA, $this->id_jns_panitia);
        if ($this->isColumnModified(JenisKepanitiaanPeer::NM_JNS_PANITIA)) $criteria->add(JenisKepanitiaanPeer::NM_JNS_PANITIA, $this->nm_jns_panitia);
        if ($this->isColumnModified(JenisKepanitiaanPeer::CREATE_DATE)) $criteria->add(JenisKepanitiaanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisKepanitiaanPeer::LAST_UPDATE)) $criteria->add(JenisKepanitiaanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisKepanitiaanPeer::EXPIRED_DATE)) $criteria->add(JenisKepanitiaanPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisKepanitiaanPeer::LAST_SYNC)) $criteria->add(JenisKepanitiaanPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisKepanitiaanPeer::DATABASE_NAME);
        $criteria->add(JenisKepanitiaanPeer::ID_JNS_PANITIA, $this->id_jns_panitia);
    ...
    /**
     * Generic method to set the primary key (id_jns_panitia column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdJnsPanitia();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisKepanitiaan (or compatible) type.
    ...
    {
        $copyObj->setNmJnsPanitia($this->getNmJnsPanitia());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdJnsPanitia(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisKepanitiaan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisKepanitiaanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisKepanitiaanPeer();
        }
     ...
     * If this JenisKepanitiaan is new, it will return
    ...
    public function setKepanitiaans(PropelCollection $kepanitiaans, PropelPDO $con = null)
    {
        ...
        foreach ($kepanitiaansToDelete as $kepanitiaanRemoved) {
            $kepanitiaanRemoved->setJenisKepanitiaan(null);
        }
    ...
    protected function doAddKepanitiaan($kepanitiaan)
    {
        ...
        $kepanitiaan->setJenisKepanitiaan($this);
    }
    ...
    public function removeKepanitiaan($kepanitiaan)
    {
        if ($this->getKepanitiaans()->contains($kepanitiaan)) {
            ...
            $this->kepanitiaansScheduledForDeletion[]= clone $kepanitiaan;
            $kepanitiaan->setJenisKepanitiaan(null);
        }
     ...
     * Otherwise if this JenisKepanitiaan is new, it will return
     * an empty collection; or if this JenisKepanitiaan has previously
     * been saved, it will retrieve related Kepanitiaans from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisKepanitiaan.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Kepanitiaan[] List of Kepanitiaan objects
     */
    public function getKepanitiaansJoinSekolah($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = KepanitiaanQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(JenisKepanitiaanPeer::DEFAULT_STRING_FORMAT);
    }
