...
/**
 * This class defines the structure of the 'vld_un' table.
 *
 *
 *
 ...
 */
class VldUnTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldUnTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('un_id', 'UnId', 'VARCHAR', true, null, null);
