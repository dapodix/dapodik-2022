...
/*
 * The Base TableInfo for JenisHapusBuku Table
 */
class BaseJenisHapusBukuTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisHapusBukuTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_hapus_buku_str');
        $this->setHeader(           'Ref.jenis Hapus Buku');
        $this->setLabel(            'Ref.jenis hapus buku');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenishapusbukucombo');
        $this->setXtypeRadio(       'ref.jenishapusbukuradio');
        $this->setXtypeList(        'ref.jenishapusbukulist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_hapus_buku');
        $cvar->setColumnPhpName(    'KetHapusBuku');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Ket Hapus Buku');
        $cvar->setLabel(            'Ket hapus buku');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_prasarana');
        $cvar->setColumnPhpName(    'UPrasarana');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Uprasarana');
        $cvar->setLabel(            'Uprasarana');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_sarana');
        $cvar->setColumnPhpName(    'USarana');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Usarana');
        $cvar->setLabel(            'Usarana');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
