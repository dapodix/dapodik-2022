...
/*
 * The Base TableInfo for Agama Table
 */
class BaseAgamaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AgamaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'agama_id_str');
        $this->setHeader(           'Ref.agama');
        $this->setLabel(            'Ref.agama');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.agamacombo');
        $this->setXtypeRadio(       'ref.agamaradio');
        $this->setXtypeList(        'ref.agamalist');
