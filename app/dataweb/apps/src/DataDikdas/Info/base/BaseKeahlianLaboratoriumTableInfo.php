...
/*
 * The Base TableInfo for KeahlianLaboratorium Table
 */
class BaseKeahlianLaboratoriumTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KeahlianLaboratoriumTableMap';
    ...
    {
        $this->setName('keahlian_laboratorium');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'keahlian_laboratorium_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'keahlian_laboratorium_id_str');
        $this->setHeader(           'Ref.keahlian Laboratorium');
        $this->setLabel(            'Ref.keahlian laboratorium');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.keahlianlaboratoriumcombo');
        $this->setXtypeRadio(       'ref.keahlianlaboratoriumradio');
        $this->setXtypeList(        'ref.keahlianlaboratoriumlist');
