...
/**
 * Base class that represents a row from the 'vld_dudi' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldDudi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldDudiPeer';
    ...
    /**
     * Initializes internal state of BaseVldDudi object.
     * @see        applyDefaults()
     */
     ...
     * @return VldDudi The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldDudiPeer::LOGID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldDudiPeer::IDTYPE;
        }
    ...
    public function setDudiId($v)
    {
        ...
        if ($this->dudi_id !== $v) {
            $this->dudi_id = $v;
            $this->modifiedColumns[] = VldDudiPeer::DUDI_ID;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldDudiPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldDudiPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldDudiPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldDudiPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldDudiPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldDudiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldDudiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldDudiPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldDudiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldDudiPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldDudiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldDudi object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldDudiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldDudiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldDudiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldDudiPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldDudiPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldDudiPeer::DUDI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"dudi_id"';
        }
        if ($this->isColumnModified(VldDudiPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldDudiPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldDudiPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldDudiPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldDudiPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldDudiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldDudiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldDudiPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldDudiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldDudiPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_dudi" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldDudiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldDudiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldDudi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldDudi'][$this->getPrimaryKey()] = true;
        $keys = VldDudiPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldDudiPeer::LOGID)) $criteria->add(VldDudiPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldDudiPeer::IDTYPE)) $criteria->add(VldDudiPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldDudiPeer::DUDI_ID)) $criteria->add(VldDudiPeer::DUDI_ID, $this->dudi_id);
        if ($this->isColumnModified(VldDudiPeer::STATUS_VALIDASI)) $criteria->add(VldDudiPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldDudiPeer::FIELD_ERROR)) $criteria->add(VldDudiPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldDudiPeer::ERROR_MESSAGE)) $criteria->add(VldDudiPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldDudiPeer::APP_USERNAME)) $criteria->add(VldDudiPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldDudiPeer::KETERANGAN)) $criteria->add(VldDudiPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldDudiPeer::CREATE_DATE)) $criteria->add(VldDudiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldDudiPeer::LAST_UPDATE)) $criteria->add(VldDudiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldDudiPeer::SOFT_DELETE)) $criteria->add(VldDudiPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldDudiPeer::LAST_SYNC)) $criteria->add(VldDudiPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldDudiPeer::UPDATER_ID)) $criteria->add(VldDudiPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldDudiPeer::DATABASE_NAME);
        $criteria->add(VldDudiPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldDudi (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldDudi Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldDudis($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldDudiPeer::DEFAULT_STRING_FORMAT);
    }
