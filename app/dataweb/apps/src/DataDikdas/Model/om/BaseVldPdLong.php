...
/**
 * Base class that represents a row from the 'vld_pd_long' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldPdLong extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldPdLongPeer';
    ...
    /**
     * @var        PesertaDidikLongitudinal
     */
    protected $aPesertaDidikLongitudinal;
    ...
    /**
     * Initializes internal state of BaseVldPdLong object.
     * @see        applyDefaults()
     */
     ...
     * @return VldPdLong The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldPdLongPeer::LOGID;
        }
    ...
    public function setPesertaDidikId($v)
    {
        ...
        if ($this->peserta_didik_id !== $v) {
            ...
            $this->modifiedColumns[] = VldPdLongPeer::PESERTA_DIDIK_ID;
        }

        if ($this->aPesertaDidikLongitudinal !== null && $this->aPesertaDidikLongitudinal->getPesertaDidikId() !== $v) {
            $this->aPesertaDidikLongitudinal = null;
        }
    ...
    public function setSemesterId($v)
    {
        ...
        if ($this->semester_id !== $v) {
            $this->semester_id = $v;
            $this->modifiedColumns[] = VldPdLongPeer::SEMESTER_ID;
        }

        if ($this->aPesertaDidikLongitudinal !== null && $this->aPesertaDidikLongitudinal->getSemesterId() !== $v) {
            $this->aPesertaDidikLongitudinal = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldPdLongPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldPdLongPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldPdLongPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldPdLongPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldPdLongPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldPdLongPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPdLongPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPdLongPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldPdLongPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldPdLongPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldPdLongPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idtype = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->status_validasi = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            $this->keterangan = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->app_username = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            ...
            return $startcol + 14; // 14 = VldPdLongPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldPdLong object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPesertaDidikLongitudinal !== null && $this->peserta_didik_id !== $this->aPesertaDidikLongitudinal->getPesertaDidikId()) {
            $this->aPesertaDidikLongitudinal = null;
        }
        if ($this->aPesertaDidikLongitudinal !== null && $this->semester_id !== $this->aPesertaDidikLongitudinal->getSemesterId()) {
            $this->aPesertaDidikLongitudinal = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldPdLongPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldPdLongQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldPdLongPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPesertaDidikLongitudinal !== null) {
                if ($this->aPesertaDidikLongitudinal->isModified() || $this->aPesertaDidikLongitudinal->isNew()) {
                    $affectedRows += $this->aPesertaDidikLongitudinal->save($con);
                }
                $this->setPesertaDidikLongitudinal($this->aPesertaDidikLongitudinal);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldPdLongPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldPdLongPeer::PESERTA_DIDIK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"peserta_didik_id"';
        }
        if ($this->isColumnModified(VldPdLongPeer::SEMESTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"semester_id"';
        }
        if ($this->isColumnModified(VldPdLongPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldPdLongPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldPdLongPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldPdLongPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldPdLongPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldPdLongPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldPdLongPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldPdLongPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldPdLongPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldPdLongPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldPdLongPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_pd_long" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPesertaDidikLongitudinal !== null) {
                if (!$this->aPesertaDidikLongitudinal->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPesertaDidikLongitudinal->getValidationFailures());
                }
            }


            if (($retval = VldPdLongPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldPdLongPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldPdLong'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldPdLong'][$this->getPrimaryKey()] = true;
        $keys = VldPdLongPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getPesertaDidikId(),
            $keys[2] => $this->getSemesterId(),
            $keys[3] => $this->getIdtype(),
            $keys[4] => $this->getStatusValidasi(),
            $keys[5] => $this->getFieldError(),
            $keys[6] => $this->getErrorMessage(),
            $keys[7] => $this->getKeterangan(),
            $keys[8] => $this->getAppUsername(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPesertaDidikLongitudinal) {
                $result['PesertaDidikLongitudinal'] = $this->aPesertaDidikLongitudinal->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIdtype($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setStatusValidasi($arr[$keys[4]]);
        ...
        if (array_key_exists($keys[8], $arr)) $this->setAppUsername($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldPdLongPeer::LOGID)) $criteria->add(VldPdLongPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldPdLongPeer::PESERTA_DIDIK_ID)) $criteria->add(VldPdLongPeer::PESERTA_DIDIK_ID, $this->peserta_didik_id);
        if ($this->isColumnModified(VldPdLongPeer::SEMESTER_ID)) $criteria->add(VldPdLongPeer::SEMESTER_ID, $this->semester_id);
        if ($this->isColumnModified(VldPdLongPeer::IDTYPE)) $criteria->add(VldPdLongPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldPdLongPeer::STATUS_VALIDASI)) $criteria->add(VldPdLongPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldPdLongPeer::FIELD_ERROR)) $criteria->add(VldPdLongPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldPdLongPeer::ERROR_MESSAGE)) $criteria->add(VldPdLongPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldPdLongPeer::KETERANGAN)) $criteria->add(VldPdLongPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldPdLongPeer::APP_USERNAME)) $criteria->add(VldPdLongPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldPdLongPeer::CREATE_DATE)) $criteria->add(VldPdLongPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldPdLongPeer::LAST_UPDATE)) $criteria->add(VldPdLongPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldPdLongPeer::SOFT_DELETE)) $criteria->add(VldPdLongPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldPdLongPeer::LAST_SYNC)) $criteria->add(VldPdLongPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldPdLongPeer::UPDATER_ID)) $criteria->add(VldPdLongPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldPdLongPeer::DATABASE_NAME);
        $criteria->add(VldPdLongPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldPdLong (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldPdLong Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldPdLongPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldPdLongPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldPdLongs($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a PesertaDidikLongitudinal object.
     *
     * @param             PesertaDidikLongitudinal $v
     * @return VldPdLong The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPesertaDidikLongitudinal(PesertaDidikLongitudinal $v = null)
    {
        if ($v === null) {
        ...
        $this->aPesertaDidikLongitudinal = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the PesertaDidikLongitudinal object, it will not be re-added.
        if ($v !== null) {
            $v->addVldPdLong($this);
        }
    ...
    /**
     * Get the associated PesertaDidikLongitudinal object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return PesertaDidikLongitudinal The associated PesertaDidikLongitudinal object.
     * @throws PropelException
     */
    public function getPesertaDidikLongitudinal(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPesertaDidikLongitudinal === null && (($this->peserta_didik_id !== "" && $this->peserta_didik_id !== null) && ($this->semester_id !== "" && $this->semester_id !== null)) && $doQuery) {
            $this->aPesertaDidikLongitudinal = PesertaDidikLongitudinalQuery::create()->findPk(array($this->peserta_didik_id, $this->semester_id), $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPesertaDidikLongitudinal->addVldPdLongs($this);
             */
        }

        return $this->aPesertaDidikLongitudinal;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPesertaDidikLongitudinal instanceof Persistent) {
              $this->aPesertaDidikLongitudinal->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldPdLongPeer::DEFAULT_STRING_FORMAT);
    }
