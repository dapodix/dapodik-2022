 ...
 * @method RwyStrukturalQuery orderByCreateDate($order = Criteria::ASC) Order by the create_date column
 ...
 * @method RwyStrukturalQuery groupByCreateDate() Group by the create_date column
 ...
 *
 * @method RwyStrukturalQuery leftJoinPtk($relationAlias = null) Adds a LEFT JOIN clause to the query using the Ptk relation
 * @method RwyStrukturalQuery rightJoinPtk($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Ptk relation
 * @method RwyStrukturalQuery innerJoinPtk($relationAlias = null) Adds a INNER JOIN clause to the query using the Ptk relation
 *
 * @method RwyStrukturalQuery leftJoinJabatanTugasPtk($relationAlias = null) Adds a LEFT JOIN clause to the query using the JabatanTugasPtk relation
 * @method RwyStrukturalQuery rightJoinJabatanTugasPtk($relationAlias = null) Adds a RIGHT JOIN clause to the query using the JabatanTugasPtk relation
 * @method RwyStrukturalQuery innerJoinJabatanTugasPtk($relationAlias = null) Adds a INNER JOIN clause to the query using the JabatanTugasPtk relation
 *
 * @method RwyStrukturalQuery leftJoinVldRwyStruktural($relationAlias = null) Adds a LEFT JOIN clause to the query using the VldRwyStruktural relation
 * @method RwyStrukturalQuery rightJoinVldRwyStruktural($relationAlias = null) Adds a RIGHT JOIN clause to the query using the VldRwyStruktural relation
 * @method RwyStrukturalQuery innerJoinVldRwyStruktural($relationAlias = null) Adds a INNER JOIN clause to the query using the VldRwyStruktural relation
 *
 ...
 * @method RwyStruktural findOneByCreateDate(string $create_date) Return the first RwyStruktural filtered by the create_date column
 ...
 * @method array findByCreateDate(string $create_date) Return RwyStruktural objects filtered by the create_date column
...
abstract class BaseRwyStrukturalQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'pendataan', $modelName = 'DataDikdas\\Model\\RwyStruktural', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT "riwayat_struktural_id", "ptk_id", "jabatan_ptk_id", "sk_struktural", "tmt_jabatan", "create_date", "last_update", "soft_delete", "last_sync", "updater_id" FROM "rwy_struktural" WHERE "riwayat_struktural_id" = :p0';
        try {
    ...
    public function filterByTmtJabatan($tmtJabatan = null, $comparison = null)
    {
        if (is_array($tmtJabatan)) {
            ...
            if (isset($tmtJabatan['min'])) {
                $this->addUsingAlias(RwyStrukturalPeer::TMT_JABATAN, $tmtJabatan['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($tmtJabatan['max'])) {
                $this->addUsingAlias(RwyStrukturalPeer::TMT_JABATAN, $tmtJabatan['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByCreateDate($createDate = null, $comparison = null)
    {
        if (is_array($createDate)) {
            ...
            if (isset($createDate['min'])) {
                $this->addUsingAlias(RwyStrukturalPeer::CREATE_DATE, $createDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createDate['max'])) {
                $this->addUsingAlias(RwyStrukturalPeer::CREATE_DATE, $createDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RwyStrukturalPeer::CREATE_DATE, $createDate, $comparison);
    }
