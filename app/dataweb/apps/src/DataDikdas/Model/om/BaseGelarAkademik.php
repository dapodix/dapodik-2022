...
/**
 * Base class that represents a row from the 'ref.gelar_akademik' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseGelarAkademik extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\GelarAkademikPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GelarAkademikPeer
     */
    ...
    /**
     * The value for the posisi_gelar field.
     * @var        string
     */
    protected $posisi_gelar;
    ...
    /**
     * Initializes internal state of BaseGelarAkademik object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [posisi_gelar] column value.
     * 
     * @return string
     */
    public function getPosisiGelar()
    {
        return $this->posisi_gelar;
    }
     ...
     * @return GelarAkademik The current object (for fluent API support)
     */
    public function setGelarAkademikId($v)
    {
        ...
        if ($this->gelar_akademik_id !== $v) {
            ...
            $this->modifiedColumns[] = GelarAkademikPeer::GELAR_AKADEMIK_ID;
        }
    ...
    public function setKode($v)
    {
        ...
        if ($this->kode !== $v) {
            $this->kode = $v;
            $this->modifiedColumns[] = GelarAkademikPeer::KODE;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = GelarAkademikPeer::NAMA;
        }
    ...
    /**
     * Set the value of [posisi_gelar] column.
     * 
     * @param string $v new value
     * @return GelarAkademik The current object (for fluent API support)
     */
    public function setPosisiGelar($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->posisi_gelar !== $v) {
            $this->posisi_gelar = $v;
            $this->modifiedColumns[] = GelarAkademikPeer::POSISI_GELAR;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GelarAkademikPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GelarAkademikPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GelarAkademikPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = GelarAkademikPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->gelar_akademik_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->kode = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->nama = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->posisi_gelar = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = GelarAkademikPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GelarAkademik object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GelarAkademikPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GelarAkademikQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GelarAkademikPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->rwyPendFormalsScheduledForDeletion !== null) {
                if (!$this->rwyPendFormalsScheduledForDeletion->isEmpty()) {
                    foreach ($this->rwyPendFormalsScheduledForDeletion as $rwyPendFormal) {
                        // need to save related object because we set the relation to null
                        $rwyPendFormal->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GelarAkademikPeer::GELAR_AKADEMIK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"gelar_akademik_id"';
        }
        if ($this->isColumnModified(GelarAkademikPeer::KODE)) {
            $modifiedColumns[':p' . $index++]  = '"kode"';
        }
        if ($this->isColumnModified(GelarAkademikPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(GelarAkademikPeer::POSISI_GELAR)) {
            $modifiedColumns[':p' . $index++]  = '"posisi_gelar"';
        }
        if ($this->isColumnModified(GelarAkademikPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(GelarAkademikPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(GelarAkademikPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(GelarAkademikPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."gelar_akademik" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"nama"':						
                        ...
                        break;
                    case '"posisi_gelar"':						
                        $stmt->bindValue($identifier, $this->posisi_gelar, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GelarAkademikPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GelarAkademikPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GelarAkademik'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GelarAkademik'][$this->getPrimaryKey()] = true;
        $keys = GelarAkademikPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getGelarAkademikId(),
            $keys[1] => $this->getKode(),
            $keys[2] => $this->getNama(),
            $keys[3] => $this->getPosisiGelar(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setGelarAkademikId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setKode($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setNama($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setPosisiGelar($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GelarAkademikPeer::GELAR_AKADEMIK_ID)) $criteria->add(GelarAkademikPeer::GELAR_AKADEMIK_ID, $this->gelar_akademik_id);
        if ($this->isColumnModified(GelarAkademikPeer::KODE)) $criteria->add(GelarAkademikPeer::KODE, $this->kode);
        if ($this->isColumnModified(GelarAkademikPeer::NAMA)) $criteria->add(GelarAkademikPeer::NAMA, $this->nama);
        if ($this->isColumnModified(GelarAkademikPeer::POSISI_GELAR)) $criteria->add(GelarAkademikPeer::POSISI_GELAR, $this->posisi_gelar);
        if ($this->isColumnModified(GelarAkademikPeer::CREATE_DATE)) $criteria->add(GelarAkademikPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(GelarAkademikPeer::LAST_UPDATE)) $criteria->add(GelarAkademikPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(GelarAkademikPeer::EXPIRED_DATE)) $criteria->add(GelarAkademikPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(GelarAkademikPeer::LAST_SYNC)) $criteria->add(GelarAkademikPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(GelarAkademikPeer::DATABASE_NAME);
        $criteria->add(GelarAkademikPeer::GELAR_AKADEMIK_ID, $this->gelar_akademik_id);
    ...
    /**
     * Generic method to set the primary key (gelar_akademik_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getGelarAkademikId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of GelarAkademik (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPosisiGelar($this->getPosisiGelar());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setGelarAkademikId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GelarAkademik Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GelarAkademikPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GelarAkademikPeer();
        }
     ...
     * If this GelarAkademik is new, it will return
    ...
    public function setRwyPendFormals(PropelCollection $rwyPendFormals, PropelPDO $con = null)
    {
        ...
        foreach ($rwyPendFormalsToDelete as $rwyPendFormalRemoved) {
            $rwyPendFormalRemoved->setGelarAkademik(null);
        }
    ...
    protected function doAddRwyPendFormal($rwyPendFormal)
    {
        ...
        $rwyPendFormal->setGelarAkademik($this);
    }
    ...
    public function removeRwyPendFormal($rwyPendFormal)
    {
        if ($this->getRwyPendFormals()->contains($rwyPendFormal)) {
            ...
            $this->rwyPendFormalsScheduledForDeletion[]= $rwyPendFormal;
            $rwyPendFormal->setGelarAkademik(null);
        }
     ...
     * Otherwise if this GelarAkademik is new, it will return
     * an empty collection; or if this GelarAkademik has previously
     * been saved, it will retrieve related RwyPendFormals from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GelarAkademik.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(GelarAkademikPeer::DEFAULT_STRING_FORMAT);
    }
