...
/**
 * This class defines the structure of the 'vld_yayasan' table.
 *
 *
 *
 ...
 */
class VldYayasanTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldYayasanTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('yayasan_id', 'YayasanId', 'VARCHAR', 'yayasan', 'yayasan_id', true, null, null);
