...
/**
 * Base class that represents a row from the 'vld_reg_pd' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRegPd extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRegPdPeer';
    ...
    /**
     * Initializes internal state of BaseVldRegPd object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRegPd The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRegPdPeer::LOGID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRegPdPeer::IDTYPE;
        }
    ...
    public function setRegistrasiId($v)
    {
        ...
        if ($this->registrasi_id !== $v) {
            ...
            $this->modifiedColumns[] = VldRegPdPeer::REGISTRASI_ID;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRegPdPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRegPdPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRegPdPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRegPdPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRegPdPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRegPdPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRegPdPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRegPdPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRegPdPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRegPdPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldRegPdPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRegPd object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRegPdPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRegPdQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRegPdPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRegPdPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRegPdPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRegPdPeer::REGISTRASI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"registrasi_id"';
        }
        if ($this->isColumnModified(VldRegPdPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRegPdPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRegPdPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRegPdPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRegPdPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRegPdPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRegPdPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRegPdPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRegPdPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRegPdPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_reg_pd" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldRegPdPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRegPdPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRegPd'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRegPd'][$this->getPrimaryKey()] = true;
        $keys = VldRegPdPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRegPdPeer::LOGID)) $criteria->add(VldRegPdPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRegPdPeer::IDTYPE)) $criteria->add(VldRegPdPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRegPdPeer::REGISTRASI_ID)) $criteria->add(VldRegPdPeer::REGISTRASI_ID, $this->registrasi_id);
        if ($this->isColumnModified(VldRegPdPeer::STATUS_VALIDASI)) $criteria->add(VldRegPdPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRegPdPeer::FIELD_ERROR)) $criteria->add(VldRegPdPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRegPdPeer::ERROR_MESSAGE)) $criteria->add(VldRegPdPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRegPdPeer::APP_USERNAME)) $criteria->add(VldRegPdPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRegPdPeer::KETERANGAN)) $criteria->add(VldRegPdPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRegPdPeer::CREATE_DATE)) $criteria->add(VldRegPdPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRegPdPeer::LAST_UPDATE)) $criteria->add(VldRegPdPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRegPdPeer::SOFT_DELETE)) $criteria->add(VldRegPdPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRegPdPeer::LAST_SYNC)) $criteria->add(VldRegPdPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRegPdPeer::UPDATER_ID)) $criteria->add(VldRegPdPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRegPdPeer::DATABASE_NAME);
        $criteria->add(VldRegPdPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRegPd (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRegPd Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldRegPds($this);
             */
        }
    ...
    public function getRegistrasiPesertaDidik(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRegistrasiPesertaDidik === null && (($this->registrasi_id !== "" && $this->registrasi_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRegistrasiPesertaDidik->addVldRegPds($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldRegPdPeer::DEFAULT_STRING_FORMAT);
    }
