...
/**
 * Base class that represents a row from the 'ref.map_bidang_mata_pelajaran' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseMapBidangMataPelajaran extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\MapBidangMataPelajaranPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        MapBidangMataPelajaranPeer
     */
    ...
    /**
     * The value for the sesuai field.
     * @var        string
     */
    protected $sesuai;
    ...
    /**
     * Initializes internal state of BaseMapBidangMataPelajaran object.
     * @see        applyDefaults()
     */
     ...
     * @return MapBidangMataPelajaran The current object (for fluent API support)
     */
    public function setMataPelajaranId($v)
    {
        ...
        if ($this->mata_pelajaran_id !== $v) {
            ...
            $this->modifiedColumns[] = MapBidangMataPelajaranPeer::MATA_PELAJARAN_ID;
        }
    ...
    public function setBidangStudiId($v)
    {
        ...
        if ($this->bidang_studi_id !== $v) {
            ...
            $this->modifiedColumns[] = MapBidangMataPelajaranPeer::BIDANG_STUDI_ID;
        }
    ...
    /**
     * Set the value of [sesuai] column.
     * 
     * @param string $v new value
     * @return MapBidangMataPelajaran The current object (for fluent API support)
     */
    public function setSesuai($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->sesuai !== $v) {
            $this->sesuai = $v;
            $this->modifiedColumns[] = MapBidangMataPelajaranPeer::SESUAI;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MapBidangMataPelajaranPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MapBidangMataPelajaranPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MapBidangMataPelajaranPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = MapBidangMataPelajaranPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sesuai = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 7; // 7 = MapBidangMataPelajaranPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating MapBidangMataPelajaran object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MapBidangMataPelajaranPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MapBidangMataPelajaranQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MapBidangMataPelajaranPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::MATA_PELAJARAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"mata_pelajaran_id"';
        }
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::BIDANG_STUDI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"bidang_studi_id"';
        }
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::SESUAI)) {
            $modifiedColumns[':p' . $index++]  = '"sesuai"';
        }
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."map_bidang_mata_pelajaran" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"bidang_studi_id"':						
                        ...
                        break;
                    case '"sesuai"':						
                        $stmt->bindValue($identifier, $this->sesuai, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MapBidangMataPelajaranPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MapBidangMataPelajaranPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MapBidangMataPelajaran'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MapBidangMataPelajaran'][serialize($this->getPrimaryKey())] = true;
        $keys = MapBidangMataPelajaranPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMataPelajaranId(),
            $keys[1] => $this->getBidangStudiId(),
            $keys[2] => $this->getSesuai(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setSesuai($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::MATA_PELAJARAN_ID)) $criteria->add(MapBidangMataPelajaranPeer::MATA_PELAJARAN_ID, $this->mata_pelajaran_id);
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::BIDANG_STUDI_ID)) $criteria->add(MapBidangMataPelajaranPeer::BIDANG_STUDI_ID, $this->bidang_studi_id);
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::SESUAI)) $criteria->add(MapBidangMataPelajaranPeer::SESUAI, $this->sesuai);
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::CREATE_DATE)) $criteria->add(MapBidangMataPelajaranPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::LAST_UPDATE)) $criteria->add(MapBidangMataPelajaranPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::EXPIRED_DATE)) $criteria->add(MapBidangMataPelajaranPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(MapBidangMataPelajaranPeer::LAST_SYNC)) $criteria->add(MapBidangMataPelajaranPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(MapBidangMataPelajaranPeer::DATABASE_NAME);
        $criteria->add(MapBidangMataPelajaranPeer::MATA_PELAJARAN_ID, $this->mata_pelajaran_id);
        $criteria->add(MapBidangMataPelajaranPeer::BIDANG_STUDI_ID, $this->bidang_studi_id);
    ...
    {
        $pks = array();
        $pks[0] = $this->getMataPelajaranId();
        $pks[1] = $this->getBidangStudiId();
    ...
    {
        $this->setMataPelajaranId($keys[0]);
        $this->setBidangStudiId($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getMataPelajaranId()) && (null === $this->getBidangStudiId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of MapBidangMataPelajaran (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSesuai($this->getSesuai());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return MapBidangMataPelajaran Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MapBidangMataPelajaranPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MapBidangMataPelajaranPeer();
        }
    ...
    public function setBidangStudi(BidangStudi $v = null)
    {
        ...
        if ($v !== null) {
            $v->addMapBidangMataPelajaran($this);
        }
    ...
    public function getBidangStudi(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBidangStudi === null && ($this->bidang_studi_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBidangStudi->addMapBidangMataPelajarans($this);
             */
        }
    ...
    public function getMataPelajaran(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMataPelajaran === null && ($this->mata_pelajaran_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMataPelajaran->addMapBidangMataPelajarans($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MapBidangMataPelajaranPeer::DEFAULT_STRING_FORMAT);
    }
