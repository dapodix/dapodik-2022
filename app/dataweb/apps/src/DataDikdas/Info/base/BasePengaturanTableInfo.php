...
/*
 * The Base TableInfo for Pengaturan Table
 */
class BasePengaturanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PengaturanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'pengaturan_id_str');
        $this->setHeader(           'Pengaturan');
        $this->setLabel(            'Pengaturan');
        ...
        $cvar->setColumnName(       'pengaturan_id');
        $cvar->setColumnPhpName(    'PengaturanId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'param_key');
        $cvar->setColumnPhpName(    'ParamKey');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Param Key');
        $cvar->setLabel(            'Param key');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'param_value');
        $cvar->setColumnPhpName(    'ParamValue');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Param Value');
        $cvar->setLabel(            'Param value');
        $cvar->setInputLength(      50);
        $cvar->setFieldWidth(       150);
        $cvar->setColumnWidth(      210);
        $cvar->setHideColumn(       0);
