...
/**
 * Base class that represents a row from the 'vld_ptk_terdaftar' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldPtkTerdaftar extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldPtkTerdaftarPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldPtkTerdaftarPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldPtkTerdaftar object.
     * @see        applyDefaults()
     */
     ...
     * @return VldPtkTerdaftar The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::LOGID;
        }
    ...
    public function setPtkTerdaftarId($v)
    {
        ...
        if ($this->ptk_terdaftar_id !== $v) {
            ...
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::PTK_TERDAFTAR_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPtkTerdaftarPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPtkTerdaftarPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldPtkTerdaftarPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldPtkTerdaftarPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldPtkTerdaftarPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldPtkTerdaftar object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldPtkTerdaftarPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldPtkTerdaftarQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldPtkTerdaftarPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldPtkTerdaftarPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::PTK_TERDAFTAR_ID)) {
            $modifiedColumns[':p' . $index++]  = '"ptk_terdaftar_id"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldPtkTerdaftarPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_ptk_terdaftar" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldPtkTerdaftarPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldPtkTerdaftarPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldPtkTerdaftar'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldPtkTerdaftar'][$this->getPrimaryKey()] = true;
        $keys = VldPtkTerdaftarPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldPtkTerdaftarPeer::LOGID)) $criteria->add(VldPtkTerdaftarPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::PTK_TERDAFTAR_ID)) $criteria->add(VldPtkTerdaftarPeer::PTK_TERDAFTAR_ID, $this->ptk_terdaftar_id);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::IDTYPE)) $criteria->add(VldPtkTerdaftarPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::STATUS_VALIDASI)) $criteria->add(VldPtkTerdaftarPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::FIELD_ERROR)) $criteria->add(VldPtkTerdaftarPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::ERROR_MESSAGE)) $criteria->add(VldPtkTerdaftarPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::APP_USERNAME)) $criteria->add(VldPtkTerdaftarPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::KETERANGAN)) $criteria->add(VldPtkTerdaftarPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::CREATE_DATE)) $criteria->add(VldPtkTerdaftarPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::LAST_UPDATE)) $criteria->add(VldPtkTerdaftarPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::SOFT_DELETE)) $criteria->add(VldPtkTerdaftarPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::LAST_SYNC)) $criteria->add(VldPtkTerdaftarPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldPtkTerdaftarPeer::UPDATER_ID)) $criteria->add(VldPtkTerdaftarPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldPtkTerdaftarPeer::DATABASE_NAME);
        $criteria->add(VldPtkTerdaftarPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldPtkTerdaftar (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldPtkTerdaftar Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldPtkTerdaftarPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldPtkTerdaftarPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldPtkTerdaftars($this);
             */
        }
    ...
    public function getPtkTerdaftar(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPtkTerdaftar === null && (($this->ptk_terdaftar_id !== "" && $this->ptk_terdaftar_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPtkTerdaftar->addVldPtkTerdaftars($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldPtkTerdaftarPeer::DEFAULT_STRING_FORMAT);
    }
