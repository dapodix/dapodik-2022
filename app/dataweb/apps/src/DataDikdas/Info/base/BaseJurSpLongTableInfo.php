...
/*
 * The Base TableInfo for JurSpLong Table
 */
class BaseJurSpLongTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JurSpLongTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'jur_sp_long_id_str');
        $this->setHeader(           'Jur Sp Long');
        $this->setLabel(            'Jur sp long');
        ...
        $cvar->setColumnName(       'jur_sp_long_id');
        $cvar->setColumnPhpName(    'JurSpLongId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setComboXtype(       'jursplongid');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jumlah_pendaftar');
        $cvar->setColumnPhpName(    'JumlahPendaftar');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jumlah Pendaftar');
        $cvar->setLabel(            'Jumlah pendaftar');
        $cvar->setInputLength(      100);
