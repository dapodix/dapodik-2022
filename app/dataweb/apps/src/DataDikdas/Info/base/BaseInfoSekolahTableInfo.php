...
/*
 * The Base TableInfo for InfoSekolah Table
 */
class BaseInfoSekolahTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.InfoSekolahTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'info_sekolah_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'info_sekolah_id_str');
        $this->setHeader(           'Info Sekolah');
        $this->setLabel(            'Info sekolah');
        ...
        $cvar->setColumnName(       'info_sekolah_id');
        $cvar->setColumnPhpName(    'InfoSekolahId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
