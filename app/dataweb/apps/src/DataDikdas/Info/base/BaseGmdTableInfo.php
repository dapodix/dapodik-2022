...
/*
 * The Base TableInfo for Gmd Table
 */
class BaseGmdTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.GmdTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_gmd_str');
        $this->setHeader(           'Pustaka.gmd');
        $this->setLabel(            'Pustaka.gmd');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'pustaka.gmdcombo');
        $this->setXtypeRadio(       'pustaka.gmdradio');
        $this->setXtypeList(        'pustaka.gmdlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_gmd');
        $cvar->setColumnPhpName(    'NmGmd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Gmd');
        $cvar->setLabel(            'Nm gmd');
