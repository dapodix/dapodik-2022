...
/**
 * This class defines the structure of the 'vld_inpassing' table.
 *
 *
 *
 ...
 */
class VldInpassingTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldInpassingTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('inpassing_id', 'InpassingId', 'VARCHAR', 'inpassing', 'inpassing_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Inpassing', 'DataDikdas\\Model\\Inpassing', RelationMap::MANY_TO_ONE, array('inpassing_id' => 'inpassing_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()

} // VldInpassingTableMap
