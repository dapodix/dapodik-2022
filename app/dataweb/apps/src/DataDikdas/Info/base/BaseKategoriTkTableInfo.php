...
/*
 * The Base TableInfo for KategoriTk Table
 */
class BaseKategoriTkTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KategoriTkTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'kategori_tk_id_str');
        $this->setHeader(           'Ref.kategori Tk');
        $this->setLabel(            'Ref.kategori tk');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.kategoritkcombo');
        $this->setXtypeRadio(       'ref.kategoritkradio');
        $this->setXtypeList(        'ref.kategoritklist');
