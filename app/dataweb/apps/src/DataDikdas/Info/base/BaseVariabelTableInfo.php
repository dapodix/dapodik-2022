...
/*
 * The Base TableInfo for Variabel Table
 */
class BaseVariabelTableInfo extends TableInfo
{
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'variabel_id_str');
        $this->setHeader(           'Ref.variabel');
        $this->setLabel(            'Ref.variabel');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "DataDynamic","VariabelValue"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "DataDynamic.variabel_id","VariabelValue.variabel_id"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jenis_variabel');
        $cvar->setColumnPhpName(    'JenisVariabel');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jenis Variabel');
        $cvar->setLabel(            'Jenis variabel');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_paud');
        $cvar->setColumnPhpName(    'UPaud');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_sd');
        $cvar->setColumnPhpName(    'USd');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_smp');
        $cvar->setColumnPhpName(    'USmp');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_sma');
        $cvar->setColumnPhpName(    'USma');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_smk');
        $cvar->setColumnPhpName(    'USmk');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
