...
/**
 * Base class that represents a row from the 'ref.ekstra_kurikuler' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseEkstraKurikuler extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\EkstraKurikulerPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EkstraKurikulerPeer
     */
    ...
    /**
     * Initializes internal state of BaseEkstraKurikuler object.
     * @see        applyDefaults()
     */
     ...
     * @return EkstraKurikuler The current object (for fluent API support)
     */
    public function setIdEkskul($v)
    {
        ...
        if ($this->id_ekskul !== $v) {
            $this->id_ekskul = $v;
            $this->modifiedColumns[] = EkstraKurikulerPeer::ID_EKSKUL;
        }
    ...
    public function setNmEkskul($v)
    {
        ...
        if ($this->nm_ekskul !== $v) {
            $this->nm_ekskul = $v;
            $this->modifiedColumns[] = EkstraKurikulerPeer::NM_EKSKUL;
        }
    ...
    public function setUSd($v)
    {
        ...
        if ($this->u_sd !== $v) {
            $this->u_sd = $v;
            $this->modifiedColumns[] = EkstraKurikulerPeer::U_SD;
        }
    ...
    public function setUSmp($v)
    {
        ...
        if ($this->u_smp !== $v) {
            $this->u_smp = $v;
            $this->modifiedColumns[] = EkstraKurikulerPeer::U_SMP;
        }
    ...
    public function setUSma($v)
    {
        ...
        if ($this->u_sma !== $v) {
            $this->u_sma = $v;
            $this->modifiedColumns[] = EkstraKurikulerPeer::U_SMA;
        }
    ...
    public function setUSmk($v)
    {
        ...
        if ($this->u_smk !== $v) {
            $this->u_smk = $v;
            $this->modifiedColumns[] = EkstraKurikulerPeer::U_SMK;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EkstraKurikulerPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EkstraKurikulerPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EkstraKurikulerPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = EkstraKurikulerPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_ekskul = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->nm_ekskul = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->u_sd = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->u_smp = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->u_sma = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->u_smk = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            return $startcol + 10; // 10 = EkstraKurikulerPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EkstraKurikuler object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EkstraKurikulerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EkstraKurikulerQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EkstraKurikulerPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EkstraKurikulerPeer::ID_EKSKUL)) {
            $modifiedColumns[':p' . $index++]  = '"id_ekskul"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::NM_EKSKUL)) {
            $modifiedColumns[':p' . $index++]  = '"nm_ekskul"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SD)) {
            $modifiedColumns[':p' . $index++]  = '"u_sd"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SMP)) {
            $modifiedColumns[':p' . $index++]  = '"u_smp"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SMA)) {
            $modifiedColumns[':p' . $index++]  = '"u_sma"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SMK)) {
            $modifiedColumns[':p' . $index++]  = '"u_smk"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(EkstraKurikulerPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."ekstra_kurikuler" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EkstraKurikulerPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EkstraKurikulerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EkstraKurikuler'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EkstraKurikuler'][$this->getPrimaryKey()] = true;
        $keys = EkstraKurikulerPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdEkskul(),
            $keys[1] => $this->getNmEkskul(),
            $keys[2] => $this->getUSd(),
            $keys[3] => $this->getUSmp(),
            $keys[4] => $this->getUSma(),
            $keys[5] => $this->getUSmk(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdEkskul($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNmEkskul($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setUSd($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setUSmp($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setUSma($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setUSmk($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EkstraKurikulerPeer::ID_EKSKUL)) $criteria->add(EkstraKurikulerPeer::ID_EKSKUL, $this->id_ekskul);
        if ($this->isColumnModified(EkstraKurikulerPeer::NM_EKSKUL)) $criteria->add(EkstraKurikulerPeer::NM_EKSKUL, $this->nm_ekskul);
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SD)) $criteria->add(EkstraKurikulerPeer::U_SD, $this->u_sd);
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SMP)) $criteria->add(EkstraKurikulerPeer::U_SMP, $this->u_smp);
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SMA)) $criteria->add(EkstraKurikulerPeer::U_SMA, $this->u_sma);
        if ($this->isColumnModified(EkstraKurikulerPeer::U_SMK)) $criteria->add(EkstraKurikulerPeer::U_SMK, $this->u_smk);
        if ($this->isColumnModified(EkstraKurikulerPeer::CREATE_DATE)) $criteria->add(EkstraKurikulerPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(EkstraKurikulerPeer::LAST_UPDATE)) $criteria->add(EkstraKurikulerPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(EkstraKurikulerPeer::EXPIRED_DATE)) $criteria->add(EkstraKurikulerPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(EkstraKurikulerPeer::LAST_SYNC)) $criteria->add(EkstraKurikulerPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(EkstraKurikulerPeer::DATABASE_NAME);
        $criteria->add(EkstraKurikulerPeer::ID_EKSKUL, $this->id_ekskul);
    ...
    /**
     * Generic method to set the primary key (id_ekskul column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of EkstraKurikuler (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdEkskul(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EkstraKurikuler Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EkstraKurikulerPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EkstraKurikulerPeer();
        }
     ...
     * If this EkstraKurikuler is new, it will return
    ...
    public function setKelasEkskuls(PropelCollection $kelasEkskuls, PropelPDO $con = null)
    {
        ...
        foreach ($kelasEkskulsToDelete as $kelasEkskulRemoved) {
            $kelasEkskulRemoved->setEkstraKurikuler(null);
        }
    ...
    protected function doAddKelasEkskul($kelasEkskul)
    {
        ...
        $kelasEkskul->setEkstraKurikuler($this);
    }
    ...
    public function removeKelasEkskul($kelasEkskul)
    {
        if ($this->getKelasEkskuls()->contains($kelasEkskul)) {
            ...
            $kelasEkskul->setEkstraKurikuler(null);
        }
     ...
     * Otherwise if this EkstraKurikuler is new, it will return
     * an empty collection; or if this EkstraKurikuler has previously
     * been saved, it will retrieve related KelasEkskuls from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EkstraKurikuler.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|KelasEkskul[] List of KelasEkskul objects
     */
    public function getKelasEkskulsJoinRombonganBelajar($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = KelasEkskulQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(EkstraKurikulerPeer::DEFAULT_STRING_FORMAT);
    }
