...
/**
 * Base class that represents a row from the 'ref.jenis_gugus' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisGugus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisGugusPeer';
    ...
    /**
     * The value for the jenis_gugus field.
     * @var        string
     */
    protected $jenis_gugus;
    ...
    /**
     * Initializes internal state of BaseJenisGugus object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [jenis_gugus] column value.
     * 
     * @return string
     */
    public function getJenisGugus()
    {
        return $this->jenis_gugus;
    }
     ...
     * @return JenisGugus The current object (for fluent API support)
     */
    public function setJenisGugusId($v)
    {
        ...
        if ($this->jenis_gugus_id !== $v) {
            ...
            $this->modifiedColumns[] = JenisGugusPeer::JENIS_GUGUS_ID;
        }
    ...
    /**
     * Set the value of [jenis_gugus] column.
     * 
     * @param string $v new value
     * @return JenisGugus The current object (for fluent API support)
     */
    public function setJenisGugus($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->jenis_gugus !== $v) {
            $this->jenis_gugus = $v;
            $this->modifiedColumns[] = JenisGugusPeer::JENIS_GUGUS;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisGugusPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisGugusPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisGugusPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisGugusPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jenis_gugus_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->jenis_gugus = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = JenisGugusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisGugus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisGugusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisGugusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisGugusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->gugusSekolahsScheduledForDeletion !== null) {
                if (!$this->gugusSekolahsScheduledForDeletion->isEmpty()) {
                    GugusSekolahQuery::create()
                        ->filterByPrimaryKeys($this->gugusSekolahsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisGugusPeer::JENIS_GUGUS_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_gugus_id"';
        }
        if ($this->isColumnModified(JenisGugusPeer::JENIS_GUGUS)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_gugus"';
        }
        if ($this->isColumnModified(JenisGugusPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisGugusPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisGugusPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisGugusPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_gugus" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"jenis_gugus_id"':						
                        ...
                        break;
                    case '"jenis_gugus"':						
                        $stmt->bindValue($identifier, $this->jenis_gugus, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisGugusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisGugusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JenisGugus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisGugus'][$this->getPrimaryKey()] = true;
        $keys = JenisGugusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getJenisGugusId(),
            $keys[1] => $this->getJenisGugus(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setJenisGugusId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setJenisGugus($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisGugusPeer::JENIS_GUGUS_ID)) $criteria->add(JenisGugusPeer::JENIS_GUGUS_ID, $this->jenis_gugus_id);
        if ($this->isColumnModified(JenisGugusPeer::JENIS_GUGUS)) $criteria->add(JenisGugusPeer::JENIS_GUGUS, $this->jenis_gugus);
        if ($this->isColumnModified(JenisGugusPeer::CREATE_DATE)) $criteria->add(JenisGugusPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisGugusPeer::LAST_UPDATE)) $criteria->add(JenisGugusPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisGugusPeer::EXPIRED_DATE)) $criteria->add(JenisGugusPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisGugusPeer::LAST_SYNC)) $criteria->add(JenisGugusPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisGugusPeer::DATABASE_NAME);
        $criteria->add(JenisGugusPeer::JENIS_GUGUS_ID, $this->jenis_gugus_id);
    ...
    /**
     * Generic method to set the primary key (jenis_gugus_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getJenisGugusId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisGugus (or compatible) type.
    ...
    {
        $copyObj->setJenisGugus($this->getJenisGugus());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setJenisGugusId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisGugus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisGugusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisGugusPeer();
        }
     ...
     * If this JenisGugus is new, it will return
    ...
    public function setGugusSekolahs(PropelCollection $gugusSekolahs, PropelPDO $con = null)
    {
        ...
        foreach ($gugusSekolahsToDelete as $gugusSekolahRemoved) {
            $gugusSekolahRemoved->setJenisGugus(null);
        }
    ...
    protected function doAddGugusSekolah($gugusSekolah)
    {
        ...
        $gugusSekolah->setJenisGugus($this);
    }
    ...
    public function removeGugusSekolah($gugusSekolah)
    {
        if ($this->getGugusSekolahs()->contains($gugusSekolah)) {
            ...
            $this->gugusSekolahsScheduledForDeletion[]= clone $gugusSekolah;
            $gugusSekolah->setJenisGugus(null);
        }
     ...
     * Otherwise if this JenisGugus is new, it will return
     * an empty collection; or if this JenisGugus has previously
     * been saved, it will retrieve related GugusSekolahs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisGugus.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|GugusSekolah[] List of GugusSekolah objects
     */
    public function getGugusSekolahsJoinSekolah($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = GugusSekolahQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(JenisGugusPeer::DEFAULT_STRING_FORMAT);
    }
