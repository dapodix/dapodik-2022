...
/*
 * The Base TableInfo for KelompokUsaha Table
 */
class BaseKelompokUsahaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KelompokUsahaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'kelompok_usaha_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'kelompok_usaha_id_str');
        $this->setHeader(           'Ref.kelompok Usaha');
        $this->setLabel(            'Ref.kelompok usaha');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.kelompokusahacombo');
        $this->setXtypeRadio(       'ref.kelompokusaharadio');
        $this->setXtypeList(        'ref.kelompokusahalist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nama_kelompok_usaha');
        $cvar->setColumnPhpName(    'NamaKelompokUsaha');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nama Kelompok Usaha');
        $cvar->setLabel(            'Nama kelompok usaha');
