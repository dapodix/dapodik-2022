...
/**
 * Base class that represents a row from the 'jur_sp_long' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJurSpLong extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JurSpLongPeer';
    ...
    /**
     * The value for the jumlah_pendaftar field.
     * Note: this column has a database default value of: '0'
     * @var        string
     */
    protected $jumlah_pendaftar;
    ...
    {
        $this->jumlah_pendaftar = '0';
        $this->last_sync = '1901-01-01 00:00:00';
    }

    /**
     * Initializes internal state of BaseJurSpLong object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [jumlah_pendaftar] column value.
     * 
     * @return string
     */
    public function getJumlahPendaftar()
    {
        return $this->jumlah_pendaftar;
    }
     ...
     * @return JurSpLong The current object (for fluent API support)
     */
    public function setJurusanSpId($v)
    {
        ...
        if ($this->jurusan_sp_id !== $v) {
            ...
            $this->modifiedColumns[] = JurSpLongPeer::JURUSAN_SP_ID;
        }
    ...
    public function setSemesterId($v)
    {
        ...
        if ($this->semester_id !== $v) {
            $this->semester_id = $v;
            $this->modifiedColumns[] = JurSpLongPeer::SEMESTER_ID;
        }
    ...
    /**
     * Set the value of [jumlah_pendaftar] column.
     * 
     * @param string $v new value
     * @return JurSpLong The current object (for fluent API support)
     */
    public function setJumlahPendaftar($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->jumlah_pendaftar !== $v) {
            $this->jumlah_pendaftar = $v;
            $this->modifiedColumns[] = JurSpLongPeer::JUMLAH_PENDAFTAR;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JurSpLongPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JurSpLongPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = JurSpLongPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JurSpLongPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = JurSpLongPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jumlah_pendaftar = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 8; // 8 = JurSpLongPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JurSpLong object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JurSpLongPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JurSpLongQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JurSpLongPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JurSpLongPeer::JURUSAN_SP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jurusan_sp_id"';
        }
        if ($this->isColumnModified(JurSpLongPeer::SEMESTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"semester_id"';
        }
        if ($this->isColumnModified(JurSpLongPeer::JUMLAH_PENDAFTAR)) {
            $modifiedColumns[':p' . $index++]  = '"jumlah_pendaftar"';
        }
        if ($this->isColumnModified(JurSpLongPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JurSpLongPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JurSpLongPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(JurSpLongPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(JurSpLongPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "jur_sp_long" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"jumlah_pendaftar"':						
                        $stmt->bindValue($identifier, $this->jumlah_pendaftar, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JurSpLongPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JurSpLongPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getJumlahPendaftar();
                break;
            case 3:
    ...
    {
        if (isset($alreadyDumpedObjects['JurSpLong'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JurSpLong'][serialize($this->getPrimaryKey())] = true;
        $keys = JurSpLongPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getJurusanSpId(),
            $keys[1] => $this->getSemesterId(),
            $keys[2] => $this->getJumlahPendaftar(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setJumlahPendaftar($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JurSpLongPeer::JURUSAN_SP_ID)) $criteria->add(JurSpLongPeer::JURUSAN_SP_ID, $this->jurusan_sp_id);
        if ($this->isColumnModified(JurSpLongPeer::SEMESTER_ID)) $criteria->add(JurSpLongPeer::SEMESTER_ID, $this->semester_id);
        if ($this->isColumnModified(JurSpLongPeer::JUMLAH_PENDAFTAR)) $criteria->add(JurSpLongPeer::JUMLAH_PENDAFTAR, $this->jumlah_pendaftar);
        if ($this->isColumnModified(JurSpLongPeer::CREATE_DATE)) $criteria->add(JurSpLongPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JurSpLongPeer::LAST_UPDATE)) $criteria->add(JurSpLongPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JurSpLongPeer::SOFT_DELETE)) $criteria->add(JurSpLongPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(JurSpLongPeer::LAST_SYNC)) $criteria->add(JurSpLongPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(JurSpLongPeer::UPDATER_ID)) $criteria->add(JurSpLongPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(JurSpLongPeer::DATABASE_NAME);
        $criteria->add(JurSpLongPeer::JURUSAN_SP_ID, $this->jurusan_sp_id);
        $criteria->add(JurSpLongPeer::SEMESTER_ID, $this->semester_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getJurusanSpId()) && (null === $this->getSemesterId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JurSpLong (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setJumlahPendaftar($this->getJumlahPendaftar());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JurSpLong Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JurSpLongPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JurSpLongPeer();
        }
    ...
    public function getSemester(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSemester === null && (($this->semester_id !== "" && $this->semester_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSemester->addJurSpLongs($this);
             */
        }
    ...
    public function getJurusanSp(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aJurusanSp === null && (($this->jurusan_sp_id !== "" && $this->jurusan_sp_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aJurusanSp->addJurSpLongs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(JurSpLongPeer::DEFAULT_STRING_FORMAT);
    }
