...
/**
 * Base class that represents a row from the 'ref.klasifikasi_lembaga' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseKlasifikasiLembaga extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\KlasifikasiLembagaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        KlasifikasiLembagaPeer
     */
    ...
    /**
     * Initializes internal state of BaseKlasifikasiLembaga object.
     * @see        applyDefaults()
     */
     ...
     * @return KlasifikasiLembaga The current object (for fluent API support)
     */
    public function setKlasifikasiLembagaId($v)
    {
        ...
        if ($this->klasifikasi_lembaga_id !== $v) {
            ...
            $this->modifiedColumns[] = KlasifikasiLembagaPeer::KLASIFIKASI_LEMBAGA_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = KlasifikasiLembagaPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KlasifikasiLembagaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KlasifikasiLembagaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KlasifikasiLembagaPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KlasifikasiLembagaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->klasifikasi_lembaga_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = KlasifikasiLembagaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating KlasifikasiLembaga object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = KlasifikasiLembagaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = KlasifikasiLembagaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KlasifikasiLembagaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(KlasifikasiLembagaPeer::KLASIFIKASI_LEMBAGA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"klasifikasi_lembaga_id"';
        }
        if ($this->isColumnModified(KlasifikasiLembagaPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(KlasifikasiLembagaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(KlasifikasiLembagaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(KlasifikasiLembagaPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(KlasifikasiLembagaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."klasifikasi_lembaga" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = KlasifikasiLembagaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = KlasifikasiLembagaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['KlasifikasiLembaga'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['KlasifikasiLembaga'][$this->getPrimaryKey()] = true;
        $keys = KlasifikasiLembagaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getKlasifikasiLembagaId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setKlasifikasiLembagaId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KlasifikasiLembagaPeer::KLASIFIKASI_LEMBAGA_ID)) $criteria->add(KlasifikasiLembagaPeer::KLASIFIKASI_LEMBAGA_ID, $this->klasifikasi_lembaga_id);
        if ($this->isColumnModified(KlasifikasiLembagaPeer::NAMA)) $criteria->add(KlasifikasiLembagaPeer::NAMA, $this->nama);
        if ($this->isColumnModified(KlasifikasiLembagaPeer::CREATE_DATE)) $criteria->add(KlasifikasiLembagaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(KlasifikasiLembagaPeer::LAST_UPDATE)) $criteria->add(KlasifikasiLembagaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(KlasifikasiLembagaPeer::EXPIRED_DATE)) $criteria->add(KlasifikasiLembagaPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(KlasifikasiLembagaPeer::LAST_SYNC)) $criteria->add(KlasifikasiLembagaPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(KlasifikasiLembagaPeer::DATABASE_NAME);
        $criteria->add(KlasifikasiLembagaPeer::KLASIFIKASI_LEMBAGA_ID, $this->klasifikasi_lembaga_id);
    ...
    /**
     * Generic method to set the primary key (klasifikasi_lembaga_id column).
     *
    ...
    {
        $this->setKlasifikasiLembagaId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getKlasifikasiLembagaId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of KlasifikasiLembaga (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setKlasifikasiLembagaId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return KlasifikasiLembaga Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return KlasifikasiLembagaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new KlasifikasiLembagaPeer();
        }
     ...
     * If this KlasifikasiLembaga is new, it will return
        ...
        if (null === $this->collSekolahPauds || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collSekolahPauds) {
                ...
                $collSekolahPauds = SekolahPaudQuery::create(null, $criteria)
                    ->filterByKlasifikasiLembaga($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setSekolahPauds(PropelCollection $sekolahPauds, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahPaudsToDelete as $sekolahPaudRemoved) {
            $sekolahPaudRemoved->setKlasifikasiLembaga(null);
        }
    ...
    protected function doAddSekolahPaud($sekolahPaud)
    {
        ...
        $sekolahPaud->setKlasifikasiLembaga($this);
    }
    ...
    public function removeSekolahPaud($sekolahPaud)
    {
        if ($this->getSekolahPauds()->contains($sekolahPaud)) {
            ...
            $sekolahPaud->setKlasifikasiLembaga(null);
        }
     ...
     * Otherwise if this KlasifikasiLembaga is new, it will return
     * an empty collection; or if this KlasifikasiLembaga has previously
     * been saved, it will retrieve related SekolahPauds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in KlasifikasiLembaga.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(KlasifikasiLembagaPeer::DEFAULT_STRING_FORMAT);
    }
