...
/*
 * The Base TableInfo for JenisTest Table
 */
class BaseJenisTestTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisTestTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'jenis_test_id_str');
        $this->setHeader(           'Ref.jenis Test');
        $this->setLabel(            'Ref.jenis test');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenistestcombo');
        $this->setXtypeRadio(       'ref.jenistestradio');
        $this->setXtypeList(        'ref.jenistestlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jenis_test');
        $cvar->setColumnPhpName(    'JenisTest');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nilai_maks');
        $cvar->setColumnPhpName(    'NilaiMaks');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nilai Maks');
        $cvar->setLabel(            'Nilai maks');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_skor1');
        $cvar->setColumnPhpName(    'KetSkor1');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Skor1');
        $cvar->setLabel(            'Ket skor1');
        $cvar->setInputLength(      80);
        $cvar->setFieldWidth(       240);
        $cvar->setColumnWidth(      300);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_skor2');
        $cvar->setColumnPhpName(    'KetSkor2');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Skor2');
        $cvar->setLabel(            'Ket skor2');
        $cvar->setInputLength(      80);
        $cvar->setFieldWidth(       240);
        $cvar->setColumnWidth(      300);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_skor3');
        $cvar->setColumnPhpName(    'KetSkor3');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Skor3');
        $cvar->setLabel(            'Ket skor3');
        $cvar->setInputLength(      80);
        $cvar->setFieldWidth(       240);
        $cvar->setColumnWidth(      300);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_skor4');
        $cvar->setColumnPhpName(    'KetSkor4');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Skor4');
        $cvar->setLabel(            'Ket skor4');
        $cvar->setInputLength(      80);
        $cvar->setFieldWidth(       240);
        $cvar->setColumnWidth(      300);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_skor5');
        $cvar->setColumnPhpName(    'KetSkor5');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Skor5');
        $cvar->setLabel(            'Ket skor5');
        $cvar->setInputLength(      80);
        $cvar->setFieldWidth(       240);
        $cvar->setColumnWidth(      300);
        $cvar->setHideColumn(       0);
