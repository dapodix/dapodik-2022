...
/**
 * Base class that represents a row from the 'ref.status_kepegawaian' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseStatusKepegawaian extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\StatusKepegawaianPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        StatusKepegawaianPeer
     */
    ...
    /**
     * Initializes internal state of BaseStatusKepegawaian object.
     * @see        applyDefaults()
     */
     ...
     * @return StatusKepegawaian The current object (for fluent API support)
     */
    public function setStatusKepegawaianId($v)
    {
        ...
        if ($this->status_kepegawaian_id !== $v) {
            ...
            $this->modifiedColumns[] = StatusKepegawaianPeer::STATUS_KEPEGAWAIAN_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = StatusKepegawaianPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKepegawaianPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKepegawaianPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKepegawaianPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = StatusKepegawaianPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->status_kepegawaian_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = StatusKepegawaianPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StatusKepegawaian object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StatusKepegawaianPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StatusKepegawaianQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StatusKepegawaianPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StatusKepegawaianPeer::STATUS_KEPEGAWAIAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"status_kepegawaian_id"';
        }
        if ($this->isColumnModified(StatusKepegawaianPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(StatusKepegawaianPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(StatusKepegawaianPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(StatusKepegawaianPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(StatusKepegawaianPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."status_kepegawaian" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StatusKepegawaianPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StatusKepegawaianPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StatusKepegawaian'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StatusKepegawaian'][$this->getPrimaryKey()] = true;
        $keys = StatusKepegawaianPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getStatusKepegawaianId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setStatusKepegawaianId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusKepegawaianPeer::STATUS_KEPEGAWAIAN_ID)) $criteria->add(StatusKepegawaianPeer::STATUS_KEPEGAWAIAN_ID, $this->status_kepegawaian_id);
        if ($this->isColumnModified(StatusKepegawaianPeer::NAMA)) $criteria->add(StatusKepegawaianPeer::NAMA, $this->nama);
        if ($this->isColumnModified(StatusKepegawaianPeer::CREATE_DATE)) $criteria->add(StatusKepegawaianPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(StatusKepegawaianPeer::LAST_UPDATE)) $criteria->add(StatusKepegawaianPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(StatusKepegawaianPeer::EXPIRED_DATE)) $criteria->add(StatusKepegawaianPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(StatusKepegawaianPeer::LAST_SYNC)) $criteria->add(StatusKepegawaianPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(StatusKepegawaianPeer::DATABASE_NAME);
        $criteria->add(StatusKepegawaianPeer::STATUS_KEPEGAWAIAN_ID, $this->status_kepegawaian_id);
    ...
    /**
     * Generic method to set the primary key (status_kepegawaian_id column).
     *
    ...
    {
        $this->setStatusKepegawaianId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getStatusKepegawaianId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of StatusKepegawaian (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStatusKepegawaianId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StatusKepegawaian Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StatusKepegawaianPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StatusKepegawaianPeer();
        }
     ...
     * If this StatusKepegawaian is new, it will return
        ...
        if (null === $this->collPtks || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPtks) {
                ...
                $collPtks = PtkQuery::create(null, $criteria)
                    ->filterByStatusKepegawaian($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPtks(PropelCollection $ptks, PropelPDO $con = null)
    {
        ...
        foreach ($ptksToDelete as $ptkRemoved) {
            $ptkRemoved->setStatusKepegawaian(null);
        }
     ...
     * Otherwise if this StatusKepegawaian is new, it will return
     * an empty collection; or if this StatusKepegawaian has previously
     * been saved, it will retrieve related Ptks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in StatusKepegawaian.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setRwyKerjas(PropelCollection $rwyKerjas, PropelPDO $con = null)
    {
        ...
        foreach ($rwyKerjasToDelete as $rwyKerjaRemoved) {
            $rwyKerjaRemoved->setStatusKepegawaian(null);
        }
    ...
    protected function doAddRwyKerja($rwyKerja)
    {
        ...
        $rwyKerja->setStatusKepegawaian($this);
    }
    ...
    public function removeRwyKerja($rwyKerja)
    {
        if ($this->getRwyKerjas()->contains($rwyKerja)) {
            ...
            $rwyKerja->setStatusKepegawaian(null);
        }
    ...
    {
        return (string) $this->exportTo(StatusKepegawaianPeer::DEFAULT_STRING_FORMAT);
    }
