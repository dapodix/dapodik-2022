...
{
    const CLASS_NAME = 'DataDikdas.Info.JenjangKepengawasanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Ref.jenjang Kepengawasan');
        $this->setLabel(            'Ref.jenjang kepengawasan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenjangkepengawasancombo');
        $this->setXtypeRadio(       'ref.jenjangkepengawasanradio');
        $this->setXtypeList(        'ref.jenjangkepengawasanlist');
