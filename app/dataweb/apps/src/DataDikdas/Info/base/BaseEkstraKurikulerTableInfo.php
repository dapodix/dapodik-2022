...
/*
 * The Base TableInfo for EkstraKurikuler Table
 */
class BaseEkstraKurikulerTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.EkstraKurikulerTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_ekskul_str');
        $this->setHeader(           'Ref.ekstra Kurikuler');
        $this->setLabel(            'Ref.ekstra kurikuler');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.ekstrakurikulercombo');
        $this->setXtypeRadio(       'ref.ekstrakurikulerradio');
        $this->setXtypeList(        'ref.ekstrakurikulerlist');
