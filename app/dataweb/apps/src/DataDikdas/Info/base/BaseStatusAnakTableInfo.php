...
/*
 * The Base TableInfo for StatusAnak Table
 */
class BaseStatusAnakTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.StatusAnakTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'status_anak_id_str');
        $this->setHeader(           'Ref.status Anak');
        $this->setLabel(            'Ref.status anak');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.statusanakcombo');
        $this->setXtypeRadio(       'ref.statusanakradio');
        $this->setXtypeList(        'ref.statusanaklist');
