...
/**
 * Base class that represents a row from the 'pustaka.gmd' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseGmd extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\GmdPeer';
    ...
    /**
     * The value for the nm_gmd field.
     * @var        string
     */
    protected $nm_gmd;
    ...
    /**
     * Initializes internal state of BaseGmd object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nm_gmd] column value.
     * 
     * @return string
     */
    public function getNmGmd()
    {
        return $this->nm_gmd;
    }
     ...
     * @return Gmd The current object (for fluent API support)
     */
    public function setIdGmd($v)
    {
        ...
        if ($this->id_gmd !== $v) {
            $this->id_gmd = $v;
            $this->modifiedColumns[] = GmdPeer::ID_GMD;
        }
    ...
    /**
     * Set the value of [nm_gmd] column.
     * 
     * @param string $v new value
     * @return Gmd The current object (for fluent API support)
     */
    public function setNmGmd($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->nm_gmd !== $v) {
            $this->nm_gmd = $v;
            $this->modifiedColumns[] = GmdPeer::NM_GMD;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GmdPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GmdPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = GmdPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = GmdPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_gmd = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->nm_gmd = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = GmdPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Gmd object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GmdPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GmdPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GmdPeer::ID_GMD)) {
            $modifiedColumns[':p' . $index++]  = '"id_gmd"';
        }
        if ($this->isColumnModified(GmdPeer::NM_GMD)) {
            $modifiedColumns[':p' . $index++]  = '"nm_gmd"';
        }
        if ($this->isColumnModified(GmdPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(GmdPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(GmdPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(GmdPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "pustaka"."gmd" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_gmd"':						
                        ...
                        break;
                    case '"nm_gmd"':						
                        $stmt->bindValue($identifier, $this->nm_gmd, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GmdPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GmdPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Gmd'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Gmd'][$this->getPrimaryKey()] = true;
        $keys = GmdPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdGmd(),
            $keys[1] => $this->getNmGmd(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdGmd($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNmGmd($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GmdPeer::ID_GMD)) $criteria->add(GmdPeer::ID_GMD, $this->id_gmd);
        if ($this->isColumnModified(GmdPeer::NM_GMD)) $criteria->add(GmdPeer::NM_GMD, $this->nm_gmd);
        if ($this->isColumnModified(GmdPeer::CREATE_DATE)) $criteria->add(GmdPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(GmdPeer::LAST_UPDATE)) $criteria->add(GmdPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(GmdPeer::EXPIRED_DATE)) $criteria->add(GmdPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(GmdPeer::LAST_SYNC)) $criteria->add(GmdPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(GmdPeer::DATABASE_NAME);
        $criteria->add(GmdPeer::ID_GMD, $this->id_gmd);
    ...
    /**
     * Generic method to set the primary key (id_gmd column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Gmd (or compatible) type.
    ...
    {
        $copyObj->setNmGmd($this->getNmGmd());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdGmd(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Gmd Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Gmd is new, it will return
     ...
     * Otherwise if this Gmd is new, it will return
     * an empty collection; or if this Gmd has previously
     * been saved, it will retrieve related Biblios from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Gmd.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(GmdPeer::DEFAULT_STRING_FORMAT);
    }
