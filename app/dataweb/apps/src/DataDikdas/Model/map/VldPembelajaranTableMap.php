...
/**
 * This class defines the structure of the 'vld_pembelajaran' table.
 *
 *
 *
 ...
 */
class VldPembelajaranTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldPembelajaranTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('pembelajaran_id', 'PembelajaranId', 'VARCHAR', 'pembelajaran', 'pembelajaran_id', true, null, null);
