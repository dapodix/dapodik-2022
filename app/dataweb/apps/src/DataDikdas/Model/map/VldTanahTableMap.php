...
/**
 * This class defines the structure of the 'vld_tanah' table.
 *
 *
 *
 ...
 */
class VldTanahTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldTanahTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_tanah', 'IdTanah', 'VARCHAR', 'tanah', 'id_tanah', true, null, null);
