...
/**
 * Base class that represents a row from the 'jurusan_kerjasama' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJurusanKerjasama extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JurusanKerjasamaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JurusanKerjasamaPeer
     */
    ...
    /**
     * Initializes internal state of BaseJurusanKerjasama object.
     * @see        applyDefaults()
     */
     ...
     * @return JurusanKerjasama The current object (for fluent API support)
     */
    public function setMouId($v)
    {
        ...
        if ($this->mou_id !== $v) {
            $this->mou_id = $v;
            $this->modifiedColumns[] = JurusanKerjasamaPeer::MOU_ID;
        }
    ...
    public function setJurusanSpId($v)
    {
        ...
        if ($this->jurusan_sp_id !== $v) {
            ...
            $this->modifiedColumns[] = JurusanKerjasamaPeer::JURUSAN_SP_ID;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JurusanKerjasamaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JurusanKerjasamaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = JurusanKerjasamaPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JurusanKerjasamaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = JurusanKerjasamaPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = JurusanKerjasamaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JurusanKerjasama object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JurusanKerjasamaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JurusanKerjasamaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JurusanKerjasamaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JurusanKerjasamaPeer::MOU_ID)) {
            $modifiedColumns[':p' . $index++]  = '"mou_id"';
        }
        if ($this->isColumnModified(JurusanKerjasamaPeer::JURUSAN_SP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jurusan_sp_id"';
        }
        if ($this->isColumnModified(JurusanKerjasamaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JurusanKerjasamaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JurusanKerjasamaPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(JurusanKerjasamaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(JurusanKerjasamaPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "jurusan_kerjasama" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JurusanKerjasamaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JurusanKerjasamaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JurusanKerjasama'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JurusanKerjasama'][serialize($this->getPrimaryKey())] = true;
        $keys = JurusanKerjasamaPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JurusanKerjasamaPeer::MOU_ID)) $criteria->add(JurusanKerjasamaPeer::MOU_ID, $this->mou_id);
        if ($this->isColumnModified(JurusanKerjasamaPeer::JURUSAN_SP_ID)) $criteria->add(JurusanKerjasamaPeer::JURUSAN_SP_ID, $this->jurusan_sp_id);
        if ($this->isColumnModified(JurusanKerjasamaPeer::CREATE_DATE)) $criteria->add(JurusanKerjasamaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JurusanKerjasamaPeer::LAST_UPDATE)) $criteria->add(JurusanKerjasamaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JurusanKerjasamaPeer::SOFT_DELETE)) $criteria->add(JurusanKerjasamaPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(JurusanKerjasamaPeer::LAST_SYNC)) $criteria->add(JurusanKerjasamaPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(JurusanKerjasamaPeer::UPDATER_ID)) $criteria->add(JurusanKerjasamaPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(JurusanKerjasamaPeer::DATABASE_NAME);
        $criteria->add(JurusanKerjasamaPeer::MOU_ID, $this->mou_id);
        $criteria->add(JurusanKerjasamaPeer::JURUSAN_SP_ID, $this->jurusan_sp_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getMouId()) && (null === $this->getJurusanSpId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JurusanKerjasama (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JurusanKerjasama Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JurusanKerjasamaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JurusanKerjasamaPeer();
        }
    ...
    public function getMou(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMou === null && (($this->mou_id !== "" && $this->mou_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMou->addJurusanKerjasamas($this);
             */
        }
    ...
    public function getJurusanSp(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aJurusanSp === null && (($this->jurusan_sp_id !== "" && $this->jurusan_sp_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aJurusanSp->addJurusanKerjasamas($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(JurusanKerjasamaPeer::DEFAULT_STRING_FORMAT);
    }
