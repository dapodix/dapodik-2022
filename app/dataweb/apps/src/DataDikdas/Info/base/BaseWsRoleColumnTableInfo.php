...
/*
 * The Base TableInfo for WsRoleColumn Table
 */
class BaseWsRoleColumnTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.WsRoleColumnTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'role_column_id_str');
        $this->setHeader(           'Ws Role Column');
        $this->setLabel(            'Ws role column');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "WsRoleTable"));
        ...
        $cvar->setColumnName(       'role_column_id');
        $cvar->setColumnPhpName(    'RoleColumnId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'WsRoleTable');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Role Table');
        $cvar->setLabel(            'Role table');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'wsroletablecombo');
        $cvar->setComboXtype(       'wsroletablecombo');
