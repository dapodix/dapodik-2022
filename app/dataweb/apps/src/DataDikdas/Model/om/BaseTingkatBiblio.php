...
/**
 * Base class that represents a row from the 'pustaka.tingkat_biblio' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseTingkatBiblio extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\TingkatBiblioPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TingkatBiblioPeer
     */
    ...
    /**
     * Initializes internal state of BaseTingkatBiblio object.
     * @see        applyDefaults()
     */
     ...
     * @return TingkatBiblio The current object (for fluent API support)
     */
    public function setIdBiblio($v)
    {
        ...
        if ($this->id_biblio !== $v) {
            $this->id_biblio = $v;
            $this->modifiedColumns[] = TingkatBiblioPeer::ID_BIBLIO;
        }
    ...
    public function setTingkatPendidikanId($v)
    {
        ...
        if ($this->tingkat_pendidikan_id !== $v) {
            ...
            $this->modifiedColumns[] = TingkatBiblioPeer::TINGKAT_PENDIDIKAN_ID;
        }
    ...
    public function setBentukPendidikanId($v)
    {
        ...
        if ($this->bentuk_pendidikan_id !== $v) {
            ...
            $this->modifiedColumns[] = TingkatBiblioPeer::BENTUK_PENDIDIKAN_ID;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatBiblioPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatBiblioPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatBiblioPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = TingkatBiblioPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tingkat_pendidikan_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->bentuk_pendidikan_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 7; // 7 = TingkatBiblioPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TingkatBiblio object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TingkatBiblioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TingkatBiblioQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TingkatBiblioPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TingkatBiblioPeer::ID_BIBLIO)) {
            $modifiedColumns[':p' . $index++]  = '"id_biblio"';
        }
        if ($this->isColumnModified(TingkatBiblioPeer::TINGKAT_PENDIDIKAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"tingkat_pendidikan_id"';
        }
        if ($this->isColumnModified(TingkatBiblioPeer::BENTUK_PENDIDIKAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"bentuk_pendidikan_id"';
        }
        if ($this->isColumnModified(TingkatBiblioPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(TingkatBiblioPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(TingkatBiblioPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(TingkatBiblioPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "pustaka"."tingkat_biblio" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TingkatBiblioPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TingkatBiblioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TingkatBiblio'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TingkatBiblio'][serialize($this->getPrimaryKey())] = true;
        $keys = TingkatBiblioPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdBiblio(),
            $keys[1] => $this->getTingkatPendidikanId(),
            $keys[2] => $this->getBentukPendidikanId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTingkatPendidikanId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setBentukPendidikanId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TingkatBiblioPeer::ID_BIBLIO)) $criteria->add(TingkatBiblioPeer::ID_BIBLIO, $this->id_biblio);
        if ($this->isColumnModified(TingkatBiblioPeer::TINGKAT_PENDIDIKAN_ID)) $criteria->add(TingkatBiblioPeer::TINGKAT_PENDIDIKAN_ID, $this->tingkat_pendidikan_id);
        if ($this->isColumnModified(TingkatBiblioPeer::BENTUK_PENDIDIKAN_ID)) $criteria->add(TingkatBiblioPeer::BENTUK_PENDIDIKAN_ID, $this->bentuk_pendidikan_id);
        if ($this->isColumnModified(TingkatBiblioPeer::CREATE_DATE)) $criteria->add(TingkatBiblioPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(TingkatBiblioPeer::LAST_UPDATE)) $criteria->add(TingkatBiblioPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(TingkatBiblioPeer::EXPIRED_DATE)) $criteria->add(TingkatBiblioPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(TingkatBiblioPeer::LAST_SYNC)) $criteria->add(TingkatBiblioPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(TingkatBiblioPeer::DATABASE_NAME);
        $criteria->add(TingkatBiblioPeer::ID_BIBLIO, $this->id_biblio);
        $criteria->add(TingkatBiblioPeer::TINGKAT_PENDIDIKAN_ID, $this->tingkat_pendidikan_id);
        $criteria->add(TingkatBiblioPeer::BENTUK_PENDIDIKAN_ID, $this->bentuk_pendidikan_id);
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[1] = $this->getTingkatPendidikanId();
        $pks[2] = $this->getBentukPendidikanId();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setTingkatPendidikanId($keys[1]);
        $this->setBentukPendidikanId($keys[2]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdBiblio()) && (null === $this->getTingkatPendidikanId()) && (null === $this->getBentukPendidikanId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TingkatBiblio (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TingkatBiblio Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TingkatBiblioPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TingkatBiblioPeer();
        }
    ...
    public function getBiblio(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBiblio === null && (($this->id_biblio !== "" && $this->id_biblio !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBiblio->addTingkatBiblios($this);
             */
        }
    ...
    public function getTingkatPendidikan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTingkatPendidikan === null && (($this->tingkat_pendidikan_id !== "" && $this->tingkat_pendidikan_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTingkatPendidikan->addTingkatBiblios($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TingkatBiblioPeer::DEFAULT_STRING_FORMAT);
    }
