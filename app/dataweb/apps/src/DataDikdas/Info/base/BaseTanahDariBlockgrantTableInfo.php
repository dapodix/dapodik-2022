...
/*
 * The Base TableInfo for TanahDariBlockgrant Table
 */
class BaseTanahDariBlockgrantTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.TanahDariBlockgrantTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'tanah_dari_blockgrant_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'tanah_dari_blockgrant_id_str');
        $this->setHeader(           'Tanah Dari Blockgrant');
        $this->setLabel(            'Tanah dari blockgrant');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "Blockgrant","Tanah"));
        ...
        $cvar->setColumnName(       'tanah_dari_blockgrant_id');
        $cvar->setColumnPhpName(    'TanahDariBlockgrantId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setComboXtype(       'tanahdariblockgrantid');
