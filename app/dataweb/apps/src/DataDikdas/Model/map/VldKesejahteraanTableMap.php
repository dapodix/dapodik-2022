...
/**
 * This class defines the structure of the 'vld_kesejahteraan' table.
 *
 *
 *
 ...
 */
class VldKesejahteraanTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldKesejahteraanTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('kesejahteraan_id', 'KesejahteraanId', 'VARCHAR', 'kesejahteraan', 'kesejahteraan_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Kesejahteraan', 'DataDikdas\\Model\\Kesejahteraan', RelationMap::MANY_TO_ONE, array('kesejahteraan_id' => 'kesejahteraan_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()

} // VldKesejahteraanTableMap
