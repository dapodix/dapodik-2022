...
/*
 * The Base TableInfo for StatusKepemilikanSarpras Table
 */
class BaseStatusKepemilikanSarprasTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.StatusKepemilikanSarprasTableMap';
    ...
    {
        $this->setName('status_kepemilikan_sarpras');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'kepemilikan_sarpras_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'kepemilikan_sarpras_id_str');
        $this->setHeader(           'Ref.status Kepemilikan Sarpras');
        $this->setLabel(            'Ref.status kepemilikan sarpras');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.statuskepemilikansarprascombo');
        $this->setXtypeRadio(       'ref.statuskepemilikansarprasradio');
        $this->setXtypeList(        'ref.statuskepemilikansarpraslist');
