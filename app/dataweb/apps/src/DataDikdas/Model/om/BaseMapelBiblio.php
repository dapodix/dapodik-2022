...
/**
 * Base class that represents a row from the 'pustaka.mapel_biblio' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseMapelBiblio extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\MapelBiblioPeer';
    ...
    /**
     * Initializes internal state of BaseMapelBiblio object.
     * @see        applyDefaults()
     */
     ...
     * @return MapelBiblio The current object (for fluent API support)
     */
    public function setIdBiblio($v)
    {
        ...
        if ($this->id_biblio !== $v) {
            $this->id_biblio = $v;
            $this->modifiedColumns[] = MapelBiblioPeer::ID_BIBLIO;
        }
    ...
    public function setMataPelajaranId($v)
    {
        ...
        if ($this->mata_pelajaran_id !== $v) {
            ...
            $this->modifiedColumns[] = MapelBiblioPeer::MATA_PELAJARAN_ID;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MapelBiblioPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MapelBiblioPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MapelBiblioPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = MapelBiblioPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = MapelBiblioPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating MapelBiblio object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MapelBiblioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MapelBiblioQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MapelBiblioPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MapelBiblioPeer::ID_BIBLIO)) {
            $modifiedColumns[':p' . $index++]  = '"id_biblio"';
        }
        if ($this->isColumnModified(MapelBiblioPeer::MATA_PELAJARAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"mata_pelajaran_id"';
        }
        if ($this->isColumnModified(MapelBiblioPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(MapelBiblioPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(MapelBiblioPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(MapelBiblioPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "pustaka"."mapel_biblio" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MapelBiblioPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MapelBiblioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MapelBiblio'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MapelBiblio'][serialize($this->getPrimaryKey())] = true;
        $keys = MapelBiblioPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MapelBiblioPeer::ID_BIBLIO)) $criteria->add(MapelBiblioPeer::ID_BIBLIO, $this->id_biblio);
        if ($this->isColumnModified(MapelBiblioPeer::MATA_PELAJARAN_ID)) $criteria->add(MapelBiblioPeer::MATA_PELAJARAN_ID, $this->mata_pelajaran_id);
        if ($this->isColumnModified(MapelBiblioPeer::CREATE_DATE)) $criteria->add(MapelBiblioPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(MapelBiblioPeer::LAST_UPDATE)) $criteria->add(MapelBiblioPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(MapelBiblioPeer::EXPIRED_DATE)) $criteria->add(MapelBiblioPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(MapelBiblioPeer::LAST_SYNC)) $criteria->add(MapelBiblioPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(MapelBiblioPeer::DATABASE_NAME);
        $criteria->add(MapelBiblioPeer::ID_BIBLIO, $this->id_biblio);
        $criteria->add(MapelBiblioPeer::MATA_PELAJARAN_ID, $this->mata_pelajaran_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdBiblio()) && (null === $this->getMataPelajaranId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of MapelBiblio (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return MapelBiblio Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MapelBiblioPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MapelBiblioPeer();
        }
    ...
    public function getBiblio(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBiblio === null && (($this->id_biblio !== "" && $this->id_biblio !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBiblio->addMapelBiblios($this);
             */
        }
    ...
    public function getMataPelajaran(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMataPelajaran === null && ($this->mata_pelajaran_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMataPelajaran->addMapelBiblios($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MapelBiblioPeer::DEFAULT_STRING_FORMAT);
    }
