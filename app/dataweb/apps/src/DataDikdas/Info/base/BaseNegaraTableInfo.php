...
/*
 * The Base TableInfo for Negara Table
 */
class BaseNegaraTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.NegaraTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'negara_id_str');
        $this->setHeader(           'Ref.negara');
        $this->setLabel(            'Ref.negara');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.negaracombo');
        $this->setXtypeRadio(       'ref.negararadio');
        $this->setXtypeList(        'ref.negaralist');
        ...
        $cvar->setHeader(           'Nama');
        $cvar->setLabel(            'Nama');
        $cvar->setInputLength(      45);
        $cvar->setFieldWidth(       135);
        $cvar->setColumnWidth(      195);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'luar_negeri');
        $cvar->setColumnPhpName(    'LuarNegeri');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Luar Negeri');
        $cvar->setLabel(            'Luar negeri');
