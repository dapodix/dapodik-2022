...
/**
 * Base class that represents a row from the 'vld_rombel' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRombel extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRombelPeer';
    ...
    /**
     * Initializes internal state of BaseVldRombel object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRombel The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRombelPeer::LOGID;
        }
    ...
    public function setRombonganBelajarId($v)
    {
        ...
        if ($this->rombongan_belajar_id !== $v) {
            ...
            $this->modifiedColumns[] = VldRombelPeer::ROMBONGAN_BELAJAR_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRombelPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRombelPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRombelPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRombelPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRombelPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRombelPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRombelPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRombelPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRombelPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRombelPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRombelPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldRombelPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRombel object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRombelPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRombelQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRombelPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRombelPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRombelPeer::ROMBONGAN_BELAJAR_ID)) {
            $modifiedColumns[':p' . $index++]  = '"rombongan_belajar_id"';
        }
        if ($this->isColumnModified(VldRombelPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRombelPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRombelPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRombelPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRombelPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRombelPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRombelPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRombelPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRombelPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRombelPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRombelPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_rombel" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldRombelPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRombelPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRombel'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRombel'][$this->getPrimaryKey()] = true;
        $keys = VldRombelPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRombelPeer::LOGID)) $criteria->add(VldRombelPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRombelPeer::ROMBONGAN_BELAJAR_ID)) $criteria->add(VldRombelPeer::ROMBONGAN_BELAJAR_ID, $this->rombongan_belajar_id);
        if ($this->isColumnModified(VldRombelPeer::IDTYPE)) $criteria->add(VldRombelPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRombelPeer::STATUS_VALIDASI)) $criteria->add(VldRombelPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRombelPeer::FIELD_ERROR)) $criteria->add(VldRombelPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRombelPeer::ERROR_MESSAGE)) $criteria->add(VldRombelPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRombelPeer::KETERANGAN)) $criteria->add(VldRombelPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRombelPeer::APP_USERNAME)) $criteria->add(VldRombelPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRombelPeer::CREATE_DATE)) $criteria->add(VldRombelPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRombelPeer::LAST_UPDATE)) $criteria->add(VldRombelPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRombelPeer::SOFT_DELETE)) $criteria->add(VldRombelPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRombelPeer::LAST_SYNC)) $criteria->add(VldRombelPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRombelPeer::UPDATER_ID)) $criteria->add(VldRombelPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRombelPeer::DATABASE_NAME);
        $criteria->add(VldRombelPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRombel (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRombel Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldRombelPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldRombelPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldRombels($this);
             */
        }
    ...
    public function getRombonganBelajar(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRombonganBelajar === null && (($this->rombongan_belajar_id !== "" && $this->rombongan_belajar_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRombonganBelajar->addVldRombels($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldRombelPeer::DEFAULT_STRING_FORMAT);
    }
