...
abstract class BaseVldPesertaDidik extends BaseObject implements Persistent
{
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldPesertaDidikPeer::KETERANGAN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldPesertaDidikPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldPesertaDidikPeer::KETERANGAN)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldPesertaDidikPeer::KETERANGAN)) $criteria->add(VldPesertaDidikPeer::KETERANGAN, $this->keterangan);
