...
/**
 * Base class that represents a row from the 'vld_karya_tulis' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldKaryaTulis extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldKaryaTulisPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldKaryaTulisPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldKaryaTulis object.
     * @see        applyDefaults()
     */
     ...
     * @return VldKaryaTulis The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldKaryaTulisPeer::LOGID;
        }
    ...
    public function setKaryaTulisId($v)
    {
        ...
        if ($this->karya_tulis_id !== $v) {
            ...
            $this->modifiedColumns[] = VldKaryaTulisPeer::KARYA_TULIS_ID;
        }

        if ($this->aKaryaTulis !== null && $this->aKaryaTulis->getKaryaTulisId() !== $v) {
            $this->aKaryaTulis = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldKaryaTulisPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldKaryaTulisPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldKaryaTulisPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldKaryaTulisPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldKaryaTulisPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldKaryaTulisPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldKaryaTulisPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldKaryaTulisPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldKaryaTulisPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldKaryaTulisPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldKaryaTulisPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->karya_tulis_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldKaryaTulisPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldKaryaTulis object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aKaryaTulis !== null && $this->karya_tulis_id !== $this->aKaryaTulis->getKaryaTulisId()) {
            $this->aKaryaTulis = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldKaryaTulisPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldKaryaTulisQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldKaryaTulisPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aKaryaTulis !== null) {
                if ($this->aKaryaTulis->isModified() || $this->aKaryaTulis->isNew()) {
                    $affectedRows += $this->aKaryaTulis->save($con);
                }
                $this->setKaryaTulis($this->aKaryaTulis);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldKaryaTulisPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::KARYA_TULIS_ID)) {
            $modifiedColumns[':p' . $index++]  = '"karya_tulis_id"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldKaryaTulisPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_karya_tulis" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aKaryaTulis !== null) {
                if (!$this->aKaryaTulis->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aKaryaTulis->getValidationFailures());
                }
            }


            if (($retval = VldKaryaTulisPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldKaryaTulisPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldKaryaTulis'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldKaryaTulis'][$this->getPrimaryKey()] = true;
        $keys = VldKaryaTulisPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getKaryaTulisId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aKaryaTulis) {
                $result['KaryaTulis'] = $this->aKaryaTulis->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setKaryaTulisId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldKaryaTulisPeer::LOGID)) $criteria->add(VldKaryaTulisPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldKaryaTulisPeer::KARYA_TULIS_ID)) $criteria->add(VldKaryaTulisPeer::KARYA_TULIS_ID, $this->karya_tulis_id);
        if ($this->isColumnModified(VldKaryaTulisPeer::IDTYPE)) $criteria->add(VldKaryaTulisPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldKaryaTulisPeer::STATUS_VALIDASI)) $criteria->add(VldKaryaTulisPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldKaryaTulisPeer::FIELD_ERROR)) $criteria->add(VldKaryaTulisPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldKaryaTulisPeer::ERROR_MESSAGE)) $criteria->add(VldKaryaTulisPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldKaryaTulisPeer::KETERANGAN)) $criteria->add(VldKaryaTulisPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldKaryaTulisPeer::APP_USERNAME)) $criteria->add(VldKaryaTulisPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldKaryaTulisPeer::CREATE_DATE)) $criteria->add(VldKaryaTulisPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldKaryaTulisPeer::LAST_UPDATE)) $criteria->add(VldKaryaTulisPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldKaryaTulisPeer::SOFT_DELETE)) $criteria->add(VldKaryaTulisPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldKaryaTulisPeer::LAST_SYNC)) $criteria->add(VldKaryaTulisPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldKaryaTulisPeer::UPDATER_ID)) $criteria->add(VldKaryaTulisPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldKaryaTulisPeer::DATABASE_NAME);
        $criteria->add(VldKaryaTulisPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldKaryaTulis (or compatible) type.
    ...
    {
        $copyObj->setKaryaTulisId($this->getKaryaTulisId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldKaryaTulis Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldKaryaTulisPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldKaryaTulisPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldKaryaTuliss($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a KaryaTulis object.
     *
     * @param             KaryaTulis $v
     * @return VldKaryaTulis The current object (for fluent API support)
     * @throws PropelException
     */
    public function setKaryaTulis(KaryaTulis $v = null)
    {
        if ($v === null) {
            $this->setKaryaTulisId(NULL);
        } else {
            $this->setKaryaTulisId($v->getKaryaTulisId());
        }

        $this->aKaryaTulis = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the KaryaTulis object, it will not be re-added.
        if ($v !== null) {
            $v->addVldKaryaTulis($this);
        }
    ...
    /**
     * Get the associated KaryaTulis object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return KaryaTulis The associated KaryaTulis object.
     * @throws PropelException
     */
    public function getKaryaTulis(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aKaryaTulis === null && (($this->karya_tulis_id !== "" && $this->karya_tulis_id !== null)) && $doQuery) {
            $this->aKaryaTulis = KaryaTulisQuery::create()->findPk($this->karya_tulis_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aKaryaTulis->addVldKaryaTuliss($this);
             */
        }

        return $this->aKaryaTulis;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aKaryaTulis instanceof Persistent) {
              $this->aKaryaTulis->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldKaryaTulisPeer::DEFAULT_STRING_FORMAT);
    }
