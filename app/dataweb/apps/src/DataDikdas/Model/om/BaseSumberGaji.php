...
/**
 * Base class that represents a row from the 'ref.sumber_gaji' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseSumberGaji extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\SumberGajiPeer';
    ...
    /**
     * Initializes internal state of BaseSumberGaji object.
     * @see        applyDefaults()
     */
     ...
     * @return SumberGaji The current object (for fluent API support)
     */
    public function setSumberGajiId($v)
    {
        ...
        if ($this->sumber_gaji_id !== $v) {
            ...
            $this->modifiedColumns[] = SumberGajiPeer::SUMBER_GAJI_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = SumberGajiPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SumberGajiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SumberGajiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SumberGajiPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = SumberGajiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sumber_gaji_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = SumberGajiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SumberGaji object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SumberGajiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SumberGajiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SumberGajiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SumberGajiPeer::SUMBER_GAJI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"sumber_gaji_id"';
        }
        if ($this->isColumnModified(SumberGajiPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(SumberGajiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(SumberGajiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(SumberGajiPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(SumberGajiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."sumber_gaji" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SumberGajiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SumberGajiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SumberGaji'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SumberGaji'][$this->getPrimaryKey()] = true;
        $keys = SumberGajiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSumberGajiId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setSumberGajiId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SumberGajiPeer::SUMBER_GAJI_ID)) $criteria->add(SumberGajiPeer::SUMBER_GAJI_ID, $this->sumber_gaji_id);
        if ($this->isColumnModified(SumberGajiPeer::NAMA)) $criteria->add(SumberGajiPeer::NAMA, $this->nama);
        if ($this->isColumnModified(SumberGajiPeer::CREATE_DATE)) $criteria->add(SumberGajiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(SumberGajiPeer::LAST_UPDATE)) $criteria->add(SumberGajiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(SumberGajiPeer::EXPIRED_DATE)) $criteria->add(SumberGajiPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(SumberGajiPeer::LAST_SYNC)) $criteria->add(SumberGajiPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(SumberGajiPeer::DATABASE_NAME);
        $criteria->add(SumberGajiPeer::SUMBER_GAJI_ID, $this->sumber_gaji_id);
    ...
    /**
     * Generic method to set the primary key (sumber_gaji_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getSumberGajiId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of SumberGaji (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSumberGajiId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SumberGaji Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SumberGajiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SumberGajiPeer();
        }
     ...
     * If this SumberGaji is new, it will return
     ...
     * Otherwise if this SumberGaji is new, it will return
     * an empty collection; or if this SumberGaji has previously
     * been saved, it will retrieve related Ptks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SumberGaji.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(SumberGajiPeer::DEFAULT_STRING_FORMAT);
    }
