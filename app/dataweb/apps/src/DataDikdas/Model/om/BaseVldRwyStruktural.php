...
/**
 * Base class that represents a row from the 'vld_rwy_struktural' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRwyStruktural extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRwyStrukturalPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldRwyStrukturalPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldRwyStruktural object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRwyStruktural The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRwyStrukturalPeer::LOGID;
        }
    ...
    public function setRiwayatStrukturalId($v)
    {
        ...
        if ($this->riwayat_struktural_id !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyStrukturalPeer::RIWAYAT_STRUKTURAL_ID;
        }

        if ($this->aRwyStruktural !== null && $this->aRwyStruktural->getRiwayatStrukturalId() !== $v) {
            $this->aRwyStruktural = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRwyStrukturalPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyStrukturalPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRwyStrukturalPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyStrukturalPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRwyStrukturalPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRwyStrukturalPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyStrukturalPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyStrukturalPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRwyStrukturalPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRwyStrukturalPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRwyStrukturalPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->riwayat_struktural_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldRwyStrukturalPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRwyStruktural object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRwyStruktural !== null && $this->riwayat_struktural_id !== $this->aRwyStruktural->getRiwayatStrukturalId()) {
            $this->aRwyStruktural = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRwyStrukturalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRwyStrukturalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRwyStrukturalPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRwyStruktural !== null) {
                if ($this->aRwyStruktural->isModified() || $this->aRwyStruktural->isNew()) {
                    $affectedRows += $this->aRwyStruktural->save($con);
                }
                $this->setRwyStruktural($this->aRwyStruktural);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRwyStrukturalPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::RIWAYAT_STRUKTURAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"riwayat_struktural_id"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRwyStrukturalPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_rwy_struktural" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aRwyStruktural !== null) {
                if (!$this->aRwyStruktural->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aRwyStruktural->getValidationFailures());
                }
            }
            ...
            if (($retval = VldRwyStrukturalPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRwyStrukturalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRwyStruktural'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRwyStruktural'][$this->getPrimaryKey()] = true;
        $keys = VldRwyStrukturalPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getRiwayatStrukturalId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aRwyStruktural) {
                $result['RwyStruktural'] = $this->aRwyStruktural->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setRiwayatStrukturalId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRwyStrukturalPeer::LOGID)) $criteria->add(VldRwyStrukturalPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRwyStrukturalPeer::RIWAYAT_STRUKTURAL_ID)) $criteria->add(VldRwyStrukturalPeer::RIWAYAT_STRUKTURAL_ID, $this->riwayat_struktural_id);
        if ($this->isColumnModified(VldRwyStrukturalPeer::IDTYPE)) $criteria->add(VldRwyStrukturalPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRwyStrukturalPeer::STATUS_VALIDASI)) $criteria->add(VldRwyStrukturalPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRwyStrukturalPeer::FIELD_ERROR)) $criteria->add(VldRwyStrukturalPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRwyStrukturalPeer::ERROR_MESSAGE)) $criteria->add(VldRwyStrukturalPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRwyStrukturalPeer::KETERANGAN)) $criteria->add(VldRwyStrukturalPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRwyStrukturalPeer::APP_USERNAME)) $criteria->add(VldRwyStrukturalPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRwyStrukturalPeer::CREATE_DATE)) $criteria->add(VldRwyStrukturalPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRwyStrukturalPeer::LAST_UPDATE)) $criteria->add(VldRwyStrukturalPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRwyStrukturalPeer::SOFT_DELETE)) $criteria->add(VldRwyStrukturalPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRwyStrukturalPeer::LAST_SYNC)) $criteria->add(VldRwyStrukturalPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRwyStrukturalPeer::UPDATER_ID)) $criteria->add(VldRwyStrukturalPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRwyStrukturalPeer::DATABASE_NAME);
        $criteria->add(VldRwyStrukturalPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRwyStruktural (or compatible) type.
    ...
    {
        $copyObj->setRiwayatStrukturalId($this->getRiwayatStrukturalId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRwyStruktural Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldRwyStrukturalPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldRwyStrukturalPeer();
        }
    ...
    /**
     * Declares an association between this object and a RwyStruktural object.
     *
     * @param             RwyStruktural $v
     * @return VldRwyStruktural The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRwyStruktural(RwyStruktural $v = null)
    {
        if ($v === null) {
            $this->setRiwayatStrukturalId(NULL);
        } else {
            $this->setRiwayatStrukturalId($v->getRiwayatStrukturalId());
        }

        $this->aRwyStruktural = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the RwyStruktural object, it will not be re-added.
        if ($v !== null) {
            $v->addVldRwyStruktural($this);
        }
    ...
    /**
     * Get the associated RwyStruktural object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return RwyStruktural The associated RwyStruktural object.
     * @throws PropelException
     */
    public function getRwyStruktural(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRwyStruktural === null && (($this->riwayat_struktural_id !== "" && $this->riwayat_struktural_id !== null)) && $doQuery) {
            $this->aRwyStruktural = RwyStrukturalQuery::create()->findPk($this->riwayat_struktural_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRwyStruktural->addVldRwyStrukturals($this);
             */
        }

        return $this->aRwyStruktural;
    }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aErrortype->addVldRwyStrukturals($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aRwyStruktural instanceof Persistent) {
              $this->aRwyStruktural->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldRwyStrukturalPeer::DEFAULT_STRING_FORMAT);
    }
