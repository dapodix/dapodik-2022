...
/*
 * The Base TableInfo for TingkatPenghargaan Table
 */
class BaseTingkatPenghargaanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.TingkatPenghargaanTableMap';
    ...
    {
        $this->setName('tingkat_penghargaan');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'tingkat_penghargaan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'tingkat_penghargaan_id_str');
        $this->setHeader(           'Ref.tingkat Penghargaan');
        $this->setLabel(            'Ref.tingkat penghargaan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.tingkatpenghargaancombo');
        $this->setXtypeRadio(       'ref.tingkatpenghargaanradio');
        $this->setXtypeList(        'ref.tingkatpenghargaanlist');
