...
/*
 * The Base TableInfo for Frequency Table
 */
class BaseFrequencyTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.FrequencyTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_freq_str');
        $this->setHeader(           'Pustaka.frequency');
        $this->setLabel(            'Pustaka.frequency');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'pustaka.frequencycombo');
        $this->setXtypeRadio(       'pustaka.frequencyradio');
        $this->setXtypeList(        'pustaka.frequencylist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'freq');
        $cvar->setColumnPhpName(    'Freq');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'interval');
        $cvar->setColumnPhpName(    'Interval');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Interval');
        $cvar->setLabel(            'Interval');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'time_unit');
        $cvar->setColumnPhpName(    'TimeUnit');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Time Unit');
        $cvar->setLabel(            'Time unit');
