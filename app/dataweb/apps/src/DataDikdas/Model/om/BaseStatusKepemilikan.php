...
/**
 * Base class that represents a row from the 'ref.status_kepemilikan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseStatusKepemilikan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\StatusKepemilikanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        StatusKepemilikanPeer
     */
    ...
    /**
     * Initializes internal state of BaseStatusKepemilikan object.
     * @see        applyDefaults()
     */
     ...
     * @return StatusKepemilikan The current object (for fluent API support)
     */
    public function setStatusKepemilikanId($v)
    {
        ...
        if ($this->status_kepemilikan_id !== $v) {
            ...
            $this->modifiedColumns[] = StatusKepemilikanPeer::STATUS_KEPEMILIKAN_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = StatusKepemilikanPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKepemilikanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKepemilikanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKepemilikanPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = StatusKepemilikanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->status_kepemilikan_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = StatusKepemilikanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StatusKepemilikan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StatusKepemilikanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StatusKepemilikanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StatusKepemilikanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StatusKepemilikanPeer::STATUS_KEPEMILIKAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"status_kepemilikan_id"';
        }
        if ($this->isColumnModified(StatusKepemilikanPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(StatusKepemilikanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(StatusKepemilikanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(StatusKepemilikanPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(StatusKepemilikanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."status_kepemilikan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StatusKepemilikanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StatusKepemilikanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StatusKepemilikan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StatusKepemilikan'][$this->getPrimaryKey()] = true;
        $keys = StatusKepemilikanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getStatusKepemilikanId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setStatusKepemilikanId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusKepemilikanPeer::STATUS_KEPEMILIKAN_ID)) $criteria->add(StatusKepemilikanPeer::STATUS_KEPEMILIKAN_ID, $this->status_kepemilikan_id);
        if ($this->isColumnModified(StatusKepemilikanPeer::NAMA)) $criteria->add(StatusKepemilikanPeer::NAMA, $this->nama);
        if ($this->isColumnModified(StatusKepemilikanPeer::CREATE_DATE)) $criteria->add(StatusKepemilikanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(StatusKepemilikanPeer::LAST_UPDATE)) $criteria->add(StatusKepemilikanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(StatusKepemilikanPeer::EXPIRED_DATE)) $criteria->add(StatusKepemilikanPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(StatusKepemilikanPeer::LAST_SYNC)) $criteria->add(StatusKepemilikanPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(StatusKepemilikanPeer::DATABASE_NAME);
        $criteria->add(StatusKepemilikanPeer::STATUS_KEPEMILIKAN_ID, $this->status_kepemilikan_id);
    ...
    /**
     * Generic method to set the primary key (status_kepemilikan_id column).
     *
    ...
    {
        $this->setStatusKepemilikanId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getStatusKepemilikanId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of StatusKepemilikan (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStatusKepemilikanId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StatusKepemilikan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StatusKepemilikanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StatusKepemilikanPeer();
        }
     ...
     * If this StatusKepemilikan is new, it will return
        ...
        if (null === $this->collSekolahs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collSekolahs) {
                ...
                $collSekolahs = SekolahQuery::create(null, $criteria)
                    ->filterByStatusKepemilikan($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setSekolahs(PropelCollection $sekolahs, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahsToDelete as $sekolahRemoved) {
            $sekolahRemoved->setStatusKepemilikan(null);
        }
    ...
    protected function doAddSekolah($sekolah)
    {
        ...
        $sekolah->setStatusKepemilikan($this);
    }
    ...
    public function removeSekolah($sekolah)
    {
        if ($this->getSekolahs()->contains($sekolah)) {
            ...
            $sekolah->setStatusKepemilikan(null);
        }
     ...
     * Otherwise if this StatusKepemilikan is new, it will return
     * an empty collection; or if this StatusKepemilikan has previously
     * been saved, it will retrieve related Sekolahs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in StatusKepemilikan.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(StatusKepemilikanPeer::DEFAULT_STRING_FORMAT);
    }
