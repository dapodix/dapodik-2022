...
class MssqlSchemaParser extends BaseSchemaParser
{
   ...
   */
    ...
    public function parse(Database $database, Task $task = null)
    {
        ...
        // to
        $stmt = $this->dbh->query("SELECT TABLE_NAME, TABLE_SCHEMA FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE' AND TABLE_NAME <> 'dtproperties'");
    ...
    protected function addColumns(Table $table)
    {
        ...
        $stmt = $this->dbh->query("sp_columns '" . $tableName . "'");
    ...
    protected function addForeignKeys(Table $table)
    {
        ...
        $stmt = $this->dbh->query("SELECT ccu1.TABLE_NAME, ccu1.COLUMN_NAME, ccu2.TABLE_NAME AS FK_TABLE_NAME, ccu2.COLUMN_NAME AS FK_COLUMN_NAME, ccu1.CONSTRAINT_NAME
                                    ...
                                    WHERE (ccu1.table_name = '".$tableName."')");
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            // Added by Abah
            $ftbl = ($row['TABLE_SCHEMA'] != 'dbo') ? $row['TABLE_SCHEMA'].".".$ftbl : $ftbl;
    ...
    protected function addIndexes(Table $table)
    {
        ...
        $stmt = $this->dbh->query("sp_indexes_rowset '" . $tableName . "'");
