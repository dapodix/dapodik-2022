...
/**
 * Base class that represents a row from the 'vld_bea_ptk' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldBeaPtk extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldBeaPtkPeer';
    ...
    /**
     * Initializes internal state of BaseVldBeaPtk object.
     * @see        applyDefaults()
     */
     ...
     * @return VldBeaPtk The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldBeaPtkPeer::LOGID;
        }
    ...
    public function setBeasiswaPtkId($v)
    {
        ...
        if ($this->beasiswa_ptk_id !== $v) {
            ...
            $this->modifiedColumns[] = VldBeaPtkPeer::BEASISWA_PTK_ID;
        }

        if ($this->aBeasiswaPtk !== null && $this->aBeasiswaPtk->getBeasiswaPtkId() !== $v) {
            $this->aBeasiswaPtk = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldBeaPtkPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldBeaPtkPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldBeaPtkPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldBeaPtkPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldBeaPtkPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldBeaPtkPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBeaPtkPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBeaPtkPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldBeaPtkPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldBeaPtkPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldBeaPtkPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->beasiswa_ptk_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldBeaPtkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldBeaPtk object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBeasiswaPtk !== null && $this->beasiswa_ptk_id !== $this->aBeasiswaPtk->getBeasiswaPtkId()) {
            $this->aBeasiswaPtk = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldBeaPtkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldBeaPtkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldBeaPtkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBeasiswaPtk !== null) {
                if ($this->aBeasiswaPtk->isModified() || $this->aBeasiswaPtk->isNew()) {
                    $affectedRows += $this->aBeasiswaPtk->save($con);
                }
                $this->setBeasiswaPtk($this->aBeasiswaPtk);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldBeaPtkPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::BEASISWA_PTK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"beasiswa_ptk_id"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldBeaPtkPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_bea_ptk" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBeasiswaPtk !== null) {
                if (!$this->aBeasiswaPtk->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBeasiswaPtk->getValidationFailures());
                }
            }


            if (($retval = VldBeaPtkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldBeaPtkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldBeaPtk'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldBeaPtk'][$this->getPrimaryKey()] = true;
        $keys = VldBeaPtkPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getBeasiswaPtkId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aBeasiswaPtk) {
                $result['BeasiswaPtk'] = $this->aBeasiswaPtk->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBeasiswaPtkId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldBeaPtkPeer::LOGID)) $criteria->add(VldBeaPtkPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldBeaPtkPeer::BEASISWA_PTK_ID)) $criteria->add(VldBeaPtkPeer::BEASISWA_PTK_ID, $this->beasiswa_ptk_id);
        if ($this->isColumnModified(VldBeaPtkPeer::IDTYPE)) $criteria->add(VldBeaPtkPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldBeaPtkPeer::STATUS_VALIDASI)) $criteria->add(VldBeaPtkPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldBeaPtkPeer::FIELD_ERROR)) $criteria->add(VldBeaPtkPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldBeaPtkPeer::ERROR_MESSAGE)) $criteria->add(VldBeaPtkPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldBeaPtkPeer::KETERANGAN)) $criteria->add(VldBeaPtkPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldBeaPtkPeer::APP_USERNAME)) $criteria->add(VldBeaPtkPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldBeaPtkPeer::CREATE_DATE)) $criteria->add(VldBeaPtkPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldBeaPtkPeer::LAST_UPDATE)) $criteria->add(VldBeaPtkPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldBeaPtkPeer::SOFT_DELETE)) $criteria->add(VldBeaPtkPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldBeaPtkPeer::LAST_SYNC)) $criteria->add(VldBeaPtkPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldBeaPtkPeer::UPDATER_ID)) $criteria->add(VldBeaPtkPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldBeaPtkPeer::DATABASE_NAME);
        $criteria->add(VldBeaPtkPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldBeaPtk (or compatible) type.
    ...
    {
        $copyObj->setBeasiswaPtkId($this->getBeasiswaPtkId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldBeaPtk Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldBeaPtkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldBeaPtkPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldBeaPtks($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a BeasiswaPtk object.
     *
     * @param             BeasiswaPtk $v
     * @return VldBeaPtk The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBeasiswaPtk(BeasiswaPtk $v = null)
    {
        if ($v === null) {
            $this->setBeasiswaPtkId(NULL);
        } else {
            $this->setBeasiswaPtkId($v->getBeasiswaPtkId());
        }

        $this->aBeasiswaPtk = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the BeasiswaPtk object, it will not be re-added.
        if ($v !== null) {
            $v->addVldBeaPtk($this);
        }
    ...
    /**
     * Get the associated BeasiswaPtk object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return BeasiswaPtk The associated BeasiswaPtk object.
     * @throws PropelException
     */
    public function getBeasiswaPtk(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBeasiswaPtk === null && (($this->beasiswa_ptk_id !== "" && $this->beasiswa_ptk_id !== null)) && $doQuery) {
            $this->aBeasiswaPtk = BeasiswaPtkQuery::create()->findPk($this->beasiswa_ptk_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBeasiswaPtk->addVldBeaPtks($this);
             */
        }

        return $this->aBeasiswaPtk;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aBeasiswaPtk instanceof Persistent) {
              $this->aBeasiswaPtk->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldBeaPtkPeer::DEFAULT_STRING_FORMAT);
    }
