...
abstract class BaseVldAlat extends BaseObject implements Persistent
{
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldAlatPeer::KETERANGAN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldAlatPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldAlatPeer::KETERANGAN)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldAlatPeer::KETERANGAN)) $criteria->add(VldAlatPeer::KETERANGAN, $this->keterangan);
