...
/*
 * The Base TableInfo for LevelWilayah Table
 */
class BaseLevelWilayahTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.LevelWilayahTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'id_level_wilayah');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'id_level_wilayah_str');
        $this->setHeader(           'Ref.level Wilayah');
        $this->setLabel(            'Ref.level wilayah');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.levelwilayahcombo');
        $this->setXtypeRadio(       'ref.levelwilayahradio');
        $this->setXtypeList(        'ref.levelwilayahlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'level_wilayah');
        $cvar->setColumnPhpName(    'LevelWilayah');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
