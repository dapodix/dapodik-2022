...
/*
 * The Base TableInfo for LargeObject Table
 */
class BaseLargeObjectTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.LargeObjectTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'blob_id_str');
        $this->setHeader(           'Blob.large Object');
        $this->setLabel(            'Blob.large object');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "Ptk","RuangLongitudinal","SekolahLongitudinal"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "Ptk.blob_id","RuangLongitudinal.blob_id","SekolahLongitudinal.blob_id"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'blob_content');
        $cvar->setColumnPhpName(    'BlobContent');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Blob Content');
        $cvar->setLabel(            'Blob content');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      60);
