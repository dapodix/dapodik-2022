...
/**
 * Base class that represents a row from the 'tanah_longitudinal' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseTanahLongitudinal extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\TanahLongitudinalPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TanahLongitudinalPeer
     */
    ...
    /**
     * Initializes internal state of BaseTanahLongitudinal object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [njop] column value.
     * 
     * @return string
     */
    public function getNjop()
    {
        return $this->njop;
    }
     ...
     * @return TanahLongitudinal The current object (for fluent API support)
     */
    public function setIdTanah($v)
    {
        ...
        if ($this->id_tanah !== $v) {
            $this->id_tanah = $v;
            $this->modifiedColumns[] = TanahLongitudinalPeer::ID_TANAH;
        }
    ...
    public function setTahunAjaranId($v)
    {
        ...
        if ($this->tahun_ajaran_id !== $v) {
            ...
            $this->modifiedColumns[] = TanahLongitudinalPeer::TAHUN_AJARAN_ID;
        }
    ...
    /**
     * Set the value of [njop] column.
     * 
     * @param string $v new value
     * @return TanahLongitudinal The current object (for fluent API support)
     */
    public function setNjop($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->njop !== $v) {
            $this->njop = $v;
            $this->modifiedColumns[] = TanahLongitudinalPeer::NJOP;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TanahLongitudinalPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TanahLongitudinalPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = TanahLongitudinalPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = TanahLongitudinalPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = TanahLongitudinalPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->njop = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 8; // 8 = TanahLongitudinalPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TanahLongitudinal object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TanahLongitudinalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TanahLongitudinalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TanahLongitudinalPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TanahLongitudinalPeer::ID_TANAH)) {
            $modifiedColumns[':p' . $index++]  = '"id_tanah"';
        }
        if ($this->isColumnModified(TanahLongitudinalPeer::TAHUN_AJARAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"tahun_ajaran_id"';
        }
        if ($this->isColumnModified(TanahLongitudinalPeer::NJOP)) {
            $modifiedColumns[':p' . $index++]  = '"njop"';
        }
        if ($this->isColumnModified(TanahLongitudinalPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(TanahLongitudinalPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(TanahLongitudinalPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(TanahLongitudinalPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(TanahLongitudinalPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "tanah_longitudinal" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"tahun_ajaran_id"':						
                        ...
                        break;
                    case '"njop"':						
                        $stmt->bindValue($identifier, $this->njop, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TanahLongitudinalPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TanahLongitudinalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TanahLongitudinal'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TanahLongitudinal'][serialize($this->getPrimaryKey())] = true;
        $keys = TanahLongitudinalPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setNjop($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TanahLongitudinalPeer::ID_TANAH)) $criteria->add(TanahLongitudinalPeer::ID_TANAH, $this->id_tanah);
        if ($this->isColumnModified(TanahLongitudinalPeer::TAHUN_AJARAN_ID)) $criteria->add(TanahLongitudinalPeer::TAHUN_AJARAN_ID, $this->tahun_ajaran_id);
        if ($this->isColumnModified(TanahLongitudinalPeer::NJOP)) $criteria->add(TanahLongitudinalPeer::NJOP, $this->njop);
        if ($this->isColumnModified(TanahLongitudinalPeer::CREATE_DATE)) $criteria->add(TanahLongitudinalPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(TanahLongitudinalPeer::LAST_UPDATE)) $criteria->add(TanahLongitudinalPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(TanahLongitudinalPeer::SOFT_DELETE)) $criteria->add(TanahLongitudinalPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(TanahLongitudinalPeer::LAST_SYNC)) $criteria->add(TanahLongitudinalPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(TanahLongitudinalPeer::UPDATER_ID)) $criteria->add(TanahLongitudinalPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(TanahLongitudinalPeer::DATABASE_NAME);
        $criteria->add(TanahLongitudinalPeer::ID_TANAH, $this->id_tanah);
        $criteria->add(TanahLongitudinalPeer::TAHUN_AJARAN_ID, $this->tahun_ajaran_id);
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdTanah();
        $pks[1] = $this->getTahunAjaranId();
    ...
    {
        $this->setIdTanah($keys[0]);
        $this->setTahunAjaranId($keys[1]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdTanah()) && (null === $this->getTahunAjaranId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TanahLongitudinal (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TanahLongitudinal Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TanahLongitudinalPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TanahLongitudinalPeer();
        }
    ...
    public function getTanah(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTanah === null && (($this->id_tanah !== "" && $this->id_tanah !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTanah->addTanahLongitudinals($this);
             */
        }
    ...
    public function getTahunAjaran(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTahunAjaran === null && (($this->tahun_ajaran_id !== "" && $this->tahun_ajaran_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTahunAjaran->addTanahLongitudinals($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TanahLongitudinalPeer::DEFAULT_STRING_FORMAT);
    }
