...
/*
 * The Base TableInfo for DataDynamic Table
 */
class BaseDataDynamicTableInfo extends TableInfo
{
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'data_dynamic_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'data_dynamic_id_str');
        $this->setHeader(           'Data Dynamic');
        $this->setLabel(            'Data dynamic');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "SekolahPaud","Sekolah","Variabel"));
        ...
        $cvar->setColumnName(       'data_dynamic_id');
        $cvar->setColumnPhpName(    'DataDynamicId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setComboXtype(       'datadynamicid');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'variabel_id');
        $cvar->setColumnPhpName(    'VariabelId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'Variabel');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'ID');
        $cvar->setLabel(            'ID');
        ...
        $cvar->setHideColumn(       1);
        $cvar->setXtype(            'hidden');
        $cvar->setComboXtype(       'variabelcombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'value_int');
        $cvar->setColumnPhpName(    'ValueInt');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Value Int');
        $cvar->setLabel(            'Value int');
        $cvar->setInputLength(      100);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'value_double');
        $cvar->setColumnPhpName(    'ValueDouble');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Value Double');
        $cvar->setLabel(            'Value double');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'value_string');
        $cvar->setColumnPhpName(    'ValueString');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Value String');
        $cvar->setLabel(            'Value string');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
