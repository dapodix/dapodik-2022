...
/**
 * Base class that represents a row from the 'ref.jenis_diklat' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisDiklat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisDiklatPeer';
    ...
    /**
     * Initializes internal state of BaseJenisDiklat object.
     * @see        applyDefaults()
     */
     ...
     * @return JenisDiklat The current object (for fluent API support)
     */
    public function setJenisDiklatId($v)
    {
        ...
        if ($this->jenis_diklat_id !== $v) {
            ...
            $this->modifiedColumns[] = JenisDiklatPeer::JENIS_DIKLAT_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = JenisDiklatPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisDiklatPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisDiklatPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisDiklatPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisDiklatPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jenis_diklat_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = JenisDiklatPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisDiklat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisDiklatPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisDiklatQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisDiklatPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisDiklatPeer::JENIS_DIKLAT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_diklat_id"';
        }
        if ($this->isColumnModified(JenisDiklatPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(JenisDiklatPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisDiklatPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisDiklatPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisDiklatPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_diklat" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisDiklatPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisDiklatPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JenisDiklat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisDiklat'][$this->getPrimaryKey()] = true;
        $keys = JenisDiklatPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getJenisDiklatId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setJenisDiklatId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisDiklatPeer::JENIS_DIKLAT_ID)) $criteria->add(JenisDiklatPeer::JENIS_DIKLAT_ID, $this->jenis_diklat_id);
        if ($this->isColumnModified(JenisDiklatPeer::NAMA)) $criteria->add(JenisDiklatPeer::NAMA, $this->nama);
        if ($this->isColumnModified(JenisDiklatPeer::CREATE_DATE)) $criteria->add(JenisDiklatPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisDiklatPeer::LAST_UPDATE)) $criteria->add(JenisDiklatPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisDiklatPeer::EXPIRED_DATE)) $criteria->add(JenisDiklatPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisDiklatPeer::LAST_SYNC)) $criteria->add(JenisDiklatPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisDiklatPeer::DATABASE_NAME);
        $criteria->add(JenisDiklatPeer::JENIS_DIKLAT_ID, $this->jenis_diklat_id);
    ...
    /**
     * Generic method to set the primary key (jenis_diklat_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getJenisDiklatId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisDiklat (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setJenisDiklatId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisDiklat Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisDiklatPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisDiklatPeer();
        }
     ...
     * If this JenisDiklat is new, it will return
    ...
    public function setDiklats(PropelCollection $diklats, PropelPDO $con = null)
    {
        ...
        foreach ($diklatsToDelete as $diklatRemoved) {
            $diklatRemoved->setJenisDiklat(null);
        }
     ...
     * Otherwise if this JenisDiklat is new, it will return
     * an empty collection; or if this JenisDiklat has previously
     * been saved, it will retrieve related Diklats from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisDiklat.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Diklat[] List of Diklat objects
     */
    public function getDiklatsJoinPtk($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = DiklatQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(JenisDiklatPeer::DEFAULT_STRING_FORMAT);
    }
