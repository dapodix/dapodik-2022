...
/*
 * The Base TableInfo for Tunjangan Table
 */
class BaseTunjanganTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.TunjanganTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'tunjangan_id_str');
        $this->setHeader(           'Tunjangan');
        $this->setLabel(            'Tunjangan');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'JenisTunjangan');
        $cvar->setMin(              0);
        $cvar->setMax(              15);
        $cvar->setHeader(           'Jenis Tunjangan');
        $cvar->setLabel(            'Jenis tunjangan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      170);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'jenistunjangancombo');
        $cvar->setComboXtype(       'jenistunjangancombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sk_tunjangan');
        $cvar->setColumnPhpName(    'SkTunjangan');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Sk Tunjangan');
        $cvar->setLabel(            'Sk tunjangan');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tgl_sk_tunjangan');
        $cvar->setColumnPhpName(    'TglSkTunjangan');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tgl Sk Tunjangan');
        $cvar->setLabel(            'Tgl sk tunjangan');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sumber_dana');
        $cvar->setColumnPhpName(    'SumberDana');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nominal');
        $cvar->setColumnPhpName(    'Nominal');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nominal');
        $cvar->setLabel(            'Nominal');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
