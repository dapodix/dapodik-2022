...
/**
 * Base class that represents a row from the 'ref.jenis_akt_pd' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisAktPd extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisAktPdPeer';
    ...
    /**
     * The value for the nm_jns_akt_pd field.
     * @var        string
     */
    protected $nm_jns_akt_pd;

    /**
     * The value for the ket_jns_akt_pd field.
     * @var        string
     */
    protected $ket_jns_akt_pd;
    ...
    /**
     * Initializes internal state of BaseJenisAktPd object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nm_jns_akt_pd] column value.
     * 
     * @return string
     */
    public function getNmJnsAktPd()
    {
        return $this->nm_jns_akt_pd;
    }

    /**
     * Get the [ket_jns_akt_pd] column value.
     * 
     * @return string
     */
    public function getKetJnsAktPd()
    {
        return $this->ket_jns_akt_pd;
    }
     ...
     * @return JenisAktPd The current object (for fluent API support)
     */
    public function setIdJnsAktPd($v)
    {
        ...
        if ($this->id_jns_akt_pd !== $v) {
            ...
            $this->modifiedColumns[] = JenisAktPdPeer::ID_JNS_AKT_PD;
        }
    ...
    /**
     * Set the value of [nm_jns_akt_pd] column.
     * 
     * @param string $v new value
     * @return JenisAktPd The current object (for fluent API support)
     */
    public function setNmJnsAktPd($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->nm_jns_akt_pd !== $v) {
            $this->nm_jns_akt_pd = $v;
            $this->modifiedColumns[] = JenisAktPdPeer::NM_JNS_AKT_PD;
        }
    ...
    /**
     * Set the value of [ket_jns_akt_pd] column.
     * 
     * @param string $v new value
     * @return JenisAktPd The current object (for fluent API support)
     */
    public function setKetJnsAktPd($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->ket_jns_akt_pd !== $v) {
            $this->ket_jns_akt_pd = $v;
            $this->modifiedColumns[] = JenisAktPdPeer::KET_JNS_AKT_PD;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisAktPdPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisAktPdPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisAktPdPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisAktPdPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_jns_akt_pd = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->nm_jns_akt_pd = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->ket_jns_akt_pd = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 7; // 7 = JenisAktPdPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisAktPd object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisAktPdPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisAktPdQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisAktPdPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisAktPdPeer::ID_JNS_AKT_PD)) {
            $modifiedColumns[':p' . $index++]  = '"id_jns_akt_pd"';
        }
        if ($this->isColumnModified(JenisAktPdPeer::NM_JNS_AKT_PD)) {
            $modifiedColumns[':p' . $index++]  = '"nm_jns_akt_pd"';
        }
        if ($this->isColumnModified(JenisAktPdPeer::KET_JNS_AKT_PD)) {
            $modifiedColumns[':p' . $index++]  = '"ket_jns_akt_pd"';
        }
        if ($this->isColumnModified(JenisAktPdPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisAktPdPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisAktPdPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisAktPdPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_akt_pd" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_jns_akt_pd"':						
                        ...
                        break;
                    case '"nm_jns_akt_pd"':						
                        $stmt->bindValue($identifier, $this->nm_jns_akt_pd, PDO::PARAM_STR);
                        break;
                    case '"ket_jns_akt_pd"':						
                        $stmt->bindValue($identifier, $this->ket_jns_akt_pd, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisAktPdPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisAktPdPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getNmJnsAktPd();
                break;
            case 2:
                return $this->getKetJnsAktPd();
                break;
            case 3:
    ...
    {
        if (isset($alreadyDumpedObjects['JenisAktPd'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisAktPd'][$this->getPrimaryKey()] = true;
        $keys = JenisAktPdPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdJnsAktPd(),
            $keys[1] => $this->getNmJnsAktPd(),
            $keys[2] => $this->getKetJnsAktPd(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setNmJnsAktPd($value);
                break;
            case 2:
                $this->setKetJnsAktPd($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdJnsAktPd($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNmJnsAktPd($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setKetJnsAktPd($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisAktPdPeer::ID_JNS_AKT_PD)) $criteria->add(JenisAktPdPeer::ID_JNS_AKT_PD, $this->id_jns_akt_pd);
        if ($this->isColumnModified(JenisAktPdPeer::NM_JNS_AKT_PD)) $criteria->add(JenisAktPdPeer::NM_JNS_AKT_PD, $this->nm_jns_akt_pd);
        if ($this->isColumnModified(JenisAktPdPeer::KET_JNS_AKT_PD)) $criteria->add(JenisAktPdPeer::KET_JNS_AKT_PD, $this->ket_jns_akt_pd);
        if ($this->isColumnModified(JenisAktPdPeer::CREATE_DATE)) $criteria->add(JenisAktPdPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisAktPdPeer::LAST_UPDATE)) $criteria->add(JenisAktPdPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisAktPdPeer::EXPIRED_DATE)) $criteria->add(JenisAktPdPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisAktPdPeer::LAST_SYNC)) $criteria->add(JenisAktPdPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisAktPdPeer::DATABASE_NAME);
        $criteria->add(JenisAktPdPeer::ID_JNS_AKT_PD, $this->id_jns_akt_pd);
    ...
    /**
     * Generic method to set the primary key (id_jns_akt_pd column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdJnsAktPd();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisAktPd (or compatible) type.
    ...
    {
        $copyObj->setNmJnsAktPd($this->getNmJnsAktPd());
        $copyObj->setKetJnsAktPd($this->getKetJnsAktPd());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdJnsAktPd(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisAktPd Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisAktPdPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisAktPdPeer();
        }
     ...
     * If this JenisAktPd is new, it will return
    ...
    public function setAktPds(PropelCollection $aktPds, PropelPDO $con = null)
    {
        ...
        foreach ($aktPdsToDelete as $aktPdRemoved) {
            $aktPdRemoved->setJenisAktPd(null);
        }
     ...
     * Otherwise if this JenisAktPd is new, it will return
     * an empty collection; or if this JenisAktPd has previously
     * been saved, it will retrieve related AktPds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisAktPd.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|AktPd[] List of AktPd objects
     */
    public function getAktPdsJoinMou($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = AktPdQuery::create(null, $criteria);
    ...
    public function clear()
    {
        ...
        $this->nm_jns_akt_pd = null;
        $this->ket_jns_akt_pd = null;
    ...
    {
        return (string) $this->exportTo(JenisAktPdPeer::DEFAULT_STRING_FORMAT);
    }
