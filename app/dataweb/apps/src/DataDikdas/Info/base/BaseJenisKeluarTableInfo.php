...
/*
 * The Base TableInfo for JenisKeluar Table
 */
class BaseJenisKeluarTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisKeluarTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_keluar_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_keluar_id_str');
        $this->setHeader(           'Ref.jenis Keluar');
        $this->setLabel(            'Ref.jenis keluar');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jeniskeluarcombo');
        $this->setXtypeRadio(       'ref.jeniskeluarradio');
        $this->setXtypeList(        'ref.jeniskeluarlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_keluar');
        $cvar->setColumnPhpName(    'KetKeluar');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Ket Keluar');
        $cvar->setLabel(            'Ket keluar');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'keluar_pd');
        $cvar->setColumnPhpName(    'KeluarPd');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Keluar Pd');
        $cvar->setLabel(            'Keluar pd');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'keluar_ptk');
        $cvar->setColumnPhpName(    'KeluarPtk');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Keluar Ptk');
        $cvar->setLabel(            'Keluar ptk');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
