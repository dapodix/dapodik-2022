...
/**
 * Base class that represents a row from the 'vld_angkutan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldAngkutan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldAngkutanPeer';
    ...
    /**
     * Initializes internal state of BaseVldAngkutan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldAngkutan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::LOGID;
        }
    ...
    public function setIdAngkutan($v)
    {
        ...
        if ($this->id_angkutan !== $v) {
            $this->id_angkutan = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::ID_ANGKUTAN;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldAngkutanPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldAngkutanPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAngkutanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAngkutanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldAngkutanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldAngkutanPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldAngkutanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldAngkutan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldAngkutanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldAngkutanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldAngkutanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldAngkutanPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::ID_ANGKUTAN)) {
            $modifiedColumns[':p' . $index++]  = '"id_angkutan"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldAngkutanPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_angkutan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldAngkutanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldAngkutanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldAngkutan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldAngkutan'][$this->getPrimaryKey()] = true;
        $keys = VldAngkutanPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldAngkutanPeer::LOGID)) $criteria->add(VldAngkutanPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldAngkutanPeer::ID_ANGKUTAN)) $criteria->add(VldAngkutanPeer::ID_ANGKUTAN, $this->id_angkutan);
        if ($this->isColumnModified(VldAngkutanPeer::IDTYPE)) $criteria->add(VldAngkutanPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldAngkutanPeer::STATUS_VALIDASI)) $criteria->add(VldAngkutanPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldAngkutanPeer::FIELD_ERROR)) $criteria->add(VldAngkutanPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldAngkutanPeer::ERROR_MESSAGE)) $criteria->add(VldAngkutanPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldAngkutanPeer::APP_USERNAME)) $criteria->add(VldAngkutanPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldAngkutanPeer::KETERANGAN)) $criteria->add(VldAngkutanPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldAngkutanPeer::CREATE_DATE)) $criteria->add(VldAngkutanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldAngkutanPeer::LAST_UPDATE)) $criteria->add(VldAngkutanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldAngkutanPeer::SOFT_DELETE)) $criteria->add(VldAngkutanPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldAngkutanPeer::LAST_SYNC)) $criteria->add(VldAngkutanPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldAngkutanPeer::UPDATER_ID)) $criteria->add(VldAngkutanPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldAngkutanPeer::DATABASE_NAME);
        $criteria->add(VldAngkutanPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldAngkutan (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldAngkutan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldAngkutanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldAngkutanPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldAngkutans($this);
             */
        }
    ...
    public function getAngkutan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAngkutan === null && (($this->id_angkutan !== "" && $this->id_angkutan !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAngkutan->addVldAngkutans($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldAngkutanPeer::DEFAULT_STRING_FORMAT);
    }
