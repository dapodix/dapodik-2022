...
/**
 * Base class that represents a row from the 'vld_rwy_kerja' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRwyKerja extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRwyKerjaPeer';
    ...
    /**
     * Initializes internal state of BaseVldRwyKerja object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRwyKerja The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::LOGID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::IDTYPE;
        }
    ...
    public function setRwyKerjaId($v)
    {
        ...
        if ($this->rwy_kerja_id !== $v) {
            $this->rwy_kerja_id = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::RWY_KERJA_ID;
        }

        if ($this->aRwyKerja !== null && $this->aRwyKerja->getRwyKerjaId() !== $v) {
            $this->aRwyKerja = null;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyKerjaPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyKerjaPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyKerjaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyKerjaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRwyKerjaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRwyKerjaPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idtype = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->rwy_kerja_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 13; // 13 = VldRwyKerjaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRwyKerja object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRwyKerja !== null && $this->rwy_kerja_id !== $this->aRwyKerja->getRwyKerjaId()) {
            $this->aRwyKerja = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRwyKerjaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRwyKerjaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRwyKerjaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRwyKerja !== null) {
                if ($this->aRwyKerja->isModified() || $this->aRwyKerja->isNew()) {
                    $affectedRows += $this->aRwyKerja->save($con);
                }
                $this->setRwyKerja($this->aRwyKerja);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRwyKerjaPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::RWY_KERJA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"rwy_kerja_id"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRwyKerjaPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_rwy_kerja" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aRwyKerja !== null) {
                if (!$this->aRwyKerja->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aRwyKerja->getValidationFailures());
                }
            }


            if (($retval = VldRwyKerjaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRwyKerjaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRwyKerja'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRwyKerja'][$this->getPrimaryKey()] = true;
        $keys = VldRwyKerjaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getIdtype(),
            $keys[2] => $this->getRwyKerjaId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aRwyKerja) {
                $result['RwyKerja'] = $this->aRwyKerja->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setRwyKerjaId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRwyKerjaPeer::LOGID)) $criteria->add(VldRwyKerjaPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRwyKerjaPeer::IDTYPE)) $criteria->add(VldRwyKerjaPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRwyKerjaPeer::RWY_KERJA_ID)) $criteria->add(VldRwyKerjaPeer::RWY_KERJA_ID, $this->rwy_kerja_id);
        if ($this->isColumnModified(VldRwyKerjaPeer::STATUS_VALIDASI)) $criteria->add(VldRwyKerjaPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRwyKerjaPeer::FIELD_ERROR)) $criteria->add(VldRwyKerjaPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRwyKerjaPeer::ERROR_MESSAGE)) $criteria->add(VldRwyKerjaPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRwyKerjaPeer::APP_USERNAME)) $criteria->add(VldRwyKerjaPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRwyKerjaPeer::KETERANGAN)) $criteria->add(VldRwyKerjaPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRwyKerjaPeer::CREATE_DATE)) $criteria->add(VldRwyKerjaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRwyKerjaPeer::LAST_UPDATE)) $criteria->add(VldRwyKerjaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRwyKerjaPeer::SOFT_DELETE)) $criteria->add(VldRwyKerjaPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRwyKerjaPeer::LAST_SYNC)) $criteria->add(VldRwyKerjaPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRwyKerjaPeer::UPDATER_ID)) $criteria->add(VldRwyKerjaPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRwyKerjaPeer::DATABASE_NAME);
        $criteria->add(VldRwyKerjaPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRwyKerja (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setRwyKerjaId($this->getRwyKerjaId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRwyKerja Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldRwyKerjaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldRwyKerjaPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldRwyKerjas($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a RwyKerja object.
     *
     * @param             RwyKerja $v
     * @return VldRwyKerja The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRwyKerja(RwyKerja $v = null)
    {
        if ($v === null) {
            $this->setRwyKerjaId(NULL);
        } else {
            $this->setRwyKerjaId($v->getRwyKerjaId());
        }

        $this->aRwyKerja = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the RwyKerja object, it will not be re-added.
        if ($v !== null) {
            $v->addVldRwyKerja($this);
        }
    ...
    /**
     * Get the associated RwyKerja object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return RwyKerja The associated RwyKerja object.
     * @throws PropelException
     */
    public function getRwyKerja(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRwyKerja === null && (($this->rwy_kerja_id !== "" && $this->rwy_kerja_id !== null)) && $doQuery) {
            $this->aRwyKerja = RwyKerjaQuery::create()->findPk($this->rwy_kerja_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRwyKerja->addVldRwyKerjas($this);
             */
        }

        return $this->aRwyKerja;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aRwyKerja instanceof Persistent) {
              $this->aRwyKerja->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldRwyKerjaPeer::DEFAULT_STRING_FORMAT);
    }
