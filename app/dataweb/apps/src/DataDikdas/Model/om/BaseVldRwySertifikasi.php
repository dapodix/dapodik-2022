...
/**
 * Base class that represents a row from the 'vld_rwy_sertifikasi' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRwySertifikasi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRwySertifikasiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldRwySertifikasiPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldRwySertifikasi object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRwySertifikasi The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRwySertifikasiPeer::LOGID;
        }
    ...
    public function setRiwayatSertifikasiId($v)
    {
        ...
        if ($this->riwayat_sertifikasi_id !== $v) {
            ...
            $this->modifiedColumns[] = VldRwySertifikasiPeer::RIWAYAT_SERTIFIKASI_ID;
        }

        if ($this->aRwySertifikasi !== null && $this->aRwySertifikasi->getRiwayatSertifikasiId() !== $v) {
            $this->aRwySertifikasi = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRwySertifikasiPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRwySertifikasiPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRwySertifikasiPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRwySertifikasiPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRwySertifikasiPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRwySertifikasiPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwySertifikasiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwySertifikasiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRwySertifikasiPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRwySertifikasiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRwySertifikasiPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->riwayat_sertifikasi_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldRwySertifikasiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRwySertifikasi object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRwySertifikasi !== null && $this->riwayat_sertifikasi_id !== $this->aRwySertifikasi->getRiwayatSertifikasiId()) {
            $this->aRwySertifikasi = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRwySertifikasiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRwySertifikasiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRwySertifikasiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRwySertifikasi !== null) {
                if ($this->aRwySertifikasi->isModified() || $this->aRwySertifikasi->isNew()) {
                    $affectedRows += $this->aRwySertifikasi->save($con);
                }
                $this->setRwySertifikasi($this->aRwySertifikasi);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRwySertifikasiPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::RIWAYAT_SERTIFIKASI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"riwayat_sertifikasi_id"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRwySertifikasiPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_rwy_sertifikasi" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aRwySertifikasi !== null) {
                if (!$this->aRwySertifikasi->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aRwySertifikasi->getValidationFailures());
                }
            }
            ...
            if (($retval = VldRwySertifikasiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRwySertifikasiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRwySertifikasi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRwySertifikasi'][$this->getPrimaryKey()] = true;
        $keys = VldRwySertifikasiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getRiwayatSertifikasiId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aRwySertifikasi) {
                $result['RwySertifikasi'] = $this->aRwySertifikasi->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setRiwayatSertifikasiId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRwySertifikasiPeer::LOGID)) $criteria->add(VldRwySertifikasiPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRwySertifikasiPeer::RIWAYAT_SERTIFIKASI_ID)) $criteria->add(VldRwySertifikasiPeer::RIWAYAT_SERTIFIKASI_ID, $this->riwayat_sertifikasi_id);
        if ($this->isColumnModified(VldRwySertifikasiPeer::IDTYPE)) $criteria->add(VldRwySertifikasiPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRwySertifikasiPeer::STATUS_VALIDASI)) $criteria->add(VldRwySertifikasiPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRwySertifikasiPeer::FIELD_ERROR)) $criteria->add(VldRwySertifikasiPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRwySertifikasiPeer::ERROR_MESSAGE)) $criteria->add(VldRwySertifikasiPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRwySertifikasiPeer::KETERANGAN)) $criteria->add(VldRwySertifikasiPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRwySertifikasiPeer::APP_USERNAME)) $criteria->add(VldRwySertifikasiPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRwySertifikasiPeer::CREATE_DATE)) $criteria->add(VldRwySertifikasiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRwySertifikasiPeer::LAST_UPDATE)) $criteria->add(VldRwySertifikasiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRwySertifikasiPeer::SOFT_DELETE)) $criteria->add(VldRwySertifikasiPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRwySertifikasiPeer::LAST_SYNC)) $criteria->add(VldRwySertifikasiPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRwySertifikasiPeer::UPDATER_ID)) $criteria->add(VldRwySertifikasiPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRwySertifikasiPeer::DATABASE_NAME);
        $criteria->add(VldRwySertifikasiPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRwySertifikasi (or compatible) type.
    ...
    {
        $copyObj->setRiwayatSertifikasiId($this->getRiwayatSertifikasiId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRwySertifikasi Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldRwySertifikasiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldRwySertifikasiPeer();
        }
    ...
    /**
     * Declares an association between this object and a RwySertifikasi object.
     *
     * @param             RwySertifikasi $v
     * @return VldRwySertifikasi The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRwySertifikasi(RwySertifikasi $v = null)
    {
        if ($v === null) {
            $this->setRiwayatSertifikasiId(NULL);
        } else {
            $this->setRiwayatSertifikasiId($v->getRiwayatSertifikasiId());
        }

        $this->aRwySertifikasi = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the RwySertifikasi object, it will not be re-added.
        if ($v !== null) {
            $v->addVldRwySertifikasi($this);
        }
    ...
    /**
     * Get the associated RwySertifikasi object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return RwySertifikasi The associated RwySertifikasi object.
     * @throws PropelException
     */
    public function getRwySertifikasi(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRwySertifikasi === null && (($this->riwayat_sertifikasi_id !== "" && $this->riwayat_sertifikasi_id !== null)) && $doQuery) {
            $this->aRwySertifikasi = RwySertifikasiQuery::create()->findPk($this->riwayat_sertifikasi_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRwySertifikasi->addVldRwySertifikasis($this);
             */
        }

        return $this->aRwySertifikasi;
    }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aErrortype->addVldRwySertifikasis($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aRwySertifikasi instanceof Persistent) {
              $this->aRwySertifikasi->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldRwySertifikasiPeer::DEFAULT_STRING_FORMAT);
    }
