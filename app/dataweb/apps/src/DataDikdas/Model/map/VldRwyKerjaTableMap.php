...
/**
 * This class defines the structure of the 'vld_rwy_kerja' table.
 *
 *
 *
 ...
 */
class VldRwyKerjaTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldRwyKerjaTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('rwy_kerja_id', 'RwyKerjaId', 'VARCHAR', 'rwy_kerja', 'rwy_kerja_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('RwyKerja', 'DataDikdas\\Model\\RwyKerja', RelationMap::MANY_TO_ONE, array('rwy_kerja_id' => 'rwy_kerja_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()
