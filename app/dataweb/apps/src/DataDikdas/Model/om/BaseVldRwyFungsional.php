...
/**
 * Base class that represents a row from the 'vld_rwy_fungsional' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRwyFungsional extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRwyFungsionalPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldRwyFungsionalPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldRwyFungsional object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRwyFungsional The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRwyFungsionalPeer::LOGID;
        }
    ...
    public function setRiwayatFungsionalId($v)
    {
        ...
        if ($this->riwayat_fungsional_id !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyFungsionalPeer::RIWAYAT_FUNGSIONAL_ID;
        }

        if ($this->aRwyFungsional !== null && $this->aRwyFungsional->getRiwayatFungsionalId() !== $v) {
            $this->aRwyFungsional = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRwyFungsionalPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyFungsionalPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRwyFungsionalPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyFungsionalPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRwyFungsionalPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRwyFungsionalPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyFungsionalPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyFungsionalPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRwyFungsionalPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRwyFungsionalPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRwyFungsionalPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->riwayat_fungsional_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldRwyFungsionalPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRwyFungsional object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRwyFungsional !== null && $this->riwayat_fungsional_id !== $this->aRwyFungsional->getRiwayatFungsionalId()) {
            $this->aRwyFungsional = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRwyFungsionalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRwyFungsionalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRwyFungsionalPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRwyFungsional !== null) {
                if ($this->aRwyFungsional->isModified() || $this->aRwyFungsional->isNew()) {
                    $affectedRows += $this->aRwyFungsional->save($con);
                }
                $this->setRwyFungsional($this->aRwyFungsional);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRwyFungsionalPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::RIWAYAT_FUNGSIONAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"riwayat_fungsional_id"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRwyFungsionalPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_rwy_fungsional" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aRwyFungsional !== null) {
                if (!$this->aRwyFungsional->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aRwyFungsional->getValidationFailures());
                }
            }
            ...
            if (($retval = VldRwyFungsionalPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRwyFungsionalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRwyFungsional'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRwyFungsional'][$this->getPrimaryKey()] = true;
        $keys = VldRwyFungsionalPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getRiwayatFungsionalId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aRwyFungsional) {
                $result['RwyFungsional'] = $this->aRwyFungsional->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setRiwayatFungsionalId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRwyFungsionalPeer::LOGID)) $criteria->add(VldRwyFungsionalPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRwyFungsionalPeer::RIWAYAT_FUNGSIONAL_ID)) $criteria->add(VldRwyFungsionalPeer::RIWAYAT_FUNGSIONAL_ID, $this->riwayat_fungsional_id);
        if ($this->isColumnModified(VldRwyFungsionalPeer::IDTYPE)) $criteria->add(VldRwyFungsionalPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRwyFungsionalPeer::STATUS_VALIDASI)) $criteria->add(VldRwyFungsionalPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRwyFungsionalPeer::FIELD_ERROR)) $criteria->add(VldRwyFungsionalPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRwyFungsionalPeer::ERROR_MESSAGE)) $criteria->add(VldRwyFungsionalPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRwyFungsionalPeer::KETERANGAN)) $criteria->add(VldRwyFungsionalPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRwyFungsionalPeer::APP_USERNAME)) $criteria->add(VldRwyFungsionalPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRwyFungsionalPeer::CREATE_DATE)) $criteria->add(VldRwyFungsionalPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRwyFungsionalPeer::LAST_UPDATE)) $criteria->add(VldRwyFungsionalPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRwyFungsionalPeer::SOFT_DELETE)) $criteria->add(VldRwyFungsionalPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRwyFungsionalPeer::LAST_SYNC)) $criteria->add(VldRwyFungsionalPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRwyFungsionalPeer::UPDATER_ID)) $criteria->add(VldRwyFungsionalPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRwyFungsionalPeer::DATABASE_NAME);
        $criteria->add(VldRwyFungsionalPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRwyFungsional (or compatible) type.
    ...
    {
        $copyObj->setRiwayatFungsionalId($this->getRiwayatFungsionalId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRwyFungsional Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldRwyFungsionalPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldRwyFungsionalPeer();
        }
    ...
    /**
     * Declares an association between this object and a RwyFungsional object.
     *
     * @param             RwyFungsional $v
     * @return VldRwyFungsional The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRwyFungsional(RwyFungsional $v = null)
    {
        if ($v === null) {
            $this->setRiwayatFungsionalId(NULL);
        } else {
            $this->setRiwayatFungsionalId($v->getRiwayatFungsionalId());
        }

        $this->aRwyFungsional = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the RwyFungsional object, it will not be re-added.
        if ($v !== null) {
            $v->addVldRwyFungsional($this);
        }
    ...
    /**
     * Get the associated RwyFungsional object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return RwyFungsional The associated RwyFungsional object.
     * @throws PropelException
     */
    public function getRwyFungsional(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRwyFungsional === null && (($this->riwayat_fungsional_id !== "" && $this->riwayat_fungsional_id !== null)) && $doQuery) {
            $this->aRwyFungsional = RwyFungsionalQuery::create()->findPk($this->riwayat_fungsional_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRwyFungsional->addVldRwyFungsionals($this);
             */
        }

        return $this->aRwyFungsional;
    }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aErrortype->addVldRwyFungsionals($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aRwyFungsional instanceof Persistent) {
              $this->aRwyFungsional->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldRwyFungsionalPeer::DEFAULT_STRING_FORMAT);
    }
