...
/**
 * Base class that represents a row from the 'vld_penghargaan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldPenghargaan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldPenghargaanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldPenghargaanPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldPenghargaan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldPenghargaan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldPenghargaanPeer::LOGID;
        }
    ...
    public function setPenghargaanId($v)
    {
        ...
        if ($this->penghargaan_id !== $v) {
            ...
            $this->modifiedColumns[] = VldPenghargaanPeer::PENGHARGAAN_ID;
        }

        if ($this->aPenghargaan !== null && $this->aPenghargaan->getPenghargaanId() !== $v) {
            $this->aPenghargaan = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldPenghargaanPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldPenghargaanPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldPenghargaanPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldPenghargaanPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldPenghargaanPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldPenghargaanPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPenghargaanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPenghargaanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldPenghargaanPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldPenghargaanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldPenghargaanPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->penghargaan_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldPenghargaanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldPenghargaan object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPenghargaan !== null && $this->penghargaan_id !== $this->aPenghargaan->getPenghargaanId()) {
            $this->aPenghargaan = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldPenghargaanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldPenghargaanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldPenghargaanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPenghargaan !== null) {
                if ($this->aPenghargaan->isModified() || $this->aPenghargaan->isNew()) {
                    $affectedRows += $this->aPenghargaan->save($con);
                }
                $this->setPenghargaan($this->aPenghargaan);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldPenghargaanPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::PENGHARGAAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"penghargaan_id"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldPenghargaanPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_penghargaan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPenghargaan !== null) {
                if (!$this->aPenghargaan->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPenghargaan->getValidationFailures());
                }
            }


            if (($retval = VldPenghargaanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldPenghargaanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldPenghargaan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldPenghargaan'][$this->getPrimaryKey()] = true;
        $keys = VldPenghargaanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getPenghargaanId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPenghargaan) {
                $result['Penghargaan'] = $this->aPenghargaan->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setPenghargaanId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldPenghargaanPeer::LOGID)) $criteria->add(VldPenghargaanPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldPenghargaanPeer::PENGHARGAAN_ID)) $criteria->add(VldPenghargaanPeer::PENGHARGAAN_ID, $this->penghargaan_id);
        if ($this->isColumnModified(VldPenghargaanPeer::IDTYPE)) $criteria->add(VldPenghargaanPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldPenghargaanPeer::STATUS_VALIDASI)) $criteria->add(VldPenghargaanPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldPenghargaanPeer::FIELD_ERROR)) $criteria->add(VldPenghargaanPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldPenghargaanPeer::ERROR_MESSAGE)) $criteria->add(VldPenghargaanPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldPenghargaanPeer::KETERANGAN)) $criteria->add(VldPenghargaanPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldPenghargaanPeer::APP_USERNAME)) $criteria->add(VldPenghargaanPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldPenghargaanPeer::CREATE_DATE)) $criteria->add(VldPenghargaanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldPenghargaanPeer::LAST_UPDATE)) $criteria->add(VldPenghargaanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldPenghargaanPeer::SOFT_DELETE)) $criteria->add(VldPenghargaanPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldPenghargaanPeer::LAST_SYNC)) $criteria->add(VldPenghargaanPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldPenghargaanPeer::UPDATER_ID)) $criteria->add(VldPenghargaanPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldPenghargaanPeer::DATABASE_NAME);
        $criteria->add(VldPenghargaanPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldPenghargaan (or compatible) type.
    ...
    {
        $copyObj->setPenghargaanId($this->getPenghargaanId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldPenghargaan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldPenghargaanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldPenghargaanPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldPenghargaans($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Penghargaan object.
     *
     * @param             Penghargaan $v
     * @return VldPenghargaan The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPenghargaan(Penghargaan $v = null)
    {
        if ($v === null) {
            $this->setPenghargaanId(NULL);
        } else {
            $this->setPenghargaanId($v->getPenghargaanId());
        }

        $this->aPenghargaan = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Penghargaan object, it will not be re-added.
        if ($v !== null) {
            $v->addVldPenghargaan($this);
        }
    ...
    /**
     * Get the associated Penghargaan object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Penghargaan The associated Penghargaan object.
     * @throws PropelException
     */
    public function getPenghargaan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPenghargaan === null && (($this->penghargaan_id !== "" && $this->penghargaan_id !== null)) && $doQuery) {
            $this->aPenghargaan = PenghargaanQuery::create()->findPk($this->penghargaan_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPenghargaan->addVldPenghargaans($this);
             */
        }

        return $this->aPenghargaan;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPenghargaan instanceof Persistent) {
              $this->aPenghargaan->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldPenghargaanPeer::DEFAULT_STRING_FORMAT);
    }
