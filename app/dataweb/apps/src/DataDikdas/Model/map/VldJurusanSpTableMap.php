...
/**
 * This class defines the structure of the 'vld_jurusan_sp' table.
 *
 *
 *
 ...
 */
class VldJurusanSpTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldJurusanSpTableMap';
