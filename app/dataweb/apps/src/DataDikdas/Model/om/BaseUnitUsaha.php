...
/**
 * Base class that represents a row from the 'unit_usaha' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseUnitUsaha extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\UnitUsahaPeer';
    ...
    /**
     * The value for the nama_unit_usaha field.
     * @var        string
     */
    protected $nama_unit_usaha;
    ...
    /**
     * Initializes internal state of BaseUnitUsaha object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nama_unit_usaha] column value.
     * 
     * @return string
     */
    public function getNamaUnitUsaha()
    {
        return $this->nama_unit_usaha;
    }
     ...
     * @return UnitUsaha The current object (for fluent API support)
     */
    public function setUnitUsahaId($v)
    {
        ...
        if ($this->unit_usaha_id !== $v) {
            ...
            $this->modifiedColumns[] = UnitUsahaPeer::UNIT_USAHA_ID;
        }
    ...
    public function setKelompokUsahaId($v)
    {
        ...
        if ($this->kelompok_usaha_id !== $v) {
            ...
            $this->modifiedColumns[] = UnitUsahaPeer::KELOMPOK_USAHA_ID;
        }

        if ($this->aKelompokUsaha !== null && $this->aKelompokUsaha->getKelompokUsahaId() !== $v) {
            $this->aKelompokUsaha = null;
        }
    ...
    public function setSekolahId($v)
    {
        ...
        if ($this->sekolah_id !== $v) {
            $this->sekolah_id = $v;
            $this->modifiedColumns[] = UnitUsahaPeer::SEKOLAH_ID;
        }
    ...
    /**
     * Set the value of [nama_unit_usaha] column.
     * 
     * @param string $v new value
     * @return UnitUsaha The current object (for fluent API support)
     */
    public function setNamaUnitUsaha($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->nama_unit_usaha !== $v) {
            $this->nama_unit_usaha = $v;
            $this->modifiedColumns[] = UnitUsahaPeer::NAMA_UNIT_USAHA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UnitUsahaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UnitUsahaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = UnitUsahaPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = UnitUsahaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = UnitUsahaPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->unit_usaha_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->kelompok_usaha_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->sekolah_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->nama_unit_usaha = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 9; // 9 = UnitUsahaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UnitUsaha object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aKelompokUsaha !== null && $this->kelompok_usaha_id !== $this->aKelompokUsaha->getKelompokUsahaId()) {
            $this->aKelompokUsaha = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UnitUsahaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UnitUsahaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UnitUsahaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aKelompokUsaha !== null) {
                if ($this->aKelompokUsaha->isModified() || $this->aKelompokUsaha->isNew()) {
                    $affectedRows += $this->aKelompokUsaha->save($con);
                }
                $this->setKelompokUsaha($this->aKelompokUsaha);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UnitUsahaPeer::UNIT_USAHA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"unit_usaha_id"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::KELOMPOK_USAHA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"kelompok_usaha_id"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::SEKOLAH_ID)) {
            $modifiedColumns[':p' . $index++]  = '"sekolah_id"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::NAMA_UNIT_USAHA)) {
            $modifiedColumns[':p' . $index++]  = '"nama_unit_usaha"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(UnitUsahaPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "unit_usaha" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"sekolah_id"':						
                        ...
                        break;
                    case '"nama_unit_usaha"':						
                        $stmt->bindValue($identifier, $this->nama_unit_usaha, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aKelompokUsaha !== null) {
                if (!$this->aKelompokUsaha->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aKelompokUsaha->getValidationFailures());
                }
            }
            ...
            if (($retval = UnitUsahaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UnitUsahaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UnitUsaha'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UnitUsaha'][$this->getPrimaryKey()] = true;
        $keys = UnitUsahaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getUnitUsahaId(),
            $keys[1] => $this->getKelompokUsahaId(),
            $keys[2] => $this->getSekolahId(),
            $keys[3] => $this->getNamaUnitUsaha(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aKelompokUsaha) {
                $result['KelompokUsaha'] = $this->aKelompokUsaha->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setUnitUsahaId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setKelompokUsahaId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setSekolahId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setNamaUnitUsaha($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UnitUsahaPeer::UNIT_USAHA_ID)) $criteria->add(UnitUsahaPeer::UNIT_USAHA_ID, $this->unit_usaha_id);
        if ($this->isColumnModified(UnitUsahaPeer::KELOMPOK_USAHA_ID)) $criteria->add(UnitUsahaPeer::KELOMPOK_USAHA_ID, $this->kelompok_usaha_id);
        if ($this->isColumnModified(UnitUsahaPeer::SEKOLAH_ID)) $criteria->add(UnitUsahaPeer::SEKOLAH_ID, $this->sekolah_id);
        if ($this->isColumnModified(UnitUsahaPeer::NAMA_UNIT_USAHA)) $criteria->add(UnitUsahaPeer::NAMA_UNIT_USAHA, $this->nama_unit_usaha);
        if ($this->isColumnModified(UnitUsahaPeer::CREATE_DATE)) $criteria->add(UnitUsahaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(UnitUsahaPeer::LAST_UPDATE)) $criteria->add(UnitUsahaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(UnitUsahaPeer::SOFT_DELETE)) $criteria->add(UnitUsahaPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(UnitUsahaPeer::LAST_SYNC)) $criteria->add(UnitUsahaPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(UnitUsahaPeer::UPDATER_ID)) $criteria->add(UnitUsahaPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(UnitUsahaPeer::DATABASE_NAME);
        $criteria->add(UnitUsahaPeer::UNIT_USAHA_ID, $this->unit_usaha_id);
    ...
    /**
     * Generic method to set the primary key (unit_usaha_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getUnitUsahaId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of UnitUsaha (or compatible) type.
    ...
    {
        $copyObj->setKelompokUsahaId($this->getKelompokUsahaId());
        $copyObj->setSekolahId($this->getSekolahId());
        $copyObj->setNamaUnitUsaha($this->getNamaUnitUsaha());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setUnitUsahaId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UnitUsaha Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UnitUsahaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UnitUsahaPeer();
        }
    ...
    /**
     * Declares an association between this object and a KelompokUsaha object.
     *
     * @param             KelompokUsaha $v
     * @return UnitUsaha The current object (for fluent API support)
     * @throws PropelException
     */
    public function setKelompokUsaha(KelompokUsaha $v = null)
    {
        if ($v === null) {
            $this->setKelompokUsahaId(NULL);
        } else {
            $this->setKelompokUsahaId($v->getKelompokUsahaId());
        }

        $this->aKelompokUsaha = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the KelompokUsaha object, it will not be re-added.
        if ($v !== null) {
            $v->addUnitUsaha($this);
        }
    ...
    /**
     * Get the associated KelompokUsaha object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return KelompokUsaha The associated KelompokUsaha object.
     * @throws PropelException
     */
    public function getKelompokUsaha(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aKelompokUsaha === null && (($this->kelompok_usaha_id !== "" && $this->kelompok_usaha_id !== null)) && $doQuery) {
            $this->aKelompokUsaha = KelompokUsahaQuery::create()->findPk($this->kelompok_usaha_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aKelompokUsaha->addUnitUsahas($this);
             */
        }

        return $this->aKelompokUsaha;
    }
    ...
    public function getSekolah(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSekolah === null && (($this->sekolah_id !== "" && $this->sekolah_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSekolah->addUnitUsahas($this);
             */
        }
     ...
     * If this UnitUsaha is new, it will return
    ...
    public function setUnitUsahaKerjasamas(PropelCollection $unitUsahaKerjasamas, PropelPDO $con = null)
    {
        ...
        foreach ($unitUsahaKerjasamasToDelete as $unitUsahaKerjasamaRemoved) {
            $unitUsahaKerjasamaRemoved->setUnitUsaha(null);
        }
    ...
    protected function doAddUnitUsahaKerjasama($unitUsahaKerjasama)
    {
        ...
        $unitUsahaKerjasama->setUnitUsaha($this);
    }
    ...
    public function removeUnitUsahaKerjasama($unitUsahaKerjasama)
    {
        if ($this->getUnitUsahaKerjasamas()->contains($unitUsahaKerjasama)) {
            ...
            $unitUsahaKerjasama->setUnitUsaha(null);
        }
     ...
     * Otherwise if this UnitUsaha is new, it will return
     * an empty collection; or if this UnitUsaha has previously
     * been saved, it will retrieve related UnitUsahaKerjasamas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in UnitUsaha.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aKelompokUsaha instanceof Persistent) {
              $this->aKelompokUsaha->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(UnitUsahaPeer::DEFAULT_STRING_FORMAT);
    }
