...
/*
 * The Base TableInfo for SumberGaji Table
 */
class BaseSumberGajiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.SumberGajiTableMap';
    ...
    {
        $this->setName('sumber_gaji');
        $this->setPhpName('SumberGaji');
        $this->setClassname('DataDikdas\\Model\\SumberGaji');
        $this->setPackage('DataDikdas.Model');
    }

    public function setVariables() {

        $this->setPkName(            'sumber_gaji_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'sumber_gaji_id_str');
        $this->setHeader(           'Ref.sumber Gaji');
        $this->setLabel(            'Ref.sumber gaji');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.sumbergajicombo');
        $this->setXtypeRadio(       'ref.sumbergajiradio');
        $this->setXtypeList(        'ref.sumbergajilist');
