...
/*
 * The Base TableInfo for InfoPengguna Table
 */
class BaseInfoPenggunaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.InfoPenggunaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'info_pengguna_id');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'info_pengguna_id_str');
        $this->setHeader(           'Info Pengguna');
        $this->setLabel(            'Info pengguna');
        ...
        $cvar->setColumnName(       'info_pengguna_id');
        $cvar->setColumnPhpName(    'InfoPenggunaId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'gambar');
        $cvar->setColumnPhpName(    'Gambar');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Gambar');
        $cvar->setLabel(            'Gambar');
