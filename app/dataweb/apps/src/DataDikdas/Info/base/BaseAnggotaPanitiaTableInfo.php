...
/*
 * The Base TableInfo for AnggotaPanitia Table
 */
class BaseAnggotaPanitiaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AnggotaPanitiaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_ang_panitia_str');
        $this->setHeader(           'Anggota Panitia');
        $this->setLabel(            'Anggota panitia');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "Kepanitiaan","PesertaDidik","Ptk"));
        ...
        $cvar->setColumnName(       'id_ang_panitia');
        $cvar->setColumnPhpName(    'IdAngPanitia');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_ang');
        $cvar->setColumnPhpName(    'NmAng');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nm Ang');
        $cvar->setLabel(            'Nm ang');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'no_kontak');
        $cvar->setColumnPhpName(    'NoKontak');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'No Kontak');
        $cvar->setLabel(            'No kontak');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'peran_ang');
        $cvar->setColumnPhpName(    'PeranAng');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Peran Ang');
        $cvar->setLabel(            'Peran ang');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'unsur_ang');
        $cvar->setColumnPhpName(    'UnsurAng');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Unsur Ang');
        $cvar->setLabel(            'Unsur ang');
