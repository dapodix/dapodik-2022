...
/**
 * Base class that represents a row from the 'ref.status_keaktifan_pegawai' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseStatusKeaktifanPegawai extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\StatusKeaktifanPegawaiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        StatusKeaktifanPegawaiPeer
     */
    ...
    /**
     * Initializes internal state of BaseStatusKeaktifanPegawai object.
     * @see        applyDefaults()
     */
     ...
     * @return StatusKeaktifanPegawai The current object (for fluent API support)
     */
    public function setStatusKeaktifanId($v)
    {
        ...
        if ($this->status_keaktifan_id !== $v) {
            ...
            $this->modifiedColumns[] = StatusKeaktifanPegawaiPeer::STATUS_KEAKTIFAN_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = StatusKeaktifanPegawaiPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKeaktifanPegawaiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKeaktifanPegawaiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusKeaktifanPegawaiPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = StatusKeaktifanPegawaiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->status_keaktifan_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = StatusKeaktifanPegawaiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StatusKeaktifanPegawai object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StatusKeaktifanPegawaiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StatusKeaktifanPegawaiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StatusKeaktifanPegawaiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::STATUS_KEAKTIFAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"status_keaktifan_id"';
        }
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."status_keaktifan_pegawai" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StatusKeaktifanPegawaiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StatusKeaktifanPegawaiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StatusKeaktifanPegawai'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StatusKeaktifanPegawai'][$this->getPrimaryKey()] = true;
        $keys = StatusKeaktifanPegawaiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getStatusKeaktifanId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setStatusKeaktifanId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::STATUS_KEAKTIFAN_ID)) $criteria->add(StatusKeaktifanPegawaiPeer::STATUS_KEAKTIFAN_ID, $this->status_keaktifan_id);
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::NAMA)) $criteria->add(StatusKeaktifanPegawaiPeer::NAMA, $this->nama);
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::CREATE_DATE)) $criteria->add(StatusKeaktifanPegawaiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::LAST_UPDATE)) $criteria->add(StatusKeaktifanPegawaiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::EXPIRED_DATE)) $criteria->add(StatusKeaktifanPegawaiPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(StatusKeaktifanPegawaiPeer::LAST_SYNC)) $criteria->add(StatusKeaktifanPegawaiPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(StatusKeaktifanPegawaiPeer::DATABASE_NAME);
        $criteria->add(StatusKeaktifanPegawaiPeer::STATUS_KEAKTIFAN_ID, $this->status_keaktifan_id);
    ...
    /**
     * Generic method to set the primary key (status_keaktifan_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getStatusKeaktifanId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of StatusKeaktifanPegawai (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStatusKeaktifanId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StatusKeaktifanPegawai Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StatusKeaktifanPegawaiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StatusKeaktifanPegawaiPeer();
        }
     ...
     * If this StatusKeaktifanPegawai is new, it will return
        ...
        if (null === $this->collPtks || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPtks) {
                ...
                $collPtks = PtkQuery::create(null, $criteria)
                    ->filterByStatusKeaktifanPegawai($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPtks(PropelCollection $ptks, PropelPDO $con = null)
    {
        ...
        foreach ($ptksToDelete as $ptkRemoved) {
            $ptkRemoved->setStatusKeaktifanPegawai(null);
        }
    ...
    {
        $this->collPtks[]= $ptk;
        $ptk->setStatusKeaktifanPegawai($this);
    }
    ...
    public function removePtk($ptk)
    {
        if ($this->getPtks()->contains($ptk)) {
            ...
            $ptk->setStatusKeaktifanPegawai(null);
        }
     ...
     * Otherwise if this StatusKeaktifanPegawai is new, it will return
     * an empty collection; or if this StatusKeaktifanPegawai has previously
     * been saved, it will retrieve related Ptks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in StatusKeaktifanPegawai.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(StatusKeaktifanPegawaiPeer::DEFAULT_STRING_FORMAT);
    }
