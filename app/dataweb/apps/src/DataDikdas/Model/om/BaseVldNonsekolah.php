...
/**
 * Base class that represents a row from the 'vld_nonsekolah' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldNonsekolah extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldNonsekolahPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldNonsekolahPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldNonsekolah object.
     * @see        applyDefaults()
     */
     ...
     * @return VldNonsekolah The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::LOGID;
        }
    ...
    public function setLembagaId($v)
    {
        ...
        if ($this->lembaga_id !== $v) {
            $this->lembaga_id = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::LEMBAGA_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldNonsekolahPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldNonsekolahPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldNonsekolahPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldNonsekolahPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldNonsekolahPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldNonsekolahPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldNonsekolahPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldNonsekolah object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldNonsekolahPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldNonsekolahQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldNonsekolahPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldNonsekolahPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::LEMBAGA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"lembaga_id"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldNonsekolahPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_nonsekolah" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldNonsekolahPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldNonsekolahPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldNonsekolah'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldNonsekolah'][$this->getPrimaryKey()] = true;
        $keys = VldNonsekolahPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldNonsekolahPeer::LOGID)) $criteria->add(VldNonsekolahPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldNonsekolahPeer::LEMBAGA_ID)) $criteria->add(VldNonsekolahPeer::LEMBAGA_ID, $this->lembaga_id);
        if ($this->isColumnModified(VldNonsekolahPeer::IDTYPE)) $criteria->add(VldNonsekolahPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldNonsekolahPeer::STATUS_VALIDASI)) $criteria->add(VldNonsekolahPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldNonsekolahPeer::FIELD_ERROR)) $criteria->add(VldNonsekolahPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldNonsekolahPeer::ERROR_MESSAGE)) $criteria->add(VldNonsekolahPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldNonsekolahPeer::KETERANGAN)) $criteria->add(VldNonsekolahPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldNonsekolahPeer::APP_USERNAME)) $criteria->add(VldNonsekolahPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldNonsekolahPeer::CREATE_DATE)) $criteria->add(VldNonsekolahPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldNonsekolahPeer::LAST_UPDATE)) $criteria->add(VldNonsekolahPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldNonsekolahPeer::SOFT_DELETE)) $criteria->add(VldNonsekolahPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldNonsekolahPeer::LAST_SYNC)) $criteria->add(VldNonsekolahPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldNonsekolahPeer::UPDATER_ID)) $criteria->add(VldNonsekolahPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldNonsekolahPeer::DATABASE_NAME);
        $criteria->add(VldNonsekolahPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldNonsekolah (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldNonsekolah Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldNonsekolahPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldNonsekolahPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldNonsekolahs($this);
             */
        }
    ...
    public function getLembagaNonSekolah(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLembagaNonSekolah === null && (($this->lembaga_id !== "" && $this->lembaga_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLembagaNonSekolah->addVldNonsekolahs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldNonsekolahPeer::DEFAULT_STRING_FORMAT);
    }
