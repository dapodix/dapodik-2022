...
/**
 * Base class that represents a row from the 'kitas_ptk' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseKitasPtk extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\KitasPtkPeer';
    ...
    /**
     * Initializes internal state of BaseKitasPtk object.
     * @see        applyDefaults()
     */
     ...
     * @return KitasPtk The current object (for fluent API support)
     */
    public function setNoKitas($v)
    {
        ...
        if ($this->no_kitas !== $v) {
            $this->no_kitas = $v;
            $this->modifiedColumns[] = KitasPtkPeer::NO_KITAS;
        }
    ...
    public function setPtkId($v)
    {
        ...
        if ($this->ptk_id !== $v) {
            $this->ptk_id = $v;
            $this->modifiedColumns[] = KitasPtkPeer::PTK_ID;
        }
    ...
    public function setTmtKitas($v)
    {
        ...
        if ($this->tmt_kitas !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KitasPtkPeer::TMT_KITAS;
            }
    ...
    public function setTstKitas($v)
    {
        ...
        if ($this->tst_kitas !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KitasPtkPeer::TST_KITAS;
            }
        } // if either are not null
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KitasPtkPeer::CREATE_DATE;
            }
        } // if either are not null
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KitasPtkPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = KitasPtkPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KitasPtkPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = KitasPtkPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = KitasPtkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating KitasPtk object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = KitasPtkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = KitasPtkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KitasPtkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(KitasPtkPeer::NO_KITAS)) {
            $modifiedColumns[':p' . $index++]  = '"no_kitas"';
        }
        if ($this->isColumnModified(KitasPtkPeer::PTK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"ptk_id"';
        }
        if ($this->isColumnModified(KitasPtkPeer::TMT_KITAS)) {
            $modifiedColumns[':p' . $index++]  = '"tmt_kitas"';
        }
        if ($this->isColumnModified(KitasPtkPeer::TST_KITAS)) {
            $modifiedColumns[':p' . $index++]  = '"tst_kitas"';
        }
        if ($this->isColumnModified(KitasPtkPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(KitasPtkPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(KitasPtkPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(KitasPtkPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(KitasPtkPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "kitas_ptk" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = KitasPtkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = KitasPtkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['KitasPtk'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['KitasPtk'][$this->getPrimaryKey()] = true;
        $keys = KitasPtkPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KitasPtkPeer::NO_KITAS)) $criteria->add(KitasPtkPeer::NO_KITAS, $this->no_kitas);
        if ($this->isColumnModified(KitasPtkPeer::PTK_ID)) $criteria->add(KitasPtkPeer::PTK_ID, $this->ptk_id);
        if ($this->isColumnModified(KitasPtkPeer::TMT_KITAS)) $criteria->add(KitasPtkPeer::TMT_KITAS, $this->tmt_kitas);
        if ($this->isColumnModified(KitasPtkPeer::TST_KITAS)) $criteria->add(KitasPtkPeer::TST_KITAS, $this->tst_kitas);
        if ($this->isColumnModified(KitasPtkPeer::CREATE_DATE)) $criteria->add(KitasPtkPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(KitasPtkPeer::LAST_UPDATE)) $criteria->add(KitasPtkPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(KitasPtkPeer::SOFT_DELETE)) $criteria->add(KitasPtkPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(KitasPtkPeer::LAST_SYNC)) $criteria->add(KitasPtkPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(KitasPtkPeer::UPDATER_ID)) $criteria->add(KitasPtkPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(KitasPtkPeer::DATABASE_NAME);
        $criteria->add(KitasPtkPeer::NO_KITAS, $this->no_kitas);
     ...
     * objects.
     *
     * @param object $copyObj An object of KitasPtk (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return KitasPtk Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(KitasPtkPeer::DEFAULT_STRING_FORMAT);
    }
