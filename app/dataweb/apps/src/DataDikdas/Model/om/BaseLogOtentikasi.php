...
/**
 * Base class that represents a row from the 'man_akses.log_otentikasi' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseLogOtentikasi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\LogOtentikasiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LogOtentikasiPeer
     */
    ...
    /**
     * Initializes internal state of BaseLogOtentikasi object.
     * @see        applyDefaults()
     */
     ...
     * @return LogOtentikasi The current object (for fluent API support)
     */
    public function setTokenSesi($v)
    {
        ...
        if ($this->token_sesi !== $v) {
            $this->token_sesi = $v;
            $this->modifiedColumns[] = LogOtentikasiPeer::TOKEN_SESI;
        }
    ...
    public function setPenggunaId($v)
    {
        ...
        if ($this->pengguna_id !== $v) {
            $this->pengguna_id = $v;
            $this->modifiedColumns[] = LogOtentikasiPeer::PENGGUNA_ID;
        }
    ...
    public function setLastActivity($v)
    {
        ...
        if ($this->last_activity !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LogOtentikasiPeer::LAST_ACTIVITY;
            }
    ...
    public function setLogOff($v)
    {
        ...
        if ($this->log_off !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LogOtentikasiPeer::LOG_OFF;
            }
        } // if either are not null
    ...
    public function setATimeOut($v)
    {
        ...
        if ($this->a_time_out !== $v) {
            $this->a_time_out = $v;
            $this->modifiedColumns[] = LogOtentikasiPeer::A_TIME_OUT;
        }
    ...
    public function setAlamatIp($v)
    {
        ...
        if ($this->alamat_ip !== $v) {
            $this->alamat_ip = $v;
            $this->modifiedColumns[] = LogOtentikasiPeer::ALAMAT_IP;
        }
    ...
    public function setASesiAktif($v)
    {
        ...
        if ($this->a_sesi_aktif !== $v) {
            $this->a_sesi_aktif = $v;
            $this->modifiedColumns[] = LogOtentikasiPeer::A_SESI_AKTIF;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LogOtentikasiPeer::CREATE_DATE;
            }
        } // if either are not null
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LogOtentikasiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = LogOtentikasiPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = LogOtentikasiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = LogOtentikasiPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 12; // 12 = LogOtentikasiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LogOtentikasi object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LogOtentikasiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LogOtentikasiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LogOtentikasiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LogOtentikasiPeer::TOKEN_SESI)) {
            $modifiedColumns[':p' . $index++]  = '"token_sesi"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::PENGGUNA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pengguna_id"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::LAST_ACTIVITY)) {
            $modifiedColumns[':p' . $index++]  = '"last_activity"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::LOG_OFF)) {
            $modifiedColumns[':p' . $index++]  = '"log_off"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::A_TIME_OUT)) {
            $modifiedColumns[':p' . $index++]  = '"a_time_out"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::ALAMAT_IP)) {
            $modifiedColumns[':p' . $index++]  = '"alamat_ip"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::A_SESI_AKTIF)) {
            $modifiedColumns[':p' . $index++]  = '"a_sesi_aktif"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(LogOtentikasiPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "man_akses"."log_otentikasi" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LogOtentikasiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LogOtentikasiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LogOtentikasi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LogOtentikasi'][$this->getPrimaryKey()] = true;
        $keys = LogOtentikasiPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogOtentikasiPeer::TOKEN_SESI)) $criteria->add(LogOtentikasiPeer::TOKEN_SESI, $this->token_sesi);
        if ($this->isColumnModified(LogOtentikasiPeer::PENGGUNA_ID)) $criteria->add(LogOtentikasiPeer::PENGGUNA_ID, $this->pengguna_id);
        if ($this->isColumnModified(LogOtentikasiPeer::LAST_ACTIVITY)) $criteria->add(LogOtentikasiPeer::LAST_ACTIVITY, $this->last_activity);
        if ($this->isColumnModified(LogOtentikasiPeer::LOG_OFF)) $criteria->add(LogOtentikasiPeer::LOG_OFF, $this->log_off);
        if ($this->isColumnModified(LogOtentikasiPeer::A_TIME_OUT)) $criteria->add(LogOtentikasiPeer::A_TIME_OUT, $this->a_time_out);
        if ($this->isColumnModified(LogOtentikasiPeer::ALAMAT_IP)) $criteria->add(LogOtentikasiPeer::ALAMAT_IP, $this->alamat_ip);
        if ($this->isColumnModified(LogOtentikasiPeer::A_SESI_AKTIF)) $criteria->add(LogOtentikasiPeer::A_SESI_AKTIF, $this->a_sesi_aktif);
        if ($this->isColumnModified(LogOtentikasiPeer::CREATE_DATE)) $criteria->add(LogOtentikasiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(LogOtentikasiPeer::LAST_UPDATE)) $criteria->add(LogOtentikasiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(LogOtentikasiPeer::SOFT_DELETE)) $criteria->add(LogOtentikasiPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(LogOtentikasiPeer::LAST_SYNC)) $criteria->add(LogOtentikasiPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(LogOtentikasiPeer::UPDATER_ID)) $criteria->add(LogOtentikasiPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(LogOtentikasiPeer::DATABASE_NAME);
        $criteria->add(LogOtentikasiPeer::TOKEN_SESI, $this->token_sesi);
     ...
     * objects.
     *
     * @param object $copyObj An object of LogOtentikasi (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LogOtentikasi Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LogOtentikasiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LogOtentikasiPeer();
        }
    ...
    public function getPengguna(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPengguna === null && (($this->pengguna_id !== "" && $this->pengguna_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPengguna->addLogOtentikasis($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LogOtentikasiPeer::DEFAULT_STRING_FORMAT);
    }
