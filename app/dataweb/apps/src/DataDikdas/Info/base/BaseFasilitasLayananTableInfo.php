...
/*
 * The Base TableInfo for FasilitasLayanan Table
 */
class BaseFasilitasLayananTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.FasilitasLayananTableMap';
    ...
    {
        $this->setName('fasilitas_layanan');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'fasilitas_layanan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'fasilitas_layanan_id_str');
        $this->setHeader(           'Ref.fasilitas Layanan');
        $this->setLabel(            'Ref.fasilitas layanan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.fasilitaslayanancombo');
        $this->setXtypeRadio(       'ref.fasilitaslayananradio');
        $this->setXtypeList(        'ref.fasilitaslayananlist');
