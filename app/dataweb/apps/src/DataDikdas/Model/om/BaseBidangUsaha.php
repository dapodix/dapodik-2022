...
abstract class BaseBidangUsaha extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the level_bidang_usaha field.
     * @var        string
     */
    protected $level_bidang_usaha;
    ...
    /**
     * Get the [level_bidang_usaha] column value.
     * 
     * @return string
     */
    public function getLevelBidangUsaha()
    {
        return $this->level_bidang_usaha;
    }
    ...
    /**
     * Set the value of [level_bidang_usaha] column.
     * 
     * @param string $v new value
     * @return BidangUsaha The current object (for fluent API support)
     */
    public function setLevelBidangUsaha($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->level_bidang_usaha !== $v) {
            $this->level_bidang_usaha = $v;
            $this->modifiedColumns[] = BidangUsahaPeer::LEVEL_BIDANG_USAHA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->level_bidang_usaha = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 7; // 7 = BidangUsahaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BidangUsahaPeer::LEVEL_BIDANG_USAHA)) {
            $modifiedColumns[':p' . $index++]  = '"level_bidang_usaha"';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"nama_bidang_usaha"':						
                        ...
                        break;
                    case '"level_bidang_usaha"':						
                        $stmt->bindValue($identifier, $this->level_bidang_usaha, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getLevelBidangUsaha();
                break;
            case 3:
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getLevelBidangUsaha(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setLevelBidangUsaha($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setLevelBidangUsaha($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BidangUsahaPeer::LEVEL_BIDANG_USAHA)) $criteria->add(BidangUsahaPeer::LEVEL_BIDANG_USAHA, $this->level_bidang_usaha);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLevelBidangUsaha($this->getLevelBidangUsaha());
