...
/**
 * Base class that represents a row from the 'vld_yayasan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldYayasan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldYayasanPeer';
    ...
    /**
     * Initializes internal state of BaseVldYayasan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldYayasan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldYayasanPeer::LOGID;
        }
    ...
    public function setYayasanId($v)
    {
        ...
        if ($this->yayasan_id !== $v) {
            $this->yayasan_id = $v;
            $this->modifiedColumns[] = VldYayasanPeer::YAYASAN_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldYayasanPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldYayasanPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldYayasanPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldYayasanPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldYayasanPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldYayasanPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldYayasanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldYayasanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldYayasanPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldYayasanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldYayasanPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->yayasan_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldYayasanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldYayasan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldYayasanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldYayasanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldYayasanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldYayasanPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldYayasanPeer::YAYASAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"yayasan_id"';
        }
        if ($this->isColumnModified(VldYayasanPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldYayasanPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldYayasanPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldYayasanPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldYayasanPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldYayasanPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldYayasanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldYayasanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldYayasanPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldYayasanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldYayasanPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_yayasan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldYayasanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldYayasanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldYayasan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldYayasan'][$this->getPrimaryKey()] = true;
        $keys = VldYayasanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getYayasanId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setYayasanId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldYayasanPeer::LOGID)) $criteria->add(VldYayasanPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldYayasanPeer::YAYASAN_ID)) $criteria->add(VldYayasanPeer::YAYASAN_ID, $this->yayasan_id);
        if ($this->isColumnModified(VldYayasanPeer::IDTYPE)) $criteria->add(VldYayasanPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldYayasanPeer::STATUS_VALIDASI)) $criteria->add(VldYayasanPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldYayasanPeer::FIELD_ERROR)) $criteria->add(VldYayasanPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldYayasanPeer::ERROR_MESSAGE)) $criteria->add(VldYayasanPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldYayasanPeer::KETERANGAN)) $criteria->add(VldYayasanPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldYayasanPeer::APP_USERNAME)) $criteria->add(VldYayasanPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldYayasanPeer::CREATE_DATE)) $criteria->add(VldYayasanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldYayasanPeer::LAST_UPDATE)) $criteria->add(VldYayasanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldYayasanPeer::SOFT_DELETE)) $criteria->add(VldYayasanPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldYayasanPeer::LAST_SYNC)) $criteria->add(VldYayasanPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldYayasanPeer::UPDATER_ID)) $criteria->add(VldYayasanPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldYayasanPeer::DATABASE_NAME);
        $criteria->add(VldYayasanPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldYayasan (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldYayasan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldYayasanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldYayasanPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldYayasans($this);
             */
        }
    ...
    public function getYayasan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aYayasan === null && (($this->yayasan_id !== "" && $this->yayasan_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aYayasan->addVldYayasans($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldYayasanPeer::DEFAULT_STRING_FORMAT);
    }
