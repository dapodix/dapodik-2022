...
abstract class BasePeranPeer
{
    ...
    public static function doCountJoinBentukPendidikan(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PeranPeer::BENTUK_PENDIDIKAN_ID, BentukPendidikanPeer::BENTUK_PENDIDIKAN_ID, $join_behavior);
    ...
    /**
     * Selects a collection of Peran objects pre-filled with their BentukPendidikan objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Peran objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinBentukPendidikan(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PeranPeer::addSelectColumns($criteria);
        $startcol = PeranPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = PeranPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = PeranPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                PeranPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Peran) to $obj2 (BentukPendidikan)
                $obj2->addPeran($obj1);
    ...
    /**
     * Selects a collection of Peran objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PeranPeer::addSelectColumns($criteria);
        $startcol2 = PeranPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Peran) to the collection in $obj2 (BentukPendidikan)
                $obj2->addPeran($obj1);
