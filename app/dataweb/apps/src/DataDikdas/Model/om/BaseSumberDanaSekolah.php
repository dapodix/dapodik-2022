...
/**
 * Base class that represents a row from the 'ref.sumber_dana_sekolah' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseSumberDanaSekolah extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\SumberDanaSekolahPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SumberDanaSekolahPeer
     */
    ...
    /**
     * Initializes internal state of BaseSumberDanaSekolah object.
     * @see        applyDefaults()
     */
     ...
     * @return SumberDanaSekolah The current object (for fluent API support)
     */
    public function setSumberDanaSekolahId($v)
    {
        ...
        if ($this->sumber_dana_sekolah_id !== $v) {
            ...
            $this->modifiedColumns[] = SumberDanaSekolahPeer::SUMBER_DANA_SEKOLAH_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = SumberDanaSekolahPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = SumberDanaSekolahPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = SumberDanaSekolahPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SumberDanaSekolahPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = SumberDanaSekolahPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sumber_dana_sekolah_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = SumberDanaSekolahPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SumberDanaSekolah object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SumberDanaSekolahPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SumberDanaSekolahQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SumberDanaSekolahPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SumberDanaSekolahPeer::SUMBER_DANA_SEKOLAH_ID)) {
            $modifiedColumns[':p' . $index++]  = '"sumber_dana_sekolah_id"';
        }
        if ($this->isColumnModified(SumberDanaSekolahPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(SumberDanaSekolahPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(SumberDanaSekolahPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(SumberDanaSekolahPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(SumberDanaSekolahPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."sumber_dana_sekolah" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SumberDanaSekolahPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SumberDanaSekolahPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SumberDanaSekolah'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SumberDanaSekolah'][$this->getPrimaryKey()] = true;
        $keys = SumberDanaSekolahPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSumberDanaSekolahId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setSumberDanaSekolahId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SumberDanaSekolahPeer::SUMBER_DANA_SEKOLAH_ID)) $criteria->add(SumberDanaSekolahPeer::SUMBER_DANA_SEKOLAH_ID, $this->sumber_dana_sekolah_id);
        if ($this->isColumnModified(SumberDanaSekolahPeer::NAMA)) $criteria->add(SumberDanaSekolahPeer::NAMA, $this->nama);
        if ($this->isColumnModified(SumberDanaSekolahPeer::CREATE_DATE)) $criteria->add(SumberDanaSekolahPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(SumberDanaSekolahPeer::LAST_UPDATE)) $criteria->add(SumberDanaSekolahPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(SumberDanaSekolahPeer::EXPIRED_DATE)) $criteria->add(SumberDanaSekolahPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(SumberDanaSekolahPeer::LAST_SYNC)) $criteria->add(SumberDanaSekolahPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(SumberDanaSekolahPeer::DATABASE_NAME);
        $criteria->add(SumberDanaSekolahPeer::SUMBER_DANA_SEKOLAH_ID, $this->sumber_dana_sekolah_id);
    ...
    /**
     * Generic method to set the primary key (sumber_dana_sekolah_id column).
     *
    ...
    {
        $this->setSumberDanaSekolahId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getSumberDanaSekolahId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of SumberDanaSekolah (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSumberDanaSekolahId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SumberDanaSekolah Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SumberDanaSekolahPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SumberDanaSekolahPeer();
        }
     ...
     * If this SumberDanaSekolah is new, it will return
        ...
        if (null === $this->collSekolahPauds || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collSekolahPauds) {
                ...
                $collSekolahPauds = SekolahPaudQuery::create(null, $criteria)
                    ->filterBySumberDanaSekolah($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setSekolahPauds(PropelCollection $sekolahPauds, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahPaudsToDelete as $sekolahPaudRemoved) {
            $sekolahPaudRemoved->setSumberDanaSekolah(null);
        }
    ...
    protected function doAddSekolahPaud($sekolahPaud)
    {
        ...
        $sekolahPaud->setSumberDanaSekolah($this);
    }
    ...
    public function removeSekolahPaud($sekolahPaud)
    {
        if ($this->getSekolahPauds()->contains($sekolahPaud)) {
            ...
            $sekolahPaud->setSumberDanaSekolah(null);
        }
     ...
     * Otherwise if this SumberDanaSekolah is new, it will return
     * an empty collection; or if this SumberDanaSekolah has previously
     * been saved, it will retrieve related SekolahPauds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SumberDanaSekolah.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|SekolahPaud[] List of SekolahPaud objects
     */
    public function getSekolahPaudsJoinLembagaPengangkat($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SekolahPaudQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(SumberDanaSekolahPeer::DEFAULT_STRING_FORMAT);
    }
