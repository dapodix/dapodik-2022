...
abstract class BaseBukuPelajaranPeer
{
    ...
    public static function doCountJoinBiblio(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BukuPelajaranPeer::ID_BIBLIO, BiblioPeer::ID_BIBLIO, $join_behavior);
    ...
    /**
     * Selects a collection of BukuPelajaran objects pre-filled with their Biblio objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinBiblio(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (BukuPelajaran) to $obj2 (Biblio)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (BukuPelajaran) to the collection in $obj2 (Biblio)
                $obj2->addBukuPelajaran($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (BukuPelajaran) to the collection in $obj3 (Pembelajaran)
                $obj3->addBukuPelajaran($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of BukuPelajaran objects pre-filled with all related objects except Biblio.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of BukuPelajaran objects pre-filled with all related objects except Pembelajaran.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
