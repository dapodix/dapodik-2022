...
/*
 * The Base TableInfo for SertifikasiIso Table
 */
class BaseSertifikasiIsoTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.SertifikasiIsoTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'sertifikasi_iso_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'sertifikasi_iso_id_str');
        $this->setHeader(           'Ref.sertifikasi Iso');
        $this->setLabel(            'Ref.sertifikasi iso');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.sertifikasiisocombo');
        $this->setXtypeRadio(       'ref.sertifikasiisoradio');
        $this->setXtypeList(        'ref.sertifikasiisolist');
