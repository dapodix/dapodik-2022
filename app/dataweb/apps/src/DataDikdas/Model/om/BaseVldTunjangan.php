...
/**
 * Base class that represents a row from the 'vld_tunjangan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldTunjangan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldTunjanganPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldTunjanganPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldTunjangan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldTunjangan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::LOGID;
        }
    ...
    public function setTunjanganId($v)
    {
        ...
        if ($this->tunjangan_id !== $v) {
            $this->tunjangan_id = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::TUNJANGAN_ID;
        }

        if ($this->aTunjangan !== null && $this->aTunjangan->getTunjanganId() !== $v) {
            $this->aTunjangan = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldTunjanganPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldTunjanganPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldTunjanganPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldTunjanganPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldTunjanganPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldTunjanganPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tunjangan_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldTunjanganPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldTunjangan object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTunjangan !== null && $this->tunjangan_id !== $this->aTunjangan->getTunjanganId()) {
            $this->aTunjangan = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldTunjanganPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldTunjanganQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldTunjanganPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTunjangan !== null) {
                if ($this->aTunjangan->isModified() || $this->aTunjangan->isNew()) {
                    $affectedRows += $this->aTunjangan->save($con);
                }
                $this->setTunjangan($this->aTunjangan);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldTunjanganPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::TUNJANGAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"tunjangan_id"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldTunjanganPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_tunjangan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aTunjangan !== null) {
                if (!$this->aTunjangan->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aTunjangan->getValidationFailures());
                }
            }


            if (($retval = VldTunjanganPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldTunjanganPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldTunjangan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldTunjangan'][$this->getPrimaryKey()] = true;
        $keys = VldTunjanganPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getTunjanganId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aTunjangan) {
                $result['Tunjangan'] = $this->aTunjangan->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTunjanganId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldTunjanganPeer::LOGID)) $criteria->add(VldTunjanganPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldTunjanganPeer::TUNJANGAN_ID)) $criteria->add(VldTunjanganPeer::TUNJANGAN_ID, $this->tunjangan_id);
        if ($this->isColumnModified(VldTunjanganPeer::IDTYPE)) $criteria->add(VldTunjanganPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldTunjanganPeer::STATUS_VALIDASI)) $criteria->add(VldTunjanganPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldTunjanganPeer::FIELD_ERROR)) $criteria->add(VldTunjanganPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldTunjanganPeer::ERROR_MESSAGE)) $criteria->add(VldTunjanganPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldTunjanganPeer::KETERANGAN)) $criteria->add(VldTunjanganPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldTunjanganPeer::APP_USERNAME)) $criteria->add(VldTunjanganPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldTunjanganPeer::CREATE_DATE)) $criteria->add(VldTunjanganPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldTunjanganPeer::LAST_UPDATE)) $criteria->add(VldTunjanganPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldTunjanganPeer::SOFT_DELETE)) $criteria->add(VldTunjanganPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldTunjanganPeer::LAST_SYNC)) $criteria->add(VldTunjanganPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldTunjanganPeer::UPDATER_ID)) $criteria->add(VldTunjanganPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldTunjanganPeer::DATABASE_NAME);
        $criteria->add(VldTunjanganPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldTunjangan (or compatible) type.
    ...
    {
        $copyObj->setTunjanganId($this->getTunjanganId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldTunjangan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldTunjanganPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldTunjanganPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldTunjangans($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Tunjangan object.
     *
     * @param             Tunjangan $v
     * @return VldTunjangan The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTunjangan(Tunjangan $v = null)
    {
        if ($v === null) {
            $this->setTunjanganId(NULL);
        } else {
            $this->setTunjanganId($v->getTunjanganId());
        }

        $this->aTunjangan = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Tunjangan object, it will not be re-added.
        if ($v !== null) {
            $v->addVldTunjangan($this);
        }
    ...
    /**
     * Get the associated Tunjangan object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Tunjangan The associated Tunjangan object.
     * @throws PropelException
     */
    public function getTunjangan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTunjangan === null && (($this->tunjangan_id !== "" && $this->tunjangan_id !== null)) && $doQuery) {
            $this->aTunjangan = TunjanganQuery::create()->findPk($this->tunjangan_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTunjangan->addVldTunjangans($this);
             */
        }

        return $this->aTunjangan;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aTunjangan instanceof Persistent) {
              $this->aTunjangan->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldTunjanganPeer::DEFAULT_STRING_FORMAT);
    }
