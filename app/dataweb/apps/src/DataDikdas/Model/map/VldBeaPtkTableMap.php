...
/**
 * This class defines the structure of the 'vld_bea_ptk' table.
 *
 *
 *
 ...
 */
class VldBeaPtkTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldBeaPtkTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('beasiswa_ptk_id', 'BeasiswaPtkId', 'VARCHAR', 'beasiswa_ptk', 'beasiswa_ptk_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('BeasiswaPtk', 'DataDikdas\\Model\\BeasiswaPtk', RelationMap::MANY_TO_ONE, array('beasiswa_ptk_id' => 'beasiswa_ptk_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()
