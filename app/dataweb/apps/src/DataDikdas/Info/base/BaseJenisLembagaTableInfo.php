...
/*
 * The Base TableInfo for JenisLembaga Table
 */
class BaseJenisLembagaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisLembagaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_lembaga_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_lembaga_id_str');
        $this->setHeader(           'Ref.jenis Lembaga');
        $this->setLabel(            'Ref.jenis lembaga');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenislembagacombo');
        $this->setXtypeRadio(       'ref.jenislembagaradio');
        $this->setXtypeList(        'ref.jenislembagalist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tempat_pengawas');
        $cvar->setColumnPhpName(    'TempatPengawas');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tempat Pengawas');
        $cvar->setLabel(            'Tempat pengawas');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'simpul_pendataan');
        $cvar->setColumnPhpName(    'SimpulPendataan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Simpul Pendataan');
        $cvar->setLabel(            'Simpul pendataan');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
