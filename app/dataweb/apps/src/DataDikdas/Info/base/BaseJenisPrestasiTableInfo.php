...
/*
 * The Base TableInfo for JenisPrestasi Table
 */
class BaseJenisPrestasiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisPrestasiTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_prestasi_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_prestasi_id_str');
        $this->setHeader(           'Ref.jenis Prestasi');
        $this->setLabel(            'Ref.jenis prestasi');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisprestasicombo');
        $this->setXtypeRadio(       'ref.jenisprestasiradio');
        $this->setXtypeList(        'ref.jenisprestasilist');
