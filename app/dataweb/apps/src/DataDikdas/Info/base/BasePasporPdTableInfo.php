...
/*
 * The Base TableInfo for PasporPd Table
 */
class BasePasporPdTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PasporPdTableMap';
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Paspor Pd');
        $this->setLabel(            'Paspor pd');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'pasporpdcombo');
        $this->setXtypeRadio(       'pasporpdradio');
        $this->setXtypeList(        'pasporpdlist');
