...
/**
 * Base class that represents a row from the 'ref.jenis_penghargaan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisPenghargaan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisPenghargaanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JenisPenghargaanPeer
     */
    ...
    /**
     * Initializes internal state of BaseJenisPenghargaan object.
     * @see        applyDefaults()
     */
     ...
     * @return JenisPenghargaan The current object (for fluent API support)
     */
    public function setJenisPenghargaanId($v)
    {
        ...
        if ($this->jenis_penghargaan_id !== $v) {
            ...
            $this->modifiedColumns[] = JenisPenghargaanPeer::JENIS_PENGHARGAAN_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = JenisPenghargaanPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisPenghargaanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisPenghargaanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisPenghargaanPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisPenghargaanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jenis_penghargaan_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = JenisPenghargaanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisPenghargaan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisPenghargaanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisPenghargaanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisPenghargaanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisPenghargaanPeer::JENIS_PENGHARGAAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_penghargaan_id"';
        }
        if ($this->isColumnModified(JenisPenghargaanPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(JenisPenghargaanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisPenghargaanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisPenghargaanPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisPenghargaanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_penghargaan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisPenghargaanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisPenghargaanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JenisPenghargaan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisPenghargaan'][$this->getPrimaryKey()] = true;
        $keys = JenisPenghargaanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getJenisPenghargaanId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setJenisPenghargaanId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisPenghargaanPeer::JENIS_PENGHARGAAN_ID)) $criteria->add(JenisPenghargaanPeer::JENIS_PENGHARGAAN_ID, $this->jenis_penghargaan_id);
        if ($this->isColumnModified(JenisPenghargaanPeer::NAMA)) $criteria->add(JenisPenghargaanPeer::NAMA, $this->nama);
        if ($this->isColumnModified(JenisPenghargaanPeer::CREATE_DATE)) $criteria->add(JenisPenghargaanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisPenghargaanPeer::LAST_UPDATE)) $criteria->add(JenisPenghargaanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisPenghargaanPeer::EXPIRED_DATE)) $criteria->add(JenisPenghargaanPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisPenghargaanPeer::LAST_SYNC)) $criteria->add(JenisPenghargaanPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisPenghargaanPeer::DATABASE_NAME);
        $criteria->add(JenisPenghargaanPeer::JENIS_PENGHARGAAN_ID, $this->jenis_penghargaan_id);
    ...
    /**
     * Generic method to set the primary key (jenis_penghargaan_id column).
     *
    ...
    {
        $this->setJenisPenghargaanId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getJenisPenghargaanId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisPenghargaan (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setJenisPenghargaanId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisPenghargaan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisPenghargaanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisPenghargaanPeer();
        }
     ...
     * If this JenisPenghargaan is new, it will return
    ...
    public function setPenghargaans(PropelCollection $penghargaans, PropelPDO $con = null)
    {
        ...
        foreach ($penghargaansToDelete as $penghargaanRemoved) {
            $penghargaanRemoved->setJenisPenghargaan(null);
        }
    ...
    protected function doAddPenghargaan($penghargaan)
    {
        ...
        $penghargaan->setJenisPenghargaan($this);
    }
    ...
    public function removePenghargaan($penghargaan)
    {
        if ($this->getPenghargaans()->contains($penghargaan)) {
            ...
            $penghargaan->setJenisPenghargaan(null);
        }
     ...
     * Otherwise if this JenisPenghargaan is new, it will return
     * an empty collection; or if this JenisPenghargaan has previously
     * been saved, it will retrieve related Penghargaans from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisPenghargaan.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(JenisPenghargaanPeer::DEFAULT_STRING_FORMAT);
    }
