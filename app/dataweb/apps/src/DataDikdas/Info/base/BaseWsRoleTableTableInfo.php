...
/*
 * The Base TableInfo for WsRoleTable Table
 */
class BaseWsRoleTableTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.WsRoleTableTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'role_table_id_str');
        $this->setHeader(           'Ws Role Table');
        $this->setLabel(            'Ws role table');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "WsRoleColumn"));
        $this->setBelongsTo(array(  "WsAplikasi"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "WsRoleColumn.role_table_id"));
        $this->setCreateWinChildDelete(1);
        $this->setTableValidation();

        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'role_table_id');
        $cvar->setColumnPhpName(    'RoleTableId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'aplikasi_id');
        $cvar->setColumnPhpName(    'AplikasiId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'WsAplikasi');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Aplikasi');
        $cvar->setLabel(            'Aplikasi');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      170);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'wsaplikasicombo');
        $cvar->setComboXtype(       'wsaplikasicombo');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'role_read');
        $cvar->setColumnPhpName(    'RoleRead');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Role Read');
        $cvar->setLabel(            'Role read');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'role_create');
        $cvar->setColumnPhpName(    'RoleCreate');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Role Create');
        $cvar->setLabel(            'Role create');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'role_update');
        $cvar->setColumnPhpName(    'RoleUpdate');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Role Update');
        $cvar->setLabel(            'Role update');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'role_delete');
        $cvar->setColumnPhpName(    'RoleDelete');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Role Delete');
        $cvar->setLabel(            'Role delete');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nama_table');
        $cvar->setColumnPhpName(    'NamaTable');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nama Table');
        $cvar->setLabel(            'Nama table');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nama_alias');
        $cvar->setColumnPhpName(    'NamaAlias');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nama Alias');
        $cvar->setLabel(            'Nama alias');
