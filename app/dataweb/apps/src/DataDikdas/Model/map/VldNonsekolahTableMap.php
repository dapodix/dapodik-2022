...
/**
 * This class defines the structure of the 'vld_nonsekolah' table.
 *
 *
 *
 ...
 */
class VldNonsekolahTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldNonsekolahTableMap';
