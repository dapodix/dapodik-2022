...
/**
 * Base class that represents a row from the 'ref.status_anak' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseStatusAnak extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\StatusAnakPeer';
    ...
    /**
     * Initializes internal state of BaseStatusAnak object.
     * @see        applyDefaults()
     */
     ...
     * @return StatusAnak The current object (for fluent API support)
     */
    public function setStatusAnakId($v)
    {
        ...
        if ($this->status_anak_id !== $v) {
            ...
            $this->modifiedColumns[] = StatusAnakPeer::STATUS_ANAK_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = StatusAnakPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusAnakPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusAnakPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StatusAnakPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = StatusAnakPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->status_anak_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = StatusAnakPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StatusAnak object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StatusAnakPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StatusAnakQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StatusAnakPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StatusAnakPeer::STATUS_ANAK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"status_anak_id"';
        }
        if ($this->isColumnModified(StatusAnakPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(StatusAnakPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(StatusAnakPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(StatusAnakPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(StatusAnakPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."status_anak" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StatusAnakPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StatusAnakPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StatusAnak'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StatusAnak'][$this->getPrimaryKey()] = true;
        $keys = StatusAnakPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getStatusAnakId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setStatusAnakId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusAnakPeer::STATUS_ANAK_ID)) $criteria->add(StatusAnakPeer::STATUS_ANAK_ID, $this->status_anak_id);
        if ($this->isColumnModified(StatusAnakPeer::NAMA)) $criteria->add(StatusAnakPeer::NAMA, $this->nama);
        if ($this->isColumnModified(StatusAnakPeer::CREATE_DATE)) $criteria->add(StatusAnakPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(StatusAnakPeer::LAST_UPDATE)) $criteria->add(StatusAnakPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(StatusAnakPeer::EXPIRED_DATE)) $criteria->add(StatusAnakPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(StatusAnakPeer::LAST_SYNC)) $criteria->add(StatusAnakPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(StatusAnakPeer::DATABASE_NAME);
        $criteria->add(StatusAnakPeer::STATUS_ANAK_ID, $this->status_anak_id);
    ...
    /**
     * Generic method to set the primary key (status_anak_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getStatusAnakId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of StatusAnak (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStatusAnakId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StatusAnak Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StatusAnakPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StatusAnakPeer();
        }
     ...
     * If this StatusAnak is new, it will return
    ...
    public function setAnaks(PropelCollection $anaks, PropelPDO $con = null)
    {
        ...
        foreach ($anaksToDelete as $anakRemoved) {
            $anakRemoved->setStatusAnak(null);
        }
     ...
     * Otherwise if this StatusAnak is new, it will return
     * an empty collection; or if this StatusAnak has previously
     * been saved, it will retrieve related Anaks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in StatusAnak.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(StatusAnakPeer::DEFAULT_STRING_FORMAT);
    }
