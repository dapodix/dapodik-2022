...
/**
 * Base class that represents a row from the 'ref.tingkat_prestasi' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseTingkatPrestasi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\TingkatPrestasiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TingkatPrestasiPeer
     */
    ...
    /**
     * Initializes internal state of BaseTingkatPrestasi object.
     * @see        applyDefaults()
     */
     ...
     * @return TingkatPrestasi The current object (for fluent API support)
     */
    public function setTingkatPrestasiId($v)
    {
        ...
        if ($this->tingkat_prestasi_id !== $v) {
            ...
            $this->modifiedColumns[] = TingkatPrestasiPeer::TINGKAT_PRESTASI_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = TingkatPrestasiPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatPrestasiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatPrestasiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatPrestasiPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = TingkatPrestasiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tingkat_prestasi_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = TingkatPrestasiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TingkatPrestasi object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TingkatPrestasiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TingkatPrestasiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TingkatPrestasiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TingkatPrestasiPeer::TINGKAT_PRESTASI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"tingkat_prestasi_id"';
        }
        if ($this->isColumnModified(TingkatPrestasiPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(TingkatPrestasiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(TingkatPrestasiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(TingkatPrestasiPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(TingkatPrestasiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."tingkat_prestasi" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TingkatPrestasiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TingkatPrestasiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TingkatPrestasi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TingkatPrestasi'][$this->getPrimaryKey()] = true;
        $keys = TingkatPrestasiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getTingkatPrestasiId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setTingkatPrestasiId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TingkatPrestasiPeer::TINGKAT_PRESTASI_ID)) $criteria->add(TingkatPrestasiPeer::TINGKAT_PRESTASI_ID, $this->tingkat_prestasi_id);
        if ($this->isColumnModified(TingkatPrestasiPeer::NAMA)) $criteria->add(TingkatPrestasiPeer::NAMA, $this->nama);
        if ($this->isColumnModified(TingkatPrestasiPeer::CREATE_DATE)) $criteria->add(TingkatPrestasiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(TingkatPrestasiPeer::LAST_UPDATE)) $criteria->add(TingkatPrestasiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(TingkatPrestasiPeer::EXPIRED_DATE)) $criteria->add(TingkatPrestasiPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(TingkatPrestasiPeer::LAST_SYNC)) $criteria->add(TingkatPrestasiPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(TingkatPrestasiPeer::DATABASE_NAME);
        $criteria->add(TingkatPrestasiPeer::TINGKAT_PRESTASI_ID, $this->tingkat_prestasi_id);
    ...
    /**
     * Generic method to set the primary key (tingkat_prestasi_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getTingkatPrestasiId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TingkatPrestasi (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setTingkatPrestasiId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TingkatPrestasi Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TingkatPrestasiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TingkatPrestasiPeer();
        }
     ...
     * If this TingkatPrestasi is new, it will return
    ...
    public function setPrestasis(PropelCollection $prestasis, PropelPDO $con = null)
    {
        ...
        foreach ($prestasisToDelete as $prestasiRemoved) {
            $prestasiRemoved->setTingkatPrestasi(null);
        }
    ...
    protected function doAddPrestasi($prestasi)
    {
        ...
        $prestasi->setTingkatPrestasi($this);
    }
    ...
    public function removePrestasi($prestasi)
    {
        if ($this->getPrestasis()->contains($prestasi)) {
            ...
            $prestasi->setTingkatPrestasi(null);
        }
     ...
     * Otherwise if this TingkatPrestasi is new, it will return
     * an empty collection; or if this TingkatPrestasi has previously
     * been saved, it will retrieve related Prestasis from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TingkatPrestasi.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(TingkatPrestasiPeer::DEFAULT_STRING_FORMAT);
    }
