...
/*
 * The Base TableInfo for JenisKs Table
 */
class BaseJenisKsTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisKsTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_jns_ks_str');
        $this->setHeader(           'Ref.jenis Ks');
        $this->setLabel(            'Ref.jenis ks');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jeniskscombo');
        $this->setXtypeRadio(       'ref.jenisksradio');
        $this->setXtypeList(        'ref.jeniskslist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_jns_ks');
        $cvar->setColumnPhpName(    'NmJnsKs');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Jns Ks');
        $cvar->setLabel(            'Nm jns ks');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_jns_ks');
        $cvar->setColumnPhpName(    'KetJnsKs');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Jns Ks');
        $cvar->setLabel(            'Ket jns ks');
