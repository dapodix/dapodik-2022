...
/**
 * Base class that represents a row from the 'vld_tanah' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldTanah extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldTanahPeer';
    ...
    /**
     * Initializes internal state of BaseVldTanah object.
     * @see        applyDefaults()
     */
     ...
     * @return VldTanah The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldTanahPeer::LOGID;
        }
    ...
    public function setIdTanah($v)
    {
        ...
        if ($this->id_tanah !== $v) {
            $this->id_tanah = $v;
            $this->modifiedColumns[] = VldTanahPeer::ID_TANAH;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldTanahPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldTanahPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldTanahPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldTanahPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldTanahPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldTanahPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldTanahPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldTanahPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldTanahPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldTanahPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldTanahPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldTanahPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldTanah object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldTanahPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldTanahQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldTanahPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldTanahPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldTanahPeer::ID_TANAH)) {
            $modifiedColumns[':p' . $index++]  = '"id_tanah"';
        }
        if ($this->isColumnModified(VldTanahPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldTanahPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldTanahPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldTanahPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldTanahPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldTanahPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldTanahPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldTanahPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldTanahPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldTanahPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldTanahPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_tanah" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldTanahPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldTanahPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldTanah'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldTanah'][$this->getPrimaryKey()] = true;
        $keys = VldTanahPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldTanahPeer::LOGID)) $criteria->add(VldTanahPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldTanahPeer::ID_TANAH)) $criteria->add(VldTanahPeer::ID_TANAH, $this->id_tanah);
        if ($this->isColumnModified(VldTanahPeer::IDTYPE)) $criteria->add(VldTanahPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldTanahPeer::STATUS_VALIDASI)) $criteria->add(VldTanahPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldTanahPeer::FIELD_ERROR)) $criteria->add(VldTanahPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldTanahPeer::ERROR_MESSAGE)) $criteria->add(VldTanahPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldTanahPeer::APP_USERNAME)) $criteria->add(VldTanahPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldTanahPeer::KETERANGAN)) $criteria->add(VldTanahPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldTanahPeer::CREATE_DATE)) $criteria->add(VldTanahPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldTanahPeer::LAST_UPDATE)) $criteria->add(VldTanahPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldTanahPeer::SOFT_DELETE)) $criteria->add(VldTanahPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldTanahPeer::LAST_SYNC)) $criteria->add(VldTanahPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldTanahPeer::UPDATER_ID)) $criteria->add(VldTanahPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldTanahPeer::DATABASE_NAME);
        $criteria->add(VldTanahPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldTanah (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldTanah Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldTanahs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldTanahPeer::DEFAULT_STRING_FORMAT);
    }
