...
/**
 * This class defines the structure of the 'rwy_kepangkatan' table.
 *
 *
 *
 ...
 */
class RwyKepangkatanTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.RwyKepangkatanTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('riwayat_kepangkatan_id', 'RiwayatKepangkatanId', 'VARCHAR', true, null, null);
        ...
        $this->addColumn('tmt_pangkat', 'TmtPangkat', 'DATE', true, null, null);
        $this->addColumn('masa_kerja_gol_tahun', 'MasaKerjaGolTahun', 'DECIMAL', true, 131072, null);
        $this->addColumn('masa_kerja_gol_bulan', 'MasaKerjaGolBulan', 'DECIMAL', true, 131072, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('VldRwyKepangkatan', 'DataDikdas\\Model\\VldRwyKepangkatan', RelationMap::ONE_TO_MANY, array('riwayat_kepangkatan_id' => 'riwayat_kepangkatan_id', ), 'RESTRICT', 'RESTRICT', 'VldRwyKepangkatans');
    } // buildRelations()

} // RwyKepangkatanTableMap
