...
/*
 * The Base TableInfo for BentukLembaga Table
 */
class BaseBentukLembagaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.BentukLembagaTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'bentuk_lembaga_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'bentuk_lembaga_id_str');
        $this->setHeader(           'Ref.bentuk Lembaga');
        $this->setLabel(            'Ref.bentuk lembaga');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.bentuklembagacombo');
        $this->setXtypeRadio(       'ref.bentuklembagaradio');
        $this->setXtypeList(        'ref.bentuklembagalist');
