...
/**
 * Base class that represents a row from the 'kesejahteraan_pd' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseKesejahteraanPd extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\KesejahteraanPdPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        KesejahteraanPdPeer
     */
    ...
    /**
     * The value for the id_sejahtera_pd field.
     * @var        string
     */
    protected $id_sejahtera_pd;
    ...
    /**
     * The value for the nomor field.
     * @var        string
     */
    protected $nomor;

    /**
     * The value for the nm_di_kartu field.
     * @var        string
     */
    protected $nm_di_kartu;
    ...
    /**
     * Initializes internal state of BaseKesejahteraanPd object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [id_sejahtera_pd] column value.
     * 
     * @return string
     */
    public function getIdSejahteraPd()
    {
        return $this->id_sejahtera_pd;
    }
    ...
    /**
     * Get the [nm_di_kartu] column value.
     * 
     * @return string
     */
    public function getNmDiKartu()
    {
        return $this->nm_di_kartu;
    }
    ...
    /**
     * Set the value of [id_sejahtera_pd] column.
     * 
     * @param string $v new value
     * @return KesejahteraanPd The current object (for fluent API support)
     */
    public function setIdSejahteraPd($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->id_sejahtera_pd !== $v) {
            $this->id_sejahtera_pd = $v;
            $this->modifiedColumns[] = KesejahteraanPdPeer::ID_SEJAHTERA_PD;
        }
    ...
    public function setPesertaDidikId($v)
    {
        ...
        if ($this->peserta_didik_id !== $v) {
            ...
            $this->modifiedColumns[] = KesejahteraanPdPeer::PESERTA_DIDIK_ID;
        }
    ...
    public function setJenisKesejahteraanId($v)
    {
        ...
        if ($this->jenis_kesejahteraan_id !== $v) {
            ...
            $this->modifiedColumns[] = KesejahteraanPdPeer::JENIS_KESEJAHTERAAN_ID;
        }
    ...
    public function setNomor($v)
    {
        ...
        if ($this->nomor !== $v) {
            $this->nomor = $v;
            $this->modifiedColumns[] = KesejahteraanPdPeer::NOMOR;
        }
    ...
    /**
     * Set the value of [nm_di_kartu] column.
     * 
     * @param string $v new value
     * @return KesejahteraanPd The current object (for fluent API support)
     */
    public function setNmDiKartu($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->nm_di_kartu !== $v) {
            $this->nm_di_kartu = $v;
            $this->modifiedColumns[] = KesejahteraanPdPeer::NM_DI_KARTU;
        }
    ...
    public function setDariTahun($v)
    {
        ...
        if ($this->dari_tahun !== $v) {
            $this->dari_tahun = $v;
            $this->modifiedColumns[] = KesejahteraanPdPeer::DARI_TAHUN;
        }
    ...
    public function setSampaiTahun($v)
    {
        ...
        if ($this->sampai_tahun !== $v) {
            $this->sampai_tahun = $v;
            $this->modifiedColumns[] = KesejahteraanPdPeer::SAMPAI_TAHUN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KesejahteraanPdPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KesejahteraanPdPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = KesejahteraanPdPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KesejahteraanPdPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = KesejahteraanPdPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_sejahtera_pd = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            $this->nomor = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->nm_di_kartu = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            return $startcol + 12; // 12 = KesejahteraanPdPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating KesejahteraanPd object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = KesejahteraanPdPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = KesejahteraanPdQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KesejahteraanPdPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(KesejahteraanPdPeer::ID_SEJAHTERA_PD)) {
            $modifiedColumns[':p' . $index++]  = '"id_sejahtera_pd"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::PESERTA_DIDIK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"peserta_didik_id"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::JENIS_KESEJAHTERAAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_kesejahteraan_id"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::NOMOR)) {
            $modifiedColumns[':p' . $index++]  = '"nomor"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::NM_DI_KARTU)) {
            $modifiedColumns[':p' . $index++]  = '"nm_di_kartu"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::DARI_TAHUN)) {
            $modifiedColumns[':p' . $index++]  = '"dari_tahun"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::SAMPAI_TAHUN)) {
            $modifiedColumns[':p' . $index++]  = '"sampai_tahun"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(KesejahteraanPdPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "kesejahteraan_pd" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_sejahtera_pd"':						
                        $stmt->bindValue($identifier, $this->id_sejahtera_pd, PDO::PARAM_STR);
                        break;
                    ...
                    case '"jenis_kesejahteraan_id"':						
                        ...
                        break;
                    case '"nomor"':						
                        $stmt->bindValue($identifier, $this->nomor, PDO::PARAM_STR);
                        break;
                    case '"nm_di_kartu"':						
                        $stmt->bindValue($identifier, $this->nm_di_kartu, PDO::PARAM_STR);
                        break;
                    case '"dari_tahun"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = KesejahteraanPdPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = KesejahteraanPdPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['KesejahteraanPd'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['KesejahteraanPd'][$this->getPrimaryKey()] = true;
        $keys = KesejahteraanPdPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSejahteraPd(),
            $keys[1] => $this->getPesertaDidikId(),
            $keys[2] => $this->getJenisKesejahteraanId(),
            $keys[3] => $this->getNomor(),
            $keys[4] => $this->getNmDiKartu(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdSejahteraPd($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[3], $arr)) $this->setNomor($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setNmDiKartu($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KesejahteraanPdPeer::ID_SEJAHTERA_PD)) $criteria->add(KesejahteraanPdPeer::ID_SEJAHTERA_PD, $this->id_sejahtera_pd);
        if ($this->isColumnModified(KesejahteraanPdPeer::PESERTA_DIDIK_ID)) $criteria->add(KesejahteraanPdPeer::PESERTA_DIDIK_ID, $this->peserta_didik_id);
        if ($this->isColumnModified(KesejahteraanPdPeer::JENIS_KESEJAHTERAAN_ID)) $criteria->add(KesejahteraanPdPeer::JENIS_KESEJAHTERAAN_ID, $this->jenis_kesejahteraan_id);
        if ($this->isColumnModified(KesejahteraanPdPeer::NOMOR)) $criteria->add(KesejahteraanPdPeer::NOMOR, $this->nomor);
        if ($this->isColumnModified(KesejahteraanPdPeer::NM_DI_KARTU)) $criteria->add(KesejahteraanPdPeer::NM_DI_KARTU, $this->nm_di_kartu);
        if ($this->isColumnModified(KesejahteraanPdPeer::DARI_TAHUN)) $criteria->add(KesejahteraanPdPeer::DARI_TAHUN, $this->dari_tahun);
        if ($this->isColumnModified(KesejahteraanPdPeer::SAMPAI_TAHUN)) $criteria->add(KesejahteraanPdPeer::SAMPAI_TAHUN, $this->sampai_tahun);
        if ($this->isColumnModified(KesejahteraanPdPeer::CREATE_DATE)) $criteria->add(KesejahteraanPdPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(KesejahteraanPdPeer::LAST_UPDATE)) $criteria->add(KesejahteraanPdPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(KesejahteraanPdPeer::SOFT_DELETE)) $criteria->add(KesejahteraanPdPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(KesejahteraanPdPeer::LAST_SYNC)) $criteria->add(KesejahteraanPdPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(KesejahteraanPdPeer::UPDATER_ID)) $criteria->add(KesejahteraanPdPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(KesejahteraanPdPeer::DATABASE_NAME);
        $criteria->add(KesejahteraanPdPeer::ID_SEJAHTERA_PD, $this->id_sejahtera_pd);
    ...
    /**
     * Generic method to set the primary key (id_sejahtera_pd column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdSejahteraPd();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of KesejahteraanPd (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNomor($this->getNomor());
        $copyObj->setNmDiKartu($this->getNmDiKartu());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSejahteraPd(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return KesejahteraanPd Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return KesejahteraanPdPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new KesejahteraanPdPeer();
        }
    ...
    public function getJenisKesejahteraan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aJenisKesejahteraan === null && ($this->jenis_kesejahteraan_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aJenisKesejahteraan->addKesejahteraanPds($this);
             */
        }
    ...
    public function getPesertaDidik(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPesertaDidik === null && (($this->peserta_didik_id !== "" && $this->peserta_didik_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPesertaDidik->addKesejahteraanPds($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(KesejahteraanPdPeer::DEFAULT_STRING_FORMAT);
    }
