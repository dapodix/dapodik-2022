...
/**
 * Base class that represents a row from the 'vld_prestasi' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldPrestasi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldPrestasiPeer';
    ...
    /**
     * Initializes internal state of BaseVldPrestasi object.
     * @see        applyDefaults()
     */
     ...
     * @return VldPrestasi The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::LOGID;
        }
    ...
    public function setPrestasiId($v)
    {
        ...
        if ($this->prestasi_id !== $v) {
            $this->prestasi_id = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::PRESTASI_ID;
        }

        if ($this->aPrestasi !== null && $this->aPrestasi->getPrestasiId() !== $v) {
            $this->aPrestasi = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldPrestasiPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldPrestasiPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPrestasiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldPrestasiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldPrestasiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldPrestasiPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->prestasi_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldPrestasiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldPrestasi object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPrestasi !== null && $this->prestasi_id !== $this->aPrestasi->getPrestasiId()) {
            $this->aPrestasi = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldPrestasiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldPrestasiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldPrestasiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPrestasi !== null) {
                if ($this->aPrestasi->isModified() || $this->aPrestasi->isNew()) {
                    $affectedRows += $this->aPrestasi->save($con);
                }
                $this->setPrestasi($this->aPrestasi);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldPrestasiPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::PRESTASI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"prestasi_id"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldPrestasiPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_prestasi" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPrestasi !== null) {
                if (!$this->aPrestasi->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPrestasi->getValidationFailures());
                }
            }


            if (($retval = VldPrestasiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldPrestasiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldPrestasi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldPrestasi'][$this->getPrimaryKey()] = true;
        $keys = VldPrestasiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getPrestasiId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPrestasi) {
                $result['Prestasi'] = $this->aPrestasi->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setPrestasiId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldPrestasiPeer::LOGID)) $criteria->add(VldPrestasiPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldPrestasiPeer::PRESTASI_ID)) $criteria->add(VldPrestasiPeer::PRESTASI_ID, $this->prestasi_id);
        if ($this->isColumnModified(VldPrestasiPeer::IDTYPE)) $criteria->add(VldPrestasiPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldPrestasiPeer::STATUS_VALIDASI)) $criteria->add(VldPrestasiPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldPrestasiPeer::FIELD_ERROR)) $criteria->add(VldPrestasiPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldPrestasiPeer::ERROR_MESSAGE)) $criteria->add(VldPrestasiPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldPrestasiPeer::KETERANGAN)) $criteria->add(VldPrestasiPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldPrestasiPeer::APP_USERNAME)) $criteria->add(VldPrestasiPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldPrestasiPeer::CREATE_DATE)) $criteria->add(VldPrestasiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldPrestasiPeer::LAST_UPDATE)) $criteria->add(VldPrestasiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldPrestasiPeer::SOFT_DELETE)) $criteria->add(VldPrestasiPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldPrestasiPeer::LAST_SYNC)) $criteria->add(VldPrestasiPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldPrestasiPeer::UPDATER_ID)) $criteria->add(VldPrestasiPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldPrestasiPeer::DATABASE_NAME);
        $criteria->add(VldPrestasiPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldPrestasi (or compatible) type.
    ...
    {
        $copyObj->setPrestasiId($this->getPrestasiId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldPrestasi Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldPrestasiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldPrestasiPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldPrestasis($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Prestasi object.
     *
     * @param             Prestasi $v
     * @return VldPrestasi The current object (for fluent API support)
     * @throws PropelException
     */
    public function setPrestasi(Prestasi $v = null)
    {
        if ($v === null) {
            $this->setPrestasiId(NULL);
        } else {
            $this->setPrestasiId($v->getPrestasiId());
        }

        $this->aPrestasi = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Prestasi object, it will not be re-added.
        if ($v !== null) {
            $v->addVldPrestasi($this);
        }
    ...
    /**
     * Get the associated Prestasi object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Prestasi The associated Prestasi object.
     * @throws PropelException
     */
    public function getPrestasi(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPrestasi === null && (($this->prestasi_id !== "" && $this->prestasi_id !== null)) && $doQuery) {
            $this->aPrestasi = PrestasiQuery::create()->findPk($this->prestasi_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPrestasi->addVldPrestasis($this);
             */
        }

        return $this->aPrestasi;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPrestasi instanceof Persistent) {
              $this->aPrestasi->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldPrestasiPeer::DEFAULT_STRING_FORMAT);
    }
