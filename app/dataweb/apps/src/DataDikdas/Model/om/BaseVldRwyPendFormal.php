...
/**
 * Base class that represents a row from the 'vld_rwy_pend_formal' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRwyPendFormal extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRwyPendFormalPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldRwyPendFormalPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldRwyPendFormal object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRwyPendFormal The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRwyPendFormalPeer::LOGID;
        }
    ...
    public function setRiwayatPendidikanFormalId($v)
    {
        ...
        if ($this->riwayat_pendidikan_formal_id !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyPendFormalPeer::RIWAYAT_PENDIDIKAN_FORMAL_ID;
        }

        if ($this->aRwyPendFormal !== null && $this->aRwyPendFormal->getRiwayatPendidikanFormalId() !== $v) {
            $this->aRwyPendFormal = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRwyPendFormalPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyPendFormalPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRwyPendFormalPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyPendFormalPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRwyPendFormalPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRwyPendFormalPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyPendFormalPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyPendFormalPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRwyPendFormalPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRwyPendFormalPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRwyPendFormalPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->riwayat_pendidikan_formal_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldRwyPendFormalPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRwyPendFormal object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRwyPendFormal !== null && $this->riwayat_pendidikan_formal_id !== $this->aRwyPendFormal->getRiwayatPendidikanFormalId()) {
            $this->aRwyPendFormal = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRwyPendFormalPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRwyPendFormalQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRwyPendFormalPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRwyPendFormal !== null) {
                if ($this->aRwyPendFormal->isModified() || $this->aRwyPendFormal->isNew()) {
                    $affectedRows += $this->aRwyPendFormal->save($con);
                }
                $this->setRwyPendFormal($this->aRwyPendFormal);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRwyPendFormalPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::RIWAYAT_PENDIDIKAN_FORMAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"riwayat_pendidikan_formal_id"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRwyPendFormalPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_rwy_pend_formal" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aRwyPendFormal !== null) {
                if (!$this->aRwyPendFormal->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aRwyPendFormal->getValidationFailures());
                }
            }
            ...
            if (($retval = VldRwyPendFormalPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRwyPendFormalPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRwyPendFormal'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRwyPendFormal'][$this->getPrimaryKey()] = true;
        $keys = VldRwyPendFormalPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getRiwayatPendidikanFormalId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aRwyPendFormal) {
                $result['RwyPendFormal'] = $this->aRwyPendFormal->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setRiwayatPendidikanFormalId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRwyPendFormalPeer::LOGID)) $criteria->add(VldRwyPendFormalPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRwyPendFormalPeer::RIWAYAT_PENDIDIKAN_FORMAL_ID)) $criteria->add(VldRwyPendFormalPeer::RIWAYAT_PENDIDIKAN_FORMAL_ID, $this->riwayat_pendidikan_formal_id);
        if ($this->isColumnModified(VldRwyPendFormalPeer::IDTYPE)) $criteria->add(VldRwyPendFormalPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRwyPendFormalPeer::STATUS_VALIDASI)) $criteria->add(VldRwyPendFormalPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRwyPendFormalPeer::FIELD_ERROR)) $criteria->add(VldRwyPendFormalPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRwyPendFormalPeer::ERROR_MESSAGE)) $criteria->add(VldRwyPendFormalPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRwyPendFormalPeer::KETERANGAN)) $criteria->add(VldRwyPendFormalPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRwyPendFormalPeer::APP_USERNAME)) $criteria->add(VldRwyPendFormalPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRwyPendFormalPeer::CREATE_DATE)) $criteria->add(VldRwyPendFormalPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRwyPendFormalPeer::LAST_UPDATE)) $criteria->add(VldRwyPendFormalPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRwyPendFormalPeer::SOFT_DELETE)) $criteria->add(VldRwyPendFormalPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRwyPendFormalPeer::LAST_SYNC)) $criteria->add(VldRwyPendFormalPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRwyPendFormalPeer::UPDATER_ID)) $criteria->add(VldRwyPendFormalPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRwyPendFormalPeer::DATABASE_NAME);
        $criteria->add(VldRwyPendFormalPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRwyPendFormal (or compatible) type.
    ...
    {
        $copyObj->setRiwayatPendidikanFormalId($this->getRiwayatPendidikanFormalId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRwyPendFormal Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldRwyPendFormalPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldRwyPendFormalPeer();
        }
    ...
    /**
     * Declares an association between this object and a RwyPendFormal object.
     *
     * @param             RwyPendFormal $v
     * @return VldRwyPendFormal The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRwyPendFormal(RwyPendFormal $v = null)
    {
        if ($v === null) {
            $this->setRiwayatPendidikanFormalId(NULL);
        } else {
            $this->setRiwayatPendidikanFormalId($v->getRiwayatPendidikanFormalId());
        }

        $this->aRwyPendFormal = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the RwyPendFormal object, it will not be re-added.
        if ($v !== null) {
            $v->addVldRwyPendFormal($this);
        }
    ...
    /**
     * Get the associated RwyPendFormal object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return RwyPendFormal The associated RwyPendFormal object.
     * @throws PropelException
     */
    public function getRwyPendFormal(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRwyPendFormal === null && (($this->riwayat_pendidikan_formal_id !== "" && $this->riwayat_pendidikan_formal_id !== null)) && $doQuery) {
            $this->aRwyPendFormal = RwyPendFormalQuery::create()->findPk($this->riwayat_pendidikan_formal_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRwyPendFormal->addVldRwyPendFormals($this);
             */
        }

        return $this->aRwyPendFormal;
    }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aErrortype->addVldRwyPendFormals($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aRwyPendFormal instanceof Persistent) {
              $this->aRwyPendFormal->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldRwyPendFormalPeer::DEFAULT_STRING_FORMAT);
    }
