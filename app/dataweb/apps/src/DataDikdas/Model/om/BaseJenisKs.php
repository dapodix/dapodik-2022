...
/**
 * Base class that represents a row from the 'ref.jenis_ks' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisKs extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisKsPeer';
    ...
    /**
     * The value for the nm_jns_ks field.
     * @var        string
     */
    protected $nm_jns_ks;

    /**
     * The value for the ket_jns_ks field.
     * @var        string
     */
    protected $ket_jns_ks;
    ...
    /**
     * Initializes internal state of BaseJenisKs object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nm_jns_ks] column value.
     * 
     * @return string
     */
    public function getNmJnsKs()
    {
        return $this->nm_jns_ks;
    }

    /**
     * Get the [ket_jns_ks] column value.
     * 
     * @return string
     */
    public function getKetJnsKs()
    {
        return $this->ket_jns_ks;
    }
     ...
     * @return JenisKs The current object (for fluent API support)
     */
    public function setIdJnsKs($v)
    {
        ...
        if ($this->id_jns_ks !== $v) {
            $this->id_jns_ks = $v;
            $this->modifiedColumns[] = JenisKsPeer::ID_JNS_KS;
        }
    ...
    /**
     * Set the value of [nm_jns_ks] column.
     * 
     * @param string $v new value
     * @return JenisKs The current object (for fluent API support)
     */
    public function setNmJnsKs($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->nm_jns_ks !== $v) {
            $this->nm_jns_ks = $v;
            $this->modifiedColumns[] = JenisKsPeer::NM_JNS_KS;
        }
    ...
    /**
     * Set the value of [ket_jns_ks] column.
     * 
     * @param string $v new value
     * @return JenisKs The current object (for fluent API support)
     */
    public function setKetJnsKs($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->ket_jns_ks !== $v) {
            $this->ket_jns_ks = $v;
            $this->modifiedColumns[] = JenisKsPeer::KET_JNS_KS;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisKsPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisKsPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisKsPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisKsPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_jns_ks = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->nm_jns_ks = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->ket_jns_ks = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 7; // 7 = JenisKsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisKs object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisKsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisKsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisKsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisKsPeer::ID_JNS_KS)) {
            $modifiedColumns[':p' . $index++]  = '"id_jns_ks"';
        }
        if ($this->isColumnModified(JenisKsPeer::NM_JNS_KS)) {
            $modifiedColumns[':p' . $index++]  = '"nm_jns_ks"';
        }
        if ($this->isColumnModified(JenisKsPeer::KET_JNS_KS)) {
            $modifiedColumns[':p' . $index++]  = '"ket_jns_ks"';
        }
        if ($this->isColumnModified(JenisKsPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisKsPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisKsPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisKsPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_ks" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_jns_ks"':						
                        ...
                        break;
                    case '"nm_jns_ks"':						
                        $stmt->bindValue($identifier, $this->nm_jns_ks, PDO::PARAM_STR);
                        break;
                    case '"ket_jns_ks"':						
                        $stmt->bindValue($identifier, $this->ket_jns_ks, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisKsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisKsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getNmJnsKs();
                break;
            case 2:
                return $this->getKetJnsKs();
                break;
            case 3:
    ...
    {
        if (isset($alreadyDumpedObjects['JenisKs'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisKs'][$this->getPrimaryKey()] = true;
        $keys = JenisKsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdJnsKs(),
            $keys[1] => $this->getNmJnsKs(),
            $keys[2] => $this->getKetJnsKs(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setNmJnsKs($value);
                break;
            case 2:
                $this->setKetJnsKs($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdJnsKs($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNmJnsKs($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setKetJnsKs($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisKsPeer::ID_JNS_KS)) $criteria->add(JenisKsPeer::ID_JNS_KS, $this->id_jns_ks);
        if ($this->isColumnModified(JenisKsPeer::NM_JNS_KS)) $criteria->add(JenisKsPeer::NM_JNS_KS, $this->nm_jns_ks);
        if ($this->isColumnModified(JenisKsPeer::KET_JNS_KS)) $criteria->add(JenisKsPeer::KET_JNS_KS, $this->ket_jns_ks);
        if ($this->isColumnModified(JenisKsPeer::CREATE_DATE)) $criteria->add(JenisKsPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisKsPeer::LAST_UPDATE)) $criteria->add(JenisKsPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisKsPeer::EXPIRED_DATE)) $criteria->add(JenisKsPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisKsPeer::LAST_SYNC)) $criteria->add(JenisKsPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisKsPeer::DATABASE_NAME);
        $criteria->add(JenisKsPeer::ID_JNS_KS, $this->id_jns_ks);
    ...
    /**
     * Generic method to set the primary key (id_jns_ks column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisKs (or compatible) type.
    ...
    {
        $copyObj->setNmJnsKs($this->getNmJnsKs());
        $copyObj->setKetJnsKs($this->getKetJnsKs());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdJnsKs(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisKs Clone of current object.
     * @throws PropelException
     */
     ...
     * If this JenisKs is new, it will return
     ...
     * Otherwise if this JenisKs is new, it will return
     * an empty collection; or if this JenisKs has previously
     * been saved, it will retrieve related Mous from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisKs.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(JenisKsPeer::DEFAULT_STRING_FORMAT);
    }
