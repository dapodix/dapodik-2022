...
/**
 * Base class that represents a row from the 'vld_demografi' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldDemografi extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldDemografiPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldDemografiPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldDemografi object.
     * @see        applyDefaults()
     */
     ...
     * @return VldDemografi The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldDemografiPeer::LOGID;
        }
    ...
    public function setDemografiId($v)
    {
        ...
        if ($this->demografi_id !== $v) {
            $this->demografi_id = $v;
            $this->modifiedColumns[] = VldDemografiPeer::DEMOGRAFI_ID;
        }

        if ($this->aDemografi !== null && $this->aDemografi->getDemografiId() !== $v) {
            $this->aDemografi = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldDemografiPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldDemografiPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldDemografiPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldDemografiPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldDemografiPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldDemografiPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldDemografiPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldDemografiPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldDemografiPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldDemografiPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldDemografiPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->demografi_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldDemografiPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldDemografi object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aDemografi !== null && $this->demografi_id !== $this->aDemografi->getDemografiId()) {
            $this->aDemografi = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldDemografiPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldDemografiQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldDemografiPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aDemografi !== null) {
                if ($this->aDemografi->isModified() || $this->aDemografi->isNew()) {
                    $affectedRows += $this->aDemografi->save($con);
                }
                $this->setDemografi($this->aDemografi);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldDemografiPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldDemografiPeer::DEMOGRAFI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"demografi_id"';
        }
        if ($this->isColumnModified(VldDemografiPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldDemografiPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldDemografiPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldDemografiPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldDemografiPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldDemografiPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldDemografiPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldDemografiPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldDemografiPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldDemografiPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldDemografiPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_demografi" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"logid"':						
                        ...
                        break;
                    case '"demografi_id"':						
                        $stmt->bindValue($identifier, $this->demografi_id, PDO::PARAM_STR);
                        break;
                    case '"idtype"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aDemografi !== null) {
                if (!$this->aDemografi->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aDemografi->getValidationFailures());
                }
            }


            if (($retval = VldDemografiPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldDemografiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldDemografi'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldDemografi'][$this->getPrimaryKey()] = true;
        $keys = VldDemografiPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getDemografiId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aDemografi) {
                $result['Demografi'] = $this->aDemografi->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDemografiId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldDemografiPeer::LOGID)) $criteria->add(VldDemografiPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldDemografiPeer::DEMOGRAFI_ID)) $criteria->add(VldDemografiPeer::DEMOGRAFI_ID, $this->demografi_id);
        if ($this->isColumnModified(VldDemografiPeer::IDTYPE)) $criteria->add(VldDemografiPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldDemografiPeer::STATUS_VALIDASI)) $criteria->add(VldDemografiPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldDemografiPeer::FIELD_ERROR)) $criteria->add(VldDemografiPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldDemografiPeer::ERROR_MESSAGE)) $criteria->add(VldDemografiPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldDemografiPeer::KETERANGAN)) $criteria->add(VldDemografiPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldDemografiPeer::APP_USERNAME)) $criteria->add(VldDemografiPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldDemografiPeer::CREATE_DATE)) $criteria->add(VldDemografiPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldDemografiPeer::LAST_UPDATE)) $criteria->add(VldDemografiPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldDemografiPeer::SOFT_DELETE)) $criteria->add(VldDemografiPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldDemografiPeer::LAST_SYNC)) $criteria->add(VldDemografiPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldDemografiPeer::UPDATER_ID)) $criteria->add(VldDemografiPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldDemografiPeer::DATABASE_NAME);
        $criteria->add(VldDemografiPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldDemografi (or compatible) type.
    ...
    {
        $copyObj->setDemografiId($this->getDemografiId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldDemografi Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldDemografiPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldDemografiPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldDemografis($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Demografi object.
     *
     * @param             Demografi $v
     * @return VldDemografi The current object (for fluent API support)
     * @throws PropelException
     */
    public function setDemografi(Demografi $v = null)
    {
        if ($v === null) {
            $this->setDemografiId(NULL);
        } else {
            $this->setDemografiId($v->getDemografiId());
        }

        $this->aDemografi = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Demografi object, it will not be re-added.
        if ($v !== null) {
            $v->addVldDemografi($this);
        }
    ...
    /**
     * Get the associated Demografi object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Demografi The associated Demografi object.
     * @throws PropelException
     */
    public function getDemografi(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDemografi === null && (($this->demografi_id !== "" && $this->demografi_id !== null)) && $doQuery) {
            $this->aDemografi = DemografiQuery::create()->findPk($this->demografi_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDemografi->addVldDemografis($this);
             */
        }

        return $this->aDemografi;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aDemografi instanceof Persistent) {
              $this->aDemografi->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldDemografiPeer::DEFAULT_STRING_FORMAT);
    }
