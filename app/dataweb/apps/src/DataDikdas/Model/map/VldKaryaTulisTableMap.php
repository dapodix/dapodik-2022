...
/**
 * This class defines the structure of the 'vld_karya_tulis' table.
 *
 *
 *
 ...
 */
class VldKaryaTulisTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldKaryaTulisTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('karya_tulis_id', 'KaryaTulisId', 'VARCHAR', 'karya_tulis', 'karya_tulis_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('KaryaTulis', 'DataDikdas\\Model\\KaryaTulis', RelationMap::MANY_TO_ONE, array('karya_tulis_id' => 'karya_tulis_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()

} // VldKaryaTulisTableMap
