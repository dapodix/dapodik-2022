...
/**
 * Base class that represents a row from the 'vld_anak' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldAnak extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldAnakPeer';
    ...
    /**
     * Initializes internal state of BaseVldAnak object.
     * @see        applyDefaults()
     */
     ...
     * @return VldAnak The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldAnakPeer::LOGID;
        }
    ...
    public function setAnakId($v)
    {
        ...
        if ($this->anak_id !== $v) {
            $this->anak_id = $v;
            $this->modifiedColumns[] = VldAnakPeer::ANAK_ID;
        }

        if ($this->aAnak !== null && $this->aAnak->getAnakId() !== $v) {
            $this->aAnak = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldAnakPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldAnakPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldAnakPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldAnakPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldAnakPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldAnakPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAnakPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAnakPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldAnakPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldAnakPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldAnakPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->anak_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldAnakPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldAnak object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aAnak !== null && $this->anak_id !== $this->aAnak->getAnakId()) {
            $this->aAnak = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldAnakPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldAnakQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldAnakPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aAnak !== null) {
                if ($this->aAnak->isModified() || $this->aAnak->isNew()) {
                    $affectedRows += $this->aAnak->save($con);
                }
                $this->setAnak($this->aAnak);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldAnakPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldAnakPeer::ANAK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"anak_id"';
        }
        if ($this->isColumnModified(VldAnakPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldAnakPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldAnakPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldAnakPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldAnakPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldAnakPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldAnakPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldAnakPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldAnakPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldAnakPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldAnakPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_anak" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aAnak !== null) {
                if (!$this->aAnak->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aAnak->getValidationFailures());
                }
            }


            if (($retval = VldAnakPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldAnakPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldAnak'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldAnak'][$this->getPrimaryKey()] = true;
        $keys = VldAnakPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getAnakId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aAnak) {
                $result['Anak'] = $this->aAnak->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setAnakId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldAnakPeer::LOGID)) $criteria->add(VldAnakPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldAnakPeer::ANAK_ID)) $criteria->add(VldAnakPeer::ANAK_ID, $this->anak_id);
        if ($this->isColumnModified(VldAnakPeer::IDTYPE)) $criteria->add(VldAnakPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldAnakPeer::STATUS_VALIDASI)) $criteria->add(VldAnakPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldAnakPeer::FIELD_ERROR)) $criteria->add(VldAnakPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldAnakPeer::ERROR_MESSAGE)) $criteria->add(VldAnakPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldAnakPeer::KETERANGAN)) $criteria->add(VldAnakPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldAnakPeer::APP_USERNAME)) $criteria->add(VldAnakPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldAnakPeer::CREATE_DATE)) $criteria->add(VldAnakPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldAnakPeer::LAST_UPDATE)) $criteria->add(VldAnakPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldAnakPeer::SOFT_DELETE)) $criteria->add(VldAnakPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldAnakPeer::LAST_SYNC)) $criteria->add(VldAnakPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldAnakPeer::UPDATER_ID)) $criteria->add(VldAnakPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldAnakPeer::DATABASE_NAME);
        $criteria->add(VldAnakPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldAnak (or compatible) type.
    ...
    {
        $copyObj->setAnakId($this->getAnakId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldAnak Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldAnaks($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Anak object.
     *
     * @param             Anak $v
     * @return VldAnak The current object (for fluent API support)
     * @throws PropelException
     */
    public function setAnak(Anak $v = null)
    {
        if ($v === null) {
            $this->setAnakId(NULL);
        } else {
            $this->setAnakId($v->getAnakId());
        }

        $this->aAnak = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Anak object, it will not be re-added.
        if ($v !== null) {
            $v->addVldAnak($this);
        }
    ...
    /**
     * Get the associated Anak object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Anak The associated Anak object.
     * @throws PropelException
     */
    public function getAnak(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAnak === null && (($this->anak_id !== "" && $this->anak_id !== null)) && $doQuery) {
            $this->aAnak = AnakQuery::create()->findPk($this->anak_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAnak->addVldAnaks($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aAnak instanceof Persistent) {
              $this->aAnak->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldAnakPeer::DEFAULT_STRING_FORMAT);
    }
