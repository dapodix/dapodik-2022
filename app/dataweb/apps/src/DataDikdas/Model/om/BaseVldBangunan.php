...
abstract class BaseVldBangunan extends BaseObject implements Persistent
{
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldBangunanPeer::KETERANGAN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldBangunanPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldBangunanPeer::KETERANGAN)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldBangunanPeer::KETERANGAN)) $criteria->add(VldBangunanPeer::KETERANGAN, $this->keterangan);
