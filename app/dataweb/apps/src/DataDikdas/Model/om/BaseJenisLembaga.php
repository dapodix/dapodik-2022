...
/**
 * Base class that represents a row from the 'ref.jenis_lembaga' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisLembaga extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisLembagaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        JenisLembagaPeer
     */
    ...
    /**
     * The value for the tempat_pengawas field.
     * @var        string
     */
    protected $tempat_pengawas;

    /**
     * The value for the simpul_pendataan field.
     * @var        string
     */
    protected $simpul_pendataan;
    ...
    /**
     * Initializes internal state of BaseJenisLembaga object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [tempat_pengawas] column value.
     * 
     * @return string
     */
    public function getTempatPengawas()
    {
        return $this->tempat_pengawas;
    }

    /**
     * Get the [simpul_pendataan] column value.
     * 
     * @return string
     */
    public function getSimpulPendataan()
    {
        return $this->simpul_pendataan;
    }
     ...
     * @return JenisLembaga The current object (for fluent API support)
     */
    public function setJenisLembagaId($v)
    {
        ...
        if ($this->jenis_lembaga_id !== $v) {
            ...
            $this->modifiedColumns[] = JenisLembagaPeer::JENIS_LEMBAGA_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = JenisLembagaPeer::NAMA;
        }
    ...
    /**
     * Set the value of [tempat_pengawas] column.
     * 
     * @param string $v new value
     * @return JenisLembaga The current object (for fluent API support)
     */
    public function setTempatPengawas($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->tempat_pengawas !== $v) {
            $this->tempat_pengawas = $v;
            $this->modifiedColumns[] = JenisLembagaPeer::TEMPAT_PENGAWAS;
        }
    ...
    /**
     * Set the value of [simpul_pendataan] column.
     * 
     * @param string $v new value
     * @return JenisLembaga The current object (for fluent API support)
     */
    public function setSimpulPendataan($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->simpul_pendataan !== $v) {
            $this->simpul_pendataan = $v;
            $this->modifiedColumns[] = JenisLembagaPeer::SIMPUL_PENDATAAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisLembagaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisLembagaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisLembagaPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisLembagaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jenis_lembaga_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->nama = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->tempat_pengawas = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->simpul_pendataan = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = JenisLembagaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisLembaga object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisLembagaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisLembagaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisLembagaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisLembagaPeer::JENIS_LEMBAGA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_lembaga_id"';
        }
        if ($this->isColumnModified(JenisLembagaPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(JenisLembagaPeer::TEMPAT_PENGAWAS)) {
            $modifiedColumns[':p' . $index++]  = '"tempat_pengawas"';
        }
        if ($this->isColumnModified(JenisLembagaPeer::SIMPUL_PENDATAAN)) {
            $modifiedColumns[':p' . $index++]  = '"simpul_pendataan"';
        }
        if ($this->isColumnModified(JenisLembagaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisLembagaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisLembagaPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisLembagaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_lembaga" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"nama"':						
                        ...
                        break;
                    case '"tempat_pengawas"':						
                        $stmt->bindValue($identifier, $this->tempat_pengawas, PDO::PARAM_STR);
                        break;
                    case '"simpul_pendataan"':						
                        $stmt->bindValue($identifier, $this->simpul_pendataan, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisLembagaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisLembagaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getTempatPengawas();
                break;
            case 3:
                return $this->getSimpulPendataan();
                break;
            case 4:
    ...
    {
        if (isset($alreadyDumpedObjects['JenisLembaga'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisLembaga'][$this->getPrimaryKey()] = true;
        $keys = JenisLembagaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getJenisLembagaId(),
            $keys[1] => $this->getNama(),
            $keys[2] => $this->getTempatPengawas(),
            $keys[3] => $this->getSimpulPendataan(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setTempatPengawas($value);
                break;
            case 3:
                $this->setSimpulPendataan($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setJenisLembagaId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setNama($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setTempatPengawas($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setSimpulPendataan($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisLembagaPeer::JENIS_LEMBAGA_ID)) $criteria->add(JenisLembagaPeer::JENIS_LEMBAGA_ID, $this->jenis_lembaga_id);
        if ($this->isColumnModified(JenisLembagaPeer::NAMA)) $criteria->add(JenisLembagaPeer::NAMA, $this->nama);
        if ($this->isColumnModified(JenisLembagaPeer::TEMPAT_PENGAWAS)) $criteria->add(JenisLembagaPeer::TEMPAT_PENGAWAS, $this->tempat_pengawas);
        if ($this->isColumnModified(JenisLembagaPeer::SIMPUL_PENDATAAN)) $criteria->add(JenisLembagaPeer::SIMPUL_PENDATAAN, $this->simpul_pendataan);
        if ($this->isColumnModified(JenisLembagaPeer::CREATE_DATE)) $criteria->add(JenisLembagaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisLembagaPeer::LAST_UPDATE)) $criteria->add(JenisLembagaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisLembagaPeer::EXPIRED_DATE)) $criteria->add(JenisLembagaPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisLembagaPeer::LAST_SYNC)) $criteria->add(JenisLembagaPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisLembagaPeer::DATABASE_NAME);
        $criteria->add(JenisLembagaPeer::JENIS_LEMBAGA_ID, $this->jenis_lembaga_id);
    ...
    /**
     * Generic method to set the primary key (jenis_lembaga_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getJenisLembagaId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisLembaga (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTempatPengawas($this->getTempatPengawas());
        $copyObj->setSimpulPendataan($this->getSimpulPendataan());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setJenisLembagaId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisLembaga Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisLembagaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisLembagaPeer();
        }
     ...
     * If this JenisLembaga is new, it will return
    ...
    public function setLembagaNonSekolahs(PropelCollection $lembagaNonSekolahs, PropelPDO $con = null)
    {
        ...
        foreach ($lembagaNonSekolahsToDelete as $lembagaNonSekolahRemoved) {
            $lembagaNonSekolahRemoved->setJenisLembaga(null);
        }
    ...
    protected function doAddLembagaNonSekolah($lembagaNonSekolah)
    {
        ...
        $lembagaNonSekolah->setJenisLembaga($this);
    }
    ...
    public function removeLembagaNonSekolah($lembagaNonSekolah)
    {
        if ($this->getLembagaNonSekolahs()->contains($lembagaNonSekolah)) {
            ...
            $lembagaNonSekolah->setJenisLembaga(null);
        }
     ...
     * Otherwise if this JenisLembaga is new, it will return
     * an empty collection; or if this JenisLembaga has previously
     * been saved, it will retrieve related LembagaNonSekolahs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisLembaga.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|LembagaNonSekolah[] List of LembagaNonSekolah objects
     */
    public function getLembagaNonSekolahsJoinMstWilayah($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LembagaNonSekolahQuery::create(null, $criteria);
    ...
    public function setRwyKerjas(PropelCollection $rwyKerjas, PropelPDO $con = null)
    {
        ...
        foreach ($rwyKerjasToDelete as $rwyKerjaRemoved) {
            $rwyKerjaRemoved->setJenisLembaga(null);
        }
    ...
    public function clear()
    {
        ...
        $this->nama = null;
        $this->tempat_pengawas = null;
        $this->simpul_pendataan = null;
    ...
    {
        return (string) $this->exportTo(JenisLembagaPeer::DEFAULT_STRING_FORMAT);
    }
