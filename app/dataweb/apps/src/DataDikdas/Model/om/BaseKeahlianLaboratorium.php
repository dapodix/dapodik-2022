...
/**
 * Base class that represents a row from the 'ref.keahlian_laboratorium' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseKeahlianLaboratorium extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\KeahlianLaboratoriumPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        KeahlianLaboratoriumPeer
     */
    ...
    /**
     * Initializes internal state of BaseKeahlianLaboratorium object.
     * @see        applyDefaults()
     */
     ...
     * @return KeahlianLaboratorium The current object (for fluent API support)
     */
    public function setKeahlianLaboratoriumId($v)
    {
        ...
        if ($this->keahlian_laboratorium_id !== $v) {
            ...
            $this->modifiedColumns[] = KeahlianLaboratoriumPeer::KEAHLIAN_LABORATORIUM_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = KeahlianLaboratoriumPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KeahlianLaboratoriumPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KeahlianLaboratoriumPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KeahlianLaboratoriumPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KeahlianLaboratoriumPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->keahlian_laboratorium_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = KeahlianLaboratoriumPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating KeahlianLaboratorium object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = KeahlianLaboratoriumPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = KeahlianLaboratoriumQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KeahlianLaboratoriumPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::KEAHLIAN_LABORATORIUM_ID)) {
            $modifiedColumns[':p' . $index++]  = '"keahlian_laboratorium_id"';
        }
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."keahlian_laboratorium" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = KeahlianLaboratoriumPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = KeahlianLaboratoriumPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['KeahlianLaboratorium'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['KeahlianLaboratorium'][$this->getPrimaryKey()] = true;
        $keys = KeahlianLaboratoriumPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getKeahlianLaboratoriumId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setKeahlianLaboratoriumId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::KEAHLIAN_LABORATORIUM_ID)) $criteria->add(KeahlianLaboratoriumPeer::KEAHLIAN_LABORATORIUM_ID, $this->keahlian_laboratorium_id);
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::NAMA)) $criteria->add(KeahlianLaboratoriumPeer::NAMA, $this->nama);
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::CREATE_DATE)) $criteria->add(KeahlianLaboratoriumPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::LAST_UPDATE)) $criteria->add(KeahlianLaboratoriumPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::EXPIRED_DATE)) $criteria->add(KeahlianLaboratoriumPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(KeahlianLaboratoriumPeer::LAST_SYNC)) $criteria->add(KeahlianLaboratoriumPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(KeahlianLaboratoriumPeer::DATABASE_NAME);
        $criteria->add(KeahlianLaboratoriumPeer::KEAHLIAN_LABORATORIUM_ID, $this->keahlian_laboratorium_id);
    ...
    /**
     * Generic method to set the primary key (keahlian_laboratorium_id column).
     *
    ...
    {
        $this->setKeahlianLaboratoriumId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getKeahlianLaboratoriumId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of KeahlianLaboratorium (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setKeahlianLaboratoriumId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return KeahlianLaboratorium Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return KeahlianLaboratoriumPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new KeahlianLaboratoriumPeer();
        }
     ...
     * If this KeahlianLaboratorium is new, it will return
        ...
        if (null === $this->collPtks || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPtks) {
                ...
                $collPtks = PtkQuery::create(null, $criteria)
                    ->filterByKeahlianLaboratorium($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPtks(PropelCollection $ptks, PropelPDO $con = null)
    {
        ...
        foreach ($ptksToDelete as $ptkRemoved) {
            $ptkRemoved->setKeahlianLaboratorium(null);
        }
    ...
    {
        $this->collPtks[]= $ptk;
        $ptk->setKeahlianLaboratorium($this);
    }
    ...
    public function removePtk($ptk)
    {
        if ($this->getPtks()->contains($ptk)) {
            ...
            $ptk->setKeahlianLaboratorium(null);
        }
     ...
     * Otherwise if this KeahlianLaboratorium is new, it will return
     * an empty collection; or if this KeahlianLaboratorium has previously
     * been saved, it will retrieve related Ptks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in KeahlianLaboratorium.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(KeahlianLaboratoriumPeer::DEFAULT_STRING_FORMAT);
    }
