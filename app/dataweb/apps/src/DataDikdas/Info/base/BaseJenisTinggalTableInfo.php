...
/*
 * The Base TableInfo for JenisTinggal Table
 */
class BaseJenisTinggalTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisTinggalTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_tinggal_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_tinggal_id_str');
        $this->setHeader(           'Ref.jenis Tinggal');
        $this->setLabel(            'Ref.jenis tinggal');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenistinggalcombo');
        $this->setXtypeRadio(       'ref.jenistinggalradio');
        $this->setXtypeList(        'ref.jenistinggallist');
