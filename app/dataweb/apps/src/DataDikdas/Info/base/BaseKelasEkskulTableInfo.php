...
/*
 * The Base TableInfo for KelasEkskul Table
 */
class BaseKelasEkskulTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KelasEkskulTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'id_kelas_ekskul');
        $this->setIsData(           1);
        ...
        $this->setRendererString(   'id_kelas_ekskul_str');
        $this->setHeader(           'Kelas Ekskul');
        $this->setLabel(            'Kelas ekskul');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'id_ekskul');
        $cvar->setColumnPhpName(    'IdEkskul');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'EkstraKurikuler');
        $cvar->setMin(              0);
        $cvar->setMax(              17);
        $cvar->setHeader(           'Ekskul');
        $cvar->setLabel(            'ekskul');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'ekstrakurikulercombo');
        $cvar->setComboXtype(       'ekstrakurikulercombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_ekskul');
        $cvar->setColumnPhpName(    'NmEkskul');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nm Ekskul');
        $cvar->setLabel(            'Nm ekskul');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sk_ekskul');
        $cvar->setColumnPhpName(    'SkEkskul');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Sk Ekskul');
        $cvar->setLabel(            'Sk ekskul');
        $cvar->setInputLength(      80);
        $cvar->setFieldWidth(       240);
        $cvar->setColumnWidth(      300);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tgl_sk_ekskul');
        $cvar->setColumnPhpName(    'TglSkEkskul');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tgl Sk Ekskul');
        $cvar->setLabel(            'Tgl sk ekskul');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jam_kegiatan_per_minggu');
        $cvar->setColumnPhpName(    'JamKegiatanPerMinggu');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jam Kegiatan Per Minggu');
        $cvar->setLabel(            'Jam kegiatan per minggu');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
