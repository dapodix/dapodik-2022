...
/**
 * Base class that represents a row from the 'ref.tingkat_penghargaan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseTingkatPenghargaan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\TingkatPenghargaanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TingkatPenghargaanPeer
     */
    ...
    /**
     * Initializes internal state of BaseTingkatPenghargaan object.
     * @see        applyDefaults()
     */
     ...
     * @return TingkatPenghargaan The current object (for fluent API support)
     */
    public function setTingkatPenghargaanId($v)
    {
        ...
        if ($this->tingkat_penghargaan_id !== $v) {
            ...
            $this->modifiedColumns[] = TingkatPenghargaanPeer::TINGKAT_PENGHARGAAN_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = TingkatPenghargaanPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatPenghargaanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatPenghargaanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TingkatPenghargaanPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = TingkatPenghargaanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tingkat_penghargaan_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = TingkatPenghargaanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TingkatPenghargaan object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TingkatPenghargaanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TingkatPenghargaanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TingkatPenghargaanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TingkatPenghargaanPeer::TINGKAT_PENGHARGAAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"tingkat_penghargaan_id"';
        }
        if ($this->isColumnModified(TingkatPenghargaanPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(TingkatPenghargaanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(TingkatPenghargaanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(TingkatPenghargaanPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(TingkatPenghargaanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."tingkat_penghargaan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TingkatPenghargaanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TingkatPenghargaanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TingkatPenghargaan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TingkatPenghargaan'][$this->getPrimaryKey()] = true;
        $keys = TingkatPenghargaanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getTingkatPenghargaanId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setTingkatPenghargaanId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TingkatPenghargaanPeer::TINGKAT_PENGHARGAAN_ID)) $criteria->add(TingkatPenghargaanPeer::TINGKAT_PENGHARGAAN_ID, $this->tingkat_penghargaan_id);
        if ($this->isColumnModified(TingkatPenghargaanPeer::NAMA)) $criteria->add(TingkatPenghargaanPeer::NAMA, $this->nama);
        if ($this->isColumnModified(TingkatPenghargaanPeer::CREATE_DATE)) $criteria->add(TingkatPenghargaanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(TingkatPenghargaanPeer::LAST_UPDATE)) $criteria->add(TingkatPenghargaanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(TingkatPenghargaanPeer::EXPIRED_DATE)) $criteria->add(TingkatPenghargaanPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(TingkatPenghargaanPeer::LAST_SYNC)) $criteria->add(TingkatPenghargaanPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(TingkatPenghargaanPeer::DATABASE_NAME);
        $criteria->add(TingkatPenghargaanPeer::TINGKAT_PENGHARGAAN_ID, $this->tingkat_penghargaan_id);
    ...
    /**
     * Generic method to set the primary key (tingkat_penghargaan_id column).
     *
    ...
    {
        $this->setTingkatPenghargaanId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getTingkatPenghargaanId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of TingkatPenghargaan (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setTingkatPenghargaanId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TingkatPenghargaan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TingkatPenghargaanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TingkatPenghargaanPeer();
        }
     ...
     * If this TingkatPenghargaan is new, it will return
        ...
        if (null === $this->collPenghargaans || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collPenghargaans) {
                ...
                $collPenghargaans = PenghargaanQuery::create(null, $criteria)
                    ->filterByTingkatPenghargaan($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPenghargaans(PropelCollection $penghargaans, PropelPDO $con = null)
    {
        ...
        foreach ($penghargaansToDelete as $penghargaanRemoved) {
            $penghargaanRemoved->setTingkatPenghargaan(null);
        }
    ...
    protected function doAddPenghargaan($penghargaan)
    {
        ...
        $penghargaan->setTingkatPenghargaan($this);
    }
    ...
    public function removePenghargaan($penghargaan)
    {
        if ($this->getPenghargaans()->contains($penghargaan)) {
            ...
            $penghargaan->setTingkatPenghargaan(null);
        }
     ...
     * Otherwise if this TingkatPenghargaan is new, it will return
     * an empty collection; or if this TingkatPenghargaan has previously
     * been saved, it will retrieve related Penghargaans from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TingkatPenghargaan.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Penghargaan[] List of Penghargaan objects
     */
    public function getPenghargaansJoinPtk($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PenghargaanQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TingkatPenghargaanPeer::DEFAULT_STRING_FORMAT);
    }
