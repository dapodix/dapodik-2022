...
/**
 * Base class that represents a row from the 'vld_jurusan_sp' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldJurusanSp extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldJurusanSpPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldJurusanSpPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldJurusanSp object.
     * @see        applyDefaults()
     */
     ...
     * @return VldJurusanSp The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldJurusanSpPeer::LOGID;
        }
    ...
    public function setJurusanSpId($v)
    {
        ...
        if ($this->jurusan_sp_id !== $v) {
            ...
            $this->modifiedColumns[] = VldJurusanSpPeer::JURUSAN_SP_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldJurusanSpPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldJurusanSpPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldJurusanSpPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldJurusanSpPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldJurusanSpPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldJurusanSpPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldJurusanSpPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldJurusanSpPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldJurusanSpPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldJurusanSpPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldJurusanSpPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldJurusanSpPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldJurusanSp object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldJurusanSpPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldJurusanSpQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldJurusanSpPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldJurusanSpPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::JURUSAN_SP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jurusan_sp_id"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldJurusanSpPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_jurusan_sp" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldJurusanSpPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldJurusanSpPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldJurusanSp'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldJurusanSp'][$this->getPrimaryKey()] = true;
        $keys = VldJurusanSpPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldJurusanSpPeer::LOGID)) $criteria->add(VldJurusanSpPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldJurusanSpPeer::JURUSAN_SP_ID)) $criteria->add(VldJurusanSpPeer::JURUSAN_SP_ID, $this->jurusan_sp_id);
        if ($this->isColumnModified(VldJurusanSpPeer::IDTYPE)) $criteria->add(VldJurusanSpPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldJurusanSpPeer::STATUS_VALIDASI)) $criteria->add(VldJurusanSpPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldJurusanSpPeer::FIELD_ERROR)) $criteria->add(VldJurusanSpPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldJurusanSpPeer::ERROR_MESSAGE)) $criteria->add(VldJurusanSpPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldJurusanSpPeer::KETERANGAN)) $criteria->add(VldJurusanSpPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldJurusanSpPeer::APP_USERNAME)) $criteria->add(VldJurusanSpPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldJurusanSpPeer::CREATE_DATE)) $criteria->add(VldJurusanSpPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldJurusanSpPeer::LAST_UPDATE)) $criteria->add(VldJurusanSpPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldJurusanSpPeer::SOFT_DELETE)) $criteria->add(VldJurusanSpPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldJurusanSpPeer::LAST_SYNC)) $criteria->add(VldJurusanSpPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldJurusanSpPeer::UPDATER_ID)) $criteria->add(VldJurusanSpPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldJurusanSpPeer::DATABASE_NAME);
        $criteria->add(VldJurusanSpPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldJurusanSp (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldJurusanSp Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldJurusanSpPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldJurusanSpPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldJurusanSps($this);
             */
        }
    ...
    public function getJurusanSp(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aJurusanSp === null && (($this->jurusan_sp_id !== "" && $this->jurusan_sp_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aJurusanSp->addVldJurusanSps($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldJurusanSpPeer::DEFAULT_STRING_FORMAT);
    }
