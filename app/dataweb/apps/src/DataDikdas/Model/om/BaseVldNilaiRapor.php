...
/**
 * Base class that represents a row from the 'vld_nilai_rapor' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldNilaiRapor extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldNilaiRaporPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldNilaiRaporPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldNilaiRapor object.
     * @see        applyDefaults()
     */
     ...
     * @return VldNilaiRapor The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::LOGID;
        }
    ...
    public function setNilaiId($v)
    {
        ...
        if ($this->nilai_id !== $v) {
            $this->nilai_id = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::NILAI_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldNilaiRaporPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldNilaiRaporPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldNilaiRaporPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldNilaiRaporPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldNilaiRaporPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldNilaiRaporPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nilai_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldNilaiRaporPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldNilaiRapor object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldNilaiRaporPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldNilaiRaporQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldNilaiRaporPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldNilaiRaporPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::NILAI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"nilai_id"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldNilaiRaporPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_nilai_rapor" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldNilaiRaporPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldNilaiRaporPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldNilaiRapor'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldNilaiRapor'][$this->getPrimaryKey()] = true;
        $keys = VldNilaiRaporPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getNilaiId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNilaiId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldNilaiRaporPeer::LOGID)) $criteria->add(VldNilaiRaporPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldNilaiRaporPeer::NILAI_ID)) $criteria->add(VldNilaiRaporPeer::NILAI_ID, $this->nilai_id);
        if ($this->isColumnModified(VldNilaiRaporPeer::IDTYPE)) $criteria->add(VldNilaiRaporPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldNilaiRaporPeer::STATUS_VALIDASI)) $criteria->add(VldNilaiRaporPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldNilaiRaporPeer::FIELD_ERROR)) $criteria->add(VldNilaiRaporPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldNilaiRaporPeer::ERROR_MESSAGE)) $criteria->add(VldNilaiRaporPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldNilaiRaporPeer::APP_USERNAME)) $criteria->add(VldNilaiRaporPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldNilaiRaporPeer::KETERANGAN)) $criteria->add(VldNilaiRaporPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldNilaiRaporPeer::CREATE_DATE)) $criteria->add(VldNilaiRaporPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldNilaiRaporPeer::LAST_UPDATE)) $criteria->add(VldNilaiRaporPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldNilaiRaporPeer::SOFT_DELETE)) $criteria->add(VldNilaiRaporPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldNilaiRaporPeer::LAST_SYNC)) $criteria->add(VldNilaiRaporPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldNilaiRaporPeer::UPDATER_ID)) $criteria->add(VldNilaiRaporPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldNilaiRaporPeer::DATABASE_NAME);
        $criteria->add(VldNilaiRaporPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldNilaiRapor (or compatible) type.
    ...
    {
        $copyObj->setNilaiId($this->getNilaiId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldNilaiRapor Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldNilaiRaporPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldNilaiRaporPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldNilaiRapors($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldNilaiRaporPeer::DEFAULT_STRING_FORMAT);
    }
