...
/*
 * The Base TableInfo for JenisBukuAlat Table
 */
class BaseJenisBukuAlatTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisBukuAlatTableMap';
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_buku_alat_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_buku_alat_id_str');
        $this->setHeader(           'Ref.jenis Buku Alat');
        $this->setLabel(            'Ref.jenis buku alat');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jenisbukualatcombo');
        $this->setXtypeRadio(       'ref.jenisbukualatradio');
        $this->setXtypeList(        'ref.jenisbukualatlist');
        ...
        $cvar->setColumnName(       'jenis_buku_alat_id');
        $cvar->setColumnPhpName(    'JenisBukuAlatId');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jenis_buku_alat');
        $cvar->setColumnPhpName(    'JenisBukuAlat');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Jenis Buku Alat');
        $cvar->setLabel(            'Jenis buku alat');
