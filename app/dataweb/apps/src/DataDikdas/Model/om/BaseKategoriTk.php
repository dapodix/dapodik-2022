...
/**
 * Base class that represents a row from the 'ref.kategori_tk' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseKategoriTk extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\KategoriTkPeer';
    ...
    /**
     * Initializes internal state of BaseKategoriTk object.
     * @see        applyDefaults()
     */
     ...
     * @return KategoriTk The current object (for fluent API support)
     */
    public function setKategoriTkId($v)
    {
        ...
        if ($this->kategori_tk_id !== $v) {
            ...
            $this->modifiedColumns[] = KategoriTkPeer::KATEGORI_TK_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = KategoriTkPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KategoriTkPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KategoriTkPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = KategoriTkPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = KategoriTkPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->kategori_tk_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = KategoriTkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating KategoriTk object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = KategoriTkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = KategoriTkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KategoriTkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(KategoriTkPeer::KATEGORI_TK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"kategori_tk_id"';
        }
        if ($this->isColumnModified(KategoriTkPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(KategoriTkPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(KategoriTkPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(KategoriTkPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(KategoriTkPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."kategori_tk" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = KategoriTkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = KategoriTkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['KategoriTk'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['KategoriTk'][$this->getPrimaryKey()] = true;
        $keys = KategoriTkPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getKategoriTkId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setKategoriTkId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KategoriTkPeer::KATEGORI_TK_ID)) $criteria->add(KategoriTkPeer::KATEGORI_TK_ID, $this->kategori_tk_id);
        if ($this->isColumnModified(KategoriTkPeer::NAMA)) $criteria->add(KategoriTkPeer::NAMA, $this->nama);
        if ($this->isColumnModified(KategoriTkPeer::CREATE_DATE)) $criteria->add(KategoriTkPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(KategoriTkPeer::LAST_UPDATE)) $criteria->add(KategoriTkPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(KategoriTkPeer::EXPIRED_DATE)) $criteria->add(KategoriTkPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(KategoriTkPeer::LAST_SYNC)) $criteria->add(KategoriTkPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(KategoriTkPeer::DATABASE_NAME);
        $criteria->add(KategoriTkPeer::KATEGORI_TK_ID, $this->kategori_tk_id);
    ...
    /**
     * Generic method to set the primary key (kategori_tk_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getKategoriTkId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of KategoriTk (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setKategoriTkId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return KategoriTk Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return KategoriTkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new KategoriTkPeer();
        }
     ...
     * If this KategoriTk is new, it will return
    ...
    public function setSekolahPauds(PropelCollection $sekolahPauds, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahPaudsToDelete as $sekolahPaudRemoved) {
            $sekolahPaudRemoved->setKategoriTk(null);
        }
    ...
    protected function doAddSekolahPaud($sekolahPaud)
    {
        ...
        $sekolahPaud->setKategoriTk($this);
    }
    ...
    public function removeSekolahPaud($sekolahPaud)
    {
        if ($this->getSekolahPauds()->contains($sekolahPaud)) {
            ...
            $sekolahPaud->setKategoriTk(null);
        }
     ...
     * Otherwise if this KategoriTk is new, it will return
     * an empty collection; or if this KategoriTk has previously
     * been saved, it will retrieve related SekolahPauds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in KategoriTk.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(KategoriTkPeer::DEFAULT_STRING_FORMAT);
    }
