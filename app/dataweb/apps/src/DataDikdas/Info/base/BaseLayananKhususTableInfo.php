...
/*
 * The Base TableInfo for LayananKhusus Table
 */
class BaseLayananKhususTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.LayananKhususTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_lk_str');
        $this->setHeader(           'Layanan Khusus');
        $this->setLabel(            'Layanan khusus');
        ...
        $cvar->setColumnName(       'id_lk');
        $cvar->setColumnPhpName(    'IdLk');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'JenisLk');
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Jenis Lk');
        $cvar->setLabel(            'jenis lk');
        $cvar->setInputLength(      6);
        $cvar->setFieldWidth(       18);
        $cvar->setColumnWidth(      140);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'jenislkcombo');
        $cvar->setComboXtype(       'jenislkcombo');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'sk_lk');
        $cvar->setColumnPhpName(    'SkLk');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tmt_lk');
        $cvar->setColumnPhpName(    'TmtLk');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tmt Lk');
        $cvar->setLabel(            'Tmt lk');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tst_lk');
        $cvar->setColumnPhpName(    'TstLk');
        $cvar->setType(             'date');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tst Lk');
        $cvar->setLabel(            'Tst lk');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_lk');
        $cvar->setColumnPhpName(    'KetLk');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Lk');
        $cvar->setLabel(            'Ket lk');
