...
class BatasWaktuRaporTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DataDikdas.Model.map.BatasWaktuRaporTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('DataDikdas\\Model\\BatasWaktuRapor');
        $this->setPackage('DataDikdas.Model');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('semester_id', 'SemesterId', 'CHAR' , 'ref.semester', 'semester_id', true, 5, null);
        $this->addColumn('tgl_rapor_mulai', 'TglRaporMulai', 'DATE', true, null, null);
        $this->addColumn('tgl_rapor_selesai', 'TglRaporSelesai', 'DATE', true, null, null);
        $this->addColumn('tgl_usm_mulai', 'TglUsmMulai', 'DATE', false, null, null);
        $this->addColumn('tgl_usm_selesai', 'TglUsmSelesai', 'DATE', false, null, null);
