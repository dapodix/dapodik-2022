...
/**
 * Base class that represents a row from the 'vld_kesejahteraan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldKesejahteraan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldKesejahteraanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldKesejahteraanPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldKesejahteraan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldKesejahteraan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldKesejahteraanPeer::LOGID;
        }
    ...
    public function setKesejahteraanId($v)
    {
        ...
        if ($this->kesejahteraan_id !== $v) {
            ...
            $this->modifiedColumns[] = VldKesejahteraanPeer::KESEJAHTERAAN_ID;
        }

        if ($this->aKesejahteraan !== null && $this->aKesejahteraan->getKesejahteraanId() !== $v) {
            $this->aKesejahteraan = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldKesejahteraanPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldKesejahteraanPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldKesejahteraanPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldKesejahteraanPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldKesejahteraanPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldKesejahteraanPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldKesejahteraanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldKesejahteraanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldKesejahteraanPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldKesejahteraanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldKesejahteraanPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->kesejahteraan_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldKesejahteraanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldKesejahteraan object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aKesejahteraan !== null && $this->kesejahteraan_id !== $this->aKesejahteraan->getKesejahteraanId()) {
            $this->aKesejahteraan = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldKesejahteraanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldKesejahteraanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldKesejahteraanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aKesejahteraan !== null) {
                if ($this->aKesejahteraan->isModified() || $this->aKesejahteraan->isNew()) {
                    $affectedRows += $this->aKesejahteraan->save($con);
                }
                $this->setKesejahteraan($this->aKesejahteraan);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldKesejahteraanPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::KESEJAHTERAAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"kesejahteraan_id"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldKesejahteraanPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_kesejahteraan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aKesejahteraan !== null) {
                if (!$this->aKesejahteraan->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aKesejahteraan->getValidationFailures());
                }
            }


            if (($retval = VldKesejahteraanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldKesejahteraanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldKesejahteraan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldKesejahteraan'][$this->getPrimaryKey()] = true;
        $keys = VldKesejahteraanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getKesejahteraanId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aKesejahteraan) {
                $result['Kesejahteraan'] = $this->aKesejahteraan->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setKesejahteraanId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldKesejahteraanPeer::LOGID)) $criteria->add(VldKesejahteraanPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldKesejahteraanPeer::KESEJAHTERAAN_ID)) $criteria->add(VldKesejahteraanPeer::KESEJAHTERAAN_ID, $this->kesejahteraan_id);
        if ($this->isColumnModified(VldKesejahteraanPeer::IDTYPE)) $criteria->add(VldKesejahteraanPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldKesejahteraanPeer::STATUS_VALIDASI)) $criteria->add(VldKesejahteraanPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldKesejahteraanPeer::FIELD_ERROR)) $criteria->add(VldKesejahteraanPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldKesejahteraanPeer::ERROR_MESSAGE)) $criteria->add(VldKesejahteraanPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldKesejahteraanPeer::KETERANGAN)) $criteria->add(VldKesejahteraanPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldKesejahteraanPeer::APP_USERNAME)) $criteria->add(VldKesejahteraanPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldKesejahteraanPeer::CREATE_DATE)) $criteria->add(VldKesejahteraanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldKesejahteraanPeer::LAST_UPDATE)) $criteria->add(VldKesejahteraanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldKesejahteraanPeer::SOFT_DELETE)) $criteria->add(VldKesejahteraanPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldKesejahteraanPeer::LAST_SYNC)) $criteria->add(VldKesejahteraanPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldKesejahteraanPeer::UPDATER_ID)) $criteria->add(VldKesejahteraanPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldKesejahteraanPeer::DATABASE_NAME);
        $criteria->add(VldKesejahteraanPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldKesejahteraan (or compatible) type.
    ...
    {
        $copyObj->setKesejahteraanId($this->getKesejahteraanId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldKesejahteraan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldKesejahteraanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldKesejahteraanPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldKesejahteraans($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Kesejahteraan object.
     *
     * @param             Kesejahteraan $v
     * @return VldKesejahteraan The current object (for fluent API support)
     * @throws PropelException
     */
    public function setKesejahteraan(Kesejahteraan $v = null)
    {
        if ($v === null) {
            $this->setKesejahteraanId(NULL);
        } else {
            $this->setKesejahteraanId($v->getKesejahteraanId());
        }

        $this->aKesejahteraan = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Kesejahteraan object, it will not be re-added.
        if ($v !== null) {
            $v->addVldKesejahteraan($this);
        }
    ...
    /**
     * Get the associated Kesejahteraan object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Kesejahteraan The associated Kesejahteraan object.
     * @throws PropelException
     */
    public function getKesejahteraan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aKesejahteraan === null && (($this->kesejahteraan_id !== "" && $this->kesejahteraan_id !== null)) && $doQuery) {
            $this->aKesejahteraan = KesejahteraanQuery::create()->findPk($this->kesejahteraan_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aKesejahteraan->addVldKesejahteraans($this);
             */
        }

        return $this->aKesejahteraan;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aKesejahteraan instanceof Persistent) {
              $this->aKesejahteraan->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldKesejahteraanPeer::DEFAULT_STRING_FORMAT);
    }
