...
/**
 * Base class that represents a row from the 'vld_buku_ptk' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldBukuPtk extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldBukuPtkPeer';
    ...
    /**
     * Initializes internal state of BaseVldBukuPtk object.
     * @see        applyDefaults()
     */
     ...
     * @return VldBukuPtk The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::LOGID;
        }
    ...
    public function setBukuId($v)
    {
        ...
        if ($this->buku_id !== $v) {
            $this->buku_id = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::BUKU_ID;
        }

        if ($this->aBukuPtk !== null && $this->aBukuPtk->getBukuId() !== $v) {
            $this->aBukuPtk = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldBukuPtkPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldBukuPtkPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBukuPtkPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBukuPtkPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldBukuPtkPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldBukuPtkPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->buku_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldBukuPtkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldBukuPtk object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBukuPtk !== null && $this->buku_id !== $this->aBukuPtk->getBukuId()) {
            $this->aBukuPtk = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldBukuPtkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldBukuPtkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldBukuPtkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBukuPtk !== null) {
                if ($this->aBukuPtk->isModified() || $this->aBukuPtk->isNew()) {
                    $affectedRows += $this->aBukuPtk->save($con);
                }
                $this->setBukuPtk($this->aBukuPtk);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldBukuPtkPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::BUKU_ID)) {
            $modifiedColumns[':p' . $index++]  = '"buku_id"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldBukuPtkPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_buku_ptk" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBukuPtk !== null) {
                if (!$this->aBukuPtk->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBukuPtk->getValidationFailures());
                }
            }


            if (($retval = VldBukuPtkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldBukuPtkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldBukuPtk'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldBukuPtk'][$this->getPrimaryKey()] = true;
        $keys = VldBukuPtkPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getBukuId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aBukuPtk) {
                $result['BukuPtk'] = $this->aBukuPtk->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBukuId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldBukuPtkPeer::LOGID)) $criteria->add(VldBukuPtkPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldBukuPtkPeer::BUKU_ID)) $criteria->add(VldBukuPtkPeer::BUKU_ID, $this->buku_id);
        if ($this->isColumnModified(VldBukuPtkPeer::IDTYPE)) $criteria->add(VldBukuPtkPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldBukuPtkPeer::STATUS_VALIDASI)) $criteria->add(VldBukuPtkPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldBukuPtkPeer::FIELD_ERROR)) $criteria->add(VldBukuPtkPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldBukuPtkPeer::ERROR_MESSAGE)) $criteria->add(VldBukuPtkPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldBukuPtkPeer::KETERANGAN)) $criteria->add(VldBukuPtkPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldBukuPtkPeer::APP_USERNAME)) $criteria->add(VldBukuPtkPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldBukuPtkPeer::CREATE_DATE)) $criteria->add(VldBukuPtkPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldBukuPtkPeer::LAST_UPDATE)) $criteria->add(VldBukuPtkPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldBukuPtkPeer::SOFT_DELETE)) $criteria->add(VldBukuPtkPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldBukuPtkPeer::LAST_SYNC)) $criteria->add(VldBukuPtkPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldBukuPtkPeer::UPDATER_ID)) $criteria->add(VldBukuPtkPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldBukuPtkPeer::DATABASE_NAME);
        $criteria->add(VldBukuPtkPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldBukuPtk (or compatible) type.
    ...
    {
        $copyObj->setBukuId($this->getBukuId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldBukuPtk Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldBukuPtkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldBukuPtkPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldBukuPtks($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a BukuPtk object.
     *
     * @param             BukuPtk $v
     * @return VldBukuPtk The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBukuPtk(BukuPtk $v = null)
    {
        if ($v === null) {
            $this->setBukuId(NULL);
        } else {
            $this->setBukuId($v->getBukuId());
        }

        $this->aBukuPtk = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the BukuPtk object, it will not be re-added.
        if ($v !== null) {
            $v->addVldBukuPtk($this);
        }
    ...
    /**
     * Get the associated BukuPtk object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return BukuPtk The associated BukuPtk object.
     * @throws PropelException
     */
    public function getBukuPtk(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBukuPtk === null && (($this->buku_id !== "" && $this->buku_id !== null)) && $doQuery) {
            $this->aBukuPtk = BukuPtkQuery::create()->findPk($this->buku_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBukuPtk->addVldBukuPtks($this);
             */
        }

        return $this->aBukuPtk;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aBukuPtk instanceof Persistent) {
              $this->aBukuPtk->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldBukuPtkPeer::DEFAULT_STRING_FORMAT);
    }
