...
/*
 * The Base TableInfo for WsAplikasi Table
 */
class BaseWsAplikasiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.WsAplikasiTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'aplikasi_id_str');
        $this->setHeader(           'Ws Aplikasi');
        $this->setLabel(            'Ws aplikasi');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "WsRoleTable"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "WsRoleTable.aplikasi_id"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'token');
        $cvar->setColumnPhpName(    'Token');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ip_address');
        $cvar->setColumnPhpName(    'IpAddress');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ip Address');
        $cvar->setLabel(            'Ip address');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'port');
        $cvar->setColumnPhpName(    'Port');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'mac_address');
        $cvar->setColumnPhpName(    'MacAddress');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Mac Address');
        $cvar->setLabel(            'Mac address');
        $cvar->setInputLength(      20);
        $cvar->setFieldWidth(       60);
        $cvar->setColumnWidth(      120);
        $cvar->setHideColumn(       0);
