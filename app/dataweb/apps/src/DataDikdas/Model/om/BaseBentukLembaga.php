...
/**
 * Base class that represents a row from the 'ref.bentuk_lembaga' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseBentukLembaga extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\BentukLembagaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BentukLembagaPeer
     */
    ...
    /**
     * Initializes internal state of BaseBentukLembaga object.
     * @see        applyDefaults()
     */
     ...
     * @return BentukLembaga The current object (for fluent API support)
     */
    public function setBentukLembagaId($v)
    {
        ...
        if ($this->bentuk_lembaga_id !== $v) {
            ...
            $this->modifiedColumns[] = BentukLembagaPeer::BENTUK_LEMBAGA_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = BentukLembagaPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BentukLembagaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = BentukLembagaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BentukLembagaPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = BentukLembagaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bentuk_lembaga_id = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = BentukLembagaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BentukLembaga object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BentukLembagaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BentukLembagaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BentukLembagaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BentukLembagaPeer::BENTUK_LEMBAGA_ID)) {
            $modifiedColumns[':p' . $index++]  = '"bentuk_lembaga_id"';
        }
        if ($this->isColumnModified(BentukLembagaPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(BentukLembagaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(BentukLembagaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(BentukLembagaPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(BentukLembagaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."bentuk_lembaga" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BentukLembagaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BentukLembagaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BentukLembaga'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BentukLembaga'][$this->getPrimaryKey()] = true;
        $keys = BentukLembagaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBentukLembagaId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setBentukLembagaId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BentukLembagaPeer::BENTUK_LEMBAGA_ID)) $criteria->add(BentukLembagaPeer::BENTUK_LEMBAGA_ID, $this->bentuk_lembaga_id);
        if ($this->isColumnModified(BentukLembagaPeer::NAMA)) $criteria->add(BentukLembagaPeer::NAMA, $this->nama);
        if ($this->isColumnModified(BentukLembagaPeer::CREATE_DATE)) $criteria->add(BentukLembagaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(BentukLembagaPeer::LAST_UPDATE)) $criteria->add(BentukLembagaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(BentukLembagaPeer::EXPIRED_DATE)) $criteria->add(BentukLembagaPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(BentukLembagaPeer::LAST_SYNC)) $criteria->add(BentukLembagaPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(BentukLembagaPeer::DATABASE_NAME);
        $criteria->add(BentukLembagaPeer::BENTUK_LEMBAGA_ID, $this->bentuk_lembaga_id);
    ...
    /**
     * Generic method to set the primary key (bentuk_lembaga_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getBentukLembagaId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BentukLembaga (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setBentukLembagaId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BentukLembaga Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BentukLembagaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BentukLembagaPeer();
        }
     ...
     * If this BentukLembaga is new, it will return
    ...
    public function setSekolahPauds(PropelCollection $sekolahPauds, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahPaudsToDelete as $sekolahPaudRemoved) {
            $sekolahPaudRemoved->setBentukLembaga(null);
        }
    ...
    protected function doAddSekolahPaud($sekolahPaud)
    {
        ...
        $sekolahPaud->setBentukLembaga($this);
    }
    ...
    public function removeSekolahPaud($sekolahPaud)
    {
        if ($this->getSekolahPauds()->contains($sekolahPaud)) {
            ...
            $sekolahPaud->setBentukLembaga(null);
        }
     ...
     * Otherwise if this BentukLembaga is new, it will return
     * an empty collection; or if this BentukLembaga has previously
     * been saved, it will retrieve related SekolahPauds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in BentukLembaga.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(BentukLembagaPeer::DEFAULT_STRING_FORMAT);
    }
