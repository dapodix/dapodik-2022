...
/**
 * Base class that represents a row from the 'vld_mou' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldMou extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldMouPeer';
    ...
    /**
     * Initializes internal state of BaseVldMou object.
     * @see        applyDefaults()
     */
     ...
     * @return VldMou The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldMouPeer::LOGID;
        }
    ...
    public function setMouId($v)
    {
        ...
        if ($this->mou_id !== $v) {
            $this->mou_id = $v;
            $this->modifiedColumns[] = VldMouPeer::MOU_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldMouPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldMouPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldMouPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldMouPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldMouPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldMouPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldMouPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldMouPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldMouPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldMouPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldMouPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldMouPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldMou object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldMouPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldMouQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldMouPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldMouPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldMouPeer::MOU_ID)) {
            $modifiedColumns[':p' . $index++]  = '"mou_id"';
        }
        if ($this->isColumnModified(VldMouPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldMouPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldMouPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldMouPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldMouPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldMouPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldMouPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldMouPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldMouPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldMouPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldMouPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_mou" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldMouPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldMouPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldMou'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldMou'][$this->getPrimaryKey()] = true;
        $keys = VldMouPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldMouPeer::LOGID)) $criteria->add(VldMouPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldMouPeer::MOU_ID)) $criteria->add(VldMouPeer::MOU_ID, $this->mou_id);
        if ($this->isColumnModified(VldMouPeer::IDTYPE)) $criteria->add(VldMouPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldMouPeer::STATUS_VALIDASI)) $criteria->add(VldMouPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldMouPeer::FIELD_ERROR)) $criteria->add(VldMouPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldMouPeer::ERROR_MESSAGE)) $criteria->add(VldMouPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldMouPeer::KETERANGAN)) $criteria->add(VldMouPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldMouPeer::APP_USERNAME)) $criteria->add(VldMouPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldMouPeer::CREATE_DATE)) $criteria->add(VldMouPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldMouPeer::LAST_UPDATE)) $criteria->add(VldMouPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldMouPeer::SOFT_DELETE)) $criteria->add(VldMouPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldMouPeer::LAST_SYNC)) $criteria->add(VldMouPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldMouPeer::UPDATER_ID)) $criteria->add(VldMouPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldMouPeer::DATABASE_NAME);
        $criteria->add(VldMouPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldMou (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldMou Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldMous($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldMouPeer::DEFAULT_STRING_FORMAT);
    }
