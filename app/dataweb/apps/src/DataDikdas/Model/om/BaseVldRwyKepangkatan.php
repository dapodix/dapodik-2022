...
/**
 * Base class that represents a row from the 'vld_rwy_kepangkatan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldRwyKepangkatan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldRwyKepangkatanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldRwyKepangkatanPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldRwyKepangkatan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldRwyKepangkatan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::LOGID;
        }
    ...
    public function setRiwayatKepangkatanId($v)
    {
        ...
        if ($this->riwayat_kepangkatan_id !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::RIWAYAT_KEPANGKATAN_ID;
        }

        if ($this->aRwyKepangkatan !== null && $this->aRwyKepangkatan->getRiwayatKepangkatanId() !== $v) {
            $this->aRwyKepangkatan = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyKepangkatanPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldRwyKepangkatanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldRwyKepangkatanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldRwyKepangkatanPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->riwayat_kepangkatan_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldRwyKepangkatanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldRwyKepangkatan object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aRwyKepangkatan !== null && $this->riwayat_kepangkatan_id !== $this->aRwyKepangkatan->getRiwayatKepangkatanId()) {
            $this->aRwyKepangkatan = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldRwyKepangkatanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldRwyKepangkatanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldRwyKepangkatanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aRwyKepangkatan !== null) {
                if ($this->aRwyKepangkatan->isModified() || $this->aRwyKepangkatan->isNew()) {
                    $affectedRows += $this->aRwyKepangkatan->save($con);
                }
                $this->setRwyKepangkatan($this->aRwyKepangkatan);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldRwyKepangkatanPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::RIWAYAT_KEPANGKATAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"riwayat_kepangkatan_id"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldRwyKepangkatanPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_rwy_kepangkatan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aRwyKepangkatan !== null) {
                if (!$this->aRwyKepangkatan->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aRwyKepangkatan->getValidationFailures());
                }
            }
            ...
            if (($retval = VldRwyKepangkatanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldRwyKepangkatanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldRwyKepangkatan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldRwyKepangkatan'][$this->getPrimaryKey()] = true;
        $keys = VldRwyKepangkatanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getRiwayatKepangkatanId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aRwyKepangkatan) {
                $result['RwyKepangkatan'] = $this->aRwyKepangkatan->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setRiwayatKepangkatanId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldRwyKepangkatanPeer::LOGID)) $criteria->add(VldRwyKepangkatanPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::RIWAYAT_KEPANGKATAN_ID)) $criteria->add(VldRwyKepangkatanPeer::RIWAYAT_KEPANGKATAN_ID, $this->riwayat_kepangkatan_id);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::IDTYPE)) $criteria->add(VldRwyKepangkatanPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::STATUS_VALIDASI)) $criteria->add(VldRwyKepangkatanPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::FIELD_ERROR)) $criteria->add(VldRwyKepangkatanPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::ERROR_MESSAGE)) $criteria->add(VldRwyKepangkatanPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::KETERANGAN)) $criteria->add(VldRwyKepangkatanPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::APP_USERNAME)) $criteria->add(VldRwyKepangkatanPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::CREATE_DATE)) $criteria->add(VldRwyKepangkatanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::LAST_UPDATE)) $criteria->add(VldRwyKepangkatanPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::SOFT_DELETE)) $criteria->add(VldRwyKepangkatanPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::LAST_SYNC)) $criteria->add(VldRwyKepangkatanPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldRwyKepangkatanPeer::UPDATER_ID)) $criteria->add(VldRwyKepangkatanPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldRwyKepangkatanPeer::DATABASE_NAME);
        $criteria->add(VldRwyKepangkatanPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldRwyKepangkatan (or compatible) type.
    ...
    {
        $copyObj->setRiwayatKepangkatanId($this->getRiwayatKepangkatanId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldRwyKepangkatan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldRwyKepangkatanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldRwyKepangkatanPeer();
        }
    ...
    /**
     * Declares an association between this object and a RwyKepangkatan object.
     *
     * @param             RwyKepangkatan $v
     * @return VldRwyKepangkatan The current object (for fluent API support)
     * @throws PropelException
     */
    public function setRwyKepangkatan(RwyKepangkatan $v = null)
    {
        if ($v === null) {
            $this->setRiwayatKepangkatanId(NULL);
        } else {
            $this->setRiwayatKepangkatanId($v->getRiwayatKepangkatanId());
        }

        $this->aRwyKepangkatan = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the RwyKepangkatan object, it will not be re-added.
        if ($v !== null) {
            $v->addVldRwyKepangkatan($this);
        }
    ...
    /**
     * Get the associated RwyKepangkatan object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return RwyKepangkatan The associated RwyKepangkatan object.
     * @throws PropelException
     */
    public function getRwyKepangkatan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRwyKepangkatan === null && (($this->riwayat_kepangkatan_id !== "" && $this->riwayat_kepangkatan_id !== null)) && $doQuery) {
            $this->aRwyKepangkatan = RwyKepangkatanQuery::create()->findPk($this->riwayat_kepangkatan_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRwyKepangkatan->addVldRwyKepangkatans($this);
             */
        }

        return $this->aRwyKepangkatan;
    }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aErrortype->addVldRwyKepangkatans($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aRwyKepangkatan instanceof Persistent) {
              $this->aRwyKepangkatan->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldRwyKepangkatanPeer::DEFAULT_STRING_FORMAT);
    }
