...
/*
 * The Base TableInfo for BukuPtk Table
 */
class BaseBukuPtkTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.BukuPtkTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'buku_id_str');
        $this->setHeader(           'Buku Ptk');
        $this->setLabel(            'Buku ptk');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'judul_buku');
        $cvar->setColumnPhpName(    'JudulBuku');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Judul Buku');
        $cvar->setLabel(            'Judul buku');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'penerbit');
        $cvar->setColumnPhpName(    'Penerbit');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Penerbit');
        $cvar->setLabel(            'Penerbit');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'isbn');
        $cvar->setColumnPhpName(    'Isbn');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
