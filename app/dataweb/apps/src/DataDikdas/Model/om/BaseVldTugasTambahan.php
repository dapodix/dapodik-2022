...
/**
 * Base class that represents a row from the 'vld_tugas_tambahan' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldTugasTambahan extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldTugasTambahanPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldTugasTambahanPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldTugasTambahan object.
     * @see        applyDefaults()
     */
     ...
     * @return VldTugasTambahan The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldTugasTambahanPeer::LOGID;
        }
    ...
    public function setPtkTugasTambahanId($v)
    {
        ...
        if ($this->ptk_tugas_tambahan_id !== $v) {
            ...
            $this->modifiedColumns[] = VldTugasTambahanPeer::PTK_TUGAS_TAMBAHAN_ID;
        }

        if ($this->aTugasTambahan !== null && $this->aTugasTambahan->getPtkTugasTambahanId() !== $v) {
            $this->aTugasTambahan = null;
        }
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldTugasTambahanPeer::UPDATER_ID;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldTugasTambahanPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldTugasTambahanPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldTugasTambahanPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldTugasTambahanPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldTugasTambahanPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldTugasTambahanPeer::CREATE_DATE;
            }
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldTugasTambahanPeer::SOFT_DELETE;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldTugasTambahanPeer::IDTYPE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldTugasTambahanPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldTugasTambahanPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->ptk_tugas_tambahan_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->updater_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            $this->idtype = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
            ...
            return $startcol + 13; // 13 = VldTugasTambahanPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldTugasTambahan object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTugasTambahan !== null && $this->ptk_tugas_tambahan_id !== $this->aTugasTambahan->getPtkTugasTambahanId()) {
            $this->aTugasTambahan = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldTugasTambahanPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldTugasTambahanQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldTugasTambahanPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTugasTambahan !== null) {
                if ($this->aTugasTambahan->isModified() || $this->aTugasTambahan->isNew()) {
                    $affectedRows += $this->aTugasTambahan->save($con);
                }
                $this->setTugasTambahan($this->aTugasTambahan);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldTugasTambahanPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::PTK_TUGAS_TAMBAHAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"ptk_tugas_tambahan_id"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldTugasTambahanPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_tugas_tambahan" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aTugasTambahan !== null) {
                if (!$this->aTugasTambahan->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aTugasTambahan->getValidationFailures());
                }
            }


            if (($retval = VldTugasTambahanPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldTugasTambahanPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldTugasTambahan'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldTugasTambahan'][$this->getPrimaryKey()] = true;
        $keys = VldTugasTambahanPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getPtkTugasTambahanId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aTugasTambahan) {
                $result['TugasTambahan'] = $this->aTugasTambahan->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setPtkTugasTambahanId($arr[$keys[1]]);
        ...
        if (array_key_exists($keys[10], $arr)) $this->setIdtype($arr[$keys[10]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldTugasTambahanPeer::LOGID)) $criteria->add(VldTugasTambahanPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldTugasTambahanPeer::PTK_TUGAS_TAMBAHAN_ID)) $criteria->add(VldTugasTambahanPeer::PTK_TUGAS_TAMBAHAN_ID, $this->ptk_tugas_tambahan_id);
        if ($this->isColumnModified(VldTugasTambahanPeer::UPDATER_ID)) $criteria->add(VldTugasTambahanPeer::UPDATER_ID, $this->updater_id);
        if ($this->isColumnModified(VldTugasTambahanPeer::STATUS_VALIDASI)) $criteria->add(VldTugasTambahanPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldTugasTambahanPeer::FIELD_ERROR)) $criteria->add(VldTugasTambahanPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldTugasTambahanPeer::ERROR_MESSAGE)) $criteria->add(VldTugasTambahanPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldTugasTambahanPeer::KETERANGAN)) $criteria->add(VldTugasTambahanPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldTugasTambahanPeer::APP_USERNAME)) $criteria->add(VldTugasTambahanPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldTugasTambahanPeer::CREATE_DATE)) $criteria->add(VldTugasTambahanPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldTugasTambahanPeer::SOFT_DELETE)) $criteria->add(VldTugasTambahanPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldTugasTambahanPeer::IDTYPE)) $criteria->add(VldTugasTambahanPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldTugasTambahanPeer::LAST_SYNC)) $criteria->add(VldTugasTambahanPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldTugasTambahanPeer::LAST_UPDATE)) $criteria->add(VldTugasTambahanPeer::LAST_UPDATE, $this->last_update);
    ...
    {
        $criteria = new Criteria(VldTugasTambahanPeer::DATABASE_NAME);
        $criteria->add(VldTugasTambahanPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldTugasTambahan (or compatible) type.
    ...
    {
        $copyObj->setPtkTugasTambahanId($this->getPtkTugasTambahanId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldTugasTambahan Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldTugasTambahanPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldTugasTambahanPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldTugasTambahans($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a TugasTambahan object.
     *
     * @param             TugasTambahan $v
     * @return VldTugasTambahan The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTugasTambahan(TugasTambahan $v = null)
    {
        if ($v === null) {
            $this->setPtkTugasTambahanId(NULL);
        } else {
            $this->setPtkTugasTambahanId($v->getPtkTugasTambahanId());
        }

        $this->aTugasTambahan = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the TugasTambahan object, it will not be re-added.
        if ($v !== null) {
            $v->addVldTugasTambahan($this);
        }
    ...
    /**
     * Get the associated TugasTambahan object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return TugasTambahan The associated TugasTambahan object.
     * @throws PropelException
     */
    public function getTugasTambahan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTugasTambahan === null && (($this->ptk_tugas_tambahan_id !== "" && $this->ptk_tugas_tambahan_id !== null)) && $doQuery) {
            $this->aTugasTambahan = TugasTambahanQuery::create()->findPk($this->ptk_tugas_tambahan_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTugasTambahan->addVldTugasTambahans($this);
             */
        }

        return $this->aTugasTambahan;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aTugasTambahan instanceof Persistent) {
              $this->aTugasTambahan->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldTugasTambahanPeer::DEFAULT_STRING_FORMAT);
    }
