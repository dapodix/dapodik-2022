...
/*
 * The Base TableInfo for BimbingPd Table
 */
class BaseBimbingPdTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.BimbingPdTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_bimb_pd_str');
        $this->setHeader(           'Bimbing Pd');
        $this->setLabel(            'Bimbing pd');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setBelongsTo(array(  "AktPd","Ptk"));
        ...
        $cvar->setColumnName(       'id_bimb_pd');
        $cvar->setColumnPhpName(    'IdBimbPd');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'urutan_pembimbing');
        $cvar->setColumnPhpName(    'UrutanPembimbing');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Urutan Pembimbing');
        $cvar->setLabel(            'Urutan pembimbing');
