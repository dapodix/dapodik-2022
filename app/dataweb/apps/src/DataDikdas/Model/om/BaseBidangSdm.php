...
/**
 * Base class that represents a row from the 'bidang_sdm' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseBidangSdm extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\BidangSdmPeer';
    ...
    /**
     * The value for the urutan field.
     * @var        string
     */
    protected $urutan;
    ...
    /**
     * Initializes internal state of BaseBidangSdm object.
     * @see        applyDefaults()
     */
     ...
     * @return BidangSdm The current object (for fluent API support)
     */
    public function setPtkId($v)
    {
        ...
        if ($this->ptk_id !== $v) {
            $this->ptk_id = $v;
            $this->modifiedColumns[] = BidangSdmPeer::PTK_ID;
        }
    ...
    public function setBidangStudiId($v)
    {
        ...
        if ($this->bidang_studi_id !== $v) {
            ...
            $this->modifiedColumns[] = BidangSdmPeer::BIDANG_STUDI_ID;
        }
    ...
    /**
     * Set the value of [urutan] column.
     * 
     * @param string $v new value
     * @return BidangSdm The current object (for fluent API support)
     */
    public function setUrutan($v)
    {
        ...
        if ($this->urutan !== $v) {
            $this->urutan = $v;
            $this->modifiedColumns[] = BidangSdmPeer::URUTAN;
        }
    ...
    public function setAsalData($v)
    {
        ...
        if ($this->asal_data !== $v) {
            $this->asal_data = $v;
            $this->modifiedColumns[] = BidangSdmPeer::ASAL_DATA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BidangSdmPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BidangSdmPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = BidangSdmPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = BidangSdmPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = BidangSdmPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->urutan = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 9; // 9 = BidangSdmPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating BidangSdm object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BidangSdmPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BidangSdmQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BidangSdmPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BidangSdmPeer::PTK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"ptk_id"';
        }
        if ($this->isColumnModified(BidangSdmPeer::BIDANG_STUDI_ID)) {
            $modifiedColumns[':p' . $index++]  = '"bidang_studi_id"';
        }
        if ($this->isColumnModified(BidangSdmPeer::URUTAN)) {
            $modifiedColumns[':p' . $index++]  = '"urutan"';
        }
        if ($this->isColumnModified(BidangSdmPeer::ASAL_DATA)) {
            $modifiedColumns[':p' . $index++]  = '"asal_data"';
        }
        if ($this->isColumnModified(BidangSdmPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(BidangSdmPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(BidangSdmPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(BidangSdmPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(BidangSdmPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "bidang_sdm" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"bidang_studi_id"':						
                        ...
                        break;
                    case '"urutan"':						
                        $stmt->bindValue($identifier, $this->urutan, PDO::PARAM_STR);
                        break;
                    case '"asal_data"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BidangSdmPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BidangSdmPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BidangSdm'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BidangSdm'][serialize($this->getPrimaryKey())] = true;
        $keys = BidangSdmPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPtkId(),
            $keys[1] => $this->getBidangStudiId(),
            $keys[2] => $this->getUrutan(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setUrutan($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BidangSdmPeer::PTK_ID)) $criteria->add(BidangSdmPeer::PTK_ID, $this->ptk_id);
        if ($this->isColumnModified(BidangSdmPeer::BIDANG_STUDI_ID)) $criteria->add(BidangSdmPeer::BIDANG_STUDI_ID, $this->bidang_studi_id);
        if ($this->isColumnModified(BidangSdmPeer::URUTAN)) $criteria->add(BidangSdmPeer::URUTAN, $this->urutan);
        if ($this->isColumnModified(BidangSdmPeer::ASAL_DATA)) $criteria->add(BidangSdmPeer::ASAL_DATA, $this->asal_data);
        if ($this->isColumnModified(BidangSdmPeer::CREATE_DATE)) $criteria->add(BidangSdmPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(BidangSdmPeer::LAST_UPDATE)) $criteria->add(BidangSdmPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(BidangSdmPeer::SOFT_DELETE)) $criteria->add(BidangSdmPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(BidangSdmPeer::LAST_SYNC)) $criteria->add(BidangSdmPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(BidangSdmPeer::UPDATER_ID)) $criteria->add(BidangSdmPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(BidangSdmPeer::DATABASE_NAME);
        $criteria->add(BidangSdmPeer::PTK_ID, $this->ptk_id);
        $criteria->add(BidangSdmPeer::BIDANG_STUDI_ID, $this->bidang_studi_id);
        $criteria->add(BidangSdmPeer::URUTAN, $this->urutan);
    ...
    {
        $this->setPtkId($keys[0]);
        $this->setBidangStudiId($keys[1]);
        $this->setUrutan($keys[2]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getPtkId()) && (null === $this->getBidangStudiId()) && (null === $this->getUrutan());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BidangSdm (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setUrutan($this->getUrutan());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BidangSdm Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BidangSdmPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BidangSdmPeer();
        }
    ...
    public function getBidangStudi(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBidangStudi === null && ($this->bidang_studi_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBidangStudi->addBidangSdms($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BidangSdmPeer::DEFAULT_STRING_FORMAT);
    }
