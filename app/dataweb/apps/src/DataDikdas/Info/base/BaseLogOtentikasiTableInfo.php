...
/*
 * The Base TableInfo for LogOtentikasi Table
 */
class BaseLogOtentikasiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.LogOtentikasiTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'token_sesi_str');
        $this->setHeader(           'Man Akses.log Otentikasi');
        $this->setLabel(            'Man akses.log otentikasi');
        ...
        $cvar->setColumnName(       'token_sesi');
        $cvar->setColumnPhpName(    'TokenSesi');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'last_activity');
        $cvar->setColumnPhpName(    'LastActivity');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Last Activity');
        $cvar->setLabel(            'Last activity');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'log_off');
        $cvar->setColumnPhpName(    'LogOff');
        $cvar->setType(             'timestamp');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Log Off');
        $cvar->setLabel(            'Log off');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      100);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_time_out');
        $cvar->setColumnPhpName(    'ATimeOut');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Atime Out');
        $cvar->setLabel(            'Atime out');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'alamat_ip');
        $cvar->setColumnPhpName(    'AlamatIp');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Alamat Ip');
        $cvar->setLabel(            'Alamat ip');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_sesi_aktif');
        $cvar->setColumnPhpName(    'ASesiAktif');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Asesi Aktif');
        $cvar->setLabel(            'Asesi aktif');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
