...
/**
 * This class defines the structure of the 'vld_penghargaan' table.
 *
 *
 *
 ...
 */
class VldPenghargaanTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldPenghargaanTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('penghargaan_id', 'PenghargaanId', 'VARCHAR', 'penghargaan', 'penghargaan_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Penghargaan', 'DataDikdas\\Model\\Penghargaan', RelationMap::MANY_TO_ONE, array('penghargaan_id' => 'penghargaan_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()

} // VldPenghargaanTableMap
