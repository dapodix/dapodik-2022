...
/*
 * The Base TableInfo for Aplikasi Table
 */
class BaseAplikasiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.AplikasiTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_aplikasi_str');
        $this->setHeader(           'Man Akses.aplikasi');
        $this->setLabel(            'Man akses.aplikasi');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "Menu"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "Menu.id_aplikasi"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_aplikasi');
        $cvar->setColumnPhpName(    'NmAplikasi');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Nm Aplikasi');
        $cvar->setLabel(            'Nm aplikasi');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ket_aplikasi');
        $cvar->setColumnPhpName(    'KetAplikasi');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ket Aplikasi');
        $cvar->setLabel(            'Ket aplikasi');
