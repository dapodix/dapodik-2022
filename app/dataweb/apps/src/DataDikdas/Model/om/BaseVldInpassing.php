...
/**
 * Base class that represents a row from the 'vld_inpassing' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldInpassing extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldInpassingPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        VldInpassingPeer
     */
    ...
    /**
     * Initializes internal state of BaseVldInpassing object.
     * @see        applyDefaults()
     */
     ...
     * @return VldInpassing The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldInpassingPeer::LOGID;
        }
    ...
    public function setInpassingId($v)
    {
        ...
        if ($this->inpassing_id !== $v) {
            $this->inpassing_id = $v;
            $this->modifiedColumns[] = VldInpassingPeer::INPASSING_ID;
        }

        if ($this->aInpassing !== null && $this->aInpassing->getInpassingId() !== $v) {
            $this->aInpassing = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldInpassingPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldInpassingPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldInpassingPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldInpassingPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldInpassingPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldInpassingPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldInpassingPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldInpassingPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldInpassingPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldInpassingPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldInpassingPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->inpassing_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldInpassingPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldInpassing object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aInpassing !== null && $this->inpassing_id !== $this->aInpassing->getInpassingId()) {
            $this->aInpassing = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldInpassingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldInpassingQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldInpassingPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aInpassing !== null) {
                if ($this->aInpassing->isModified() || $this->aInpassing->isNew()) {
                    $affectedRows += $this->aInpassing->save($con);
                }
                $this->setInpassing($this->aInpassing);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldInpassingPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldInpassingPeer::INPASSING_ID)) {
            $modifiedColumns[':p' . $index++]  = '"inpassing_id"';
        }
        if ($this->isColumnModified(VldInpassingPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldInpassingPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldInpassingPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldInpassingPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldInpassingPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldInpassingPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldInpassingPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldInpassingPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldInpassingPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldInpassingPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldInpassingPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_inpassing" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"logid"':						
                        ...
                        break;
                    case '"inpassing_id"':						
                        $stmt->bindValue($identifier, $this->inpassing_id, PDO::PARAM_STR);
                        break;
                    case '"idtype"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aInpassing !== null) {
                if (!$this->aInpassing->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aInpassing->getValidationFailures());
                }
            }


            if (($retval = VldInpassingPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldInpassingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldInpassing'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldInpassing'][$this->getPrimaryKey()] = true;
        $keys = VldInpassingPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getInpassingId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aInpassing) {
                $result['Inpassing'] = $this->aInpassing->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setInpassingId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldInpassingPeer::LOGID)) $criteria->add(VldInpassingPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldInpassingPeer::INPASSING_ID)) $criteria->add(VldInpassingPeer::INPASSING_ID, $this->inpassing_id);
        if ($this->isColumnModified(VldInpassingPeer::IDTYPE)) $criteria->add(VldInpassingPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldInpassingPeer::STATUS_VALIDASI)) $criteria->add(VldInpassingPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldInpassingPeer::FIELD_ERROR)) $criteria->add(VldInpassingPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldInpassingPeer::ERROR_MESSAGE)) $criteria->add(VldInpassingPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldInpassingPeer::KETERANGAN)) $criteria->add(VldInpassingPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldInpassingPeer::APP_USERNAME)) $criteria->add(VldInpassingPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldInpassingPeer::CREATE_DATE)) $criteria->add(VldInpassingPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldInpassingPeer::LAST_UPDATE)) $criteria->add(VldInpassingPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldInpassingPeer::SOFT_DELETE)) $criteria->add(VldInpassingPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldInpassingPeer::LAST_SYNC)) $criteria->add(VldInpassingPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldInpassingPeer::UPDATER_ID)) $criteria->add(VldInpassingPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldInpassingPeer::DATABASE_NAME);
        $criteria->add(VldInpassingPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldInpassing (or compatible) type.
    ...
    {
        $copyObj->setInpassingId($this->getInpassingId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldInpassing Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return VldInpassingPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new VldInpassingPeer();
        }
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldInpassings($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a Inpassing object.
     *
     * @param             Inpassing $v
     * @return VldInpassing The current object (for fluent API support)
     * @throws PropelException
     */
    public function setInpassing(Inpassing $v = null)
    {
        if ($v === null) {
            $this->setInpassingId(NULL);
        } else {
            $this->setInpassingId($v->getInpassingId());
        }

        $this->aInpassing = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Inpassing object, it will not be re-added.
        if ($v !== null) {
            $v->addVldInpassing($this);
        }
    ...
    /**
     * Get the associated Inpassing object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Inpassing The associated Inpassing object.
     * @throws PropelException
     */
    public function getInpassing(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aInpassing === null && (($this->inpassing_id !== "" && $this->inpassing_id !== null)) && $doQuery) {
            $this->aInpassing = InpassingQuery::create()->findPk($this->inpassing_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aInpassing->addVldInpassings($this);
             */
        }

        return $this->aInpassing;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aInpassing instanceof Persistent) {
              $this->aInpassing->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldInpassingPeer::DEFAULT_STRING_FORMAT);
    }
