...
/*
 * The Base TableInfo for JenisKesejahteraan Table
 */
class BaseJenisKesejahteraanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisKesejahteraanTableMap';
    ...
    {
        $this->setName('jenis_kesejahteraan');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'jenis_kesejahteraan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'jenis_kesejahteraan_id_str');
        $this->setHeader(           'Ref.jenis Kesejahteraan');
        $this->setLabel(            'Ref.jenis kesejahteraan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jeniskesejahteraancombo');
        $this->setXtypeRadio(       'ref.jeniskesejahteraanradio');
        $this->setXtypeList(        'ref.jeniskesejahteraanlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_ptk');
        $cvar->setColumnPhpName(    'UPtk');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'u_pd');
        $cvar->setColumnPhpName(    'UPd');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
