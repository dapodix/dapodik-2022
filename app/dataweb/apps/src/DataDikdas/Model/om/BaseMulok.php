...
/**
 * Base class that represents a row from the 'ref.mulok' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseMulok extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\MulokPeer';
    ...
    /**
     * The value for the sk_mulok field.
     * @var        string
     */
    protected $sk_mulok;

    /**
     * The value for the tgl_sk_mulok field.
     * @var        string
     */
    protected $tgl_sk_mulok;
    ...
    /**
     * Initializes internal state of BaseMulok object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [sk_mulok] column value.
     * 
     * @return string
     */
    public function getSkMulok()
    {
        return $this->sk_mulok;
    }

    /**
     * Get the [optionally formatted] temporal [tgl_sk_mulok] column value.
     * 
     *
     ...
     */
    public function getTglSkMulok($format = '%Y-%m-%d')
    {
        if ($this->tgl_sk_mulok === null) {
            return null;
        }


        try {
            $dt = new DateTime($this->tgl_sk_mulok);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->tgl_sk_mulok, true), $x);
        }
     ...
     * @return Mulok The current object (for fluent API support)
     */
    public function setKodeWilayah($v)
    {
        ...
        if ($this->kode_wilayah !== $v) {
            $this->kode_wilayah = $v;
            $this->modifiedColumns[] = MulokPeer::KODE_WILAYAH;
        }
    ...
    public function setMataPelajaranId($v)
    {
        ...
        if ($this->mata_pelajaran_id !== $v) {
            ...
            $this->modifiedColumns[] = MulokPeer::MATA_PELAJARAN_ID;
        }
    ...
    /**
     * Set the value of [sk_mulok] column.
     * 
     * @param string $v new value
     * @return Mulok The current object (for fluent API support)
     */
    public function setSkMulok($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->sk_mulok !== $v) {
            $this->sk_mulok = $v;
            $this->modifiedColumns[] = MulokPeer::SK_MULOK;
        }
    ...
    /**
     * Sets the value of [tgl_sk_mulok] column to a normalized version of the date/time value specified.
     * 
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Mulok The current object (for fluent API support)
     */
    public function setTglSkMulok($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->tgl_sk_mulok !== null || $dt !== null) {
            $currentDateAsString = ($this->tgl_sk_mulok !== null && $tmpDt = new DateTime($this->tgl_sk_mulok)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->tgl_sk_mulok = $newDateAsString;
                $this->modifiedColumns[] = MulokPeer::TGL_SK_MULOK;
            }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MulokPeer::CREATE_DATE;
            }
        } // if either are not null
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MulokPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MulokPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = MulokPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sk_mulok = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->tgl_sk_mulok = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 8; // 8 = MulokPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Mulok object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MulokPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MulokPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MulokPeer::KODE_WILAYAH)) {
            $modifiedColumns[':p' . $index++]  = '"kode_wilayah"';
        }
        if ($this->isColumnModified(MulokPeer::MATA_PELAJARAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"mata_pelajaran_id"';
        }
        if ($this->isColumnModified(MulokPeer::SK_MULOK)) {
            $modifiedColumns[':p' . $index++]  = '"sk_mulok"';
        }
        if ($this->isColumnModified(MulokPeer::TGL_SK_MULOK)) {
            $modifiedColumns[':p' . $index++]  = '"tgl_sk_mulok"';
        }
        if ($this->isColumnModified(MulokPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(MulokPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(MulokPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(MulokPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."mulok" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"mata_pelajaran_id"':						
                        ...
                        break;
                    case '"sk_mulok"':						
                        $stmt->bindValue($identifier, $this->sk_mulok, PDO::PARAM_STR);
                        break;
                    case '"tgl_sk_mulok"':						
                        $stmt->bindValue($identifier, $this->tgl_sk_mulok, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MulokPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MulokPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getSkMulok();
                break;
            case 3:
                return $this->getTglSkMulok();
                break;
            case 4:
    ...
    {
        if (isset($alreadyDumpedObjects['Mulok'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Mulok'][serialize($this->getPrimaryKey())] = true;
        $keys = MulokPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getKodeWilayah(),
            $keys[1] => $this->getMataPelajaranId(),
            $keys[2] => $this->getSkMulok(),
            $keys[3] => $this->getTglSkMulok(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setSkMulok($value);
                break;
            case 3:
                $this->setTglSkMulok($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setSkMulok($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setTglSkMulok($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MulokPeer::KODE_WILAYAH)) $criteria->add(MulokPeer::KODE_WILAYAH, $this->kode_wilayah);
        if ($this->isColumnModified(MulokPeer::MATA_PELAJARAN_ID)) $criteria->add(MulokPeer::MATA_PELAJARAN_ID, $this->mata_pelajaran_id);
        if ($this->isColumnModified(MulokPeer::SK_MULOK)) $criteria->add(MulokPeer::SK_MULOK, $this->sk_mulok);
        if ($this->isColumnModified(MulokPeer::TGL_SK_MULOK)) $criteria->add(MulokPeer::TGL_SK_MULOK, $this->tgl_sk_mulok);
        if ($this->isColumnModified(MulokPeer::CREATE_DATE)) $criteria->add(MulokPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(MulokPeer::LAST_UPDATE)) $criteria->add(MulokPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(MulokPeer::EXPIRED_DATE)) $criteria->add(MulokPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(MulokPeer::LAST_SYNC)) $criteria->add(MulokPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(MulokPeer::DATABASE_NAME);
        $criteria->add(MulokPeer::KODE_WILAYAH, $this->kode_wilayah);
        $criteria->add(MulokPeer::MATA_PELAJARAN_ID, $this->mata_pelajaran_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getKodeWilayah()) && (null === $this->getMataPelajaranId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Mulok (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSkMulok($this->getSkMulok());
        $copyObj->setTglSkMulok($this->getTglSkMulok());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Mulok Clone of current object.
     * @throws PropelException
     */
    ...
    public function getMataPelajaran(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMataPelajaran === null && ($this->mata_pelajaran_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMataPelajaran->addMuloks($this);
             */
        }
    ...
    public function getMstWilayah(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMstWilayah === null && (($this->kode_wilayah !== "" && $this->kode_wilayah !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMstWilayah->addMuloks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MulokPeer::DEFAULT_STRING_FORMAT);
    }
