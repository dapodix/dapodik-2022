...
/**
 * This class defines the structure of the 'vld_angkutan' table.
 *
 *
 *
 ...
 */
class VldAngkutanTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldAngkutanTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_angkutan', 'IdAngkutan', 'VARCHAR', 'angkutan', 'id_angkutan', true, null, null);
