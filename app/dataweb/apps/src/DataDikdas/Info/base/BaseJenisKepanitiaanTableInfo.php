...
/*
 * The Base TableInfo for JenisKepanitiaan Table
 */
class BaseJenisKepanitiaanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.JenisKepanitiaanTableMap';
    ...
    {
        $this->setName('jenis_kepanitiaan');
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'id_jns_panitia_str');
        $this->setHeader(           'Ref.jenis Kepanitiaan');
        $this->setLabel(            'Ref.jenis kepanitiaan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.jeniskepanitiaancombo');
        $this->setXtypeRadio(       'ref.jeniskepanitiaanradio');
        $this->setXtypeList(        'ref.jeniskepanitiaanlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'nm_jns_panitia');
        $cvar->setColumnPhpName(    'NmJnsPanitia');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setHeader(           'Nm Jns Panitia');
        $cvar->setLabel(            'Nm jns panitia');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
