...
/*
 * The Base TableInfo for Penghasilan Table
 */
class BasePenghasilanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PenghasilanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'penghasilan_id_str');
        $this->setHeader(           'Ref.penghasilan');
        $this->setLabel(            'Ref.penghasilan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.penghasilancombo');
        $this->setXtypeRadio(       'ref.penghasilanradio');
        $this->setXtypeList(        'ref.penghasilanlist');
