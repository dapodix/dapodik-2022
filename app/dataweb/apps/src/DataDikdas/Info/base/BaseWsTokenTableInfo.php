...
/*
 * The Base TableInfo for WsToken Table
 */
class BaseWsTokenTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.WsTokenTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'ws_token_id_str');
        $this->setHeader(           'Ws Token');
        $this->setLabel(            'Ws token');
        ...
        $cvar->setColumnName(       'ws_token_id');
        $cvar->setColumnPhpName(    'WsTokenId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '1');
		$cvar->setIsPk(             '1');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'request_date');
        $cvar->setColumnPhpName(    'RequestDate');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Request Date');
        $cvar->setLabel(            'Request date');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'ws_aplikasi_id');
        $cvar->setColumnPhpName(    'WsAplikasiId');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Ws Aplikasi');
        $cvar->setLabel(            'Ws aplikasi');
        $cvar->setInputLength(      0);
        $cvar->setFieldWidth(       0);
        $cvar->setColumnWidth(      60);
        $cvar->setHideColumn(       0);
