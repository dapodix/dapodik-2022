...
/*
 * The Base TableInfo for KlasifikasiLembaga Table
 */
class BaseKlasifikasiLembagaTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KlasifikasiLembagaTableMap';
    ...
    {
        $this->setName('klasifikasi_lembaga');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'klasifikasi_lembaga_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'klasifikasi_lembaga_id_str');
        $this->setHeader(           'Ref.klasifikasi Lembaga');
        $this->setLabel(            'Ref.klasifikasi lembaga');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.klasifikasilembagacombo');
        $this->setXtypeRadio(       'ref.klasifikasilembagaradio');
        $this->setXtypeList(        'ref.klasifikasilembagalist');
