...
/*
 * The Base TableInfo for KitasPtk Table
 */
class BaseKitasPtkTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KitasPtkTableMap';
    ...
    {
        $this->setName('kitas_ptk');
        $this->setPhpName('KitasPtk');
        $this->setClassname('DataDikdas\\Model\\KitasPtk');
    ...
    public function setVariables() {
        ...
        $this->setHeader(           'Kitas Ptk');
        $this->setLabel(            'Kitas ptk');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'kitasptkcombo');
        $this->setXtypeRadio(       'kitasptkradio');
        $this->setXtypeList(        'kitasptklist');
