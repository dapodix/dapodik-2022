...
/**
 * Base class that represents a row from the 'ref.jenis_cita' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseJenisCita extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\JenisCitaPeer';
    ...
    /**
     * The value for the nm_cita field.
     * @var        string
     */
    protected $nm_cita;
    ...
    /**
     * Initializes internal state of BaseJenisCita object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nm_cita] column value.
     * 
     * @return string
     */
    public function getNmCita()
    {
        return $this->nm_cita;
    }
     ...
     * @return JenisCita The current object (for fluent API support)
     */
    public function setIdCita($v)
    {
        ...
        if ($this->id_cita !== $v) {
            $this->id_cita = $v;
            $this->modifiedColumns[] = JenisCitaPeer::ID_CITA;
        }
    ...
    /**
     * Set the value of [nm_cita] column.
     * 
     * @param string $v new value
     * @return JenisCita The current object (for fluent API support)
     */
    public function setNmCita($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->nm_cita !== $v) {
            $this->nm_cita = $v;
            $this->modifiedColumns[] = JenisCitaPeer::NM_CITA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisCitaPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisCitaPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JenisCitaPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = JenisCitaPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_cita = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->nm_cita = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 6; // 6 = JenisCitaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating JenisCita object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = JenisCitaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = JenisCitaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                JenisCitaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JenisCitaPeer::ID_CITA)) {
            $modifiedColumns[':p' . $index++]  = '"id_cita"';
        }
        if ($this->isColumnModified(JenisCitaPeer::NM_CITA)) {
            $modifiedColumns[':p' . $index++]  = '"nm_cita"';
        }
        if ($this->isColumnModified(JenisCitaPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(JenisCitaPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(JenisCitaPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(JenisCitaPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."jenis_cita" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"id_cita"':						
                        ...
                        break;
                    case '"nm_cita"':						
                        $stmt->bindValue($identifier, $this->nm_cita, PDO::PARAM_STR);
                        break;
                    case '"create_date"':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = JenisCitaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = JenisCitaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['JenisCita'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['JenisCita'][$this->getPrimaryKey()] = true;
        $keys = JenisCitaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdCita(),
            $keys[1] => $this->getNmCita(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNmCita($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JenisCitaPeer::ID_CITA)) $criteria->add(JenisCitaPeer::ID_CITA, $this->id_cita);
        if ($this->isColumnModified(JenisCitaPeer::NM_CITA)) $criteria->add(JenisCitaPeer::NM_CITA, $this->nm_cita);
        if ($this->isColumnModified(JenisCitaPeer::CREATE_DATE)) $criteria->add(JenisCitaPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(JenisCitaPeer::LAST_UPDATE)) $criteria->add(JenisCitaPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(JenisCitaPeer::EXPIRED_DATE)) $criteria->add(JenisCitaPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(JenisCitaPeer::LAST_SYNC)) $criteria->add(JenisCitaPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(JenisCitaPeer::DATABASE_NAME);
        $criteria->add(JenisCitaPeer::ID_CITA, $this->id_cita);
    ...
    /**
     * Generic method to set the primary key (id_cita column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of JenisCita (or compatible) type.
    ...
    {
        $copyObj->setNmCita($this->getNmCita());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return JenisCita Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return JenisCitaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new JenisCitaPeer();
        }
     ...
     * If this JenisCita is new, it will return
    ...
    public function setRegistrasiPesertaDidiks(PropelCollection $registrasiPesertaDidiks, PropelPDO $con = null)
    {
        ...
        foreach ($registrasiPesertaDidiksToDelete as $registrasiPesertaDidikRemoved) {
            $registrasiPesertaDidikRemoved->setJenisCita(null);
        }
    ...
    protected function doAddRegistrasiPesertaDidik($registrasiPesertaDidik)
    {
        ...
        $registrasiPesertaDidik->setJenisCita($this);
    }
    ...
    public function removeRegistrasiPesertaDidik($registrasiPesertaDidik)
    {
        if ($this->getRegistrasiPesertaDidiks()->contains($registrasiPesertaDidik)) {
            ...
            $registrasiPesertaDidik->setJenisCita(null);
        }
     ...
     * Otherwise if this JenisCita is new, it will return
     * an empty collection; or if this JenisCita has previously
     * been saved, it will retrieve related RegistrasiPesertaDidiks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in JenisCita.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(JenisCitaPeer::DEFAULT_STRING_FORMAT);
    }
