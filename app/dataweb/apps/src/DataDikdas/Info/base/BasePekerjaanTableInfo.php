...
/*
 * The Base TableInfo for Pekerjaan Table
 */
class BasePekerjaanTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PekerjaanTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'pekerjaan_id_str');
        $this->setHeader(           'Ref.pekerjaan');
        $this->setLabel(            'Ref.pekerjaan');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 0);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.pekerjaancombo');
        $this->setXtypeRadio(       'ref.pekerjaanradio');
        $this->setXtypeList(        'ref.pekerjaanlist');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_wirausaha');
        $cvar->setColumnPhpName(    'AWirausaha');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Awirausaha');
        $cvar->setLabel(            'Awirausaha');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'a_pejabat_publik');
        $cvar->setColumnPhpName(    'APejabatPublik');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Apejabat Publik');
        $cvar->setLabel(            'Apejabat publik');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
