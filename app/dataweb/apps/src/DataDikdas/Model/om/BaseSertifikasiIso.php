...
/**
 * Base class that represents a row from the 'ref.sertifikasi_iso' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseSertifikasiIso extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\SertifikasiIsoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SertifikasiIsoPeer
     */
    ...
    /**
     * Initializes internal state of BaseSertifikasiIso object.
     * @see        applyDefaults()
     */
     ...
     * @return SertifikasiIso The current object (for fluent API support)
     */
    public function setSertifikasiIsoId($v)
    {
        ...
        if ($this->sertifikasi_iso_id !== $v) {
            ...
            $this->modifiedColumns[] = SertifikasiIsoPeer::SERTIFIKASI_ISO_ID;
        }
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[] = SertifikasiIsoPeer::NAMA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SertifikasiIsoPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SertifikasiIsoPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setExpiredDate($v)
    {
        ...
        if ($this->expired_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SertifikasiIsoPeer::EXPIRED_DATE;
            }
        } // if either are not null
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = SertifikasiIsoPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sertifikasi_iso_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = SertifikasiIsoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SertifikasiIso object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SertifikasiIsoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SertifikasiIsoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SertifikasiIsoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SertifikasiIsoPeer::SERTIFIKASI_ISO_ID)) {
            $modifiedColumns[':p' . $index++]  = '"sertifikasi_iso_id"';
        }
        if ($this->isColumnModified(SertifikasiIsoPeer::NAMA)) {
            $modifiedColumns[':p' . $index++]  = '"nama"';
        }
        if ($this->isColumnModified(SertifikasiIsoPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(SertifikasiIsoPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(SertifikasiIsoPeer::EXPIRED_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"expired_date"';
        }
        if ($this->isColumnModified(SertifikasiIsoPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }

        $sql = sprintf(
            'INSERT INTO "ref"."sertifikasi_iso" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SertifikasiIsoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SertifikasiIsoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SertifikasiIso'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SertifikasiIso'][$this->getPrimaryKey()] = true;
        $keys = SertifikasiIsoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSertifikasiIsoId(),
            $keys[1] => $this->getNama(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setSertifikasiIsoId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SertifikasiIsoPeer::SERTIFIKASI_ISO_ID)) $criteria->add(SertifikasiIsoPeer::SERTIFIKASI_ISO_ID, $this->sertifikasi_iso_id);
        if ($this->isColumnModified(SertifikasiIsoPeer::NAMA)) $criteria->add(SertifikasiIsoPeer::NAMA, $this->nama);
        if ($this->isColumnModified(SertifikasiIsoPeer::CREATE_DATE)) $criteria->add(SertifikasiIsoPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(SertifikasiIsoPeer::LAST_UPDATE)) $criteria->add(SertifikasiIsoPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(SertifikasiIsoPeer::EXPIRED_DATE)) $criteria->add(SertifikasiIsoPeer::EXPIRED_DATE, $this->expired_date);
        if ($this->isColumnModified(SertifikasiIsoPeer::LAST_SYNC)) $criteria->add(SertifikasiIsoPeer::LAST_SYNC, $this->last_sync);
    ...
    {
        $criteria = new Criteria(SertifikasiIsoPeer::DATABASE_NAME);
        $criteria->add(SertifikasiIsoPeer::SERTIFIKASI_ISO_ID, $this->sertifikasi_iso_id);
    ...
    /**
     * Generic method to set the primary key (sertifikasi_iso_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getSertifikasiIsoId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of SertifikasiIso (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSertifikasiIsoId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SertifikasiIso Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SertifikasiIsoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SertifikasiIsoPeer();
        }
     ...
     * If this SertifikasiIso is new, it will return
    ...
    public function setSekolahLongitudinals(PropelCollection $sekolahLongitudinals, PropelPDO $con = null)
    {
        ...
        foreach ($sekolahLongitudinalsToDelete as $sekolahLongitudinalRemoved) {
            $sekolahLongitudinalRemoved->setSertifikasiIso(null);
        }
    ...
    protected function doAddSekolahLongitudinal($sekolahLongitudinal)
    {
        ...
        $sekolahLongitudinal->setSertifikasiIso($this);
    }
    ...
    public function removeSekolahLongitudinal($sekolahLongitudinal)
    {
        if ($this->getSekolahLongitudinals()->contains($sekolahLongitudinal)) {
            ...
            $sekolahLongitudinal->setSertifikasiIso(null);
        }
     ...
     * Otherwise if this SertifikasiIso is new, it will return
     * an empty collection; or if this SertifikasiIso has previously
     * been saved, it will retrieve related SekolahLongitudinals from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SertifikasiIso.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(SertifikasiIsoPeer::DEFAULT_STRING_FORMAT);
    }
