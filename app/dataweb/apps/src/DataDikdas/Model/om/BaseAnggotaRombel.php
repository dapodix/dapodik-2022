...
abstract class BaseAnggotaRombel extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\AnggotaRombelPeer';
    ...
    /**
     * Initializes internal state of BaseAnggotaRombel object.
     * @see        applyDefaults()
     */
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AnggotaRombelPeer::CREATE_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = AnggotaRombelPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AnggotaRombelPeer::ANGGOTA_ROMBEL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"anggota_rombel_id"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::ROMBONGAN_BELAJAR_ID)) {
            $modifiedColumns[':p' . $index++]  = '"rombongan_belajar_id"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::PESERTA_DIDIK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"peserta_didik_id"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::JENIS_PENDAFTARAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"jenis_pendaftaran_id"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(AnggotaRombelPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "anggota_rombel" (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AnggotaRombelPeer::CREATE_DATE)) $criteria->add(AnggotaRombelPeer::CREATE_DATE, $this->create_date);
    ...
    public function getPesertaDidik(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPesertaDidik === null && (($this->peserta_didik_id !== "" && $this->peserta_didik_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPesertaDidik->addAnggotaRombels($this);
             */
        }
    ...
    public function getRombonganBelajar(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRombonganBelajar === null && (($this->rombongan_belajar_id !== "" && $this->rombongan_belajar_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRombonganBelajar->addAnggotaRombels($this);
             */
        }
    ...
    public function getJenisPendaftaran(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aJenisPendaftaran === null && (($this->jenis_pendaftaran_id !== "" && $this->jenis_pendaftaran_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aJenisPendaftaran->addAnggotaRombels($this);
             */
        }
     ...
     * If this AnggotaRombel is new, it will return
    ...
    public function setBantuanPds(PropelCollection $bantuanPds, PropelPDO $con = null)
    {
        ...
        foreach ($bantuanPdsToDelete as $bantuanPdRemoved) {
            $bantuanPdRemoved->setAnggotaRombel(null);
        }
    ...
    protected function doAddBantuanPd($bantuanPd)
    {
        ...
        $bantuanPd->setAnggotaRombel($this);
    }
    ...
    public function removeBantuanPd($bantuanPd)
    {
        if ($this->getBantuanPds()->contains($bantuanPd)) {
            ...
            $bantuanPd->setAnggotaRombel(null);
        }
     ...
     * Otherwise if this AnggotaRombel is new, it will return
     * an empty collection; or if this AnggotaRombel has previously
     * been saved, it will retrieve related BantuanPds from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AnggotaRombel.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|BantuanPd[] List of BantuanPd objects
     */
    public function getBantuanPdsJoinJenisBantuan($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BantuanPdQuery::create(null, $criteria);
