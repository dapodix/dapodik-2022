...
/*
 * The Base TableInfo for StatusKeaktifanPegawai Table
 */
class BaseStatusKeaktifanPegawaiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.StatusKeaktifanPegawaiTableMap';
    ...
    {
        $this->setName('status_keaktifan_pegawai');
    ...
    public function setVariables() {
        ...
        $this->setPkName(            'status_keaktifan_id');
        $this->setIsData(           0);
        ...
        $this->setRendererString(   'status_keaktifan_id_str');
        $this->setHeader(           'Ref.status Keaktifan Pegawai');
        $this->setLabel(            'Ref.status keaktifan pegawai');
        $this->setCreateCombobox(   1);
        $this->setCreateRadiogroup( 1);
        $this->setCreateList(       1);
        $this->setCreateModel(      1);
        $this->setXtypeCombo(       'ref.statuskeaktifanpegawaicombo');
        $this->setXtypeRadio(       'ref.statuskeaktifanpegawairadio');
        $this->setXtypeList(        'ref.statuskeaktifanpegawailist');
