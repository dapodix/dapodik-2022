...
/**
 * This class defines the structure of the 'vld_dudi' table.
 *
 *
 *
 ...
 */
class VldDudiTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldDudiTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('dudi_id', 'DudiId', 'VARCHAR', 'dudi', 'dudi_id', true, null, null);
