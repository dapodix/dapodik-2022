...
abstract class BaseVldSekolah extends BaseObject implements Persistent
{
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldSekolahPeer::KETERANGAN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldSekolahPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldSekolahPeer::KETERANGAN)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldSekolahPeer::KETERANGAN)) $criteria->add(VldSekolahPeer::KETERANGAN, $this->keterangan);
