...
/**
 * This class defines the structure of the 'vld_tunjangan' table.
 *
 *
 *
 ...
 */
class VldTunjanganTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldTunjanganTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('tunjangan_id', 'TunjanganId', 'VARCHAR', 'tunjangan', 'tunjangan_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Tunjangan', 'DataDikdas\\Model\\Tunjangan', RelationMap::MANY_TO_ONE, array('tunjangan_id' => 'tunjangan_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()

} // VldTunjanganTableMap
