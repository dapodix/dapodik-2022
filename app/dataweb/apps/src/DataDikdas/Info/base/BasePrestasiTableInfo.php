...
/*
 * The Base TableInfo for Prestasi Table
 */
class BasePrestasiTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.PrestasiTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'prestasi_id_str');
        $this->setHeader(           'Prestasi');
        $this->setLabel(            'Prestasi');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'jenis_prestasi_id');
        $cvar->setColumnPhpName(    'JenisPrestasiId');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'JenisPrestasi');
        $cvar->setMin(              0);
        $cvar->setMax(              4);
        $cvar->setHeader(           'Jenis Prestasi');
        $cvar->setLabel(            'Jenis prestasi');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      170);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'jenisprestasiradiogroup');
        $cvar->setComboXtype(       'jenisprestasicombo');
		...
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '1');
        $cvar->setFkTableName(      'TingkatPrestasi');
        $cvar->setMin(              0);
        $cvar->setMax(              7);
        $cvar->setHeader(           'Tingkat Prestasi');
        $cvar->setLabel(            'Tingkat prestasi');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      170);
        $cvar->setHideColumn(       0);
        $cvar->setXtype(            'tingkatprestasicombo');
        $cvar->setComboXtype(       'tingkatprestasicombo');
        $cvar->setDisplayField(     'Nama');
        $cvar->setValidationType(   '');
        $cvar->setAllowEmpty(       0);
        $cvar->setCompositeKey(     0);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tahun_prestasi');
        $cvar->setColumnPhpName(    'TahunPrestasi');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tahun Prestasi');
        $cvar->setLabel(            'Tahun prestasi');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'peringkat');
        $cvar->setColumnPhpName(    'Peringkat');
        $cvar->setType(             'int');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Peringkat');
        $cvar->setLabel(            'Peringkat');
        $cvar->setInputLength(      100);
        $cvar->setFieldWidth(       300);
        $cvar->setColumnWidth(      360);
        $cvar->setHideColumn(       0);
