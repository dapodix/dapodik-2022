...
/**
 * Base class that represents a row from the 'vld_bea_pd' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldBeaPd extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldBeaPdPeer';
    ...
    /**
     * @var        BeasiswaPesertaDidik
     */
    protected $aBeasiswaPesertaDidik;
    ...
    /**
     * Initializes internal state of BaseVldBeaPd object.
     * @see        applyDefaults()
     */
     ...
     * @return VldBeaPd The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldBeaPdPeer::LOGID;
        }
    ...
    public function setBeasiswaPesertaDidikId($v)
    {
        ...
        if ($this->beasiswa_peserta_didik_id !== $v) {
            ...
            $this->modifiedColumns[] = VldBeaPdPeer::BEASISWA_PESERTA_DIDIK_ID;
        }

        if ($this->aBeasiswaPesertaDidik !== null && $this->aBeasiswaPesertaDidik->getBeasiswaPesertaDidikId() !== $v) {
            $this->aBeasiswaPesertaDidik = null;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldBeaPdPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldBeaPdPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldBeaPdPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldBeaPdPeer::ERROR_MESSAGE;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldBeaPdPeer::KETERANGAN;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldBeaPdPeer::APP_USERNAME;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBeaPdPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldBeaPdPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldBeaPdPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldBeaPdPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldBeaPdPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->beasiswa_peserta_didik_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldBeaPdPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldBeaPd object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBeasiswaPesertaDidik !== null && $this->beasiswa_peserta_didik_id !== $this->aBeasiswaPesertaDidik->getBeasiswaPesertaDidikId()) {
            $this->aBeasiswaPesertaDidik = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldBeaPdPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldBeaPdQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldBeaPdPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBeasiswaPesertaDidik !== null) {
                if ($this->aBeasiswaPesertaDidik->isModified() || $this->aBeasiswaPesertaDidik->isNew()) {
                    $affectedRows += $this->aBeasiswaPesertaDidik->save($con);
                }
                $this->setBeasiswaPesertaDidik($this->aBeasiswaPesertaDidik);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldBeaPdPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::BEASISWA_PESERTA_DIDIK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"beasiswa_peserta_didik_id"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldBeaPdPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_bea_pd" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBeasiswaPesertaDidik !== null) {
                if (!$this->aBeasiswaPesertaDidik->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBeasiswaPesertaDidik->getValidationFailures());
                }
            }


            if (($retval = VldBeaPdPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldBeaPdPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldBeaPd'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldBeaPd'][$this->getPrimaryKey()] = true;
        $keys = VldBeaPdPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getLogid(),
            $keys[1] => $this->getBeasiswaPesertaDidikId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aBeasiswaPesertaDidik) {
                $result['BeasiswaPesertaDidik'] = $this->aBeasiswaPesertaDidik->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBeasiswaPesertaDidikId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldBeaPdPeer::LOGID)) $criteria->add(VldBeaPdPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldBeaPdPeer::BEASISWA_PESERTA_DIDIK_ID)) $criteria->add(VldBeaPdPeer::BEASISWA_PESERTA_DIDIK_ID, $this->beasiswa_peserta_didik_id);
        if ($this->isColumnModified(VldBeaPdPeer::IDTYPE)) $criteria->add(VldBeaPdPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldBeaPdPeer::STATUS_VALIDASI)) $criteria->add(VldBeaPdPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldBeaPdPeer::FIELD_ERROR)) $criteria->add(VldBeaPdPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldBeaPdPeer::ERROR_MESSAGE)) $criteria->add(VldBeaPdPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldBeaPdPeer::KETERANGAN)) $criteria->add(VldBeaPdPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldBeaPdPeer::APP_USERNAME)) $criteria->add(VldBeaPdPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldBeaPdPeer::CREATE_DATE)) $criteria->add(VldBeaPdPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldBeaPdPeer::LAST_UPDATE)) $criteria->add(VldBeaPdPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldBeaPdPeer::SOFT_DELETE)) $criteria->add(VldBeaPdPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldBeaPdPeer::LAST_SYNC)) $criteria->add(VldBeaPdPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldBeaPdPeer::UPDATER_ID)) $criteria->add(VldBeaPdPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldBeaPdPeer::DATABASE_NAME);
        $criteria->add(VldBeaPdPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldBeaPd (or compatible) type.
    ...
    {
        $copyObj->setBeasiswaPesertaDidikId($this->getBeasiswaPesertaDidikId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldBeaPd Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldBeaPds($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a BeasiswaPesertaDidik object.
     *
     * @param             BeasiswaPesertaDidik $v
     * @return VldBeaPd The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBeasiswaPesertaDidik(BeasiswaPesertaDidik $v = null)
    {
        if ($v === null) {
            $this->setBeasiswaPesertaDidikId(NULL);
        } else {
            $this->setBeasiswaPesertaDidikId($v->getBeasiswaPesertaDidikId());
        }

        $this->aBeasiswaPesertaDidik = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the BeasiswaPesertaDidik object, it will not be re-added.
        if ($v !== null) {
            $v->addVldBeaPd($this);
        }
    ...
    /**
     * Get the associated BeasiswaPesertaDidik object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return BeasiswaPesertaDidik The associated BeasiswaPesertaDidik object.
     * @throws PropelException
     */
    public function getBeasiswaPesertaDidik(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBeasiswaPesertaDidik === null && (($this->beasiswa_peserta_didik_id !== "" && $this->beasiswa_peserta_didik_id !== null)) && $doQuery) {
            $this->aBeasiswaPesertaDidik = BeasiswaPesertaDidikQuery::create()->findPk($this->beasiswa_peserta_didik_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBeasiswaPesertaDidik->addVldBeaPds($this);
             */
        }

        return $this->aBeasiswaPesertaDidik;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aBeasiswaPesertaDidik instanceof Persistent) {
              $this->aBeasiswaPesertaDidik->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(VldBeaPdPeer::DEFAULT_STRING_FORMAT);
    }
