...
/**
 * This class defines the structure of the 'angkutan' table.
 *
 *
 *
 ...
 */
class AngkutanTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.AngkutanTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id_angkutan', 'IdAngkutan', 'VARCHAR', true, null, null);
        ...
        $this->addColumn('merk', 'Merk', 'VARCHAR', false, 255, null);
        $this->addColumn('no_polisi', 'NoPolisi', 'VARCHAR', false, 255, null);
        $this->addColumn('no_bpkb', 'NoBpkb', 'VARCHAR', false, 255, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('AngkutanDariBlockgrant', 'DataDikdas\\Model\\AngkutanDariBlockgrant', RelationMap::ONE_TO_MANY, array('id_angkutan' => 'id_angkutan', ), 'RESTRICT', 'RESTRICT', 'AngkutanDariBlockgrants');
        $this->addRelation('VldAngkutan', 'DataDikdas\\Model\\VldAngkutan', RelationMap::ONE_TO_MANY, array('id_angkutan' => 'id_angkutan', ), 'RESTRICT', 'RESTRICT', 'VldAngkutans');
    } // buildRelations()
