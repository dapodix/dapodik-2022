...
abstract class BaseInpassing extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\InpassingPeer';
    ...
    /**
     * The value for the tgl_sk_inpassing field.
     * @var        string
     */
    protected $tgl_sk_inpassing;
    ...
    /**
     * Get the [optionally formatted] temporal [tgl_sk_inpassing] column value.
     * 
     *
     ...
     */
    public function getTglSkInpassing($format = '%Y-%m-%d')
    {
        if ($this->tgl_sk_inpassing === null) {
            return null;
        }


        try {
            $dt = new DateTime($this->tgl_sk_inpassing);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->tgl_sk_inpassing, true), $x);
        }
    ...
    /**
     * Get the [optionally formatted] temporal [tmt_inpassing] column value.
     * 
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getTmtInpassing($format = '%Y-%m-%d')
    {
        if ($this->tmt_inpassing === null) {
            return null;
        }


        try {
            $dt = new DateTime($this->tmt_inpassing);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->tmt_inpassing, true), $x);
        }
    ...
    /**
     * Sets the value of [tgl_sk_inpassing] column to a normalized version of the date/time value specified.
     * 
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Inpassing The current object (for fluent API support)
     */
    public function setTglSkInpassing($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->tgl_sk_inpassing !== null || $dt !== null) {
            $currentDateAsString = ($this->tgl_sk_inpassing !== null && $tmpDt = new DateTime($this->tgl_sk_inpassing)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->tgl_sk_inpassing = $newDateAsString;
                $this->modifiedColumns[] = InpassingPeer::TGL_SK_INPASSING;
            }
    ...
    /**
     * Sets the value of [tmt_inpassing] column to a normalized version of the date/time value specified.
     * 
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Inpassing The current object (for fluent API support)
    ...
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->tmt_inpassing !== null || $dt !== null) {
            $currentDateAsString = ($this->tmt_inpassing !== null && $tmpDt = new DateTime($this->tmt_inpassing)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->tmt_inpassing = $newDateAsString;
    ...
    public function setAsalData($v)
    {
        ...
        if ($this->asal_data !== $v) {
            $this->asal_data = $v;
            $this->modifiedColumns[] = InpassingPeer::ASAL_DATA;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = InpassingPeer::CREATE_DATE;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tgl_sk_inpassing = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->tmt_inpassing = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->angka_kredit = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->masa_kerja_tahun = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->masa_kerja_bulan = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            ...
            return $startcol + 15; // 15 = InpassingPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(InpassingPeer::INPASSING_ID)) {
            $modifiedColumns[':p' . $index++]  = '"inpassing_id"';
        }
        if ($this->isColumnModified(InpassingPeer::PANGKAT_GOLONGAN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pangkat_golongan_id"';
        }
        if ($this->isColumnModified(InpassingPeer::PTK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"ptk_id"';
        }
        if ($this->isColumnModified(InpassingPeer::NO_SK_INPASSING)) {
            $modifiedColumns[':p' . $index++]  = '"no_sk_inpassing"';
        }
        if ($this->isColumnModified(InpassingPeer::TGL_SK_INPASSING)) {
            $modifiedColumns[':p' . $index++]  = '"tgl_sk_inpassing"';
        }
        if ($this->isColumnModified(InpassingPeer::TMT_INPASSING)) {
            $modifiedColumns[':p' . $index++]  = '"tmt_inpassing"';
        }
        if ($this->isColumnModified(InpassingPeer::ANGKA_KREDIT)) {
            $modifiedColumns[':p' . $index++]  = '"angka_kredit"';
        }
        if ($this->isColumnModified(InpassingPeer::MASA_KERJA_TAHUN)) {
            $modifiedColumns[':p' . $index++]  = '"masa_kerja_tahun"';
        }
        if ($this->isColumnModified(InpassingPeer::MASA_KERJA_BULAN)) {
            $modifiedColumns[':p' . $index++]  = '"masa_kerja_bulan"';
        }
        if ($this->isColumnModified(InpassingPeer::ASAL_DATA)) {
            $modifiedColumns[':p' . $index++]  = '"asal_data"';
        }
        if ($this->isColumnModified(InpassingPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(InpassingPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(InpassingPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(InpassingPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(InpassingPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "inpassing" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"ptk_id"':						
                        ...
                        break;
                    case '"no_sk_inpassing"':						
                        $stmt->bindValue($identifier, $this->no_sk_inpassing, PDO::PARAM_STR);
                        break;
                    case '"tgl_sk_inpassing"':						
                        $stmt->bindValue($identifier, $this->tgl_sk_inpassing, PDO::PARAM_STR);
                        break;
                    case '"tmt_inpassing"':						
                        $stmt->bindValue($identifier, $this->tmt_inpassing, PDO::PARAM_STR);
                        break;
                    case '"angka_kredit"':						
                        $stmt->bindValue($identifier, $this->angka_kredit, PDO::PARAM_STR);
                        break;
    ...
    public function toArray($keyType = BasePeer::TYPE_FIELDNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[4] => $this->getTglSkInpassing(),
            $keys[5] => $this->getTmtInpassing(),
            $keys[6] => $this->getAngkaKredit(),
            $keys[7] => $this->getMasaKerjaTahun(),
            $keys[8] => $this->getMasaKerjaBulan(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setTglSkInpassing($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setTmtInpassing($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setAngkaKredit($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setMasaKerjaTahun($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setMasaKerjaBulan($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InpassingPeer::TGL_SK_INPASSING)) $criteria->add(InpassingPeer::TGL_SK_INPASSING, $this->tgl_sk_inpassing);
        ...
        if ($this->isColumnModified(InpassingPeer::ASAL_DATA)) $criteria->add(InpassingPeer::ASAL_DATA, $this->asal_data);
        if ($this->isColumnModified(InpassingPeer::CREATE_DATE)) $criteria->add(InpassingPeer::CREATE_DATE, $this->create_date);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTglSkInpassing($this->getTglSkInpassing());
    ...
    public function getPangkatGolongan(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPangkatGolongan === null && (($this->pangkat_golongan_id !== "" && $this->pangkat_golongan_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPangkatGolongan->addInpassings($this);
             */
        }
    ...
    public function setVldInpassings(PropelCollection $vldInpassings, PropelPDO $con = null)
    {
        ...
        foreach ($vldInpassingsToDelete as $vldInpassingRemoved) {
            $vldInpassingRemoved->setInpassing(null);
        }
    ...
    protected function doAddVldInpassing($vldInpassing)
    {
        ...
        $vldInpassing->setInpassing($this);
    }
    ...
    public function removeVldInpassing($vldInpassing)
    {
        if ($this->getVldInpassings()->contains($vldInpassing)) {
            ...
            $vldInpassing->setInpassing(null);
        }
     ...
     * @return PropelObjectCollection|VldInpassing[] List of VldInpassing objects
     */
    public function getVldInpassingsJoinErrortype($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = VldInpassingQuery::create(null, $criteria);
