...
/**
 * This class defines the structure of the 'vld_buku_ptk' table.
 *
 *
 *
 ...
 */
class VldBukuPtkTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldBukuPtkTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('buku_id', 'BukuId', 'VARCHAR', 'buku_ptk', 'buku_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('BukuPtk', 'DataDikdas\\Model\\BukuPtk', RelationMap::MANY_TO_ONE, array('buku_id' => 'buku_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()
