...
/**
 * Base class that represents a row from the 'vld_un' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldUn extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldUnPeer';
    ...
    /**
     * Initializes internal state of BaseVldUn object.
     * @see        applyDefaults()
     */
     ...
     * @return VldUn The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldUnPeer::LOGID;
        }
    ...
    public function setUnId($v)
    {
        ...
        if ($this->un_id !== $v) {
            $this->un_id = $v;
            $this->modifiedColumns[] = VldUnPeer::UN_ID;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldUnPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldUnPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldUnPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldUnPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldUnPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldUnPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldUnPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldUnPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldUnPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldUnPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldUnPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->un_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 13; // 13 = VldUnPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldUn object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldUnPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldUnPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldUnPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldUnPeer::UN_ID)) {
            $modifiedColumns[':p' . $index++]  = '"un_id"';
        }
        if ($this->isColumnModified(VldUnPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldUnPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldUnPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldUnPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldUnPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldUnPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldUnPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldUnPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldUnPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldUnPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldUnPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_un" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldUnPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldUnPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldUn'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldUn'][$this->getPrimaryKey()] = true;
        $keys = VldUnPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setUnId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldUnPeer::LOGID)) $criteria->add(VldUnPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldUnPeer::UN_ID)) $criteria->add(VldUnPeer::UN_ID, $this->un_id);
        if ($this->isColumnModified(VldUnPeer::IDTYPE)) $criteria->add(VldUnPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldUnPeer::STATUS_VALIDASI)) $criteria->add(VldUnPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldUnPeer::FIELD_ERROR)) $criteria->add(VldUnPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldUnPeer::ERROR_MESSAGE)) $criteria->add(VldUnPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldUnPeer::APP_USERNAME)) $criteria->add(VldUnPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldUnPeer::KETERANGAN)) $criteria->add(VldUnPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldUnPeer::CREATE_DATE)) $criteria->add(VldUnPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldUnPeer::LAST_UPDATE)) $criteria->add(VldUnPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldUnPeer::SOFT_DELETE)) $criteria->add(VldUnPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldUnPeer::LAST_SYNC)) $criteria->add(VldUnPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldUnPeer::UPDATER_ID)) $criteria->add(VldUnPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldUnPeer::DATABASE_NAME);
        $criteria->add(VldUnPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldUn (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldUn Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldUns($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldUnPeer::DEFAULT_STRING_FORMAT);
    }
