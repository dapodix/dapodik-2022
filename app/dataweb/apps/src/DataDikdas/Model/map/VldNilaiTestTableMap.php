...
/**
 * This class defines the structure of the 'vld_nilai_test' table.
 *
 *
 *
 ...
 */
class VldNilaiTestTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'DataDikdas.Model.map.VldNilaiTestTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('nilai_test_id', 'NilaiTestId', 'VARCHAR', 'nilai_test', 'nilai_test_id', true, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('NilaiTest', 'DataDikdas\\Model\\NilaiTest', RelationMap::MANY_TO_ONE, array('nilai_test_id' => 'nilai_test_id', ), 'RESTRICT', 'RESTRICT');
    } // buildRelations()

} // VldNilaiTestTableMap
