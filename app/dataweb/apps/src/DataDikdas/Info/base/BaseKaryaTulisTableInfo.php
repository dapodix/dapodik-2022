...
/*
 * The Base TableInfo for KaryaTulis Table
 */
class BaseKaryaTulisTableInfo extends TableInfo
{
    const CLASS_NAME = 'DataDikdas.Info.KaryaTulisTableMap';
    ...
    public function setVariables() {
        ...
        $this->setRendererString(   'karya_tulis_id_str');
        $this->setHeader(           'Karya Tulis');
        $this->setLabel(            'Karya tulis');
        ...
        $this->setXtypeRadio(       '');
        $this->setXtypeList(        '');
        $this->setHasMany(array(    "VldKaryaTulis"));
        $this->setBelongsTo(array(  "Ptk"));
        $this->setIsSplitEntity(    );
        $this->setHasSplitEntity(   );
        $this->setSplitEntityName(  '');
        $this->setRelatingColumns(array(    "VldKaryaTulis.karya_tulis_id"));
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'judul');
        $cvar->setColumnPhpName(    'Judul');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'tahun_pembuatan');
        $cvar->setColumnPhpName(    'TahunPembuatan');
        $cvar->setType(             'float');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Tahun Pembuatan');
        $cvar->setLabel(            'Tahun pembuatan');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'publikasi');
        $cvar->setColumnPhpName(    'Publikasi');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Publikasi');
        $cvar->setLabel(            'Publikasi');
        ...
        $cvar = new \DataDikdas\ColumnInfo();
        $cvar->setColumnName(       'url_publikasi');
        $cvar->setColumnPhpName(    'UrlPublikasi');
        $cvar->setType(             'string');
        $cvar->setIsPkUuid(         '0');
		$cvar->setIsPk(             '0');
        $cvar->setIsFk(             '0');
        ...
        $cvar->setMin(              0);
        $cvar->setMax(              99999999);
        $cvar->setHeader(           'Url Publikasi');
        $cvar->setLabel(            'Url publikasi');
