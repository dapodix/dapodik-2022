...
/**
 * Base class that represents a row from the 'vld_akt_pd' table.
 *
 * 
 *
 * @package    propel.generator.DataDikdas.Model.om
 */
abstract class BaseVldAktPd extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DataDikdas\\Model\\VldAktPdPeer';
    ...
    /**
     * Initializes internal state of BaseVldAktPd object.
     * @see        applyDefaults()
     */
     ...
     * @return VldAktPd The current object (for fluent API support)
     */
    public function setLogid($v)
    {
        ...
        if ($this->logid !== $v) {
            $this->logid = $v;
            $this->modifiedColumns[] = VldAktPdPeer::LOGID;
        }
    ...
    public function setIdAktPd($v)
    {
        ...
        if ($this->id_akt_pd !== $v) {
            $this->id_akt_pd = $v;
            $this->modifiedColumns[] = VldAktPdPeer::ID_AKT_PD;
        }
    ...
    public function setIdtype($v)
    {
        ...
        if ($this->idtype !== $v) {
            $this->idtype = $v;
            $this->modifiedColumns[] = VldAktPdPeer::IDTYPE;
        }
    ...
    public function setStatusValidasi($v)
    {
        ...
        if ($this->status_validasi !== $v) {
            ...
            $this->modifiedColumns[] = VldAktPdPeer::STATUS_VALIDASI;
        }
    ...
    public function setFieldError($v)
    {
        ...
        if ($this->field_error !== $v) {
            $this->field_error = $v;
            $this->modifiedColumns[] = VldAktPdPeer::FIELD_ERROR;
        }
    ...
    public function setErrorMessage($v)
    {
        ...
        if ($this->error_message !== $v) {
            ...
            $this->modifiedColumns[] = VldAktPdPeer::ERROR_MESSAGE;
        }
    ...
    public function setAppUsername($v)
    {
        ...
        if ($this->app_username !== $v) {
            $this->app_username = $v;
            $this->modifiedColumns[] = VldAktPdPeer::APP_USERNAME;
        }
    ...
    public function setKeterangan($v)
    {
        ...
        if ($this->keterangan !== $v) {
            $this->keterangan = $v;
            $this->modifiedColumns[] = VldAktPdPeer::KETERANGAN;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAktPdPeer::CREATE_DATE;
            }
    ...
    public function setLastUpdate($v)
    {
        ...
        if ($this->last_update !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = VldAktPdPeer::LAST_UPDATE;
            }
        } // if either are not null
    ...
    public function setSoftDelete($v)
    {
        ...
        if ($this->soft_delete !== $v) {
            $this->soft_delete = $v;
            $this->modifiedColumns[] = VldAktPdPeer::SOFT_DELETE;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = VldAktPdPeer::LAST_SYNC;
            }
        } // if either are not null
    ...
    public function setUpdaterId($v)
    {
        ...
        if ($this->updater_id !== $v) {
            $this->updater_id = $v;
            $this->modifiedColumns[] = VldAktPdPeer::UPDATER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 13; // 13 = VldAktPdPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating VldAktPd object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = VldAktPdPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = VldAktPdQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VldAktPdPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VldAktPdPeer::LOGID)) {
            $modifiedColumns[':p' . $index++]  = '"logid"';
        }
        if ($this->isColumnModified(VldAktPdPeer::ID_AKT_PD)) {
            $modifiedColumns[':p' . $index++]  = '"id_akt_pd"';
        }
        if ($this->isColumnModified(VldAktPdPeer::IDTYPE)) {
            $modifiedColumns[':p' . $index++]  = '"idtype"';
        }
        if ($this->isColumnModified(VldAktPdPeer::STATUS_VALIDASI)) {
            $modifiedColumns[':p' . $index++]  = '"status_validasi"';
        }
        if ($this->isColumnModified(VldAktPdPeer::FIELD_ERROR)) {
            $modifiedColumns[':p' . $index++]  = '"field_error"';
        }
        if ($this->isColumnModified(VldAktPdPeer::ERROR_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '"error_message"';
        }
        if ($this->isColumnModified(VldAktPdPeer::APP_USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '"app_username"';
        }
        if ($this->isColumnModified(VldAktPdPeer::KETERANGAN)) {
            $modifiedColumns[':p' . $index++]  = '"keterangan"';
        }
        if ($this->isColumnModified(VldAktPdPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '"create_date"';
        }
        if ($this->isColumnModified(VldAktPdPeer::LAST_UPDATE)) {
            $modifiedColumns[':p' . $index++]  = '"last_update"';
        }
        if ($this->isColumnModified(VldAktPdPeer::SOFT_DELETE)) {
            $modifiedColumns[':p' . $index++]  = '"soft_delete"';
        }
        if ($this->isColumnModified(VldAktPdPeer::LAST_SYNC)) {
            $modifiedColumns[':p' . $index++]  = '"last_sync"';
        }
        if ($this->isColumnModified(VldAktPdPeer::UPDATER_ID)) {
            $modifiedColumns[':p' . $index++]  = '"updater_id"';
        }

        $sql = sprintf(
            'INSERT INTO "vld_akt_pd" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = VldAktPdPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = VldAktPdPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['VldAktPd'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VldAktPd'][$this->getPrimaryKey()] = true;
        $keys = VldAktPdPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VldAktPdPeer::LOGID)) $criteria->add(VldAktPdPeer::LOGID, $this->logid);
        if ($this->isColumnModified(VldAktPdPeer::ID_AKT_PD)) $criteria->add(VldAktPdPeer::ID_AKT_PD, $this->id_akt_pd);
        if ($this->isColumnModified(VldAktPdPeer::IDTYPE)) $criteria->add(VldAktPdPeer::IDTYPE, $this->idtype);
        if ($this->isColumnModified(VldAktPdPeer::STATUS_VALIDASI)) $criteria->add(VldAktPdPeer::STATUS_VALIDASI, $this->status_validasi);
        if ($this->isColumnModified(VldAktPdPeer::FIELD_ERROR)) $criteria->add(VldAktPdPeer::FIELD_ERROR, $this->field_error);
        if ($this->isColumnModified(VldAktPdPeer::ERROR_MESSAGE)) $criteria->add(VldAktPdPeer::ERROR_MESSAGE, $this->error_message);
        if ($this->isColumnModified(VldAktPdPeer::APP_USERNAME)) $criteria->add(VldAktPdPeer::APP_USERNAME, $this->app_username);
        if ($this->isColumnModified(VldAktPdPeer::KETERANGAN)) $criteria->add(VldAktPdPeer::KETERANGAN, $this->keterangan);
        if ($this->isColumnModified(VldAktPdPeer::CREATE_DATE)) $criteria->add(VldAktPdPeer::CREATE_DATE, $this->create_date);
        if ($this->isColumnModified(VldAktPdPeer::LAST_UPDATE)) $criteria->add(VldAktPdPeer::LAST_UPDATE, $this->last_update);
        if ($this->isColumnModified(VldAktPdPeer::SOFT_DELETE)) $criteria->add(VldAktPdPeer::SOFT_DELETE, $this->soft_delete);
        if ($this->isColumnModified(VldAktPdPeer::LAST_SYNC)) $criteria->add(VldAktPdPeer::LAST_SYNC, $this->last_sync);
        if ($this->isColumnModified(VldAktPdPeer::UPDATER_ID)) $criteria->add(VldAktPdPeer::UPDATER_ID, $this->updater_id);
    ...
    {
        $criteria = new Criteria(VldAktPdPeer::DATABASE_NAME);
        $criteria->add(VldAktPdPeer::LOGID, $this->logid);
     ...
     * objects.
     *
     * @param object $copyObj An object of VldAktPd (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return VldAktPd Clone of current object.
     * @throws PropelException
     */
    ...
    public function getErrortype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aErrortype === null && ($this->idtype !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aErrortype->addVldAktPds($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(VldAktPdPeer::DEFAULT_STRING_FORMAT);
    }
